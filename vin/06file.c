...
fr.fun_name = ViWin_initialize_v6; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct ViWin* result  ;
    char* __dec_obj1  ;
...
void ViWin_statusBarView_v6(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_statusBarView_v6; neo_current_frame = &fr;    int maxy;
    int maxx;
...
void ViWin_saveCursorPosition(struct ViWin* self  , char* file_name)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_saveCursorPosition; neo_current_frame = &fr;    char* home;
...
void ViWin_readCursorPosition(struct ViWin* self  , char* file_name)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_readCursorPosition; neo_current_frame = &fr;    char* home;
    void* __right_value0 = (void*)0;
    char* bname  ;
    char* file_name2  ;
    struct _IO_FILE* f  ;
...
void ViWin_openFile_v6(struct ViWin* self  , char* file_name  , int line_num, _Bool binary_mode)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_openFile_v6; neo_current_frame = &fr;    struct _IO_FILE* f  ;
    void* __right_value0 = (void*)0;
    char* cmd  ;
    int rc;
    char* __dec_obj6  ;
...
void ViWin_makeTmpFile(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_makeTmpFile; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct _IO_FILE* f  ;
...
void ViWin_deleteTmpFile(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_deleteTmpFile; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
...
void ViWin_writeFile(struct ViWin* self  , _Bool binary_mode)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_writeFile; neo_current_frame = &fr;    char* home;
    void* __right_value0 = (void*)0;
    char* path  ;
    char* __dec_obj10  ;
    struct _IO_FILE* f  ;
...
void ViWin_writedFlagOn_v6(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_writedFlagOn_v6; neo_current_frame = &fr;    self->writed=1;
neo_current_frame = fr.prev;}
...
_Bool ViWin_saveDotToFile_v6(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_saveDotToFile_v6; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void Vi_openNewFile(struct Vi* self  , char* file_name  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_openNewFile; neo_current_frame = &fr;    int maxy;
    int maxx;
    int height;
    void* __right_value0 = (void*)0;
    ...
    ViWin_openFile_v6(win,(char*)come_increment_ref_count(file_name),-1,0);
...
void Vi_closeActiveWin(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_closeActiveWin; neo_current_frame = &fr;    int active_pos;
    void* __right_value0 = (void*)0;
...
static int list$1ViWin$ph_find(struct list$1ViWin$ph* self, struct ViWin* item  , int default_value, _Bool by_pointer)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1ViWin$ph_find; neo_current_frame = &fr;    int it2;
    struct list_item$1ViWin$ph* it;
    if(self==((void*)0)) {
           neo_current_frame = fr.prev;
        return default_value;
...
static struct list$1ViWin$ph* list$1ViWin$ph_delete(struct list$1ViWin$ph* self, int head, int tail)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1ViWin$ph_delete; neo_current_frame = &fr;    struct list$1ViWin$ph* __result_obj__0;
    int tmp;
    struct list_item$1ViWin$ph* it;
    int i;
    struct list_item$1ViWin$ph* prev_it;
...
static struct list$1ViWin$ph* list$1ViWin$ph_reset(struct list$1ViWin$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1ViWin$ph_reset; neo_current_frame = &fr;    struct list$1ViWin$ph* __result_obj__0;
    struct list_item$1ViWin$ph* it;
    struct list_item$1ViWin$ph* prev_it;
    if(self==((void*)0)) {
        __result_obj__0 = self;
...
static struct ViWin* list$1ViWin$ph_item(struct list$1ViWin$ph* self, int position, struct ViWin* default_value  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1ViWin$ph_item; neo_current_frame = &fr;    struct ViWin* __result_obj__0  ;
    struct list_item$1ViWin$ph* it;
    int i;
    if(self==((void*)0)) {
        __result_obj__0 = (struct ViWin*)come_increment_ref_count(default_value);
...
void Vi_exitFromApp_v6(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_exitFromApp_v6; neo_current_frame = &fr;    struct list$1ViWin$ph* o2_saved;
    struct ViWin* it  ;
    for(o2_saved=(struct list$1ViWin$ph*)come_increment_ref_count(self->wins),it=list$1ViWin$ph_begin(o2_saved);!list$1ViWin$ph_end(o2_saved);it=list$1ViWin$ph_next(o2_saved)){
        ViWin_writeFile(it,0);
...
void Vi_toggleWin(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_toggleWin; neo_current_frame = &fr;    int toggle_win;
    void* __right_value0 = (void*)0;
...
void Vi_nextWin(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_nextWin; neo_current_frame = &fr;    int next_win;
    int toggle_win;
    void* __right_value0 = (void*)0;
...
void Vi_prevWin(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_prevWin; neo_current_frame = &fr;    int prev_win;
    int toggle_win;
    void* __right_value0 = (void*)0;
...
struct Vi* Vi_initialize_v6(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_initialize_v6; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct Vi* result  ;
...
void Vi_repositionWindows_v6(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_repositionWindows_v6; neo_current_frame = &fr;    int maxy;
    int maxx;
    int height;
    int it2;
    struct list$1ViWin$ph* o2_saved;
...
void Vi_saveLastOpenFile(struct Vi* self  , char* file_name)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_saveLastOpenFile; neo_current_frame = &fr;    char* home;
    void* __right_value0 = (void*)0;
    char* file_name2  ;
    char* __dec_obj14  ;
    struct _IO_FILE* f  ;
...
char* Vi_readLastOpenFile(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_readLastOpenFile; neo_current_frame = &fr;    char* home;
...
void Vi_openFile_v6(struct Vi* self  , char* file_name  , int line_num, _Bool binary_mode)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_openFile_v6; neo_current_frame = &fr;    int active_pos;
    int maxx;
    int maxy;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
