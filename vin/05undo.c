...
fr.fun_name = ViWin_initialize_v5; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct ViWin* result  ;
...
static struct list$1list$1int$ph$ph* list$1list$1int$ph$ph_initialize(struct list$1list$1int$ph$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1list$1int$ph$ph_initialize; neo_current_frame = &fr;    struct list$1list$1int$ph$ph* __result_obj__0;
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
    ...
    neo_current_frame = fr.prev;    come_call_finalizer(list$1list$1int$ph$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__0;
    neo_current_frame = fr.prev;}
...
static void list$1list$1int$ph$ph_finalize(struct list$1list$1int$ph$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1list$1int$ph$ph_finalize; neo_current_frame = &fr;    struct list_item$1list$1int$ph$ph* it;
    struct list_item$1list$1int$ph$ph* prev_it;
    if(self==((void*)0)) {
        neo_current_frame = fr.prev;
        return;
...
void ViWin_pushUndo_v5(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_pushUndo_v5; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
...
static struct list$1list$1int$ph$ph* list$1list$1int$ph$ph_delete(struct list$1list$1int$ph$ph* self, int head, int tail)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1list$1int$ph$ph_delete; neo_current_frame = &fr;    struct list$1list$1int$ph$ph* __result_obj__0;
    int tmp;
    struct list_item$1list$1int$ph$ph* it;
    int i;
    struct list_item$1list$1int$ph$ph* prev_it;
...
static struct list$1list$1int$ph$ph* list$1list$1int$ph$ph_reset(struct list$1list$1int$ph$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1list$1int$ph$ph_reset; neo_current_frame = &fr;    struct list$1list$1int$ph$ph* __result_obj__0;
    struct list_item$1list$1int$ph$ph* it;
    struct list_item$1list$1int$ph$ph* prev_it;
    if(self==((void*)0)) {
        __result_obj__0 = self;
...
static struct list$1int$ph* list$1int$ph$p_clone(struct list$1int$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1int$ph$p_clone; neo_current_frame = &fr;    struct list$1int$ph* __result_obj__0;
...
static struct list$1list$1int$ph$ph* list$1list$1int$ph$ph_push_back(struct list$1list$1int$ph$ph* self, struct list$1int$ph* item)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1list$1int$ph$ph_push_back; neo_current_frame = &fr;    struct list$1list$1int$ph$ph* __result_obj__0;
    void* __right_value0 = (void*)0;
...
void ViWin_redo(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_redo; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct list$1int$ph* undo;
    int cursor_x;
    int scroll;
...
static int list$1list$1int$ph$ph_length(struct list$1list$1int$ph$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1list$1int$ph$ph_length; neo_current_frame = &fr;    if(self==((void*)0)) {
           neo_current_frame = fr.prev;
        return 0;
    }
       neo_current_frame = fr.prev;
...
static struct list$1int$ph* list$1list$1int$ph$ph_item(struct list$1list$1int$ph$ph* self, int position, struct list$1int$ph* default_value)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1list$1int$ph$ph_item; neo_current_frame = &fr;    struct list$1int$ph* __result_obj__0;
    struct list_item$1list$1int$ph$ph* it;
    int i;
    if(self==((void*)0)) {
...
void ViWin_undo(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_undo; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct list$1int$ph* undo;
    int cursor_x;
    int cursor_y;
...
static void lambda1(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda1; neo_current_frame = &fr;    ViWin_undo(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda2(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda2; neo_current_frame = &fr;    ViWin_redo(self->activeWin);
neo_current_frame = fr.prev;}
...
struct Vi* Vi_initialize_v5(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_initialize_v5; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct Vi* result  ;
...
void Vi_enterInsertMode_v5(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_enterInsertMode_v5; neo_current_frame = &fr;    Vi_enterInsertMode_v3(self);
