...
void ViWin_insertText(struct ViWin*  self  , int*  text  )
{
    ...
    if(list$1int$ph_length(self->texts)==0) {
        list$1int$ph_push_back(self->texts,(int* )come_increment_ref_count((int* )come_memdup(text, "src/03insert_mode.nc", 57, 15, "int* "), "src/03insert_mode.nc", 57, 16));
        list$1int$_push_back(self->texts_length,wcslen(text));
        self->cursorX+=wstring_length(text);
    }
    else {
        __right_value0 = (void*)0;
        old_line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","src/03insert_mode.nc",62)))), "src/03insert_mode.nc", 62, 29);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 62, 30));
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        new_line=(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value2=xsprintf("%ls%ls%ls",((int* )(__right_value0=wstring_substring(old_line,0,self->cursorX))),text,((int* )(__right_value1=wstring_substring(old_line,self->cursorX,-1)))))),"src/03insert_mode.nc",64), "src/03insert_mode.nc", 64, 31);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 64, 32));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 64, 33));
        (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 64, 34));
        list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(new_line, "src/03insert_mode.nc", 66, 43));
        list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(new_line));
        self->cursorX+=wstring_length(text);
        (old_line = come_decrement_ref_count(old_line, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 70, 44));
        (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 70, 45));
    }
    (text = come_decrement_ref_count(text, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 72, 46));
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_push_back(struct list$1int$ph* self, int*  item  )
{
    ...
    if(self==((void*)0)) {
        ...
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 1798, 1));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(self->len==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "lib/neo-c.h", 1802, 2, "struct list_item$1int$ph*"))), "lib/neo-c.h", 1802, 3);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        __dec_obj1=litem->item,
        litem->item=(int* )come_increment_ref_count(item, "lib/neo-c.h", 1806, 5);
        __dec_obj1 = come_decrement_ref_count(__dec_obj1, (void*)0, (void*)0, 0,0, (void*)0, "lib/neo-c.h", 1806, 4);
        self->tail=litem;
        self->head=litem;
    }
    else if(self->len==1) {
        __right_value0 = (void*)0;
        litem_0=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "lib/neo-c.h", 1812, 6, "struct list_item$1int$ph*"))), "lib/neo-c.h", 1812, 7);
        litem_0->prev=self->head;
        litem_0->next=((void*)0);
        __dec_obj2=litem_0->item,
        litem_0->item=(int* )come_increment_ref_count(item, "lib/neo-c.h", 1816, 9);
        __dec_obj2 = come_decrement_ref_count(__dec_obj2, (void*)0, (void*)0, 0,0, (void*)0, "lib/neo-c.h", 1816, 8);
        self->tail=litem_0;
        self->head->next=litem_0;
    }
    else {
        __right_value0 = (void*)0;
        litem_1=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "lib/neo-c.h", 1822, 10, "struct list_item$1int$ph*"))), "lib/neo-c.h", 1822, 11);
        litem_1->prev=self->tail;
        litem_1->next=((void*)0);
        __dec_obj3=litem_1->item,
        litem_1->item=(int* )come_increment_ref_count(item, "lib/neo-c.h", 1826, 13);
        __dec_obj3 = come_decrement_ref_count(__dec_obj3, (void*)0, (void*)0, 0,0, (void*)0, "lib/neo-c.h", 1826, 12);
        self->tail->next=litem_1;
        self->tail=litem_1;
    }
    self->len++;
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 1834, 14));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
static struct list$1int$* list$1int$_push_back(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "lib/neo-c.h", 1802, 17, "struct list_item$1int$*"))), "lib/neo-c.h", 1802, 18);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_2=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "lib/neo-c.h", 1812, 19, "struct list_item$1int$*"))), "lib/neo-c.h", 1812, 20);
        ...
        __right_value0 = (void*)0;
        litem_3=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "lib/neo-c.h", 1822, 21, "struct list_item$1int$*"))), "lib/neo-c.h", 1822, 22);
...
static int*  list$1int$ph_item(struct list$1int$ph* self, int position, int*  default_value  )
{
    ...
    memset(&i, 0, sizeof(i));
    if(self==((void*)0)) {
                __result_obj__0 = (int* )come_increment_ref_count(default_value, "lib/neo-c.h", 1930, 23);
        neo_current_frame = fr.prev;
        (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "lib/neo-c.h", 1930, 24));
        return __result_obj__0;
    }
    if(position<0) {
        position+=self->len;
    ...
    while(it!=((void*)0)) {
        if(position==i) {
                        __result_obj__0 = (int* )come_increment_ref_count(it->item, "lib/neo-c.h", 1941, 25);
            neo_current_frame = fr.prev;
            (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "lib/neo-c.h", 1941, 26));
            return __result_obj__0;
        }
        it=it->next;
        i++;
    }
        __result_obj__0 = (int* )come_increment_ref_count(default_value, "lib/neo-c.h", 1947, 27);
    neo_current_frame = fr.prev;
    (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "lib/neo-c.h", 1947, 28));
    return __result_obj__0;
}
...
static struct list$1int$ph* list$1int$ph_replace(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(self==((void*)0)) {
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 2213, 35));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position<0) {
    ...
    if(self->len==0||position>=self->len) {
        ...
        for(i=0        ;i<position-len;i++){
            ...
            list$1int$ph_push_back(self,(int* )come_increment_ref_count(default_value, "lib/neo-c.h", 2228, 36));
            (default_value = come_decrement_ref_count(default_value, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 2230, 37));
        }
        list$1int$ph_push_back(self,(int* )come_increment_ref_count(item, "lib/neo-c.h", 2230, 38));
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 2231, 39));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    it=self->head;
    ...
    while(it!=((void*)0)) {
        if(position==i_4) {
            __dec_obj4=it->item,
            it->item=(int* )come_increment_ref_count(item, "lib/neo-c.h", 2238, 41);
            __dec_obj4 = come_decrement_ref_count(__dec_obj4, (void*)0, (void*)0, 0,0, (void*)0, "lib/neo-c.h", 2238, 40);
            break;
        }
        it=it->next;
        i_4++;
        ...
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 2245, 42));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
void ViWin_enterNewLine(struct ViWin*  self  )
{
    ...
    old_line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","src/03insert_mode.nc",74)))), "src/03insert_mode.nc", 74, 47);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 74, 48));
    num_spaces=0;
    ...
    if(self->pasteMode) {
        ...
        new_line1=(int* )come_increment_ref_count(wstring_substring(old_line,0,self->cursorX), "src/03insert_mode.nc", 91, 50);
        __dec_obj5 = come_decrement_ref_count(__dec_obj5, (void*)0, (void*)0, 0,0, (void*)0, "src/03insert_mode.nc", 91, 49);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __dec_obj6=new_line2,
        new_line2=(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value1=xsprintf("%ls",((int* )(__right_value0=wstring_substring(old_line,self->cursorX,-1)))))),"src/03insert_mode.nc",92), "src/03insert_mode.nc", 92, 52);
        __dec_obj6 = come_decrement_ref_count(__dec_obj6, (void*)0, (void*)0, 0,0, (void*)0, "src/03insert_mode.nc", 92, 51);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 92, 53));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 92, 54));
    }
    else {
        __right_value0 = (void*)0;
        head_new_line=(int* )come_increment_ref_count((int *)come_calloc(1, sizeof(int )*(1*(num_spaces+1)), "src/03insert_mode.nc", 95, 55, "int* "), "src/03insert_mode.nc", 95, 56);
        __right_value0 = (void*)0;
        wcsncpy(head_new_line,((int* )(__right_value0=__builtin_wstring("","src/03insert_mode.nc",97))),num_spaces+1);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 97, 57));
        for(i_6=0        ;i_6<num_spaces;i_6++){
            __right_value0 = (void*)0;
            wcsncat(head_new_line,((int* )(__right_value0=__builtin_wstring(" ","src/03insert_mode.nc",100))),num_spaces+1);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 100, 58));
        }
        __right_value0 = (void*)0;
        __dec_obj7=new_line1,
        new_line1=(int* )come_increment_ref_count(wstring_substring(old_line,0,self->cursorX), "src/03insert_mode.nc", 103, 60);
        __dec_obj7 = come_decrement_ref_count(__dec_obj7, (void*)0, (void*)0, 0,0, (void*)0, "src/03insert_mode.nc", 103, 59);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __right_value2 = (void*)0;
        __dec_obj8=new_line2,
        new_line2=(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value1=xsprintf("%ls%ls",head_new_line,((int* )(__right_value0=wstring_substring(old_line,self->cursorX,-1)))))),"src/03insert_mode.nc",104), "src/03insert_mode.nc", 104, 62);
        __dec_obj8 = come_decrement_ref_count(__dec_obj8, (void*)0, (void*)0, 0,0, (void*)0, "src/03insert_mode.nc", 104, 61);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 104, 63));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 104, 64));
        (head_new_line = come_decrement_ref_count(head_new_line, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 107, 65));
    }
    list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(new_line1, "src/03insert_mode.nc", 107, 66));
    list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(new_line1));
    list$1int$ph_insert(self->texts,self->scroll+self->cursorY+1,(int* )come_increment_ref_count(new_line2, "src/03insert_mode.nc", 109, 85));
    ...
    (old_line = come_decrement_ref_count(old_line, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 117, 92));
    (new_line1 = come_decrement_ref_count(new_line1, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 117, 93));
    (new_line2 = come_decrement_ref_count(new_line2, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 117, 94));
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_insert(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(self==((void*)0)) {
        ...
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 1971, 67));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position<0) {
    ...
    if(self->len==0||position>=self->len) {
        ...
        for(i=0        ;i<position-len;i++){
            memset(&default_value,0,sizeof(int* ));
            list$1int$ph_push_back(self,(int* )come_increment_ref_count(default_value, "lib/neo-c.h", 1984, 68));
            (default_value = come_decrement_ref_count(default_value, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 1986, 69));
        }
        list$1int$ph_push_back(self,(int* )come_increment_ref_count(item, "lib/neo-c.h", 1986, 70));
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 1987, 71));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "lib/neo-c.h", 1991, 72, "struct list_item$1int$ph*"))), "lib/neo-c.h", 1991, 73);
        litem->prev=((void*)0);
        litem->next=self->head;
        __dec_obj9=litem->item,
        litem->item=(int* )come_increment_ref_count(item, "lib/neo-c.h", 1995, 75);
        __dec_obj9 = come_decrement_ref_count(__dec_obj9, (void*)0, (void*)0, 0,0, (void*)0, "lib/neo-c.h", 1995, 74);
        ...
        __right_value0 = (void*)0;
        litem_7=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "lib/neo-c.h", 2003, 76, "struct list_item$1int$ph*"))), "lib/neo-c.h", 2003, 77);
        litem_7->prev=self->head;
        litem_7->next=self->tail;
        __dec_obj10=litem_7->item,
        litem_7->item=(int* )come_increment_ref_count(item, "lib/neo-c.h", 2007, 79);
        __dec_obj10 = come_decrement_ref_count(__dec_obj10, (void*)0, (void*)0, 0,0, (void*)0, "lib/neo-c.h", 2007, 78);
        ...
        while(it!=((void*)0)) {
            if(position==i_8) {
                __right_value0 = (void*)0;
                litem_9=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "lib/neo-c.h", 2019, 80, "struct list_item$1int$ph*"))), "lib/neo-c.h", 2019, 81);
                litem_9->prev=it->prev;
                litem_9->next=it;
                __dec_obj11=litem_9->item,
                litem_9->item=(int* )come_increment_ref_count(item, "lib/neo-c.h", 2023, 83);
                __dec_obj11 = come_decrement_ref_count(__dec_obj11, (void*)0, (void*)0, 0,0, (void*)0, "lib/neo-c.h", 2023, 82);
        ...
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 2036, 84));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
static struct list$1int$* list$1int$_insert(struct list$1int$* self, int position, int item)
{
    ...
    if(position==0) {
        litem=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "lib/neo-c.h", 1991, 86, "struct list_item$1int$*"))), "lib/neo-c.h", 1991, 87);
        litem->prev=((void*)0);
        litem->next=self->head;
        litem->item=item;
        self->head->prev=litem;
        ...
        __right_value0 = (void*)0;
        litem_10=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "lib/neo-c.h", 2003, 88, "struct list_item$1int$*"))), "lib/neo-c.h", 2003, 89);
        ...
        while(it!=((void*)0)) {
            if(position==i_11) {
                __right_value0 = (void*)0;
                litem_12=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "lib/neo-c.h", 2019, 90, "struct list_item$1int$*"))), "lib/neo-c.h", 2019, 91);
...
void ViWin_enterNewLine2(struct ViWin*  self  )
{
    ...
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "src/03insert_mode.nc", 119, 95);
    num_spaces=0;
    ...
    __right_value0 = (void*)0;
    new_line=(int* )come_increment_ref_count((int *)come_calloc(1, sizeof(int )*(1*(num_spaces+1)), "src/03insert_mode.nc", 131, 96, "int* "), "src/03insert_mode.nc", 131, 97);
    __right_value0 = (void*)0;
    wcsncpy(new_line,((int* )(__right_value0=__builtin_wstring("","src/03insert_mode.nc",133))),num_spaces+1);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 133, 98));
    if(self->pasteMode) {
    }
    else {
        for(i_13=0        ;i_13<num_spaces;i_13++){
            __right_value0 = (void*)0;
            wcsncat(new_line,((int* )(__right_value0=__builtin_wstring(" ","src/03insert_mode.nc",139))),num_spaces+1);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 139, 99));
        }
    }
    list$1int$ph_insert(self->texts,self->scroll+self->cursorY+1,(int* )come_increment_ref_count(new_line, "src/03insert_mode.nc", 143, 100));
    list$1int$_insert(self->texts_length,self->scroll+self->cursorY+1,wcslen(new_line));
    self->cursorY++;
    self->cursorX=num_spaces;
    ViWin_modifyOverCursorYValue(self);
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 151, 101));
    (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 151, 102));
    neo_current_frame = fr.prev;
}
...
void ViWin_backSpace(struct ViWin*  self  )
{
    ...
    int*  line  ;
    memset(&line, 0, sizeof(line));
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","src/03insert_mode.nc",153)))), "src/03insert_mode.nc", 153, 103);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 153, 104));
    if(wstring_length(line)>0&&self->cursorX>0) {
        __right_value0 = (void*)0;
        ((int* )(__right_value0=wstring_delete(line,self->cursorX-1,self->cursorX)));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 156, 105));
        self->cursorX--;
    }
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 161, 106));
    neo_current_frame = fr.prev;
}
...
void ViWin_backIndent(struct ViWin*  self  )
{
    ...
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","src/03insert_mode.nc",165)))), "src/03insert_mode.nc", 165, 107);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 165, 108));
    if(wstring_length(line)>=4) {
        if(__right_value0 = (void*)0,
({(_conditional_value_X0=(wstring_index(line,((int* )(__right_value0=__builtin_wstring("    ","src/03insert_mode.nc",168))),-1)==0));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 168, 109));
_conditional_value_X0;})) {
            for(i=0            ;i<4;i++){
                __right_value0 = (void*)0;
                ((int* )(__right_value0=wstring_delete(line,0,1)));
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 170, 110));
                self->cursorX--;
                if(self->cursorX<0) {
                    self->cursorX=0;
                }
    ...
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 181, 111));
    neo_current_frame = fr.prev;
}
...
void ViWin_inputInsertMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    ...
    if(key==3||key==27) {
        ...
        str=(int* )come_increment_ref_count(wstring_substring(((int* )(__right_value0=list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)))),0,self->cursorX), "src/03insert_mode.nc", 226, 112);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 226, 113));
        all_space=(_Bool)1;
        ...
        if(str[0]==0||all_space) {
            __right_value0 = (void*)0;
            ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring("    ","src/03insert_mode.nc",234), "src/03insert_mode.nc", 234, 114));
        }
        else {
            ViWin_completion_v13(self,nvi);
        }
        (str = come_decrement_ref_count(str, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 338, 115));
    }
    else if(key>127) {
        ...
        __right_value0 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(keys,"src/03insert_mode.nc",265), "src/03insert_mode.nc", 265, 116));
    }
    else if(key==40) {
        ViWin_blinkBraceFoward(self,40,41,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/03insert_mode.nc",269), "src/03insert_mode.nc", 269, 117));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 269, 118));
    }
    else if(key==123) {
        ViWin_blinkBraceFoward(self,123,125,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/03insert_mode.nc",273), "src/03insert_mode.nc", 273, 119));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 273, 120));
    }
    else if(key==91) {
        ViWin_blinkBraceFoward(self,60,62,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/03insert_mode.nc",277), "src/03insert_mode.nc", 277, 121));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 277, 122));
    }
    else if(key==41) {
        ViWin_blinkBraceEnd(self,40,41,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/03insert_mode.nc",281), "src/03insert_mode.nc", 281, 123));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 281, 124));
    }
    else if(key==125) {
        ViWin_blinkBraceEnd(self,123,125,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/03insert_mode.nc",285), "src/03insert_mode.nc", 285, 125));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 285, 126));
    }
    else if(key==93) {
        ViWin_blinkBraceEnd(self,91,93,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/03insert_mode.nc",289), "src/03insert_mode.nc", 289, 127));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 289, 128));
    }
    else if(key==62) {
        ViWin_blinkBraceEnd(self,60,62,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/03insert_mode.nc",293), "src/03insert_mode.nc", 293, 129));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 293, 130));
    }
    else if(key==87-65+1) {
        ...
        if(cursor_y==self->cursorY) {
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","src/03insert_mode.nc",302)))), "src/03insert_mode.nc", 302, 131);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 302, 132));
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line,self->cursorX,cursor_x+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 303, 133));
            __right_value0 = (void*)0;
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count((int* )come_memdup(line, "src/03insert_mode.nc", 305, 134, "int* "), "src/03insert_mode.nc", 305, 135));
            list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(line));
            ViWin_modifyOverCursorXValue(self);
            self->cursorX++;
            (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 322, 136));
        }
        else {
            self->cursorY=cursor_y;
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            line_15=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","src/03insert_mode.nc",312)))), "src/03insert_mode.nc", 312, 137);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 312, 138));
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line_15,0,cursor_x+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/03insert_mode.nc", 314, 139));
            __right_value0 = (void*)0;
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count((int* )come_memdup(line_15, "src/03insert_mode.nc", 316, 140, "int* "), "src/03insert_mode.nc", 316, 141));
            list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(line_15));
            self->cursorX=0;
            self->cursorY=cursor_y;
            (line_15 = come_decrement_ref_count(line_15, (void*)0, (void*)0, 0, 0, (void*)0, "src/03insert_mode.nc", 322, 142));
        }
    }
    else if(key==86-65+1) {
        ...
        str_17[1]=0;
        __right_value0 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(str_17,"src/03insert_mode.nc",331), "src/03insert_mode.nc", 331, 143));
    }
    else {
        char buf[128];
        ...
        __right_value0 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(buf,"src/03insert_mode.nc",336), "src/03insert_mode.nc", 336, 144));
    }
    neo_current_frame = fr.prev;
}
...
struct Vi*  Vi_initialize_v3(struct Vi*  self  )
{
    ...
    result=(struct Vi* )come_increment_ref_count(Vi_initialize_v2((struct Vi* )come_increment_ref_count(self, "src/03insert_mode.nc", 428, 145)), "src/03insert_mode.nc", 428, 146);
    result->mode=(0);
    ...
    list$1lambda$_replace(result->events,111,lambda5);
        __result_obj__0 = (struct Vi* )come_increment_ref_count(result, "src/03insert_mode.nc", 468, 153);
    come_call_finalizer(Vi_finalize, self, (void*)0, (void*)0, 0, 0, 0, (void*)0, "src/03insert_mode.nc}", 468, 207);
    come_call_finalizer(Vi_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "src/03insert_mode.nc}", 468, 208);
    neo_current_frame = fr.prev;
    come_call_finalizer(Vi_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "src/03insert_mode.nc}", 468, 209);
    return __result_obj__0;
}
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "lib/neo-c.h", 1802, 147, "struct list_item$1lambda$*"))), "lib/neo-c.h", 1802, 148);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_18=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "lib/neo-c.h", 1812, 149, "struct list_item$1lambda$*"))), "lib/neo-c.h", 1812, 150);
        ...
        __right_value0 = (void*)0;
        litem_19=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "lib/neo-c.h", 1822, 151, "struct list_item$1lambda$*"))), "lib/neo-c.h", 1822, 152);
...
static void list$1ViWin$ph$p_finalize(struct list$1ViWin$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1ViWin$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 189);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1int$ph$p_finalize(struct list$1int$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 155);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1int$$p_finalize(struct list$1int$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 157);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1tuple3$3int$int$int$$ph$p_finalize(struct list$1tuple3$3int$int$int$$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1tuple3$3int$int$int$$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 161);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1list$1int$ph$ph$p_finalize(struct list$1list$1int$ph$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1list$1int$ph$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 164);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$list$1list$1int$$ph$ph$p_finalize(struct map$2int$list$1list$1int$$ph$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(list$1list$1int$$ph$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 2, 174);
            }
        }
    }
    ...
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3660, 175);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3662, 176));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3663, 177));
            neo_current_frame = fr.prev;
}
...
static void list$1list$1int$$ph$p_finalize(struct list$1list$1int$$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1list$1int$$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 173);
    }
                    neo_current_frame = fr.prev;
}
...
static void map$2int$tuple3$3int$int$int$$ph$p_finalize(struct map$2int$tuple3$3int$int$int$$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(tuple3$3int$int$int$$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3645, 181);
            }
        }
    }
    come_free((char*)self->items);
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3660, 182);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3662, 183));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3663, 184));
            neo_current_frame = fr.prev;
}
...
static void list$1lambda$$p_finalize(struct list$1lambda$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1lambda$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 191);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$list$1int$ph$ph$p_finalize(struct map$2int$list$1int$ph$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(list$1int$ph$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3645, 195);
            }
        }
    }
    come_free((char*)self->items);
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3660, 196);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3662, 197));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3663, 198));
            neo_current_frame = fr.prev;
}
...
static void map$2int$int$$p_finalize(struct map$2int$int$* self)
{
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3660, 200);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3662, 201));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3663, 202));
            neo_current_frame = fr.prev;
}
...
static void list$1char$ph$p_finalize(struct list$1char$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1char$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 205);
    }
            neo_current_frame = fr.prev;
}
...
int Vi_main_loop_v3(struct Vi*  self  )
{
    ...
    while(!self->appEnd) {
        werase(stdscr);
        for(_o2_saved_1=(struct list$1ViWin$ph*)come_increment_ref_count(self->wins, "src/03insert_mode.nc", 476, 210),it=list$1ViWin$ph_begin(_o2_saved_1)        ;!list$1ViWin$ph_end(_o2_saved_1);it=list$1ViWin$ph_next(_o2_saved_1)){
        ...
        come_call_finalizer(list$1ViWin$ph$p_finalize, _o2_saved_1, (void*)0, (void*)0, 0, 0, 0, (void*)0, "src/03insert_mode.nc}", 486, 211);
    }
        neo_current_frame = fr.prev;
    return 0;
    neo_current_frame = fr.prev;
