...
static _Bool is_insert_mode_word_char(int  c  );
static _Bool is_insert_mode_file_char(int  c  );
...
static _Bool is_insert_mode_word_char(int  c  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "is_insert_mode_word_char"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
...
static _Bool is_insert_mode_file_char(int  c  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "is_insert_mode_file_char"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
        neo_current_frame = fr.prev;
...
void ViWin_insertModeView(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_insertModeView"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    werase(self->win);
...
void ViWin_view_v3(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_view_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    if(nvi->mode==(1)&&ViWin_equals(self,nvi->activeWin)) {
        ViWin_insertModeView(self,nvi);
    }
    else {
...
void ViWin_insertText(struct ViWin*  self  , int*  text  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_insertText"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    ...
    if(list$1int$ph_length(self->texts)==0) {
        list$1int$ph_push_back(self->texts,(int* )come_increment_ref_count((int* )come_memdup(text, "03insert_mode.nc", 57, 15, "int* "), "03insert_mode.nc", 57, 16));
        list$1int$_push_back(self->texts_length,wcslen(text));
        self->cursorX+=wstring_length(text);
    }
    else {
        __right_value0 = (void*)0;
        old_line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","03insert_mode.nc",62)))), "03insert_mode.nc", 62, 29);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 62, 30));
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        new_line=(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value2=xsprintf("%ls%ls%ls",((int* )(__right_value0=wstring_substring(old_line,0,self->cursorX))),text,((int* )(__right_value1=wstring_substring(old_line,self->cursorX,-1)))))),"03insert_mode.nc",64), "03insert_mode.nc", 64, 31);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 64, 32));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 64, 33));
        (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 64, 34));
        list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(new_line, "03insert_mode.nc", 66, 43));
        list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(new_line));
        self->cursorX+=wstring_length(text);
        (old_line = come_decrement_ref_count(old_line, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 70, 44));
        (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 70, 45));
    }
    (text = come_decrement_ref_count(text, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 72, 46));
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_push_back(struct list$1int$ph* self, int*  item  )
{
    ...
    if(self==((void*)0)) {
        ...
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1674, 1));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(self->len==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1678, 2, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1678, 3);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        __dec_obj1=litem->item,
        litem->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1682, 5);
        __dec_obj1 = come_decrement_ref_count(__dec_obj1, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1682, 4);
        self->tail=litem;
        self->head=litem;
    }
    else if(self->len==1) {
        __right_value0 = (void*)0;
        litem_0=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1688, 6, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1688, 7);
        litem_0->prev=self->head;
        litem_0->next=((void*)0);
        __dec_obj2=litem_0->item,
        litem_0->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1692, 9);
        __dec_obj2 = come_decrement_ref_count(__dec_obj2, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1692, 8);
        self->tail=litem_0;
        self->head->next=litem_0;
    }
    else {
        __right_value0 = (void*)0;
        litem_1=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1698, 10, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1698, 11);
        litem_1->prev=self->tail;
        litem_1->next=((void*)0);
        __dec_obj3=litem_1->item,
        litem_1->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1702, 13);
        __dec_obj3 = come_decrement_ref_count(__dec_obj3, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1702, 12);
        self->tail->next=litem_1;
        self->tail=litem_1;
    }
    self->len++;
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1710, 14));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
static struct list$1int$* list$1int$_push_back(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1678, 17, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1678, 18);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_2=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1688, 19, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1688, 20);
        ...
        __right_value0 = (void*)0;
        litem_3=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1698, 21, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1698, 22);
...
static int*  list$1int$ph_item(struct list$1int$ph* self, int position, int*  default_value  )
{
    ...
    memset(&i, 0, sizeof(i));
    if(self==((void*)0)) {
                __result_obj__0 = (int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 1806, 23);
        neo_current_frame = fr.prev;
        (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "/usr/local/include/neo-c.h", 1806, 24));
        return __result_obj__0;
    }
    if(position<0) {
        position+=self->len;
    ...
    while(it!=((void*)0)) {
        if(position==i) {
                        __result_obj__0 = (int* )come_increment_ref_count(it->item, "/usr/local/include/neo-c.h", 1817, 25);
            neo_current_frame = fr.prev;
            (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "/usr/local/include/neo-c.h", 1817, 26));
            return __result_obj__0;
        }
        it=it->next;
        i++;
    }
        __result_obj__0 = (int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 1823, 27);
    neo_current_frame = fr.prev;
    (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "/usr/local/include/neo-c.h", 1823, 28));
    return __result_obj__0;
}
...
static struct list$1int$ph* list$1int$ph_replace(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(self==((void*)0)) {
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2089, 35));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position<0) {
    ...
    if(self->len==0||position>=self->len) {
        ...
        for(i=0        ;i<position-len;i++){
            ...
            list$1int$ph_push_back(self,(int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 2104, 36));
            (default_value = come_decrement_ref_count(default_value, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2106, 37));
        }
        list$1int$ph_push_back(self,(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 2106, 38));
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2107, 39));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    it=self->head;
    ...
    while(it!=((void*)0)) {
        if(position==i_4) {
            __dec_obj4=it->item,
            it->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 2114, 41);
            __dec_obj4 = come_decrement_ref_count(__dec_obj4, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 2114, 40);
            break;
        }
        it=it->next;
        i_4++;
        ...
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2121, 42));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
void ViWin_enterNewLine(struct ViWin*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_enterNewLine"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int*  old_line  ;
    int num_spaces;
    ...
    int*  __dec_obj8  ;
    memset(&old_line, 0, sizeof(old_line));
    memset(&num_spaces, 0, sizeof(num_spaces));
    memset(&i, 0, sizeof(i));
    memset(&new_line1, 0, sizeof(new_line1));
    memset(&new_line2, 0, sizeof(new_line2));
    memset(&head_new_line, 0, sizeof(head_new_line));
    memset(&i_6, 0, sizeof(i_6));
    old_line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","03insert_mode.nc",74)))), "03insert_mode.nc", 74, 47);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 74, 48));
    num_spaces=0;
    ...
    if(self->pasteMode) {
        ...
        new_line1=(int* )come_increment_ref_count(wstring_substring(old_line,0,self->cursorX), "03insert_mode.nc", 91, 50);
        __dec_obj5 = come_decrement_ref_count(__dec_obj5, (void*)0, (void*)0, 0,0, (void*)0, "03insert_mode.nc", 91, 49);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __dec_obj6=new_line2,
        new_line2=(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value1=xsprintf("%ls",((int* )(__right_value0=wstring_substring(old_line,self->cursorX,-1)))))),"03insert_mode.nc",92), "03insert_mode.nc", 92, 52);
        __dec_obj6 = come_decrement_ref_count(__dec_obj6, (void*)0, (void*)0, 0,0, (void*)0, "03insert_mode.nc", 92, 51);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 92, 53));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 92, 54));
    }
    else {
        __right_value0 = (void*)0;
        head_new_line=(int* )come_increment_ref_count((int *)come_calloc(1, sizeof(int )*(1*(num_spaces+1)), "03insert_mode.nc", 95, 55, "int* "), "03insert_mode.nc", 95, 56);
        __right_value0 = (void*)0;
        wcsncpy(head_new_line,((int* )(__right_value0=__builtin_wstring("","03insert_mode.nc",97))),num_spaces+1);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 97, 57));
        for(i_6=0        ;i_6<num_spaces;i_6++){
            __right_value0 = (void*)0;
            wcsncat(head_new_line,((int* )(__right_value0=__builtin_wstring(" ","03insert_mode.nc",100))),num_spaces+1);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 100, 58));
        }
        __right_value0 = (void*)0;
        __dec_obj7=new_line1,
        new_line1=(int* )come_increment_ref_count(wstring_substring(old_line,0,self->cursorX), "03insert_mode.nc", 103, 60);
        __dec_obj7 = come_decrement_ref_count(__dec_obj7, (void*)0, (void*)0, 0,0, (void*)0, "03insert_mode.nc", 103, 59);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __right_value2 = (void*)0;
        __dec_obj8=new_line2,
        new_line2=(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value1=xsprintf("%ls%ls",head_new_line,((int* )(__right_value0=wstring_substring(old_line,self->cursorX,-1)))))),"03insert_mode.nc",104), "03insert_mode.nc", 104, 62);
        __dec_obj8 = come_decrement_ref_count(__dec_obj8, (void*)0, (void*)0, 0,0, (void*)0, "03insert_mode.nc", 104, 61);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 104, 63));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 104, 64));
        (head_new_line = come_decrement_ref_count(head_new_line, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 107, 65));
    }
    list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(new_line1, "03insert_mode.nc", 107, 66));
    list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(new_line1));
    list$1int$ph_insert(self->texts,self->scroll+self->cursorY+1,(int* )come_increment_ref_count(new_line2, "03insert_mode.nc", 109, 85));
    ...
    (old_line = come_decrement_ref_count(old_line, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 117, 92));
    (new_line1 = come_decrement_ref_count(new_line1, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 117, 93));
    (new_line2 = come_decrement_ref_count(new_line2, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 117, 94));
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_insert(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(self==((void*)0)) {
        ...
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1847, 67));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position<0) {
    ...
    if(self->len==0||position>=self->len) {
        ...
        for(i=0        ;i<position-len;i++){
            memset(&default_value,0,sizeof(int* ));
            list$1int$ph_push_back(self,(int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 1860, 68));
            (default_value = come_decrement_ref_count(default_value, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1862, 69));
        }
        list$1int$ph_push_back(self,(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1862, 70));
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1863, 71));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1867, 72, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1867, 73);
        litem->prev=((void*)0);
        litem->next=self->head;
        __dec_obj9=litem->item,
        litem->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1871, 75);
        __dec_obj9 = come_decrement_ref_count(__dec_obj9, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1871, 74);
        ...
        __right_value0 = (void*)0;
        litem_7=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1879, 76, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1879, 77);
        litem_7->prev=self->head;
        litem_7->next=self->tail;
        __dec_obj10=litem_7->item,
        litem_7->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1883, 79);
        __dec_obj10 = come_decrement_ref_count(__dec_obj10, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1883, 78);
        self->tail->prev=litem_7;
        ...
        while(it!=((void*)0)) {
            if(position==i_8) {
                __right_value0 = (void*)0;
                litem_9=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1895, 80, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1895, 81);
                litem_9->prev=it->prev;
                litem_9->next=it;
                __dec_obj11=litem_9->item,
                litem_9->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1899, 83);
                __dec_obj11 = come_decrement_ref_count(__dec_obj11, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1899, 82);
                it->prev->next=litem_9;
                it->prev=litem_9;
                self->len++;
            }
            it=it->next;
        ...
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1912, 84));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
static struct list$1int$* list$1int$_insert(struct list$1int$* self, int position, int item)
{
    ...
    if(position==0) {
        litem=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1867, 86, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1867, 87);
        litem->prev=((void*)0);
        litem->next=self->head;
        litem->item=item;
        self->head->prev=litem;
        ...
        __right_value0 = (void*)0;
        litem_10=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1879, 88, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1879, 89);
        litem_10->prev=self->head;
        litem_10->next=self->tail;
        litem_10->item=item;
        self->tail->prev=litem_10;
        ...
        while(it!=((void*)0)) {
            if(position==i_11) {
                __right_value0 = (void*)0;
                litem_12=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1895, 90, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1895, 91);
                litem_12->prev=it->prev;
                litem_12->next=it;
                litem_12->item=item;
                it->prev->next=litem_12;
                it->prev=litem_12;
                self->len++;
            }
            it=it->next;
...
void ViWin_enterNewLine2(struct ViWin*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_enterNewLine2"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    int*  line  ;
    int num_spaces;
    int i;
    ...
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "03insert_mode.nc", 119, 95);
    num_spaces=0;
    ...
    __right_value0 = (void*)0;
    new_line=(int* )come_increment_ref_count((int *)come_calloc(1, sizeof(int )*(1*(num_spaces+1)), "03insert_mode.nc", 131, 96, "int* "), "03insert_mode.nc", 131, 97);
    __right_value0 = (void*)0;
    wcsncpy(new_line,((int* )(__right_value0=__builtin_wstring("","03insert_mode.nc",133))),num_spaces+1);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 133, 98));
    if(self->pasteMode) {
    }
    else {
        for(i_13=0        ;i_13<num_spaces;i_13++){
            __right_value0 = (void*)0;
            wcsncat(new_line,((int* )(__right_value0=__builtin_wstring(" ","03insert_mode.nc",139))),num_spaces+1);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 139, 99));
        }
    }
    list$1int$ph_insert(self->texts,self->scroll+self->cursorY+1,(int* )come_increment_ref_count(new_line, "03insert_mode.nc", 143, 100));
    list$1int$_insert(self->texts_length,self->scroll+self->cursorY+1,wcslen(new_line));
    self->cursorY++;
    self->cursorX=num_spaces;
    ViWin_modifyOverCursorYValue(self);
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 151, 101));
    (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 151, 102));
    neo_current_frame = fr.prev;
}

void ViWin_backSpace(struct ViWin*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_backSpace"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int*  line  ;
    memset(&line, 0, sizeof(line));
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","03insert_mode.nc",153)))), "03insert_mode.nc", 153, 103);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 153, 104));
    if(wstring_length(line)>0&&self->cursorX>0) {
        __right_value0 = (void*)0;
        ((int* )(__right_value0=wstring_delete(line,self->cursorX-1,self->cursorX)));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 156, 105));
        self->cursorX--;
    }
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 161, 106));
    neo_current_frame = fr.prev;
}

void ViWin_backIndent(struct ViWin*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_backIndent"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int*  line  ;
    ...
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","03insert_mode.nc",165)))), "03insert_mode.nc", 165, 107);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 165, 108));
    if(wstring_length(line)>=4) {
        if(__right_value0 = (void*)0,
({(_conditional_value_X0=(wstring_index(line,((int* )(__right_value0=__builtin_wstring("    ","03insert_mode.nc",168))),-1)==0));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 168, 109));
_conditional_value_X0;})) {
            for(i=0            ;i<4;i++){
                __right_value0 = (void*)0;
                ((int* )(__right_value0=wstring_delete(line,0,1)));
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 170, 110));
                self->cursorX--;
                if(self->cursorX<0) {
                    self->cursorX=0;
                }
    ...
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 181, 111));
    neo_current_frame = fr.prev;
}

void ViWin_blinkBraceFoward(struct ViWin*  self  , int  head  , int  tail  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_blinkBraceFoward"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_blinkBraceEnd(struct ViWin*  self  , int  head  , int  tail  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_blinkBraceEnd"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_inputInsertMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_inputInsertMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int key;
    int key2;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    ...
    memset(&all_space, 0, sizeof(all_space));
    memset(&i, 0, sizeof(i));
    ...
    memset(&key2_16, 0, sizeof(key2_16));
    key=ViWin_getKey_v14(self,(_Bool)0);
    if(key!=78-65+1&&key!=80-65+1) {
    ...
    if(key==3||key==27) {
        ...
        ViWin_completionNext_v3(self,nvi,(_Bool)0);
    }
    else if(key==80-65+1) {
        ViWin_completionNext_v3(self,nvi,(_Bool)1);
    }
    else if(key==70-65+1) {
        ViWin_completionFileName_v13(self,nvi);
    }
    else if(key==88-65+1) {
        key2=ViWin_getKey_v14(self,(_Bool)0);
        if(key2==88-65+1) {
            ViWin_completion_neo_c2_v3(self,nvi);
        }
    }
    else if(key==4) {
        ...
        str=(int* )come_increment_ref_count(wstring_substring(((int* )(__right_value0=list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)))),0,self->cursorX), "03insert_mode.nc", 226, 112);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 226, 113));
        all_space=(_Bool)1;
        ...
        if(str[0]==0||all_space) {
            __right_value0 = (void*)0;
            ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring("    ","03insert_mode.nc",234), "03insert_mode.nc", 234, 114));
        }
        else {
            ViWin_completion_v13(self,nvi);
        }
        (str = come_decrement_ref_count(str, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 338, 115));
    }
    else if(key>127) {
        size=((key&0x80)>>7)+((key&0x40)>>6)+((key&0x20)>>5)+((key&0x10)>>4);
        char keys[16];
        memset(&keys, 0, sizeof(keys));
        ({ long long __neo_array_index1_0 = (long long)(0); if(__neo_array_index1_0 < 0 || __neo_array_index1_0 >= (long long)(16)) { extern void stackframe(void) __attribute__((weak)); extern void exit(int); puts("array index out of bounds"); if(stackframe) stackframe(); else { puts("stackframe"); puts(__func__); } exit(2); } keys[__neo_array_index1_0] = key; });
        for(i_14=1        ;i_14<size;i_14++){
            ({ long long __neo_array_index2_0 = (long long)(i_14); if(__neo_array_index2_0 < 0 || __neo_array_index2_0 >= (long long)(16)) { extern void stackframe(void) __attribute__((weak)); extern void exit(int); puts("array index out of bounds"); if(stackframe) stackframe(); else { puts("stackframe"); puts(__func__); } exit(2); } keys[__neo_array_index2_0] = ViWin_getKey_v14(self,(_Bool)0); });
        }
        ({ long long __neo_array_index3_0 = (long long)(i_14); if(__neo_array_index3_0 < 0 || __neo_array_index3_0 >= (long long)(16)) { extern void stackframe(void) __attribute__((weak)); extern void exit(int); puts("array index out of bounds"); if(stackframe) stackframe(); else { puts("stackframe"); puts(__func__); } exit(2); } keys[__neo_array_index3_0] = 0; });
        __right_value0 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(keys,"03insert_mode.nc",265), "03insert_mode.nc", 265, 116));
    }
    else if(key==40) {
        ViWin_blinkBraceFoward(self,40,41,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"03insert_mode.nc",269), "03insert_mode.nc", 269, 117));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 269, 118));
    }
    else if(key==123) {
        ViWin_blinkBraceFoward(self,123,125,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"03insert_mode.nc",273), "03insert_mode.nc", 273, 119));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 273, 120));
    }
    else if(key==91) {
        ViWin_blinkBraceFoward(self,60,62,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"03insert_mode.nc",277), "03insert_mode.nc", 277, 121));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 277, 122));
    }
    else if(key==41) {
        ViWin_blinkBraceEnd(self,40,41,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"03insert_mode.nc",281), "03insert_mode.nc", 281, 123));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 281, 124));
    }
    else if(key==125) {
        ViWin_blinkBraceEnd(self,123,125,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"03insert_mode.nc",285), "03insert_mode.nc", 285, 125));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 285, 126));
    }
    else if(key==93) {
        ViWin_blinkBraceEnd(self,91,93,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"03insert_mode.nc",289), "03insert_mode.nc", 289, 127));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 289, 128));
    }
    else if(key==62) {
        ViWin_blinkBraceEnd(self,60,62,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"03insert_mode.nc",293), "03insert_mode.nc", 293, 129));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 293, 130));
    }
    else if(key==87-65+1) {
        ...
        if(cursor_y==self->cursorY) {
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","03insert_mode.nc",302)))), "03insert_mode.nc", 302, 131);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 302, 132));
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line,self->cursorX,cursor_x+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 303, 133));
            __right_value0 = (void*)0;
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count((int* )come_memdup(line, "03insert_mode.nc", 305, 134, "int* "), "03insert_mode.nc", 305, 135));
            list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(line));
            ViWin_modifyOverCursorXValue(self);
            self->cursorX++;
            (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 322, 136));
        }
        else {
            self->cursorY=cursor_y;
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            line_15=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","03insert_mode.nc",312)))), "03insert_mode.nc", 312, 137);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 312, 138));
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line_15,0,cursor_x+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "03insert_mode.nc", 314, 139));
            __right_value0 = (void*)0;
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count((int* )come_memdup(line_15, "03insert_mode.nc", 316, 140, "int* "), "03insert_mode.nc", 316, 141));
            list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(line_15));
            self->cursorX=0;
            self->cursorY=cursor_y;
            (line_15 = come_decrement_ref_count(line_15, (void*)0, (void*)0, 0, 0, (void*)0, "03insert_mode.nc", 322, 142));
        }
    }
    else if(key==86-65+1) {
        key2_16=ViWin_getKey_v14(self,(_Bool)0);
        char str_17[2];
        memset(&str_17, 0, sizeof(str_17));
        str_17[0]=key2_16;
        str_17[1]=0;
        __right_value0 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(str_17,"03insert_mode.nc",331), "03insert_mode.nc", 331, 143));
    }
    else {
        char buf[128];
        ...
        __right_value0 = (void*)0;
        ViWin_insertText(self,(int* )come_increment_ref_count(__builtin_wstring(buf,"03insert_mode.nc",336), "03insert_mode.nc", 336, 144));
    }
    neo_current_frame = fr.prev;
}
...
void ViWin_input_v3(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_input_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    if(nvi->mode==(1)) {
        ViWin_inputInsertMode(self,nvi);
    }
    else {
...
void ViWin_pushUndo_v3(struct ViWin*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_pushUndo_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_writedFlagOn_v3(struct ViWin*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_writedFlagOn_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_completion_v3(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_completion_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_completion_neo_c2_v3(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_completion_neo_c2_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_completionFileName_v3(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_completionFileName_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_completionNext_v3(struct ViWin*  self  , struct Vi*  nvi  , _Bool prev)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_completionNext_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_clearInputedKey_v3(struct ViWin*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_clearInputedKey_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_resetCompletionState_v3(struct ViWin*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_resetCompletionState_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_saveInputedKey_v3(struct ViWin*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_saveInputedKey_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_backwardWord_v3(struct ViWin*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_backwardWord_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void Vi_enterInsertMode_v3(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterInsertMode_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    self->mode=(1);
    ViWin_writedFlagOn_v6(self->activeWin);
    ViWin_modifyOverCursorXValue(self->activeWin);
    wclear(stdscr);
    ViWin_view_v21(self->activeWin,self);
    wrefresh(stdscr);
    neo_current_frame = fr.prev;
}
...
void Vi_enterInsertMode2_v3(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterInsertMode2_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    self->mode=(1);
    ViWin_writedFlagOn_v6(self->activeWin);
    ViWin_modifyOverCursorXValue2(self->activeWin);
    wclear(stdscr);
    ViWin_view_v21(self->activeWin,self);
    wrefresh(stdscr);
    neo_current_frame = fr.prev;
...
void Vi_exitFromInsertMode_v3(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_exitFromInsertMode_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    self->mode=(0);
...
static void lambda4(struct Vi*  self  , int key)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "lambda4"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    if(list$1int$ph_length(self->activeWin->texts)!=0) {
...
static void lambda5(struct Vi*  self  , int key)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "lambda5"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    Vi_enterInsertMode_v5(self);
    if(list$1int$ph_length(self->activeWin->texts)!=0) {
        ViWin_enterNewLine2(self->activeWin);
    }
    neo_current_frame = fr.prev;
}
...
struct Vi*  Vi_initialize_v3(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_initialize_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct Vi*  result  ;
    struct Vi*  __result_obj__0  ;
    memset(&result, 0, sizeof(result));
    result=(struct Vi* )come_increment_ref_count(Vi_initialize_v2((struct Vi* )come_increment_ref_count(self, "03insert_mode.nc", 428, 145)), "03insert_mode.nc", 428, 146);
    result->mode=(0);
    list$1lambda$_replace(result->events,105,lambda1);
    list$1lambda$_replace(result->events,73,lambda2);
    list$1lambda$_replace(result->events,97,lambda3);
    list$1lambda$_replace(result->events,65,lambda4);
    list$1lambda$_replace(result->events,111,lambda5);
        __result_obj__0 = (struct Vi* )come_increment_ref_count(result, "03insert_mode.nc", 468, 153);
    come_call_finalizer(Vi_finalize, self, (void*)0, (void*)0, 0, 0, 0, (void*)0, "03insert_mode.nc}", 468, 207);
    come_call_finalizer(Vi_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "03insert_mode.nc}", 468, 208);
    neo_current_frame = fr.prev;
    come_call_finalizer(Vi_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "03insert_mode.nc}", 468, 209);
    return __result_obj__0;
}
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    struct list_item$1lambda$* litem_19;
    memset(&litem, 0, sizeof(litem));
    ...
    if(self->len==0) {
        litem=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1678, 147, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1678, 148);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_18=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1688, 149, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1688, 150);
        ...
        __right_value0 = (void*)0;
        litem_19=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1698, 151, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1698, 152);
...
static void Vi_finalize(struct Vi*  self  )
{
    ...
    if(self!=((void*)0)&&self->wins!=((void*)0)) {
        come_call_finalizer(list$1ViWin$ph$p_finalize, self->wins, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 8, 190);
    }
    if(self!=((void*)0)&&self->events!=((void*)0)) {
        come_call_finalizer(list$1lambda$$p_finalize, self->events, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 2, 192);
    }
    if(self!=((void*)0)&&self->yank!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->yank, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 4, 193);
    }
    if(self!=((void*)0)&&self->fileYank!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->fileYank, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 5, 194);
    }
    if(self!=((void*)0)&&self->registers!=((void*)0)) {
        come_call_finalizer(map$2int$list$1int$ph$ph$p_finalize, self->registers, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 199);
    }
    if(self!=((void*)0)&&self->registerKinds!=((void*)0)) {
        come_call_finalizer(map$2int$int$$p_finalize, self->registerKinds, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 203);
    }
    if(self!=((void*)0)&&self->commandHistory!=((void*)0)) {
        come_call_finalizer(list$1char$ph$p_finalize, self->commandHistory, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 206);
    }
        neo_current_frame = fr.prev;
}
...
static void list$1ViWin$ph$p_finalize(struct list$1ViWin$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1ViWin$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 189);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1ViWin$ph$p_finalize(struct list_item$1ViWin$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(ViWin_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1ViWin$ph$p_finalize}", 2, 188);
    }
            neo_current_frame = fr.prev;
}
...
static void ViWin_finalize(struct ViWin*  self  )
{
    ...
    if(self!=((void*)0)&&self->texts!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->texts, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 18, 156);
    }
    if(self!=((void*)0)&&self->texts_length!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->texts_length, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 2, 158);
    }
    if(self!=((void*)0)&&self->returnPoint!=((void*)0)) {
        come_call_finalizer(tuple3$3int$int$int$$p_finalize, self->returnPoint, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 4, 159);
    }
    if(self!=((void*)0)&&self->returnPointStack!=((void*)0)) {
        come_call_finalizer(list$1tuple3$3int$int$int$$ph$p_finalize, self->returnPointStack, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 0, 162);
    }
    if(self!=((void*)0)&&self->undo!=((void*)0)) {
        come_call_finalizer(list$1list$1int$ph$ph$p_finalize, self->undo, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 2, 165);
    }
    if(self!=((void*)0)&&self->undoScroll!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->undoScroll, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 7, 166);
    }
    if(self!=((void*)0)&&self->undoCursorX!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->undoCursorX, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 8, 167);
    }
    if(self!=((void*)0)&&self->undoCursorY!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->undoCursorY, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 9, 168);
    }
    if(self!=((void*)0)&&self->fileName!=((void*)0)) {
        (self->fileName = come_decrement_ref_count(self->fileName, (void*)0, (void*)0, 0, 0, (void*)0, "ViWin_finalize", 10, 169));
    }
    if(self!=((void*)0)&&self->inputedKeys!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->inputedKeys, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 11, 170);
    }
    if(self!=((void*)0)&&self->savedInputedKeys!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->savedInputedKeys, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 12, 171);
    }
    if(self!=((void*)0)&&self->macro!=((void*)0)) {
        come_call_finalizer(map$2int$list$1list$1int$$ph$ph$p_finalize, self->macro, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 2, 178);
    }
    if(self!=((void*)0)&&self->recordingMacro!=((void*)0)) {
        come_call_finalizer(list$1list$1int$$ph$p_finalize, self->recordingMacro, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 14, 179);
    }
    if(self!=((void*)0)&&self->runningMacro!=((void*)0)) {
        come_call_finalizer(list$1list$1int$$ph$p_finalize, self->runningMacro, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 15, 180);
    }
    if(self!=((void*)0)&&self->mark!=((void*)0)) {
        come_call_finalizer(map$2int$tuple3$3int$int$int$$ph$p_finalize, self->mark, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 2, 185);
    }
    if(self!=((void*)0)&&self->completionCandidates!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->completionCandidates, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 17, 186);
    }
    if(self!=((void*)0)&&self->completionPrefix!=((void*)0)) {
        (self->completionPrefix = come_decrement_ref_count(self->completionPrefix, (void*)0, (void*)0, 0, 0, (void*)0, "ViWin_finalize", 18, 187));
    }
            neo_current_frame = fr.prev;
}
...
static void list$1int$ph$p_finalize(struct list$1int$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 155);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1int$ph$p_finalize(struct list_item$1int$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        (self->item = come_decrement_ref_count(self->item, (void*)0, (void*)0, 0, 0, (void*)0, "list_item$1int$ph$p_finalize", 2, 154));
    }
            neo_current_frame = fr.prev;
}
...
static void list$1int$$p_finalize(struct list$1int$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 157);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1tuple3$3int$int$int$$ph$p_finalize(struct list$1tuple3$3int$int$int$$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1tuple3$3int$int$int$$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 161);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1tuple3$3int$int$int$$ph$p_finalize(struct list_item$1tuple3$3int$int$int$$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(tuple3$3int$int$int$$p_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1tuple3$3int$int$int$$ph$p_finalize}", 2, 160);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1list$1int$ph$ph$p_finalize(struct list$1list$1int$ph$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1list$1int$ph$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 164);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1list$1int$ph$ph$p_finalize(struct list_item$1list$1int$ph$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1list$1int$ph$ph$p_finalize}", 2, 163);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$list$1list$1int$$ph$ph$p_finalize(struct map$2int$list$1list$1int$$ph$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(list$1list$1int$$ph$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2, 174);
            }
        }
    }
    ...
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3524, 175);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3526, 176));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3527, 177));
            neo_current_frame = fr.prev;
}
...
static void list$1list$1int$$ph$p_finalize(struct list$1list$1int$$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1list$1int$$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 173);
    }
                    neo_current_frame = fr.prev;
}
...
static void list_item$1list$1int$$ph$p_finalize(struct list_item$1list$1int$$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1list$1int$$ph$p_finalize}", 2, 172);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$tuple3$3int$int$int$$ph$p_finalize(struct map$2int$tuple3$3int$int$int$$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(tuple3$3int$int$int$$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3509, 181);
            }
        }
    }
    come_free((char*)self->items);
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3524, 182);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3526, 183));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3527, 184));
            neo_current_frame = fr.prev;
}
...
static void list$1lambda$$p_finalize(struct list$1lambda$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1lambda$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 191);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$list$1int$ph$ph$p_finalize(struct map$2int$list$1int$ph$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(list$1int$ph$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3509, 195);
            }
        }
    }
    come_free((char*)self->items);
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3524, 196);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3526, 197));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3527, 198));
            neo_current_frame = fr.prev;
}
...
static void map$2int$int$$p_finalize(struct map$2int$int$* self)
{
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3524, 200);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3526, 201));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3527, 202));
            neo_current_frame = fr.prev;
}
...
static void list$1char$ph$p_finalize(struct list$1char$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1char$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 205);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1char$ph$p_finalize(struct list_item$1char$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        (self->item = come_decrement_ref_count(self->item, (void*)0, (void*)0, 0, 0, (void*)0, "list_item$1char$ph$p_finalize", 2, 204));
    }
            neo_current_frame = fr.prev;
}
...
int Vi_main_loop_v3(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_main_loop_v3"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    ...
    while(!self->appEnd) {
        werase(stdscr);
        for(_o2_saved_1=(struct list$1ViWin$ph*)come_increment_ref_count(self->wins, "03insert_mode.nc", 476, 210),it=list$1ViWin$ph_begin(_o2_saved_1)        ;!list$1ViWin$ph_end(_o2_saved_1);it=list$1ViWin$ph_next(_o2_saved_1)){
        ...
        come_call_finalizer(list$1ViWin$ph$p_finalize, _o2_saved_1, (void*)0, (void*)0, 0, 0, 0, (void*)0, "03insert_mode.nc}", 486, 211);
    }
        neo_current_frame = fr.prev;
    return 0;
    neo_current_frame = fr.prev;
...
static struct ViWin*  list$1ViWin$ph_begin(struct list$1ViWin$ph* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1ViWin$ph_begin"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    struct ViWin*  result  ;
    struct ViWin*  __result_obj__0  ;
    struct ViWin*  result_25  ;
    if(self==((void*)0)) {
    ...
    memset(&result_25,0,sizeof(struct ViWin* ));
...
static _Bool list$1ViWin$ph_end(struct list$1ViWin$ph* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1ViWin$ph_end"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
        neo_current_frame = fr.prev;
...
static struct ViWin*  list$1ViWin$ph_next(struct list$1ViWin$ph* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1ViWin$ph_next"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    struct ViWin*  result  ;
    struct ViWin*  __result_obj__0  ;
    struct ViWin*  result_26  ;
    ...
    memset(&result_26,0,sizeof(struct ViWin* ));
