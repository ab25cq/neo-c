...
fr.fun_name = ViWin_insertModeView; neo_current_frame = &fr;    werase(self->win);
...
void ViWin_view_v3(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_view_v3; neo_current_frame = &fr;    if(nvi->mode==(1)&&ViWin_equals(self,nvi->activeWin)) {
...
void ViWin_insertText(struct ViWin* self  , int* text  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_insertText; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    ...
    if(list$1int$ph_length(self->texts)==0) {
        list$1int$ph_push_back(self->texts,(int*)come_increment_ref_count((int*)come_memdup(text, "03insert_mode.nc", 29, "int*")));
        ...
        new_line=(int*)come_increment_ref_count(__builtin_wstring(((char*)(__right_value2=xsprintf("%ls%ls%ls",((int*)(__right_value0=wstring_substring(old_line,0,self->cursorX))),text,((int*)(__right_value1=wstring_substring(old_line,self->cursorX,-1))))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
static int list$1int$ph_length(struct list$1int$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1int$ph_length; neo_current_frame = &fr;    if(self==((void*)0)) {
           neo_current_frame = fr.prev;
        return 0;
    }
       neo_current_frame = fr.prev;
...
static struct list$1int$ph* list$1int$ph_push_back(struct list$1int$ph* self, int* item  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1int$ph_push_back; neo_current_frame = &fr;    struct list$1int$ph* __result_obj__0;
    ...
    if(self->len==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 701, "struct list_item$1int$ph*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        ...
        litem_0=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 711, "struct list_item$1int$ph*"))));
        litem_0->prev=self->head;
        litem_0->next=((void*)0);
        __dec_obj2=litem_0->item,
        litem_0->item=(int*)come_increment_ref_count(item);
        __dec_obj2 = come_decrement_ref_count(__dec_obj2, (void*)0, (void*)0, 0,0, (void*)0);
        self->tail=litem_0;
        self->head->next=litem_0;
    }
    else {
        litem_1=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 721, "struct list_item$1int$ph*"))));
        litem_1->prev=self->tail;
        litem_1->next=((void*)0);
        __dec_obj3=litem_1->item,
        litem_1->item=(int*)come_increment_ref_count(item);
...
fr.fun_name = list$1int$_push_back; neo_current_frame = &fr;    struct list$1int$* __result_obj__0;
    ...
    if(self->len==0) {
        ...
        litem_2=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 711, "struct list_item$1int$*"))));
        ...
        litem_3=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 721, "struct list_item$1int$*"))));
...
static int* list$1int$ph_item(struct list$1int$ph* self, int position, int* default_value  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1int$ph_item; neo_current_frame = &fr;    int* __result_obj__0  ;
    struct list_item$1int$ph* it;
    int i;
    if(self==((void*)0)) {
...
static struct list$1int$ph* list$1int$ph_replace(struct list$1int$ph* self, int position, int* item  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1int$ph_replace; neo_current_frame = &fr;    struct list$1int$ph* __result_obj__0;
    int len;
    int i;
    int* default_value  ;
    struct list_item$1int$ph* it;
...
static struct list$1int$* list$1int$_replace(struct list$1int$* self, int position, int item)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1int$_replace; neo_current_frame = &fr;    struct list$1int$* __result_obj__0;
    int len;
    int i;
    int default_value;
    struct list_item$1int$* it;
...
void ViWin_enterNewLine(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_enterNewLine; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int* old_line  ;
    int num_spaces;
    int i;
    ...
    if(self->pasteMode) {
        ...
        new_line1=(int*)come_increment_ref_count(wstring_substring(old_line,0,self->cursorX));
        __dec_obj5 = come_decrement_ref_count(__dec_obj5, (void*)0, (void*)0, 0,0, (void*)0);
        __dec_obj6=new_line2,
        new_line2=(int*)come_increment_ref_count(__builtin_wstring(((char*)(__right_value1=xsprintf("%ls",((int*)(__right_value0=wstring_substring(old_line,self->cursorX,-1))))))));
        ...
        new_line2=(int*)come_increment_ref_count(__builtin_wstring(((char*)(__right_value1=xsprintf("%ls%ls",head_new_line,((int*)(__right_value0=wstring_substring(old_line,self->cursorX,-1))))))));
    ...
    list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int*)come_increment_ref_count(new_line1));
...
static struct list$1int$ph* list$1int$ph_insert(struct list$1int$ph* self, int position, int* item  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1int$ph_insert; neo_current_frame = &fr;    struct list$1int$ph* __result_obj__0;
    int len;
    int i;
    int* default_value  ;
    void* __right_value0 = (void*)0;
    ...
    if(position==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 876, "struct list_item$1int$ph*"))));
        litem->prev=((void*)0);
        ...
        litem_7=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 888, "struct list_item$1int$ph*"))));
        ...
        while(it!=((void*)0)) {
            if(position==i_8) {
                litem_9=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 904, "struct list_item$1int$ph*"))));
...
static struct list$1int$* list$1int$_insert(struct list$1int$* self, int position, int item)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1int$_insert; neo_current_frame = &fr;    struct list$1int$* __result_obj__0;
    int len;
    int i;
    int default_value;
    void* __right_value0 = (void*)0;
    ...
    if(position==0) {
        litem=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 876, "struct list_item$1int$*"))));
        litem->prev=((void*)0);
        litem->next=self->head;
        litem->item=item;
        self->head->prev=litem;
        ...
        litem_10=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 888, "struct list_item$1int$*"))));
        ...
        while(it!=((void*)0)) {
            if(position==i_11) {
                litem_12=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 904, "struct list_item$1int$*"))));
...
void ViWin_enterNewLine2(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_enterNewLine2; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    int* line  ;
    int num_spaces;
    int i;
    int* new_line  ;
    ...
    list$1int$ph_insert(self->texts,self->scroll+self->cursorY+1,(int*)come_increment_ref_count(new_line));
...
void ViWin_backSpace(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_backSpace; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int* line  ;
...
void ViWin_backIndent(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_backIndent; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int* line  ;
    ...
    if(wstring_length(line)>=4) {
        if(({(_conditional_value_X0=(wstring_index(line,((int*)(__right_value0=__builtin_wstring("    "))),-1)==0));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
void ViWin_blinkBraceFoward(struct ViWin* self  , int head  , int tail  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_blinkBraceFoward; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void ViWin_blinkBraceEnd(struct ViWin* self  , int head  , int tail  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_blinkBraceEnd; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void ViWin_inputInsertMode(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_inputInsertMode; neo_current_frame = &fr;    int key;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int* str  ;
    _Bool all_space;
    ...
    if(key==3||key==27) {
        ...
        if(str[0]==0||all_space) {
            ViWin_insertText(self,(int*)come_increment_ref_count(__builtin_wstring("    ")));
        }
        else {
            if(({(_conditional_value_X0=(xiswalpha(((int*)(__right_value0=wstring_substring(str,-1,-1)))[0])));            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
_conditional_value_X0;})) {
        ...
        for(i_14=1;i_14<size;i_14++){
            keys[i_14]=ViWin_getKey_v14(self,0);
        }
        keys[i_14]=0;
        ViWin_insertText(self,(int*)come_increment_ref_count(__builtin_wstring(keys)));
    }
    else if(key==40) {
        ViWin_blinkBraceFoward(self,40,41,nvi);
        ViWin_insertText(self,(int*)come_increment_ref_count(__builtin_wstring(((char*)(__right_value0=xsprintf("%c",key))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    else if(key==123) {
        ...
        if(cursor_y==self->cursorY) {
            ...
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int*)come_increment_ref_count((int*)come_memdup(line, "03insert_mode.nc", 251, "int*")));
            ...
            line_15=(int*)come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int*)(__right_value0=__builtin_wstring("")))));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            ((int*)(__right_value0=wstring_delete(line_15,0,cursor_x+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int*)come_increment_ref_count((int*)come_memdup(line_15, "03insert_mode.nc", 262, "int*")));
        ...
        key2=ViWin_getKey_v14(self,0);
        char str_16[2];
        memset(&str_16, 0, sizeof(str_16));
        str_16[0]=key2;
        str_16[1]=0;
        ViWin_insertText(self,(int*)come_increment_ref_count(__builtin_wstring(str_16)));
    }
    else {
        char buf[128];
        memset(&buf, 0, sizeof(buf));
        snprintf(buf,128,"%c",key);
        ViWin_insertText(self,(int*)come_increment_ref_count(__builtin_wstring(buf)));
    }
neo_current_frame = fr.prev;}
...
void ViWin_input_v3(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_input_v3; neo_current_frame = &fr;    if(nvi->mode==(1)) {
...
void ViWin_pushUndo_v3(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_pushUndo_v3; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void ViWin_writedFlagOn_v3(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_writedFlagOn_v3; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void ViWin_completion_v3(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_completion_v3; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void ViWin_completion_neo_c2_v3(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_completion_neo_c2_v3; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void ViWin_clearInputedKey_v3(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_clearInputedKey_v3; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void ViWin_saveInputedKey_v3(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_saveInputedKey_v3; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void ViWin_backwardWord_v3(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_backwardWord_v3; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void Vi_enterInsertMode_v3(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_enterInsertMode_v3; neo_current_frame = &fr;    self->mode=(1);
...
void Vi_enterInsertMode2_v3(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_enterInsertMode2_v3; neo_current_frame = &fr;    self->mode=(1);
    ViWin_writedFlagOn_v6(self->activeWin);
...
void Vi_exitFromInsertMode_v3(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_exitFromInsertMode_v3; neo_current_frame = &fr;    self->mode=(0);
...
static void lambda1(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda1; neo_current_frame = &fr;    Vi_enterInsertMode_v5(self);
neo_current_frame = fr.prev;}
...
static void lambda2(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda2; neo_current_frame = &fr;    if(list$1int$ph_length(self->activeWin->texts)!=0) {
...
static void lambda3(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda3; neo_current_frame = &fr;    Vi_enterInsertMode_v5(self);
...
static void lambda4(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda4; neo_current_frame = &fr;    if(list$1int$ph_length(self->activeWin->texts)!=0) {
...
static void lambda5(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda5; neo_current_frame = &fr;    Vi_enterInsertMode_v5(self);
    if(list$1int$ph_length(self->activeWin->texts)!=0) {
...
struct Vi* Vi_initialize_v3(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_initialize_v3; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct Vi* result  ;
...
fr.fun_name = list$1lambda$_push_back; neo_current_frame = &fr;    struct list$1lambda$* __result_obj__0;
    ...
    if(self->len==0) {
        ...
        litem_17=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 711, "struct list_item$1lambda$*"))));
        ...
        litem_18=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 721, "struct list_item$1lambda$*"))));
...
int Vi_main_loop_v3(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_main_loop_v3; neo_current_frame = &fr;    struct list$1ViWin$ph* o2_saved;
    struct ViWin* it  ;
    while(!self->appEnd) {
        werase(stdscr);
...
static struct ViWin* list$1ViWin$ph_begin(struct list$1ViWin$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1ViWin$ph_begin; neo_current_frame = &fr;    struct ViWin* result  ;
...
static _Bool list$1ViWin$ph_end(struct list$1ViWin$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1ViWin$ph_end; neo_current_frame = &fr;       neo_current_frame = fr.prev;
...
static struct ViWin* list$1ViWin$ph_next(struct list$1ViWin$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1ViWin$ph_next; neo_current_frame = &fr;    struct ViWin* result  ;
    struct ViWin* __result_obj__0  ;
