...
struct ViWin*  ViWin_initialize_v10(struct ViWin*  self  , int y, int x, int width, int height, struct Vi*  vi  )
{
    ...
    come_call_finalizer(ViWin_finalize, self, (void*)0, (void*)0, 0, 0, 0, (void*)0, "10edit.nc}", 10, 34);
    come_call_finalizer(ViWin_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "10edit.nc}", 10, 35);
    neo_current_frame = fr.prev;
    come_call_finalizer(ViWin_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "10edit.nc}", 10, 36);
...
void ViWin_deleteOneLine_v10(struct ViWin*  self  , struct Vi*  nvi  )
{
    ...
    if(self->digitInput>0&&!gBinaryMode) {
        ...
        for(i=0        ;i<self->digitInput+1;i++){
            line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 28, 44);
            if(line!=((void*)0)) {
                __right_value0 = (void*)0;
                list$1int$ph_push_back(nvi->yank,(int* )come_increment_ref_count((int* )come_memdup(line, "10edit.nc", 31, 59, "int* "), "10edit.nc", 31, 60));
            ...
            (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 41, 68));
        }
        ...
        __right_value0 = (void*)0;
        line_16=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 45, 69);
        if(line_16!=((void*)0)) {
            ViWin_pushUndo_v5(self);
            list$1int$ph_reset(nvi->yank);
            __right_value0 = (void*)0;
            list$1int$ph_push_back(nvi->yank,(int* )come_increment_ref_count((int* )come_memdup(line_16, "10edit.nc", 49, 70, "int* "), "10edit.nc", 49, 71));
            nvi->yankKind=(0);
            ViWin_saveYankToFile(self,nvi);
            list$1int$ph_delete(self->texts,self->scroll+self->cursorY,self->scroll+self->cursorY+1);
            list$1int$_delete(self->texts_length,self->scroll+self->cursorY,self->scroll+self->cursorY+1);
        ...
        (line_16 = come_decrement_ref_count(line_16, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 58, 72));
    }
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_reset(struct list$1int$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1854, 37);
    }
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
...
static int*  list$1int$ph_item(struct list$1int$ph* self, int position, int*  default_value  )
{
    ...
    int i;
    if(self==((void*)0)) {
                __result_obj__0 = (int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 1745, 38);
        neo_current_frame = fr.prev;
        (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "/usr/local/include/neo-c.h", 1745, 39));
        return __result_obj__0;
    }
    if(position<0) {
        position+=self->len;
    ...
    while(it!=((void*)0)) {
        if(position==i) {
                        __result_obj__0 = (int* )come_increment_ref_count(it->item, "/usr/local/include/neo-c.h", 1756, 40);
            neo_current_frame = fr.prev;
            (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "/usr/local/include/neo-c.h", 1756, 41));
            return __result_obj__0;
        }
        it=it->next;
        i++;
    }
        __result_obj__0 = (int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 1762, 42);
    neo_current_frame = fr.prev;
    (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "/usr/local/include/neo-c.h", 1762, 43));
    return __result_obj__0;
}
...
static struct list$1int$ph* list$1int$ph_push_back(struct list$1int$ph* self, int*  item  )
{
    ...
    if(self==((void*)0)) {
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1613, 45));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(self->len==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1617, 46, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1617, 47);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        __dec_obj1=litem->item,
        litem->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1621, 49);
        __dec_obj1 = come_decrement_ref_count(__dec_obj1, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1621, 48);
        self->tail=litem;
        self->head=litem;
    }
    else if(self->len==1) {
        __right_value0 = (void*)0;
        litem_2=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1627, 50, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1627, 51);
        litem_2->prev=self->head;
        litem_2->next=((void*)0);
        __dec_obj2=litem_2->item,
        litem_2->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1631, 53);
        __dec_obj2 = come_decrement_ref_count(__dec_obj2, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1631, 52);
        self->tail=litem_2;
        self->head->next=litem_2;
    }
    else {
        __right_value0 = (void*)0;
        litem_3=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1637, 54, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1637, 55);
        litem_3->prev=self->tail;
        litem_3->next=((void*)0);
        __dec_obj3=litem_3->item,
        litem_3->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1641, 57);
        __dec_obj3 = come_decrement_ref_count(__dec_obj3, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1641, 56);
        self->tail->next=litem_3;
        self->tail=litem_3;
    }
    self->len++;
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1649, 58));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
    ...
    if(head==0&&tail==self->len) {
        ...
        while(it!=((void*)0)) {
            if(i<tail) {
                ...
                it=it->next;
                i++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1932, 61);
                self->len--;
            }
            else if(i==tail) {
                self->head=it;
        ...
        while(it_4!=((void*)0)) {
            ...
            if(i_5>=head) {
                ...
                it_4=it_4->next;
                i_5++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it_6, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1962, 62);
                self->len--;
            }
            else {
                it_4=it_4->next;
        ...
        while(it_7!=((void*)0)) {
            ...
            if(i_8>=head&&i_8<tail) {
                ...
                it_7=it_7->next;
                i_8++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it_9, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1995, 63);
                self->len--;
            }
            else {
                it_7=it_7->next;
    ...
    if(head==0&&tail==self->len) {
        ...
        while(it!=((void*)0)) {
            if(i<tail) {
                ...
                it=it->next;
                i++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1932, 65);
                self->len--;
            }
            else if(i==tail) {
                self->head=it;
        ...
        while(it_10!=((void*)0)) {
            ...
            if(i_11>=head) {
                ...
                it_10=it_10->next;
                i_11++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it_12, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1962, 66);
                self->len--;
            }
            else {
                it_10=it_10->next;
        ...
        while(it_13!=((void*)0)) {
            ...
            if(i_14>=head&&i_14<tail) {
                ...
                it_13=it_13->next;
                i_14++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it_15, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1995, 67);
                self->len--;
            }
            else {
                it_13=it_13->next;
...
static struct list$1int$* list$1int$_reset(struct list$1int$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1854, 64);
    }
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
...
void ViWin_deleteOneLine2(struct ViWin*  self  , struct Vi*  nvi  )
{
    ...
    if(self->digitInput>0) {
        ...
        nvi->yankKind=(0);
        for(i=0        ;i<self->digitInput+1;i++){
            line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 69, 73);
            if(line!=((void*)0)) {
                __right_value0 = (void*)0;
                list$1int$ph_push_back(nvi->yank,(int* )come_increment_ref_count((int* )come_memdup(line, "10edit.nc", 72, 74, "int* "), "10edit.nc", 72, 75));
                list$1int$ph_delete(self->texts,self->scroll+self->cursorY,self->scroll+self->cursorY+1);
                list$1int$_delete(self->texts_length,self->scroll+self->cursorY,self->scroll+self->cursorY+1);
                ViWin_modifyCursorOnDeleting(self);
            }
            (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 81, 76));
        }
        self->digitInput=0;
        ViWin_saveYankToFile(self,nvi);
    }
        ...
        __right_value0 = (void*)0;
        line_17=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 85, 77);
        if(line_17!=((void*)0)) {
            ViWin_pushUndo_v5(self);
            list$1int$ph_delete(self->texts,self->scroll+self->cursorY,self->scroll+self->cursorY+1);
            list$1int$_delete(self->texts_length,self->scroll+self->cursorY,self->scroll+self->cursorY+1);
            __right_value0 = (void*)0;
            list$1int$ph_insert(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(__builtin_wstring(""), "10edit.nc", 90, 96));
            list$1int$_insert(self->texts_length,self->scroll+self->cursorY,0);
            ViWin_modifyCursorOnDeleting(self);
        }
        (line_17 = come_decrement_ref_count(line_17, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 96, 109));
    }
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_insert(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(self==((void*)0)) {
        ...
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1778, 78));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position<0) {
    ...
    if(self->len==0||position>=self->len) {
        ...
        for(i=0        ;i<position-len;i++){
            ...
            list$1int$ph_push_back(self,(int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 1791, 79));
            (default_value = come_decrement_ref_count(default_value, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1793, 80));
        }
        list$1int$ph_push_back(self,(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1793, 81));
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1794, 82));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1798, 83, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1798, 84);
        litem->prev=((void*)0);
        litem->next=self->head;
        __dec_obj4=litem->item,
        litem->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1802, 86);
        __dec_obj4 = come_decrement_ref_count(__dec_obj4, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1802, 85);
        ...
        __right_value0 = (void*)0;
        litem_18=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1810, 87, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1810, 88);
        litem_18->prev=self->head;
        litem_18->next=self->tail;
        __dec_obj5=litem_18->item,
        litem_18->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1814, 90);
        __dec_obj5 = come_decrement_ref_count(__dec_obj5, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1814, 89);
        ...
        while(it!=((void*)0)) {
            if(position==i_19) {
                __right_value0 = (void*)0;
                litem_20=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1826, 91, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1826, 92);
                litem_20->prev=it->prev;
                litem_20->next=it;
                __dec_obj6=litem_20->item,
                litem_20->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1830, 94);
                __dec_obj6 = come_decrement_ref_count(__dec_obj6, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1830, 93);
        ...
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1843, 95));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
static struct list$1int$* list$1int$_insert(struct list$1int$* self, int position, int item)
{
    ...
    if(position==0) {
        litem=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1798, 103, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1798, 104);
        litem->prev=((void*)0);
        litem->next=self->head;
        litem->item=item;
        self->head->prev=litem;
        ...
        __right_value0 = (void*)0;
        litem_23=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1810, 105, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1810, 106);
        ...
        while(it!=((void*)0)) {
            if(position==i_24) {
                __right_value0 = (void*)0;
                litem_25=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1826, 107, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1826, 108);
...
static struct list$1int$* list$1int$_push_back(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1617, 97, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1617, 98);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_21=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1627, 99, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1627, 100);
        ...
        __right_value0 = (void*)0;
        litem_22=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1637, 101, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1637, 102);
...
void ViWin_deleteWord(struct ViWin*  self  , struct Vi*  nvi  )
{
    ...
    ViWin_pushUndo_v5(self);
    if(self->digitInput>0) {
        line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("")))), "10edit.nc", 103, 110);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 103, 111));
        if(wcslen(line)==0) {
            ...
            list$1int$ph_reset(nvi->yank);
            __right_value0 = (void*)0;
            list$1int$ph_push_back(nvi->yank,(int* )come_increment_ref_count(wstring_substring(line,self->cursorX,x), "10edit.nc", 166, 112));
            nvi->yankKind=(1);
            ViWin_saveYankToFile(self,nvi);
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line,self->cursorX,x)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 169, 113));
            ViWin_modifyCursorOnDeleting(self);
        }
        self->digitInput=0;
        (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 243, 114));
    }
    else {
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        line_26=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("")))), "10edit.nc", 177, 115);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 177, 116));
        if(wcslen(line_26)==0) {
            ViWin_deleteOneLine_v10(self,nvi);
        }
        else {
            ...
            list$1int$ph_reset(nvi->yank);
            __right_value0 = (void*)0;
            list$1int$ph_push_back(nvi->yank,(int* )come_increment_ref_count(wstring_substring(line_26,self->cursorX,x_27), "10edit.nc", 235, 117));
            nvi->yankKind=(1);
            ViWin_saveYankToFile(self,nvi);
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line_26,self->cursorX,x_27)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 238, 118));
            ViWin_modifyCursorOnDeleting(self);
        }
        (line_26 = come_decrement_ref_count(line_26, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 243, 119));
    }
    neo_current_frame = fr.prev;
}
...
void ViWin_deleteForNextCharacter(struct ViWin*  self  )
{
    ...
    if(self->digitInput>0) {
        ...
        line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("")))), "10edit.nc", 252, 120);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 252, 121));
        if(wcslen(line)>0) {
            x=self->cursorX;
            count=self->digitInput+1;
            for(i=0            ;i<count;i++){
            ...
            if(*p==key) {
                ...
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 281, 122));
            }
        }
        self->digitInput=0;
        (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 312, 123));
    }
    else {
        key_29=ViWin_getKey_v14(self,(_Bool)0);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        line_30=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("")))), "10edit.nc", 290, 124);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 290, 125));
        if(wcslen(line_30)>0) {
            x_31=self->cursorX;
            p_32=line_30+x_31;
            while(*p_32!=key_29) {
            ...
            if(*p_32==key_29) {
                ...
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 308, 126));
            }
        }
        (line_30 = come_decrement_ref_count(line_30, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 312, 127));
    }
    neo_current_frame = fr.prev;
}
...
void ViWin_deleteForNextCharacter2(struct ViWin*  self  )
{
    ...
    if(self->digitInput>0) {
        key=ViWin_getKey_v14(self,(_Bool)0);
        line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("")))), "10edit.nc", 321, 128);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 321, 129));
        if(wcslen(line)>0) {
            x=self->cursorX;
            count=self->digitInput+1;
            for(i=0            ;i<count;i++){
            ...
            if(*p==key) {
                __right_value0 = (void*)0;
                ((int* )(__right_value0=wstring_delete(line,self->cursorX,x)));
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 350, 130));
            }
        }
        self->digitInput=0;
        (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 381, 131));
    }
    else {
        key_33=ViWin_getKey_v14(self,(_Bool)0);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        line_34=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("")))), "10edit.nc", 359, 132);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 359, 133));
        if(wcslen(line_34)>0) {
            x_35=self->cursorX;
            p_36=line_34+x_35;
            while(*p_36!=key_33) {
            ...
            if(*p_36==key_33) {
                ...
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 377, 134));
            }
        }
        (line_34 = come_decrement_ref_count(line_34, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 381, 135));
    }
    neo_current_frame = fr.prev;
}
...
void ViWin_deleteCursorCharactor(struct ViWin*  self  )
{
    ...
    if(self->digitInput>0&&!gBinaryMode) {
        ...
        line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 390, 136);
        for(i=0        ;i<num;i++){
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line,self->cursorX,self->cursorX+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 393, 137));
        }
        ViWin_modifyOverCursorXValue(self);
        self->digitInput=0;
        (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 430, 138));
    }
    else {
        if(gBinaryMode) {
            __right_value0 = (void*)0;
            line_37=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 403, 139);
            ...
            if(len>=1) {
                __right_value0 = (void*)0;
                new_line=(int* )come_increment_ref_count((int *)come_calloc(1, sizeof(int )*(1*(len+1)), "10edit.nc", 410, 140, "int* "), "10edit.nc", 410, 141);
                memcpy(new_line,line_37,sizeof(int )*self->cursorX);
                memcpy(new_line+self->cursorX,line_37+self->cursorX+1,sizeof(int )*(len-self->cursorX));
                list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(new_line, "10edit.nc", 414, 150));
                ViWin_modifyOverCursorXValue(self);
                (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 418, 151));
            }
            (line_37 = come_decrement_ref_count(line_37, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 429, 152));
        }
        else {
            __right_value0 = (void*)0;
            line_40=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 420, 153);
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line_40,self->cursorX,self->cursorX+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 421, 154));
            len_41=list$1int$_item(self->texts_length,self->scroll+self->cursorY,-1);
            len_41--;
            list$1int$_replace(self->texts_length,self->scroll+self->cursorY,len_41);
            ViWin_modifyOverCursorXValue(self);
            (line_40 = come_decrement_ref_count(line_40, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 429, 155));
        }
    }
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_replace(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(self==((void*)0)) {
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2020, 142));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position<0) {
    ...
    if(self->len==0||position>=self->len) {
        ...
        for(i=0        ;i<position-len;i++){
            memset(&default_value,0,sizeof(int* ));
            list$1int$ph_push_back(self,(int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 2035, 143));
            (default_value = come_decrement_ref_count(default_value, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2037, 144));
        }
        list$1int$ph_push_back(self,(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 2037, 145));
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2038, 146));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    it=self->head;
    ...
    while(it!=((void*)0)) {
        if(position==i_39) {
            __dec_obj7=it->item,
            it->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 2045, 148);
            __dec_obj7 = come_decrement_ref_count(__dec_obj7, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 2045, 147);
            break;
        }
        it=it->next;
        i_39++;
        ...
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2052, 149));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
void ViWin_deleteBack(struct ViWin*  self  )
{
    ...
    if(self->digitInput>0) {
        num=self->digitInput+1;
        line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 439, 156);
        for(i=0        ;i<num;i++){
            if(self->cursorX>0) {
                self->cursorX--;
                __right_value0 = (void*)0;
                ((int* )(__right_value0=wstring_delete(line,self->cursorX,self->cursorX+1)));
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 444, 157));
            }
        }
        ViWin_modifyOverCursorXValue(self);
        self->digitInput=0;
        (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 463, 158));
    }
    else {
        __right_value0 = (void*)0;
        line_42=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 454, 159);
        if(self->cursorX>0) {
            self->cursorX--;
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line_42,self->cursorX,self->cursorX+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 458, 160));
        }
        ViWin_modifyOverCursorXValue(self);
        (line_42 = come_decrement_ref_count(line_42, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 463, 161));
    }
    neo_current_frame = fr.prev;
}
...
void ViWin_getCursorNumber(struct ViWin*  self  , int* head, int* tail)
{
    ...
    int  c_43  ;
    int  c_44  ;
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 467, 162);
    c=line[self->cursorX];
    if(xiswdigit(c)) {
        *head=self->cursorX;
        if(*head>0) {
    ...
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 516, 163));
    neo_current_frame = fr.prev;
}
...
void ViWin_incrementNumber(struct ViWin*  self  )
{
    ...
    if(self->digitInput>0) {
        num=self->digitInput+1;
        line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 523, 164);
        ViWin_getCursorNumber(self,&head,&tail);
        if(head!=-1&&tail!=-1) {
            __right_value0 = (void*)0;
            number_string=(char* )come_increment_ref_count(wstring_to_string(((int* )(__right_value0=wstring_substring(line,head,tail)))), "10edit.nc", 530, 165);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 530, 166));
            n=atoi(number_string);
            n+=num;
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            new_line=(int* )come_increment_ref_count(string_to_wstring(((char* )(__right_value2=xsprintf("%ls%d%ls",((int* )(__right_value0=wstring_substring(line,0,head))),n,((int* )(__right_value1=wstring_substring(line,tail,-1))))))), "10edit.nc", 536, 167);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 536, 168));
            (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 536, 169));
            (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 536, 170));
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(new_line, "10edit.nc", 538, 171));
            list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(new_line));
            (number_string = come_decrement_ref_count(number_string, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 542, 172));
            (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 542, 173));
        }
        ViWin_modifyOverCursorXValue(self);
        self->digitInput=0;
        (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 568, 174));
    }
    else {
        __right_value0 = (void*)0;
        line_45=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 547, 175);
        ViWin_getCursorNumber(self,&head_46,&tail_47);
        if(head_46!=-1&&tail_47!=-1) {
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            number_string_48=(char* )come_increment_ref_count(wstring_to_string(((int* )(__right_value0=wstring_substring(line_45,head_46,tail_47)))), "10edit.nc", 554, 176);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 554, 177));
            ...
            new_line_50=(int* )come_increment_ref_count(string_to_wstring(((char* )(__right_value2=xsprintf("%ls%d%ls",((int* )(__right_value0=wstring_substring(line_45,0,head_46))),n_49,((int* )(__right_value1=wstring_substring(line_45,tail_47,-1))))))), "10edit.nc", 560, 178);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 560, 179));
            (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 560, 180));
            (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 560, 181));
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(new_line_50, "10edit.nc", 562, 182));
            list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(new_line_50));
            (number_string_48 = come_decrement_ref_count(number_string_48, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 566, 183));
            (new_line_50 = come_decrement_ref_count(new_line_50, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 566, 184));
        }
        ViWin_modifyOverCursorXValue(self);
        (line_45 = come_decrement_ref_count(line_45, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 568, 185));
    }
    neo_current_frame = fr.prev;
}
...
void ViWin_replaceCursorCharactor(struct ViWin*  self  )
{
    ...
    ViWin_pushUndo_v5(self);
    key=ViWin_getKey_v14(self,(_Bool)0);
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 590, 186);
    line[self->cursorX]=(int )key;
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 595, 187));
    neo_current_frame = fr.prev;
}
...
void ViWin_deleteUntilTail(struct ViWin*  self  )
{
    ...
    ViWin_pushUndo_v5(self);
    if(self->digitInput>0) {
        line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 600, 188);
        __right_value0 = (void*)0;
        ((int* )(__right_value0=wstring_delete(line,self->cursorX,-1)));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 602, 189));
        num=self->digitInput+1;
        for(i=1        ;i<num;i++){
            __right_value0 = (void*)0;
            line_51=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY+1,((void*)0)), "10edit.nc", 607, 190);
            if(line_51!=((void*)0)) {
            ...
            (line_51 = come_decrement_ref_count(line_51, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 618, 191));
        }
        ViWin_modifyOverCursorXValue(self);
        self->digitInput=0;
        (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 628, 192));
    }
    else {
        __right_value0 = (void*)0;
        line_52=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 623, 193);
        __right_value0 = (void*)0;
        ((int* )(__right_value0=wstring_delete(line_52,self->cursorX,-1)));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 624, 194));
        ViWin_modifyOverCursorXValue(self);
        (line_52 = come_decrement_ref_count(line_52, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 628, 195));
    }
    neo_current_frame = fr.prev;
}
...
void ViWin_joinLines(struct ViWin*  self  )
{
    ...
    if(self->scroll+self->cursorY+1<list$1int$ph_length(self->texts)) {
        line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 635, 196);
        __right_value0 = (void*)0;
        next_line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY+1,((void*)0)), "10edit.nc", 636, 197);
        __right_value0 = (void*)0;
        line2=(int* )come_increment_ref_count(string_to_wstring(((char* )(__right_value0=xsprintf("%ls %ls",line,next_line)))), "10edit.nc", 638, 198);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 638, 199));
        list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(line2, "10edit.nc", 640, 200));
        list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(line2));
        list$1int$ph_delete(self->texts,self->scroll+self->cursorY+1,self->scroll+self->cursorY+1+1);
        list$1int$_delete(self->texts_length,self->scroll+self->cursorY+1,self->scroll+self->cursorY+1+1);
        list$1int$_delete(self->texts_length,self->scroll+self->cursorY+1,self->scroll+self->cursorY+1+1);
        (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 647, 201));
        (next_line = come_decrement_ref_count(next_line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 647, 202));
        (line2 = come_decrement_ref_count(line2, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 647, 203));
    }
    ViWin_modifyOverCursorXValue(self);
    neo_current_frame = fr.prev;
}
...
void ViWin_yankOneLine(struct ViWin*  self  , struct Vi*  nvi  )
{
    ...
    if(self->digitInput>0) {
        ...
        nvi->yankKind=(0);
        for(i=0        ;i<self->digitInput+1;i++){
            line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY+i,((void*)0)), "10edit.nc", 659, 204);
            if(line!=((void*)0)) {
                __right_value0 = (void*)0;
                list$1int$ph_push_back(nvi->yank,(int* )come_increment_ref_count((int* )come_memdup(line, "10edit.nc", 662, 205, "int* "), "10edit.nc", 662, 206));
            }
            (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 667, 207));
        }
        self->digitInput=0;
        ViWin_saveYankToFile(self,nvi);
    }
        ...
        __right_value0 = (void*)0;
        line_53=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 671, 208);
        if(line_53!=((void*)0)) {
            ViWin_pushUndo_v5(self);
            list$1int$ph_reset(nvi->yank);
            __right_value0 = (void*)0;
            list$1int$ph_push_back(nvi->yank,(int* )come_increment_ref_count((int* )come_memdup(line_53, "10edit.nc", 676, 209, "int* "), "10edit.nc", 676, 210));
            nvi->yankKind=(0);
            ViWin_saveYankToFile(self,nvi);
        }
        (line_53 = come_decrement_ref_count(line_53, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 681, 211));
    }
    neo_current_frame = fr.prev;
}
...
void ViWin_joinLines2_v10(struct ViWin*  self  )
{
    ...
    ViWin_pushUndo_v5(self);
    if(self->scroll+self->cursorY+1<list$1int$ph_length(self->texts)) {
        line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 688, 212);
        __right_value0 = (void*)0;
        next_line=(int* )come_increment_ref_count((int* )come_memdup(((int* )(__right_value0=list$1int$ph_item(self->texts,self->scroll+self->cursorY+1,((void*)0)))), "10edit.nc", 689, 213, "int* "), "10edit.nc", 689, 214);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 689, 215));
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(string_to_wstring(((char* )(__right_value0=xsprintf("%ls%ls",line,next_line)))), "10edit.nc", 691, 216));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 691, 217));
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ...
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 692, 218));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 692, 219));
        list$1int$ph_delete(self->texts,self->scroll+self->cursorY+1,self->scroll+self->cursorY+1+1);
        list$1int$_delete(self->texts_length,self->scroll+self->cursorY+1,self->scroll+self->cursorY+1+1);
        (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 697, 220));
        (next_line = come_decrement_ref_count(next_line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 697, 221));
    }
    ViWin_modifyOverCursorXValue(self);
    neo_current_frame = fr.prev;
}
...
void ViWin_forwardToNextCharacter1(struct ViWin*  self  , int key)
{
    ...
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 705, 222);
    if(self->digitInput>0) {
        for(i=0        ;i<self->digitInput+1;i++){
            __right_value0 = (void*)0;
            ...
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 709, 223));
            (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 709, 224));
            (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 709, 225));
            if(cursor_x!=-1) {
        ...
        __right_value1 = (void*)0;
        __right_value2 = (void*)0;
        cursor_x_54=wstring_index(((int* )(__right_value0=wstring_substring(line,self->cursorX+1,-1))),((int* )(__right_value2=string_to_wstring(((char* )(__right_value1=xsprintf("%c",key)))))),-1);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 723, 226));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 723, 227));
        (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 723, 228));
        if(cursor_x_54!=-1) {
            self->cursorX+=cursor_x_54+1;
        }
    }
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 731, 229));
    neo_current_frame = fr.prev;
}
...
void ViWin_forwardToNextCharacter2(struct ViWin*  self  , int key)
{
    ...
    self->mRepeatFowardNextCharacter=key;
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 736, 230);
    if(self->digitInput>0) {
        for(i=0        ;i<self->digitInput+1;i++){
            __right_value0 = (void*)0;
            ...
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 740, 231));
            (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 740, 232));
            (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 740, 233));
            if(cursor_x!=-1) {
                self->cursorX+=cursor_x+1;
            }
            else {
        ...
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 754, 234));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 754, 235));
        (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 754, 236));
        if(cursor_x_55!=-1) {
            self->cursorX+=cursor_x_55;
        }
    }
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 762, 237));
    neo_current_frame = fr.prev;
}
...
void ViWin_backwardToNextCharacter1(struct ViWin*  self  )
{
    ...
    int cursor_x_56;
    key=ViWin_getKey_v14(self,(_Bool)0);
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 780, 238);
    if(self->digitInput>0) {
        for(i=0        ;i<self->digitInput+1;i++){
            __right_value0 = (void*)0;
            ...
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 784, 239));
            (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 784, 240));
            (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 784, 241));
            if(cursor_x!=-1) {
        ...
        __right_value1 = (void*)0;
        __right_value2 = (void*)0;
        cursor_x_56=wstring_rindex(((int* )(__right_value0=wstring_substring(line,0,self->cursorX))),((int* )(__right_value2=string_to_wstring(((char* )(__right_value1=xsprintf("%c",key)))))),-1);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 798, 242));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 798, 243));
        (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 798, 244));
        if(cursor_x_56!=-1) {
            self->cursorX=cursor_x_56;
        }
    }
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 806, 245));
    neo_current_frame = fr.prev;
}
...
void ViWin_backwardToNextCharacter2(struct ViWin*  self  )
{
    ...
    int cursor_x_57;
    key=ViWin_getKey_v14(self,(_Bool)0);
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 810, 246);
    if(self->digitInput>0) {
        for(i=0        ;i<self->digitInput+1;i++){
            __right_value0 = (void*)0;
            ...
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 814, 247));
            (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 814, 248));
            (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 814, 249));
            if(cursor_x!=-1) {
                self->cursorX=cursor_x+1;
            }
            else {
        ...
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 828, 250));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 828, 251));
        (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "10edit.nc", 828, 252));
        if(cursor_x_57!=-1) {
            self->cursorX=cursor_x_57+1;
        }
    }
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 836, 253));
    neo_current_frame = fr.prev;
}
...
void ViWin_changeCase(struct ViWin*  self  )
{
    ...
    int  c2_61  ;
    ViWin_pushUndo_v5(self);
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 840, 254);
    if(self->digitInput>0) {
        for(i=0        ;i<self->digitInput+1;i++){
        ...
        c_59=line[self->cursorX];
        if(c_59!=-1) {
            if(c_59>=97&&c_59<=122) {
                c2_60=c_59-97+65;
                line[self->cursorX]=c2_60;
            }
    ...
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 884, 255));
    neo_current_frame = fr.prev;
}
...
void ViWin_moveToHead(struct ViWin*  self  )
{
    ...
    int i;
    memset(&i, 0, sizeof(i));
    line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)), "10edit.nc", 886, 256);
    ...
    self->cursorX=i;
    (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "10edit.nc", 898, 257));
    neo_current_frame = fr.prev;
}
...
struct Vi*  Vi_initialize_v10(struct Vi*  self  )
{
    ...
    result=(struct Vi* )come_increment_ref_count(Vi_initialize_v9((struct Vi* )come_increment_ref_count(self, "10edit.nc", 900, 258)), "10edit.nc", 900, 259);
    ...
    list$1lambda$_replace(self->events,69-65+1,lambda25);
        __result_obj__0 = (struct Vi* )come_increment_ref_count(result, "10edit.nc", 1160, 266);
    come_call_finalizer(Vi_finalize, self, (void*)0, (void*)0, 0, 0, 0, (void*)0, "10edit.nc}", 1160, 274);
    come_call_finalizer(Vi_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "10edit.nc}", 1160, 275);
    neo_current_frame = fr.prev;
    come_call_finalizer(Vi_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "10edit.nc}", 1160, 276);
    return __result_obj__0;
}
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1617, 260, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1617, 261);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_62=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1627, 262, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1627, 263);
        ...
        __right_value0 = (void*)0;
        litem_63=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1637, 264, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1637, 265);
...
static void Vi_finalize(struct Vi*  self  )
{
    ...
    if(self!=((void*)0)&&self->wins!=((void*)0)) {
        come_call_finalizer(list$1ViWin$ph$p_finalize, self->wins, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 2, 269);
    }
    if(self!=((void*)0)&&self->events!=((void*)0)) {
        come_call_finalizer(list$1lambda$$p_finalize, self->events, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 3, 271);
    }
    if(self!=((void*)0)&&self->yank!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->yank, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 4, 272);
    }
    if(self!=((void*)0)&&self->fileYank!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->fileYank, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 5, 273);
    }
        neo_current_frame = fr.prev;
}
...
static void list$1ViWin$ph$p_finalize(struct list$1ViWin$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1ViWin$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1504, 268);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1ViWin$ph$p_finalize(struct list_item$1ViWin$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(ViWin_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1ViWin$ph$p_finalize}", 2, 267);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1lambda$$p_finalize(struct list$1lambda$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1lambda$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1504, 270);
    }
            neo_current_frame = fr.prev;
}
