    ...
    if(head==0&&tail==self->len) {
        ...
        while(it_4!=((void*)0)) {
            ...
            if(i_5>=head) {
                ...
                it_4=it_4->next;
                i_5++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it_6, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1943);
                self->len--;
            }
            else {
                it_4=it_4->next;
        ...
        while(it_7!=((void*)0)) {
            ...
            if(i_8>=head&&i_8<tail) {
                ...
                it_7=it_7->next;
                i_8++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it_9, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1976);
                self->len--;
            }
            else {
                it_7=it_7->next;
    ...
    if(head==0&&tail==self->len) {
        ...
        while(it_10!=((void*)0)) {
            ...
            if(i_11>=head) {
                ...
                it_10=it_10->next;
                i_11++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it_12, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1943);
                self->len--;
            }
            else {
                it_10=it_10->next;
        ...
        while(it_13!=((void*)0)) {
            ...
            if(i_14>=head&&i_14<tail) {
                ...
                it_13=it_13->next;
                i_14++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it_15, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1976);
                self->len--;
            }
            else {
                it_13=it_13->next;
...
static struct list$1int$ph* list$1int$ph_insert(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(position==0) {
        ...
        __right_value0 = (void*)0;
        litem_18=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1791, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1791);
        litem_18->prev=self->head;
        litem_18->next=self->tail;
        __dec_obj5=litem_18->item,
        litem_18->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1795);
        ...
        while(it!=((void*)0)) {
            if(position==i_19) {
                __right_value0 = (void*)0;
                litem_20=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1807, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1807);
                litem_20->prev=it->prev;
                litem_20->next=it;
                __dec_obj6=litem_20->item,
                litem_20->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1811);
...
static struct list$1int$* list$1int$_insert(struct list$1int$* self, int position, int item)
{
    ...
    if(position==0) {
        ...
        __right_value0 = (void*)0;
        litem_23=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1791, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1791);
        ...
        while(it!=((void*)0)) {
            if(position==i_24) {
                __right_value0 = (void*)0;
                litem_25=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1807, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1807);
...
static struct list$1int$* list$1int$_push_back(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_21=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1608, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1608);
        ...
        __right_value0 = (void*)0;
        litem_22=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1618, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1618);
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_62=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1608, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1608);
        ...
        __right_value0 = (void*)0;
        litem_63=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1618, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1618);
