...
struct ViWin*  ViWin_initialize_v17(struct ViWin*  self  , int y, int x, int width, int height, struct Vi*  vi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_initialize_v17"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
...
void ViWin_horizonVisualModeView(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_horizonVisualModeView"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int maxy;
    int maxx;
    int head_abs;
    int tail_abs;
    ...
    memset(&head_abs, 0, sizeof(head_abs));
    memset(&tail_abs, 0, sizeof(tail_abs));
    ...
    werase(self->win);
    head_abs=self->visualModeHorizonHeadScroll+self->visualModeHorizonHeadY;
    tail_abs=self->scroll+self->cursorY;
        ...
        while(x<wstring_length(printable_line)&&cur_row<maxy-1) {
            ...
            if(forward) {
                if(i==head_abs&&i==tail_abs) {
                    lo=self->visualModeHorizonHeadX;
                    hi=self->cursorX;
                    if(lo>hi) {
                        tmp=lo;
                        lo=hi;
...
void ViWin_view_v17(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_view_v17"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
...
void ViWin_yankOnHorizonVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_yankOnHorizonVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int y;
    int hv_y;
    void* __right_value0 = (void*)0;
    ...
    memset(&first_line_7, 0, sizeof(first_line_7));
    memset(&_o2_saved_2, 0, sizeof(_o2_saved_2));
    memset(&it_8, 0, sizeof(it_8));
    memset(&last_line_9, 0, sizeof(last_line_9));
...
static struct list$1int$ph* list$1int$ph_sublist(struct list$1int$ph* self, int begin, int tail)
{
    ...
    memset(&i, 0, sizeof(i));
    if(self==((void*)0)) {
                __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(self, "/usr/local/include/neo-c.h", 2171, 74);
        neo_current_frame = fr.prev;
        come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2171, 75);
        return __result_obj__0;
    }
    result=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_initialize((struct list$1int$ph*)come_increment_ref_count((struct list$1int$ph*)come_calloc(1, sizeof(struct list$1int$ph)*(1), "/usr/local/include/neo-c.h", 2174, 76, "struct list$1int$ph*"), "/usr/local/include/neo-c.h", 2174, 80)), "/usr/local/include/neo-c.h", 2174, 81);
    if(begin<0) {
        begin+=self->len;
    }
    if(tail<0) {
    ...
    if(begin>=self->len) {
                __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(((struct list$1int$ph*)(__right_value1=list$1int$ph_initialize((struct list$1int$ph*)come_increment_ref_count((struct list$1int$ph*)come_calloc(1, sizeof(struct list$1int$ph)*(1), "/usr/local/include/neo-c.h", 2189, 82, "struct list$1int$ph*"), "/usr/local/include/neo-c.h", 2189, 83)))), "/usr/local/include/neo-c.h", 2189, 84);
        come_call_finalizer(list$1int$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2189, 85);
        come_call_finalizer(list$1int$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0, "/usr/local/include/neo-c.h}", 2189, 86);
        neo_current_frame = fr.prev;
        come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2189, 87);
        return __result_obj__0;
    }
    if(tail>=self->len) {
        tail=self->len;
    ...
    while(it!=((void*)0)) {
        if(i>=begin&&i<tail) {
            list$1int$ph_push_back(result,(int* )come_increment_ref_count(it->item, "/usr/local/include/neo-c.h", 2200, 88));
        }
        it=it->next;
        i++;
    }
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(result, "/usr/local/include/neo-c.h", 2206, 89);
    come_call_finalizer(list$1int$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2206, 90);
    neo_current_frame = fr.prev;
    come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2206, 91);
    return __result_obj__0;
}
...
static struct list$1int$ph* list$1int$ph_initialize(struct list$1int$ph* self)
{
    ...
    self->tail=((void*)0);
    self->len=0;
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(self, "/usr/local/include/neo-c.h", 1544, 77);
    come_call_finalizer(list$1int$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 1544, 78);
    neo_current_frame = fr.prev;
    come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 1544, 79);
    return __result_obj__0;
}
...
void ViWin_deleteOnHorizonVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_deleteOnHorizonVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int y;
    int hv_y;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
...
static struct list$1int$ph* list$1int$ph_replace(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(self==((void*)0)) {
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2089, 134));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position<0) {
    ...
    if(self->len==0||position>=self->len) {
        ...
        for(i=0        ;i<position-len;i++){
            ...
            list$1int$ph_push_back(self,(int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 2104, 135));
            (default_value = come_decrement_ref_count(default_value, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2106, 136));
        }
        list$1int$ph_push_back(self,(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 2106, 137));
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2107, 138));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    it=self->head;
    ...
    while(it!=((void*)0)) {
        if(position==i_10) {
            __dec_obj4=it->item,
            it->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 2114, 140);
            __dec_obj4 = come_decrement_ref_count(__dec_obj4, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 2114, 139);
            break;
        }
        it=it->next;
        i_10++;
        ...
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2121, 141));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
static struct list$1int$* list$1int$_push_back(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1678, 144, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1678, 145);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_11=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1688, 146, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1688, 147);
        ...
        __right_value0 = (void*)0;
        litem_12=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1698, 148, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1698, 149);
...
static struct list$1int$ph* list$1int$ph_delete(struct list$1int$ph* self, int head, int tail)
{
    ...
    int i;
    struct list_item$1int$ph* prev_it;
    struct list_item$1int$ph* it_14;
    int i_15;
    struct list_item$1int$ph* prev_it_16;
    struct list_item$1int$ph* it_17;
    struct list_item$1int$ph* head_prev_it;
    struct list_item$1int$ph* tail_it;
    int i_18;
    struct list_item$1int$ph* prev_it_19;
    memset(&tmp, 0, sizeof(tmp));
    memset(&it, 0, sizeof(it));
    memset(&i, 0, sizeof(i));
    memset(&prev_it, 0, sizeof(prev_it));
    ...
    if(head==0&&tail==self->len) {
        ...
        while(it!=((void*)0)) {
            if(i<tail) {
                ...
                it=it->next;
                i++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2001, 150);
                self->len--;
            }
            else if(i==tail) {
                self->head=it;
        ...
        while(it_14!=((void*)0)) {
            ...
            if(i_15>=head) {
                ...
                it_14=it_14->next;
                i_15++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it_16, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2031, 151);
                self->len--;
            }
            else {
                it_14=it_14->next;
        ...
        while(it_17!=((void*)0)) {
            ...
            if(i_18>=head&&i_18<tail) {
                ...
                it_17=it_17->next;
                i_18++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it_19, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2064, 152);
                self->len--;
            }
            else {
                it_17=it_17->next;
    ...
    if(head==0&&tail==self->len) {
        ...
        while(it!=((void*)0)) {
            if(i<tail) {
                ...
                it=it->next;
                i++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2001, 154);
                self->len--;
            }
            else if(i==tail) {
                self->head=it;
        ...
        while(it_20!=((void*)0)) {
            ...
            if(i_21>=head) {
                ...
                it_20=it_20->next;
                i_21++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it_22, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2031, 155);
                self->len--;
            }
            else {
                it_20=it_20->next;
        ...
        while(it_23!=((void*)0)) {
            ...
            if(i_24>=head&&i_24<tail) {
                ...
                it_23=it_23->next;
                i_24++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it_25, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2064, 156);
                self->len--;
            }
            else {
                it_23=it_23->next;
...
static struct list$1int$* list$1int$_reset(struct list$1int$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1923, 153);
    }
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
...
void ViWin_changeCaseHorizonVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_changeCaseHorizonVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int y;
    int hv_y;
    int x;
    int hv_x;
    ...
    memset(&c2_28, 0, sizeof(c2_28));
    memset(&new_line, 0, sizeof(new_line));
    memset(&it2, 0, sizeof(it2));
    memset(&_o2_saved_3, 0, sizeof(_o2_saved_3));
    memset(&it, 0, sizeof(it));
    memset(&new_line_29, 0, sizeof(new_line_29));
    memset(&i_30, 0, sizeof(i_30));
    memset(&c_31, 0, sizeof(c_31));
    memset(&c2_32, 0, sizeof(c2_32));
    memset(&c2_33, 0, sizeof(c2_33));
    memset(&last_line, 0, sizeof(last_line));
    memset(&head_last_line, 0, sizeof(head_last_line));
    memset(&i_34, 0, sizeof(i_34));
    memset(&c_35, 0, sizeof(c_35));
    memset(&c2_36, 0, sizeof(c2_36));
    memset(&c2_37, 0, sizeof(c2_37));
    ...
    memset(&c_39, 0, sizeof(c_39));
    memset(&c2_40, 0, sizeof(c2_40));
    memset(&c2_41, 0, sizeof(c2_41));
    memset(&tail_line, 0, sizeof(tail_line));
    memset(&new_line_42, 0, sizeof(new_line_42));
    ViWin_pushUndo_v5(self);
    y=self->scroll+self->cursorY;
    hv_y=self->visualModeHorizonHeadScroll+self->visualModeHorizonHeadY;
    x=self->cursorX;
...
({(_conditional_value_X0=(_o2_saved_3=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,y+1,hv_y), "17hvisual.nc", 265, 182),it=list$1int$ph_begin(_o2_saved_3)));_conditional_value_X0;})        ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_3)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(_o2_saved_3)));_conditional_value_X2;})){
            ...
            for(i_30=0            ;i_30<wstring_length(new_line_29);i_30++){
                ...
                if(c_31>=97&&c_31<=122) {
                    c2_32=c_31-97+65;
                    new_line_29[i_30]=c2_32;
                }
                else if(c_31>=65&&c_31<=90) {
                    c2_33=c_31-65+97;
                    new_line_29[i_30]=c2_33;
                }
            }
            __right_value0 = (void*)0;
        ...
        for(i_34=0        ;i_34<wstring_length(head_last_line);i_34++){
            ...
            if(c_35>=97&&c_35<=122) {
                c2_36=c_35-97+65;
                head_last_line[i_34]=c2_36;
            }
            else if(c_35>=65&&c_35<=90) {
                c2_37=c_35-65+97;
                head_last_line[i_34]=c2_37;
            }
        }
        __right_value0 = (void*)0;
        ...
        for(i_38=0        ;i_38<wstring_length(middle_line);i_38++){
            ...
            if(c_39>=97&&c_39<=122) {
                c2_40=c_39-97+65;
                middle_line[i_38]=c2_40;
            }
            else if(c_39>=65&&c_39<=90) {
                c2_41=c_39-65+97;
                middle_line[i_38]=c2_41;
            }
        }
        __right_value0 = (void*)0;
...
void ViWin_rewriteOnHorizonVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_rewriteOnHorizonVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int y;
    int hv_y;
    int x;
    int hv_x;
    ...
    memset(&middle_line, 0, sizeof(middle_line));
    memset(&tail_line, 0, sizeof(tail_line));
    memset(&new_line_44, 0, sizeof(new_line_44));
    ViWin_pushUndo_v5(self);
    y=self->scroll+self->cursorY;
    hv_y=self->visualModeHorizonHeadScroll+self->visualModeHorizonHeadY;
    x=self->cursorX;
...
void ViWin_inputHorizonVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_inputHorizonVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int key;
    memset(&key, 0, sizeof(key));
    key=ViWin_getKey_v14(self,(_Bool)0);
    switch (    key) {
...
void ViWin_input_v17(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_input_v17"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    if(nvi->mode==(5)) {
...
void Vi_enterHorizonVisualMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterHorizonVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    self->mode=(5);
...
struct Vi*  Vi_initialize_v17(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_initialize_v17"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct Vi*  result  ;
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    struct list_item$1lambda$* litem_46;
    memset(&litem, 0, sizeof(litem));
    ...
    if(self->len==0) {
        litem=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1678, 268, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1678, 269);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_45=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1688, 270, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1688, 271);
        ...
        __right_value0 = (void*)0;
        litem_46=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1698, 272, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1698, 273);
...
static void Vi_finalize(struct Vi*  self  )
{
    ...
    if(self!=((void*)0)&&self->wins!=((void*)0)) {
        come_call_finalizer(list$1ViWin$ph$p_finalize, self->wins, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 8, 277);
    }
    if(self!=((void*)0)&&self->events!=((void*)0)) {
        come_call_finalizer(list$1lambda$$p_finalize, self->events, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 2, 279);
    }
    if(self!=((void*)0)&&self->yank!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->yank, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 4, 280);
    }
    if(self!=((void*)0)&&self->fileYank!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->fileYank, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 5, 281);
    }
    if(self!=((void*)0)&&self->registers!=((void*)0)) {
        come_call_finalizer(map$2int$list$1int$ph$ph$p_finalize, self->registers, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 286);
    }
    if(self!=((void*)0)&&self->registerKinds!=((void*)0)) {
        come_call_finalizer(map$2int$int$$p_finalize, self->registerKinds, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 290);
    }
    if(self!=((void*)0)&&self->commandHistory!=((void*)0)) {
        come_call_finalizer(list$1char$ph$p_finalize, self->commandHistory, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 293);
    }
        neo_current_frame = fr.prev;
}
...
static void list$1ViWin$ph$p_finalize(struct list$1ViWin$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1ViWin$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 276);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1ViWin$ph$p_finalize(struct list_item$1ViWin$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(ViWin_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1ViWin$ph$p_finalize}", 2, 275);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1lambda$$p_finalize(struct list$1lambda$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1lambda$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 278);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$list$1int$ph$ph$p_finalize(struct map$2int$list$1int$ph$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(list$1int$ph$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3509, 282);
            }
        }
    }
    come_free((char*)self->items);
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3524, 283);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3526, 284));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3527, 285));
            neo_current_frame = fr.prev;
}
...
static void map$2int$int$$p_finalize(struct map$2int$int$* self)
{
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3524, 287);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3526, 288));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3527, 289));
            neo_current_frame = fr.prev;
}
...
static void list$1char$ph$p_finalize(struct list$1char$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1char$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 292);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1char$ph$p_finalize(struct list_item$1char$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        (self->item = come_decrement_ref_count(self->item, (void*)0, (void*)0, 0, 0, (void*)0, "list_item$1char$ph$p_finalize", 2, 291));
    }
            neo_current_frame = fr.prev;
}
