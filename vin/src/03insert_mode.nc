...
void ViWin*::enterNewLine(ViWin* self)
{
    ...
    if(self.pasteMode) {
        new_line1 = old_line.substring(0, self.cursorX);
        new_line2 = wstring(xsprintf("%ls", old_line.substring(self.cursorX, -1)));
    }
    else {
        ...
        new_line1 = old_line.substring(0, self.cursorX);
        new_line2 = wstring(xsprintf("%ls%ls", head_new_line, old_line.substring(self.cursorX, -1)));
    }
