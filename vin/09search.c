...
void ViWin_searchModeView(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_searchModeView"; neo_current_frame = &fr;
    werase(self->win);
...
void ViWin_view_v9(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_view_v9"; neo_current_frame = &fr;
...
void ViWin_search(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_search"; neo_current_frame = &fr;
...
void ViWin_searchReverse(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_searchReverse"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    _Bool _conditional_value_X0;
    int*  cursor_line  ;
    int x;
...
void ViWin_searchWordOnCursor(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_searchWordOnCursor"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int*  line  ;
    int cursor_x_before;
...
void ViWin_searchWordOnCursorReverse(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_searchWordOnCursorReverse"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int*  line  ;
    int cursor_x_before;
...
void ViWin_inputSearchlMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_inputSearchlMode"; neo_current_frame = &fr;
    int key;
    void* __right_value0 = (void*)0;
    int  c  ;
    void* __right_value1 = (void*)0;
...
void ViWin_input_v9(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_input_v9"; neo_current_frame = &fr;
    if(nvi->mode==(4)) {
...
void Vi_saveSearchString(struct Vi*  self  , const char* file_name)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_saveSearchString"; neo_current_frame = &fr;
    char* home;
    void* __right_value0 = (void*)0;
    char*  file_name2  ;
    char*  __dec_obj4  ;
...
void Vi_readSearchString(struct Vi*  self  , const char* file_name)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_readSearchString"; neo_current_frame = &fr;
    char* home;
    void* __right_value0 = (void*)0;
    char*  file_name2  ;
    struct _IO_FILE*  f  ;
...
void Vi_enterSearchMode_v9(struct Vi*  self  , _Bool regex_search, _Bool reverse)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterSearchMode_v9"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    self->mode=(4);
    wcsncpy(self->searchString,((int* )(__right_value0=__builtin_wstring(""))),128);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
void Vi_exitFromSearchMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_exitFromSearchMode"; neo_current_frame = &fr;
    self->mode=(0);
    neo_current_frame = fr.prev;
}
...
struct Vi*  Vi_initialize_v9(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_initialize_v9"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct Vi*  result  ;
