...
fr.fun_name = ViWin_forwardWord; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
...
void ViWin_forwardWord2(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_forwardWord2; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int* line  ;
    int* p  ;
    int* __dec_obj15  ;
...
void ViWin_backwardWord_v4(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_backwardWord_v4; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int* line  ;
    int* p  ;
    int* __dec_obj25  ;
...
static void lambda1(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda1; neo_current_frame = &fr;    int i;
...
static void lambda2(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda2; neo_current_frame = &fr;    int i;
    if(self->activeWin->digitInput>0) {
        for(i=0;i<self->activeWin->digitInput+1;i++){
...
static void lambda3(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda3; neo_current_frame = &fr;    int i;
    if(self->activeWin->digitInput>0) {
        for(i=0;i<self->activeWin->digitInput+1;i++){
...
struct Vi* Vi_initialize_v4(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_initialize_v4; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct Vi* result  ;
...
fr.fun_name = list$1lambda$_push_back; neo_current_frame = &fr;    struct list$1lambda$* __result_obj__0;
    ...
    if(self->len==0) {
        ...
        litem_0=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 711, "struct list_item$1lambda$*"))));
        ...
        litem_1=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 721, "struct list_item$1lambda$*"))));
