...
static _Bool is_directory_path(char* path)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "is_directory_path"; neo_current_frame = &fr;
...
void ViWin_commandModeView(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_commandModeView"; neo_current_frame = &fr;
...
char*  ViWin_selector(struct ViWin*  self  , struct list$1char$ph* lines)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_selector"; neo_current_frame = &fr;
    _Bool end_of_select;
    _Bool canceled;
    int maxx;
    int maxy;
    ...
    __result_obj__0 = (char* )come_increment_ref_count(((char* )(__right_value2=__builtin_string(((char* )(__right_value1=list$1char$ph_item(lines,scrolltop+cursor,((char* )(__right_value0=__builtin_string(""))))))))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
void ViWin_fileCompetion(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_fileCompetion"; neo_current_frame = &fr;
    char* line;
    char* p;
    void* __right_value0 = (void*)0;
    char*  word  ;
    ...
    words=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), (void*)0, 174, "struct list$1char$ph*"))));
    if(string_equals(dir_name,"./")) {
        ...
        while((_Bool)1) {
            ...
            path=(char* )come_increment_ref_count(xsprintf("%s/%s",cwd,entry->d_name));
            if(is_directory_path(path)) {
                item=(char* )come_increment_ref_count(xsprintf("%s/",entry->d_name));
                list$1char$ph_push_back(words,(char* )come_increment_ref_count(item));
                (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0));
            }
            else {
                list$1char$ph_push_back(words,(char* )come_increment_ref_count(__builtin_string(entry->d_name)));
            }
        ...
        while((_Bool)1) {
            ...
            path_5=(char* )come_increment_ref_count(xsprintf("%s%s",dir_name,entry_4->d_name));
            if(is_directory_path(path_5)) {
                item_6=(char* )come_increment_ref_count(xsprintf("%s%s/",dir_name,entry_4->d_name));
                list$1char$ph_push_back(words,(char* )come_increment_ref_count(item_6));
                (item_6 = come_decrement_ref_count(item_6, (void*)0, (void*)0, 0, 0, (void*)0));
            }
            else {
                list$1char$ph_push_back(words,(char* )come_increment_ref_count(xsprintf("%s%s",dir_name,((char* )(__right_value0=__builtin_string(entry_4->d_name))))));
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            }
        ...
        while((_Bool)1) {
            ...
            path_9=(char* )come_increment_ref_count(xsprintf("%s%s",dir_name,entry_8->d_name));
            if(is_directory_path(path_9)) {
                item_10=(char* )come_increment_ref_count(xsprintf("%s%s/",dir_name,entry_8->d_name));
                list$1char$ph_push_back(words,(char* )come_increment_ref_count(item_10));
                (item_10 = come_decrement_ref_count(item_10, (void*)0, (void*)0, 0, 0, (void*)0));
            }
            else {
                list$1char$ph_push_back(words,(char* )come_increment_ref_count(xsprintf("%s%s",dir_name,entry_8->d_name)));
            }
            (path_9 = come_decrement_ref_count(path_9, (void*)0, (void*)0, 0, 0, (void*)0));
        }
        closedir(dir_7);
    }
    words2=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), (void*)0, 276, "struct list$1char$ph*"))));
    ...
    file_name=(char* )come_increment_ref_count(charp_substring(((char* )(__right_value0=ViWin_selector(self,words3))),strlen(word),-1));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
static struct list$1char$ph* list$1char$ph_push_back(struct list$1char$ph* self, char*  item  )
{
    ...
    if(self->len==0) {
        ...
        litem_1=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), (void*)0, 714, "struct list_item$1char$ph*"))));
        ...
        litem_2=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), (void*)0, 724, "struct list_item$1char$ph*"))));
...
static struct list$1char$ph* list$1char$ph_add(struct list$1char$ph* self, char*  item  )
{
    ...
    if(self->len==0) {
        ...
        litem_13=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), (void*)0, 629, "struct list_item$1char$ph*"))));
        ...
        litem_14=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), (void*)0, 639, "struct list_item$1char$ph*"))));
...
void ViWin_commandModeInput(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_commandModeInput"; neo_current_frame = &fr;
    int key;
    int key2;
    int len;
...
void ViWin_view_v12(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_view_v12"; neo_current_frame = &fr;
...
void ViWin_input_v12(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_input_v12"; neo_current_frame = &fr;
    if(nvi->mode==(3)) {
...
void ViWin_subAllTextsFromCommandMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_subAllTextsFromCommandMode"; neo_current_frame = &fr;
    char* p;
    char* p2;
    char* p3;
    void* __right_value0 = (void*)0;
    ...
    p3=strstr(p2,"/");
    if(p&&p2&&p3) {
        str=(char* )come_increment_ref_count(charp_substring(p,0,p2-p-1));
        replace=(char* )come_increment_ref_count(charp_substring(p2,0,p3-p2));
        if(str!=((void*)0)&&replace!=((void*)0)) {
            ...
            for(o2_saved=(struct list$1int$ph*)come_increment_ref_count(self->texts),it=list$1int$ph_begin(o2_saved);!list$1int$ph_end(o2_saved);it=list$1int$ph_next(o2_saved)){
                ...
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
                (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
                list$1int$ph_replace(self->texts,it2,(int* )come_increment_ref_count(new_line));
...
static int*  list$1int$ph_begin(struct list$1int$ph* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$ph_begin"; neo_current_frame = &fr;
    int*  result  ;
    int*  __result_obj__0  ;
    int*  result_17  ;
    if(self==((void*)0)) {
...
static _Bool list$1int$ph_end(struct list$1int$ph* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$ph_end"; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
    return self==((void*)0)||self->it==((void*)0);
    neo_current_frame = fr.prev;
}
...
static int*  list$1int$ph_next(struct list$1int$ph* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$ph_next"; neo_current_frame = &fr;
    int*  result  ;
    int*  __result_obj__0  ;
    int*  result_18  ;
    if(self==((void*)0)||self->it==((void*)0)) {
...
static struct list$1int$ph* list$1int$ph_replace(struct list$1int$ph* self, int position, int*  item  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$ph_replace"; neo_current_frame = &fr;
...
static struct list$1int$ph* list$1int$ph_push_back(struct list$1int$ph* self, int*  item  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$ph_push_back"; neo_current_frame = &fr;
    struct list$1int$ph* __result_obj__0;
    void* __right_value0 = (void*)0;
    ...
    if(self->len==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 704, "struct list_item$1int$ph*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        ...
        litem_19=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 714, "struct list_item$1int$ph*"))));
        litem_19->prev=self->head;
        litem_19->next=((void*)0);
        __dec_obj12=litem_19->item,
        litem_19->item=(int* )come_increment_ref_count(item);
        __dec_obj12 = come_decrement_ref_count(__dec_obj12, (void*)0, (void*)0, 0,0, (void*)0);
        self->tail=litem_19;
        self->head->next=litem_19;
    }
    else {
        litem_20=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 724, "struct list_item$1int$ph*"))));
        litem_20->prev=self->tail;
        litem_20->next=((void*)0);
        __dec_obj13=litem_20->item,
        litem_20->item=(int* )come_increment_ref_count(item);
...
static struct list$1int$* list$1int$_replace(struct list$1int$* self, int position, int item)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$_replace"; neo_current_frame = &fr;
...
static struct list$1int$* list$1int$_push_back(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        ...
        litem_22=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 714, "struct list_item$1int$*"))));
        ...
        litem_23=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 724, "struct list_item$1int$*"))));
...
void Vi_enterComandMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterComandMode"; neo_current_frame = &fr;
    self->mode=(3);
...
void Vi_exitFromComandMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_exitFromComandMode"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    ...
    if(({(_conditional_value_X0=(string_index(((char* )(__right_value0=__builtin_string(self->commandString))),"sp",-1)==0));    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
_conditional_value_X0;})) {
        file_name=(char* )come_increment_ref_count(string_to_string(((char* )(__right_value3=list$1char$ph_item(((struct list$1char$ph*)(__right_value2=string_scan(((char* )(__right_value0=__builtin_string(self->commandString))),((char*)(__right_value1=xsprintf("sp (.+)"))),(_Bool)0))),0,((void*)0))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        if(file_name!=((void*)0)) {
            Vi_openNewFile(self,(char* )come_increment_ref_count(file_name));
        }
        (file_name = come_decrement_ref_count(file_name, (void*)0, (void*)0, 0, 0, (void*)0));
    }
    else if(({(_conditional_value_X1=(string_index(((char* )(__right_value0=__builtin_string(self->commandString))),"paste",-1)==0));    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
_conditional_value_X1;})) {
        self->activeWin->pasteMode=!self->activeWin->pasteMode;
    }
    else {
        if(({(_conditional_value_X2=(string_index(((char* )(__right_value0=__builtin_string(self->commandString))),"%",-1)!=-1));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
_conditional_value_X2;})) {
            ViWin_subAllTextsFromCommandMode(self->activeWin,self);
            self->mode=(0);
        }
        if(({(_conditional_value_X3=(string_index(((char* )(__right_value0=__builtin_string(self->commandString))),"w",-1)!=-1));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
_conditional_value_X3;})) {
            ViWin_writeFile(self->activeWin,gBinaryMode);
        }
        if(({(_conditional_value_X4=(string_index(((char* )(__right_value0=__builtin_string(self->commandString))),"q",-1)!=-1));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
_conditional_value_X4;})) {
            writed=self->activeWin->writed;
            if(({(_conditional_value_X5=(!writed||string_index(((char* )(__right_value0=__builtin_string(self->commandString))),"!",-1)!=-1));            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
_conditional_value_X5;})) {
        ...
        if(({(_conditional_value_X6=(string_index(((char* )(__right_value0=__builtin_string(self->commandString))),"shell",-1)!=-1));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
_conditional_value_X6;})) {
    ...
    if(({(_conditional_value_X0=(string_index(((char* )(__right_value0=__builtin_string(self->commandString))),"paste",-1)==0));    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
_conditional_value_X0;})) {
...
static int list$1ViWin$ph_length(struct list$1ViWin$ph* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1ViWin$ph_length"; neo_current_frame = &fr;
    if(self==((void*)0)) {
        neo_current_frame = fr.prev;
        return 0;
    }
...
struct Vi*  Vi_initialize_v12(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_initialize_v12"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct Vi*  result  ;
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    if(self->len==0) {
        ...
        litem_25=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 714, "struct list_item$1lambda$*"))));
        ...
        litem_26=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 724, "struct list_item$1lambda$*"))));
