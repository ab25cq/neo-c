...
fr.fun_name = ViWin_saveYankToFile; neo_current_frame = &fr;    char* home;
...
_Bool ViWin_loadYankFromFile(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_loadYankFromFile; neo_current_frame = &fr;    char* home;
    void* __right_value0 = (void*)0;
    char* path  ;
    struct _IO_FILE* f  ;
    _Bool __result_obj__0;
...
_Bool ViWin_saveFileYankToFile(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_saveFileYankToFile; neo_current_frame = &fr;    char* home;
    void* __right_value0 = (void*)0;
    char* path  ;
    struct _IO_FILE* f  ;
    _Bool __result_obj__0;
...
_Bool ViWin_loadFileYankFromFile(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_loadFileYankFromFile; neo_current_frame = &fr;    char* home;
    void* __right_value0 = (void*)0;
    char* path  ;
    struct _IO_FILE* f  ;
    _Bool __result_obj__0;
...
void ViWin_pasteAfterCursor(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_pasteAfterCursor; neo_current_frame = &fr;    int it2;
    struct list$1int$ph* o2_saved;
    int* it  ;
    void* __right_value0 = (void*)0;
    int* line  ;
...
fr.fun_name = list$1int$ph_insert; neo_current_frame = &fr;    struct list$1int$ph* __result_obj__0;
    ...
    if(position==0) {
        ...
        litem_4=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 888, "struct list_item$1int$ph*"))));
...
fr.fun_name = list$1int$_insert; neo_current_frame = &fr;    struct list$1int$* __result_obj__0;
    ...
    if(position==0) {
        ...
        litem_9=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 888, "struct list_item$1int$*"))));
...
void ViWin_pasteBeforeCursor(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_pasteBeforeCursor; neo_current_frame = &fr;    int it2;
    struct list$1int$ph* o2_saved;
    int* it  ;
    void* __right_value0 = (void*)0;
    int* line  ;
...
void ViWin_filePasteAfterCursor(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_filePasteAfterCursor; neo_current_frame = &fr;    int it2;
    struct list$1int$ph* o2_saved;
    int* it  ;
    void* __right_value0 = (void*)0;
    int* line  ;
...
static void lambda1(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda1; neo_current_frame = &fr;    ViWin_pasteAfterCursor(self->activeWin,self);
...
static void lambda2(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda2; neo_current_frame = &fr;    ViWin_pasteBeforeCursor(self->activeWin,self);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
struct Vi* Vi_initialize_v7(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_initialize_v7; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct Vi* result  ;
    void* __right_value1 = (void*)0;
