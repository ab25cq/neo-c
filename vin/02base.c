...
fr.fun_name = ViWin_initialize_v2; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct ViWin* result  ;
...
static struct list$1tuple3$3int$int$int$$ph* list$1tuple3$3int$int$int$$ph_initialize(struct list$1tuple3$3int$int$int$$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1tuple3$3int$int$int$$ph_initialize; neo_current_frame = &fr;    struct list$1tuple3$3int$int$int$$ph* __result_obj__0;
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
    ...
    neo_current_frame = fr.prev;    come_call_finalizer(list$1tuple3$3int$int$int$$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__0;
    neo_current_frame = fr.prev;}
...
static void list$1tuple3$3int$int$int$$ph_finalize(struct list$1tuple3$3int$int$int$$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1tuple3$3int$int$int$$ph_finalize; neo_current_frame = &fr;    struct list_item$1tuple3$3int$int$int$$ph* it;
    struct list_item$1tuple3$3int$int$int$$ph* prev_it;
    if(self==((void*)0)) {
        neo_current_frame = fr.prev;
        return;
...
void ViWin_textsView(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_textsView; neo_current_frame = &fr;    int maxy;
    int maxx;
...
void ViWin_statusBarView_v2(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_statusBarView_v2; neo_current_frame = &fr;    int maxy;
    int maxx;
    maxy=getmaxy(self->win);
    maxx=getmaxx(self->win);
    wattr_on(self->win,(unsigned int)(((unsigned int)((1U))<<((10)+8))),((void*)0));
...
void ViWin_view_v2(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_view_v2; neo_current_frame = &fr;    werase(self->win);
...
int ViWin_getKey_v2(struct ViWin* self  , _Bool head)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_getKey_v2; neo_current_frame = &fr;       neo_current_frame = fr.prev;
...
void ViWin_input_v2(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_input_v2; neo_current_frame = &fr;    int key;
    void (*event)(struct Vi*,int);
    key=ViWin_getKey_v14(self,1);
...
static void (*list$1lambda$_item(struct list$1lambda$* self, int position, void (*default_value)(struct Vi*,int)))(struct Vi*,int)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1lambda$_item; neo_current_frame = &fr;    void (*__result_obj__0)(struct Vi*,int);
    struct list_item$1lambda$* it;
    int i;
    if(self==((void*)0)) {
...
void ViWin_modifyUnderCursorYValue(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_modifyUnderCursorYValue; neo_current_frame = &fr;    if(self->cursorY<0) {
...
void ViWin_modifyOverCursorYValue(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_modifyOverCursorYValue; neo_current_frame = &fr;    int maxy;
    if(list$1int$ph_length(self->texts)==0) {
        self->scroll=0;
        self->cursorY=0;
        self->cursorX=0;
...
void ViWin_modifyOverCursorXValue(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_modifyOverCursorXValue; neo_current_frame = &fr;    int len;
    void* __right_value0 = (void*)0;
    int* cursor_line  ;
    if(list$1int$ph_length(self->texts)==0) {
        self->scroll=0;
...
void ViWin_modifyOverCursorXValue2(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_modifyOverCursorXValue2; neo_current_frame = &fr;    int len;
    void* __right_value0 = (void*)0;
    int* cursor_line  ;
    if(list$1int$ph_length(self->texts)==0) {
        self->scroll=0;
...
void ViWin_modifyUnderCursorXValue(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_modifyUnderCursorXValue; neo_current_frame = &fr;    if(self->cursorX<0) {
        self->cursorX=0;
    }
neo_current_frame = fr.prev;}
...
void ViWin_forward_v2(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_forward_v2; neo_current_frame = &fr;    self->cursorX++;
...
void ViWin_backward_v2(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_backward_v2; neo_current_frame = &fr;    self->cursorX--;
...
void ViWin_prevLine(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_prevLine; neo_current_frame = &fr;    self->cursorY--;
...
void ViWin_nextLine(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_nextLine; neo_current_frame = &fr;    self->cursorY++;
...
void ViWin_halfScrollUp(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_halfScrollUp; neo_current_frame = &fr;    int maxy;
    maxy=getmaxy(self->win);
    self->cursorY-=maxy/2;
    ViWin_modifyUnderCursorYValue(self);
    ViWin_modifyOverCursorXValue(self);
...
void ViWin_halfScrollDown(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_halfScrollDown; neo_current_frame = &fr;    int maxy;
    maxy=getmaxy(self->win);
    self->cursorY+=maxy/2;
    ViWin_modifyOverCursorYValue(self);
    ViWin_modifyOverCursorXValue(self);
...
void ViWin_centeringCursor(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_centeringCursor; neo_current_frame = &fr;    int maxy;
    int n;
    maxy=getmaxy(self->win);
...
void ViWin_topCursor(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_topCursor; neo_current_frame = &fr;    self->scroll=self->scroll+self->cursorY;
    self->cursorY=0;
neo_current_frame = fr.prev;}
...
void ViWin_moveAtHead(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_moveAtHead; neo_current_frame = &fr;    self->cursorX=0;
neo_current_frame = fr.prev;}
...
void ViWin_moveAtHead2(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_moveAtHead2; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int* cursor_line  ;
    self->cursorX=0;
...
void ViWin_moveAtTail(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_moveAtTail; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int* cursor_line  ;
    int line_max;
    cursor_line=(int*)come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int*)(__right_value0=__builtin_wstring("")))));
...
void ViWin_moveTop(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_moveTop; neo_current_frame = &fr;    ViWin_saveReturnPoint(self);
    self->scroll=0;
    self->cursorY=0;
    self->cursorX=0;
    ViWin_modifyOverCursorXValue(self);
...
void ViWin_restoreVisualMode_v2(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_restoreVisualMode_v2; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void ViWin_keyG(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_keyG; neo_current_frame = &fr;    int key2;
...
void ViWin_moveBottom(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_moveBottom; neo_current_frame = &fr;    ViWin_saveReturnPoint(self);
...
void ViWin_openFile_v2(struct ViWin* self  , char* file_name  , int line_num, _Bool binary_mode)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_openFile_v2; neo_current_frame = &fr;    (file_name = come_decrement_ref_count(file_name, (void*)0, (void*)0, 0, 0, (void*)0));
neo_current_frame = fr.prev;}
...
void ViWin_saveReturnPoint(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_saveReturnPoint; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
...
static struct tuple3$3int$int$int$* tuple3$3int$int$int$_clone(struct tuple3$3int$int$int$* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = tuple3$3int$int$int$_clone; neo_current_frame = &fr;    struct tuple3$3int$int$int$* __result_obj__0;
    void* __right_value0 = (void*)0;
...
static void tuple3$3int$int$int$_finalize(struct tuple3$3int$int$int$* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = tuple3$3int$int$int$_finalize; neo_current_frame = &fr;    neo_current_frame = fr.prev;}

static struct list$1tuple3$3int$int$int$$ph* list$1tuple3$3int$int$int$$ph_push_back(struct list$1tuple3$3int$int$int$$ph* self, struct tuple3$3int$int$int$* item)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1tuple3$3int$int$int$$ph_push_back; neo_current_frame = &fr;    struct list$1tuple3$3int$int$int$$ph* __result_obj__0;
    void* __right_value0 = (void*)0;
...
void ViWin_saveInputedKeyOnTheMovingCursor_v2(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_saveInputedKeyOnTheMovingCursor_v2; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void ViWin_joinLines2_v2(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_joinLines2_v2; neo_current_frame = &fr;neo_current_frame = fr.prev;}

static void lambda1(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda1; neo_current_frame = &fr;    ViWin_forward_v2(self->activeWin);
...
static void lambda2(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda2; neo_current_frame = &fr;    ViWin_forward_v2(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda3(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda3; neo_current_frame = &fr;    ViWin_forward_v2(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda4(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda4; neo_current_frame = &fr;    ViWin_backward_v2(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda5(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda5; neo_current_frame = &fr;    ViWin_backward_v2(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda6(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda6; neo_current_frame = &fr;    ViWin_backward_v2(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda7(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda7; neo_current_frame = &fr;    ViWin_nextLine(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda8(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda8; neo_current_frame = &fr;    ViWin_nextLine(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda9(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda9; neo_current_frame = &fr;    ViWin_nextLine(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda10(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda10; neo_current_frame = &fr;    ViWin_prevLine(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda11(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda11; neo_current_frame = &fr;    ViWin_prevLine(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda12(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda12; neo_current_frame = &fr;    ViWin_prevLine(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda13(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda13; neo_current_frame = &fr;    ViWin_moveAtHead(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda14(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda14; neo_current_frame = &fr;    ViWin_moveAtHead2(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda15(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda15; neo_current_frame = &fr;    ViWin_moveAtHead2(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda16(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda16; neo_current_frame = &fr;    ViWin_moveAtHead(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda17(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda17; neo_current_frame = &fr;    if(self->activeWin->digitInput>0) {
...
static void lambda18(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda18; neo_current_frame = &fr;    ViWin_halfScrollDown(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda19(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda19; neo_current_frame = &fr;    ViWin_halfScrollDown(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda20(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda20; neo_current_frame = &fr;    ViWin_halfScrollUp(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda21(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda21; neo_current_frame = &fr;    ViWin_halfScrollUp(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda22(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda22; neo_current_frame = &fr;    Vi_clearView(self);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda23(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda23; neo_current_frame = &fr;    ViWin_keyG(self->activeWin,self);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda24(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda24; neo_current_frame = &fr;    ViWin_moveBottom(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda25(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda25; neo_current_frame = &fr;    int key2;
...
static void lambda26(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda26; neo_current_frame = &fr;    int key2;
    key2=ViWin_getKey_v14(self->activeWin,0);
    switch (    key2) {
        case 90:
...
struct Vi* Vi_initialize_v2(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_initialize_v2; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
...
static struct list$1lambda$* list$1lambda$_initialize(struct list$1lambda$* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1lambda$_initialize; neo_current_frame = &fr;    struct list$1lambda$* __result_obj__0;
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
    ...
    neo_current_frame = fr.prev;    come_call_finalizer(list$1lambda$$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__0;
    neo_current_frame = fr.prev;}
...
static void list$1lambda$_finalize(struct list$1lambda$* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1lambda$_finalize; neo_current_frame = &fr;    struct list_item$1lambda$* it;
    struct list_item$1lambda$* prev_it;
    if(self==((void*)0)) {
        neo_current_frame = fr.prev;
        return;
...
void Vi_exitFromApp_v2(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_exitFromApp_v2; neo_current_frame = &fr;    self->appEnd=1;
neo_current_frame = fr.prev;}
...
void Vi_view(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_view; neo_current_frame = &fr;    struct list$1ViWin$ph* o2_saved;
    struct ViWin* it  ;
    werase(stdscr);
...
void Vi_clearView(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_clearView; neo_current_frame = &fr;    struct list$1ViWin$ph* o2_saved;
    struct ViWin* it  ;
    clearok(stdscr,1);
    wclear(stdscr);
    clearok(stdscr,0);
...
int Vi_main_loop_v2(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_main_loop_v2; neo_current_frame = &fr;    while(!self->appEnd) {
        Vi_view(self);
...
void Vi_openFile_v2(struct Vi* self  , char* file_name  , int line_num, _Bool binary_mode)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_openFile_v2; neo_current_frame = &fr;    (file_name = come_decrement_ref_count(file_name, (void*)0, (void*)0, 0, 0, (void*)0));
neo_current_frame = fr.prev;}
...
void Vi_repositionWindows_v2(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_repositionWindows_v2; neo_current_frame = &fr;neo_current_frame = fr.prev;}

void Vi_enterSearchMode_v2(struct Vi* self  , _Bool regex_search, _Bool search_reverse)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_enterSearchMode_v2; neo_current_frame = &fr;neo_current_frame = fr.prev;}
