...
static struct list$1tuple3$3int$int$int$$ph* list$1tuple3$3int$int$int$$ph_push_back(struct list$1tuple3$3int$int$int$$ph* self, struct tuple3$3int$int$int$* item)
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1tuple3$3int$int$int$$ph*)come_increment_ref_count(((struct list_item$1tuple3$3int$int$int$$ph*)(__right_value0=(struct list_item$1tuple3$3int$int$int$$ph*)come_calloc(1, sizeof(struct list_item$1tuple3$3int$int$int$$ph)*(1), "/usr/local/include/neo-c.h", 1461, "struct list_item$1tuple3$3int$int$int$$ph*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
