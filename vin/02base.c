...
static void lambda6(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda6"; neo_current_frame = &fr;
    ViWin_backward_v2(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda7(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda7"; neo_current_frame = &fr;
...
static void lambda8(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda8"; neo_current_frame = &fr;
    ViWin_nextLine(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda9(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda9"; neo_current_frame = &fr;
    ViWin_nextLine(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda10(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda10"; neo_current_frame = &fr;
...
static void lambda11(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda11"; neo_current_frame = &fr;
    ViWin_prevLine(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda12(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda12"; neo_current_frame = &fr;
    ViWin_prevLine(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda13(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda13"; neo_current_frame = &fr;
...
static void lambda14(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda14"; neo_current_frame = &fr;
...
static void lambda15(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda15"; neo_current_frame = &fr;
    ViWin_moveAtHead2(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda16(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda16"; neo_current_frame = &fr;
    ViWin_moveAtHead(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda17(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda17"; neo_current_frame = &fr;
...
static void lambda18(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda18"; neo_current_frame = &fr;
...
static void lambda19(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda19"; neo_current_frame = &fr;
    ViWin_halfScrollDown(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda20(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda20"; neo_current_frame = &fr;
...
static void lambda21(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda21"; neo_current_frame = &fr;
    ViWin_halfScrollUp(self->activeWin);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda22(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda22"; neo_current_frame = &fr;
    Vi_clearView(self);
    ViWin_saveInputedKeyOnTheMovingCursor_v14(self->activeWin);
neo_current_frame = fr.prev;}
...
static void lambda23(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda23"; neo_current_frame = &fr;
...
static void lambda24(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda24"; neo_current_frame = &fr;
...
static void lambda25(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda25"; neo_current_frame = &fr;
    int key2;
...
static void lambda26(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "lambda26"; neo_current_frame = &fr;
    int key2;
    key2=ViWin_getKey_v14(self->activeWin,0);
    switch (    key2) {
        case 90:
