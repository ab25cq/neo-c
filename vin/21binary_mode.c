...
static struct list$1int$ph* list$1int$ph_sublist(struct list$1int$ph* self, int begin, int tail)
{
    ...
    result=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_initialize((struct list$1int$ph*)come_increment_ref_count((struct list$1int$ph*)come_calloc(1, sizeof(struct list$1int$ph)*(1), (void*)0, 1194, "struct list$1int$ph*"))));
    if(begin<0) {
        begin+=self->len;
    }
    if(tail<0) {
    ...
    if(begin>=self->len) {
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(((struct list$1int$ph*)(__right_value1=list$1int$ph_initialize((struct list$1int$ph*)come_increment_ref_count((struct list$1int$ph*)come_calloc(1, sizeof(struct list$1int$ph)*(1), (void*)0, 1209, "struct list$1int$ph*"))))));
...
static struct list$1int$ph* list$1int$ph_insert(struct list$1int$ph* self, int position, int* item  )
{
    ...
    if(position==0) {
        ...
        litem_9=(struct list_item$1int$ph*)come_increment_ref_count((struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 901, "struct list_item$1int$ph*"));
        ...
        while(it!=((void*)0)) {
            if(position==i_10) {
                litem_11=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 917, "struct list_item$1int$ph*"))));
...
static struct list$1int$* list$1int$_insert(struct list$1int$* self, int position, int item)
{
    ...
    if(position==0) {
        ...
        litem_12=(struct list_item$1int$*)come_increment_ref_count((struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 901, "struct list_item$1int$*"));
        ...
        while(it!=((void*)0)) {
            if(position==i_13) {
                litem_14=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 917, "struct list_item$1int$*"))));
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi*,int))
{
    ...
    if(self->len==0) {
        ...
        litem_24=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 734, "struct list_item$1lambda$*"))));
