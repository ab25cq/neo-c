...
void ViWin_binaryModeView(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_binaryModeView"; neo_current_frame = &fr;
    int maxy;
    int maxx;
    int it2;
...
static struct list$1int$ph* list$1int$ph_sublist(struct list$1int$ph* self, int begin, int tail)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$ph_sublist"; neo_current_frame = &fr;
    ...
    result=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_initialize((struct list$1int$ph*)come_increment_ref_count((struct list$1int$ph*)come_calloc(1, sizeof(struct list$1int$ph)*(1), (void*)0, 1184, "struct list$1int$ph*"))));
    if(begin<0) {
        begin+=self->len;
    }
    if(tail<0) {
    ...
    if(begin>=self->len) {
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(((struct list$1int$ph*)(__right_value1=list$1int$ph_initialize((struct list$1int$ph*)come_increment_ref_count((struct list$1int$ph*)come_calloc(1, sizeof(struct list$1int$ph)*(1), (void*)0, 1199, "struct list$1int$ph*"))))));
...
static struct list$1int$ph* list$1int$ph_initialize(struct list$1int$ph* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$ph_initialize"; neo_current_frame = &fr;
    struct list$1int$ph* __result_obj__0;
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
...
void ViWin_view_v21(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_view_v21"; neo_current_frame = &fr;
...
void ViWin_insertBinary(struct ViWin*  self  , int  c  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_insertBinary"; neo_current_frame = &fr;
    int len;
    void* __right_value0 = (void*)0;
    int*  line  ;
    int*  new_line  ;
...
static struct list$1int$ph* list$1int$ph_insert(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(position==0) {
        ...
        litem_9=(struct list_item$1int$ph*)come_increment_ref_count((struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 891, "struct list_item$1int$ph*"));
        ...
        self->len++;
        come_call_finalizer(list_item$1int$ph$p_finalize, litem_9, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    else {
        it=self->head;
        i_10=0;
        while(it!=((void*)0)) {
            if(position==i_10) {
                litem_11=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 907, "struct list_item$1int$ph*"))));
...
static struct list$1int$* list$1int$_insert(struct list$1int$* self, int position, int item)
{
    ...
    if(position==0) {
        ...
        litem_12=(struct list_item$1int$*)come_increment_ref_count((struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 891, "struct list_item$1int$*"));
        ...
        self->len++;
        come_call_finalizer(list_item$1int$$p_finalize, litem_12, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    else {
        it=self->head;
        i_13=0;
        while(it!=((void*)0)) {
            if(position==i_13) {
                litem_14=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 907, "struct list_item$1int$*"))));
...
void ViWin_inputBinaryMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_inputBinaryMode"; neo_current_frame = &fr;
    int key;
    int key2;
    int key2_21;
    int key2_22;
...
void ViWin_input_v21(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_input_v21"; neo_current_frame = &fr;
...
void Vi_enterBinaryMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterBinaryMode"; neo_current_frame = &fr;
    self->mode=(9);
...
void Vi_enterBinaryMode2(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterBinaryMode2"; neo_current_frame = &fr;
    self->mode=(9);
    ViWin_writedFlagOn_v6(self->activeWin);
    ViWin_modifyOverCursorXValue(self->activeWin);
    wclear(stdscr);
...
void Vi_enterBinaryMode3(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterBinaryMode3"; neo_current_frame = &fr;
    struct ViWin*  win  ;
    int len;
    self->mode=(9);
    ViWin_writedFlagOn_v6(self->activeWin);
...
void Vi_exitFromBinaryMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_exitFromBinaryMode"; neo_current_frame = &fr;
    self->mode=(0);
...
struct Vi*  Vi_initialize_v21(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_initialize_v21"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct Vi*  result  ;
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    if(self->len==0) {
        ...
        litem_23=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 714, "struct list_item$1lambda$*"))));
        ...
        litem_24=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 724, "struct list_item$1lambda$*"))));
