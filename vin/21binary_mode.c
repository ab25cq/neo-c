...
void ViWin_binaryModeView(struct ViWin*  self  , struct Vi*  nvi  )
{
    ...
    if(list$1int$ph_length(self->texts)>0) {
        it2=0;
        for(({(_conditional_value_X0=(_o2_saved_1=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,self->scroll,self->scroll+maxy-1), "21binary_mode.nc", 14),it=list$1int$ph_begin(_o2_saved_1)));_conditional_value_X0;})        ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_1)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(_o2_saved_1)));_conditional_value_X2;})){
        ...
        come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_1, (void*)0, (void*)0, 0, 0, 0, (void*)0, "21binary_mode.nc}", 43);
    }
    wattr_on(self->win,(unsigned int )(((unsigned int )((1U))<<((10)+8))),((void*)0));
...
static struct list$1int$ph* list$1int$ph_sublist(struct list$1int$ph* self, int begin, int tail)
{
    ...
    int i;
    if(self==((void*)0)) {
                __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(self, "/usr/local/include/neo-c.h", 2009);
        neo_current_frame = fr.prev;
        come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2009);
        return __result_obj__0;
    }
    result=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_initialize((struct list$1int$ph*)come_increment_ref_count((struct list$1int$ph*)come_calloc(1, sizeof(struct list$1int$ph)*(1), "/usr/local/include/neo-c.h", 2012, "struct list$1int$ph*"), "/usr/local/include/neo-c.h", 2012)), "/usr/local/include/neo-c.h", 2012);
    if(begin<0) {
        begin+=self->len;
    }
    if(tail<0) {
    ...
    if(begin>=self->len) {
        ...
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(((struct list$1int$ph*)(__right_value1=list$1int$ph_initialize((struct list$1int$ph*)come_increment_ref_count((struct list$1int$ph*)come_calloc(1, sizeof(struct list$1int$ph)*(1), "/usr/local/include/neo-c.h", 2027, "struct list$1int$ph*"), "/usr/local/include/neo-c.h", 2027)))), "/usr/local/include/neo-c.h", 2027);
        come_call_finalizer(list$1int$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2027);
        come_call_finalizer(list$1int$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0, "/usr/local/include/neo-c.h}", 2027);
        neo_current_frame = fr.prev;
        come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2027);
        return __result_obj__0;
    }
    if(tail>=self->len) {
        tail=self->len;
    ...
    while(it!=((void*)0)) {
        if(i>=begin&&i<tail) {
            list$1int$ph_push_back(result,(int* )come_increment_ref_count(it->item, "/usr/local/include/neo-c.h", 2038));
        }
        it=it->next;
        i++;
    }
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(result, "/usr/local/include/neo-c.h", 2044);
    come_call_finalizer(list$1int$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2044);
    neo_current_frame = fr.prev;
    come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2044);
    return __result_obj__0;
}
...
static struct list$1int$ph* list$1int$ph_initialize(struct list$1int$ph* self)
{
    ...
    self->tail=((void*)0);
    self->len=0;
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(self, "/usr/local/include/neo-c.h", 1390);
    come_call_finalizer(list$1int$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 1390);
    neo_current_frame = fr.prev;
    come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 1390);
    return __result_obj__0;
}
...
void ViWin_insertBinary(struct ViWin*  self  , int  c  )
{
    ...
    if(line==((void*)0)||len==-1) {
        __right_value0 = (void*)0;
        new_line=(int* )come_increment_ref_count((int *)come_calloc(1, sizeof(int )*(1*(2)), "21binary_mode.nc", 69, "int* "), "21binary_mode.nc", 69);
        memcpy(new_line,&c,sizeof(int ));
        sentinel=L'\0';
        memcpy(new_line+sizeof(int ),&sentinel,sizeof(int ));
        list$1int$ph_push_back(self->texts,(int* )come_increment_ref_count(new_line, "21binary_mode.nc", 73));
        list$1int$_push_back(self->texts_length,1);
        self->cursorX++;
        (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "21binary_mode.nc", 110));
    }
    else if(self->cursorX==16&&len>=16) {
        __right_value0 = (void*)0;
        new_line_7=(int* )come_increment_ref_count((int *)come_calloc(1, sizeof(int )*(1*(2)), "21binary_mode.nc", 78, "int* "), "21binary_mode.nc", 78);
        memcpy(new_line_7,&c,sizeof(int ));
        sentinel_8=L'\0';
        memcpy(new_line_7+1,&sentinel_8,sizeof(int ));
        list$1int$ph_insert(self->texts,self->scroll+self->cursorY+1,(int* )come_increment_ref_count(new_line_7, "21binary_mode.nc", 82));
        list$1int$_insert(self->texts_length,self->scroll+self->cursorY+1,1);
        self->cursorX=1;
        self->cursorY++;
        (new_line_7 = come_decrement_ref_count(new_line_7, (void*)0, (void*)0, 0, 0, (void*)0, "21binary_mode.nc", 110));
    }
    else if(self->cursorX>=len) {
        __right_value0 = (void*)0;
        new_line_15=(int* )come_increment_ref_count((int *)come_calloc(1, sizeof(int )*(1*(len+2)), "21binary_mode.nc", 88, "int* "), "21binary_mode.nc", 88);
        memcpy(new_line_15,line,sizeof(int )*len);
        memcpy(new_line_15+len,&c,sizeof(int ));
        sentinel_16=L'\0';
        memcpy(new_line_15+len+1,&sentinel_16,sizeof(int ));
        list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(new_line_15, "21binary_mode.nc", 93));
        list$1int$_replace(self->texts_length,self->scroll+self->cursorY,len+1);
        self->cursorX++;
        (new_line_15 = come_decrement_ref_count(new_line_15, (void*)0, (void*)0, 0, 0, (void*)0, "21binary_mode.nc", 110));
    }
    else {
        __right_value0 = (void*)0;
        new_line_19=(int* )come_increment_ref_count((int *)come_calloc(1, sizeof(int )*(1*(len+2)), "21binary_mode.nc", 98, "int* "), "21binary_mode.nc", 98);
        ...
        list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count(new_line_19, "21binary_mode.nc", 107));
        list$1int$_replace(self->texts_length,self->scroll+self->cursorY,len);
        (new_line_19 = come_decrement_ref_count(new_line_19, (void*)0, (void*)0, 0, 0, (void*)0, "21binary_mode.nc", 110));
    }
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_insert(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(position==0) {
        ...
        __dec_obj4 = come_decrement_ref_count(__dec_obj4, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1709);
        ...
        __right_value0 = (void*)0;
        litem_9=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1717, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1717);
        litem_9->prev=self->head;
        litem_9->next=self->tail;
        __dec_obj5=litem_9->item,
        litem_9->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1721);
        __dec_obj5 = come_decrement_ref_count(__dec_obj5, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1721);
        ...
        while(it!=((void*)0)) {
            if(position==i_10) {
                __right_value0 = (void*)0;
                litem_11=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1733, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1733);
                litem_11->prev=it->prev;
                litem_11->next=it;
                __dec_obj6=litem_11->item,
                litem_11->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1737);
                __dec_obj6 = come_decrement_ref_count(__dec_obj6, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1737);
...
static struct list$1int$* list$1int$_insert(struct list$1int$* self, int position, int item)
{
    ...
    if(position==0) {
        ...
        __right_value0 = (void*)0;
        litem_12=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1717, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1717);
        ...
        while(it!=((void*)0)) {
            if(position==i_13) {
                __right_value0 = (void*)0;
                litem_14=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1733, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1733);
...
static struct list$1int$ph* list$1int$ph_replace(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    while(it!=((void*)0)) {
        if(position==i_17) {
            ...
            __dec_obj7 = come_decrement_ref_count(__dec_obj7, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1952);
            break;
        }
        it=it->next;
        i_17++;
...
struct Vi*  Vi_initialize_v21(struct Vi*  self  )
{
    ...
    result=(struct Vi* )come_increment_ref_count(Vi_initialize_v20((struct Vi* )come_increment_ref_count(self, "21binary_mode.nc", 273)), "21binary_mode.nc", 273);
    result->mode=(0);
    if(gBinaryMode) {
        ...
        __result_obj__0 = (struct Vi* )come_increment_ref_count(result, "21binary_mode.nc", 292);
    come_call_finalizer(Vi_finalize, self, (void*)0, (void*)0, 0, 0, 0, (void*)0, "21binary_mode.nc}", 292);
    come_call_finalizer(Vi_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "21binary_mode.nc}", 292);
    neo_current_frame = fr.prev;
    come_call_finalizer(Vi_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "21binary_mode.nc}", 292);
    return __result_obj__0;
}
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_23=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1534, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1534);
        ...
        __right_value0 = (void*)0;
        litem_24=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1544, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1544);
