...
fr.fun_name = ViWin_toggleBraceForward; neo_current_frame = &fr;    int cursor_y;
    int cursor_x;
    int nest;
...
void ViWin_toggleBraceBack(struct ViWin* self  , int head  , int tail  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_toggleBraceBack; neo_current_frame = &fr;    int cursor_y;
    int cursor_x;
    int nest;
    void* __right_value0 = (void*)0;
    int* line  ;
...
static struct list$1int$ph* list$1int$ph_reverse(struct list$1int$ph* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = list$1int$ph_reverse; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct list$1int$ph* result;
...
void ViWin_toggleCommentForward(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_toggleCommentForward; neo_current_frame = &fr;    int head;
    int tail;
    int nest;
    int it2;
    void* __right_value0 = (void*)0;
...
void ViWin_toggleCommentBackward(struct ViWin* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_toggleCommentBackward; neo_current_frame = &fr;    int head;
    int tail;
    int nest;
    int it2;
    void* __right_value0 = (void*)0;
...
void ViWin_gotoBraceEnd_v11(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_gotoBraceEnd_v11; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    int* line  ;
    int c  ;
    int c1  ;
    int c2  ;
...
void ViWin_gotoFunctionTop(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_gotoFunctionTop; neo_current_frame = &fr;    int it2;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct list$1int$ph* o2_saved;
    int* it  ;
    ...
    for(({(_conditional_value_X0=(o2_saved=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_reverse(((struct list$1int$ph*)(__right_value0=list$1int$ph_sublist(self->texts,0,self->scroll+self->cursorY))))),it=list$1int$ph_begin(o2_saved)));    come_call_finalizer(list$1int$ph$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
_conditional_value_X0;});({(_conditional_value_X1=(!list$1int$ph_end(o2_saved)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(o2_saved)));_conditional_value_X2;})){
        if(({(_conditional_value_X3=(string_match(((char*)(__right_value0=wstring_to_string(it))),"^{",0)));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
void ViWin_gotoMethodTop(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_gotoMethodTop; neo_current_frame = &fr;    int it2;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct list$1int$ph* o2_saved;
    int* it  ;
...
_conditional_value_X0;});({(_conditional_value_X1=(!list$1int$ph_end(o2_saved)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(o2_saved)));_conditional_value_X2;})){
        ...
        reg3="^{";
        reg4="^[a-zA-Z].*{$";
        if(({(_conditional_value_X3=(reg&&reg2&&reg3&&reg4&&((string_match(((char*)(__right_value0=wstring_to_string(it))),reg,0))||(string_match(((char*)(__right_value1=wstring_to_string(it))),reg2,0))||(string_match(((char*)(__right_value2=wstring_to_string(it))),reg3,0))||(string_match(((char*)(__right_value3=wstring_to_string(it))),reg4,0)))));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
void ViWin_gotoFunctionBottom(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_gotoFunctionBottom; neo_current_frame = &fr;    int cursor_y;
    int it2;
    void* __right_value0 = (void*)0;
    struct list$1int$ph* o2_saved;
    int* it  ;
...
static void lambda1(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda1; neo_current_frame = &fr;    ViWin_gotoBraceEnd_v11(self->activeWin,self);
...
struct Vi* Vi_initialize_v11(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_initialize_v11; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct Vi* result  ;
