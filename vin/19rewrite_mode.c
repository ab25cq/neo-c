...
fr.fun_name = ViWin_rewriteModeView; neo_current_frame = &fr;    ViWin_textsView(self,nvi);
...
void ViWin_view_v19(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_view_v19; neo_current_frame = &fr;    if(nvi->mode==(7)&&ViWin_equals(self,nvi->activeWin)) {
...
void ViWin_insertText2(struct ViWin* self  , int* text  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_insertText2; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    ...
    if(list$1int$ph_length(self->texts)==0) {
        list$1int$ph_push_back(self->texts,(int*)come_increment_ref_count((int*)come_memdup(text, "19rewrite_mode.nc", 26, "int*")));
        ...
        new_line=(int*)come_increment_ref_count(string_to_wstring(((char*)(__right_value2=xsprintf("%ls%ls%ls",((int*)(__right_value0=wstring_substring(old_line,0,self->cursorX))),text,((int*)(__right_value1=wstring_substring(old_line,self->cursorX+wstring_length(text),-1))))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0));
        list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int*)come_increment_ref_count((int*)come_memdup(new_line, "19rewrite_mode.nc", 38, "int*")));
...
void ViWin_inputRewritetMode(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_inputRewritetMode; neo_current_frame = &fr;    int key;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int* str  ;
    char* Value;
    ...
    if(key==3||key==27) {
        ...
        Value="^$|^[ ]+$";
        if(Value) {
            if(({(_conditional_value_X0=(string_match(((char*)(__right_value0=wstring_to_string(str))),Value,0)));            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
_conditional_value_X0;})) {
                ViWin_insertText2(self,(int*)come_increment_ref_count(__builtin_wstring("    ")));
            }
            else {
        ...
        keys[0]=key;
        for(i=1;i<size;i++){
            keys[i]=ViWin_getKey_v14(self,0);
        }
        keys[i]=0;
        ViWin_insertText2(self,(int*)come_increment_ref_count(__builtin_wstring(keys)));
    }
    else if(key==40) {
        ViWin_blinkBraceFoward(self,40,41,nvi);
        ViWin_insertText2(self,(int*)come_increment_ref_count(__builtin_wstring(((char*)(__right_value0=xsprintf("%c",key))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    else if(key==123) {
        ...
        if(cursor_y==self->cursorY) {
            ...
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int*)come_increment_ref_count((int*)come_memdup(line, "19rewrite_mode.nc", 126, "int*")));
            ...
            line_6=(int*)come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int*)(__right_value0=__builtin_wstring("")))));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            ((int*)(__right_value0=wstring_delete(line_6,0,cursor_x+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int*)come_increment_ref_count((int*)come_memdup(line_6, "19rewrite_mode.nc", 137, "int*")));
        ...
        str_7[0]=key2;
        str_7[1]=0;
        ViWin_insertText2(self,(int*)come_increment_ref_count(__builtin_wstring(str_7)));
    }
    else {
        ViWin_insertText2(self,(int*)come_increment_ref_count(__builtin_wstring(((char*)(__right_value0=xsprintf("%c",key))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
void ViWin_input_v19(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_input_v19; neo_current_frame = &fr;    if(nvi->mode==(7)) {
...
void Vi_enterRewriteMode(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_enterRewriteMode; neo_current_frame = &fr;    self->mode=(7);
...
void Vi_exitFromRewiteMode(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_exitFromRewiteMode; neo_current_frame = &fr;    self->mode=(0);
...
static void lambda1(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda1; neo_current_frame = &fr;    ViWin_pushUndo_v5(self->activeWin);
...
struct Vi* Vi_initialize_v19(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_initialize_v19; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct Vi* result  ;
...
fr.fun_name = list$1lambda$_push_back; neo_current_frame = &fr;    struct list$1lambda$* __result_obj__0;
    ...
    if(self->len==0) {
        ...
        litem_8=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 711, "struct list_item$1lambda$*"))));
        ...
        litem_9=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 721, "struct list_item$1lambda$*"))));
...
int Vi_main_loop_v19(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_main_loop_v19; neo_current_frame = &fr;    while(!self->appEnd) {
        Vi_view(self);
        if(self->mode!=(1)) {
