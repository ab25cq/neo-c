...
void ViWin_rewriteModeView(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_rewriteModeView"; neo_current_frame = &fr;
...
void ViWin_view_v19(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_view_v19"; neo_current_frame = &fr;
...
void ViWin_insertText2(struct ViWin*  self  , int*  text  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_insertText2"; neo_current_frame = &fr;
...
void ViWin_inputRewritetMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_inputRewritetMode"; neo_current_frame = &fr;
    int key;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int*  str  ;
    ...
    if(key==3||key==27) {
        ...
        const char* Value="^$|^[ ]+$";
        if(Value) {
            if(({(_conditional_value_X0=(string_match(((char* )(__right_value0=wstring_to_string(str))),Value,(_Bool)0)));            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
void ViWin_input_v19(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_input_v19"; neo_current_frame = &fr;
    if(nvi->mode==(7)) {
...
void Vi_enterRewriteMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterRewriteMode"; neo_current_frame = &fr;
    self->mode=(7);
...
void Vi_exitFromRewiteMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_exitFromRewiteMode"; neo_current_frame = &fr;
    self->mode=(0);
...
struct Vi*  Vi_initialize_v19(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_initialize_v19"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct Vi*  result  ;
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    if(self->len==0) {
        ...
        litem_8=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 714, "struct list_item$1lambda$*"))));
        ...
        litem_9=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 724, "struct list_item$1lambda$*"))));
...
int Vi_main_loop_v19(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_main_loop_v19"; neo_current_frame = &fr;
    while(!self->appEnd) {
        Vi_view(self);
        if(self->mode!=(1)) {
