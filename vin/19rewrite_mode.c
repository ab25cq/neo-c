...
void ViWin_rewriteModeView(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_rewriteModeView"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
...
void ViWin_view_v19(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_view_v19"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
...
void ViWin_insertText2(struct ViWin*  self  , int*  text  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_insertText2"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    ...
    if(list$1int$ph_length(self->texts)==0) {
        list$1int$ph_push_back(self->texts,(int* )come_increment_ref_count((int* )come_memdup(text, "src/19rewrite_mode.nc", 27, 15, "int* "), "src/19rewrite_mode.nc", 27, 16));
        list$1int$_push_back(self->texts_length,wcslen(text));
        self->cursorX+=wstring_length(text);
    }
    else {
        __right_value0 = (void*)0;
        old_line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","src/19rewrite_mode.nc",32)))), "src/19rewrite_mode.nc", 32, 29);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 32, 30));
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        new_line=(int* )come_increment_ref_count(string_to_wstring(((char* )(__right_value2=xsprintf("%ls%ls%ls",((int* )(__right_value0=wstring_substring(old_line,0,self->cursorX))),text,((int* )(__right_value1=wstring_substring(old_line,self->cursorX+wstring_length(text),-1))))))), "src/19rewrite_mode.nc", 37, 31);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 36, 32));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 37, 33));
        (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 37, 34));
        __right_value0 = (void*)0;
        list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count((int* )come_memdup(new_line, "src/19rewrite_mode.nc", 39, 43, "int* "), "src/19rewrite_mode.nc", 39, 44));
        list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(new_line));
        self->cursorX+=wstring_length(text);
        (old_line = come_decrement_ref_count(old_line, (void*)0, (void*)0, 0, 0, (void*)0, "src/19rewrite_mode.nc", 43, 45));
        (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "src/19rewrite_mode.nc", 43, 46));
    }
    (text = come_decrement_ref_count(text, (void*)0, (void*)0, 0, 0, (void*)0, "src/19rewrite_mode.nc", 45, 47));
    neo_current_frame = fr.prev;
}
...
void ViWin_inputRewritetMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_inputRewritetMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int key;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    int*  str  ;
    ...
    if(key==3||key==27) {
        ...
        str=(int* )come_increment_ref_count(wstring_substring(((int* )(__right_value0=list$1int$ph_item(self->texts,self->scroll+self->cursorY,((void*)0)))),0,self->cursorX), "src/19rewrite_mode.nc", 62, 48);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 62, 49));
        Value="^$|^[ ]+$";
        if(Value) {
            if(__right_value0 = (void*)0,
({(_conditional_value_X0=(string_match(((char* )(__right_value0=wstring_to_string(str))),Value,(_Bool)0)));            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 65, 50));
_conditional_value_X0;})) {
                __right_value0 = (void*)0;
                ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring("    ","src/19rewrite_mode.nc",66), "src/19rewrite_mode.nc", 66, 51));
            }
            else {
                ViWin_completion_v13(self,nvi);
            }
        }
        (str = come_decrement_ref_count(str, (void*)0, (void*)0, 0, 0, (void*)0, "src/19rewrite_mode.nc", 158, 52));
    }
    else if(key>127) {
        ...
        for(i=1        ;i<size;i++){
            ({ long long __neo_array_index2_0 = (long long)(i); if(__neo_array_index2_0 < 0 || __neo_array_index2_0 >= (long long)(16)) { extern void stackframe(void) __attribute__((weak)); extern void exit(int); puts("array index out of bounds"); if(stackframe) stackframe(); else { puts("stackframe"); puts(__func__); } exit(2); } keys[__neo_array_index2_0] = ViWin_getKey_v14(self,(_Bool)0); });
        }
        ({ long long __neo_array_index3_0 = (long long)(i); if(__neo_array_index3_0 < 0 || __neo_array_index3_0 >= (long long)(16)) { extern void stackframe(void) __attribute__((weak)); extern void exit(int); puts("array index out of bounds"); if(stackframe) stackframe(); else { puts("stackframe"); puts(__func__); } exit(2); } keys[__neo_array_index3_0] = 0; });
        __right_value0 = (void*)0;
        ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring(keys,"src/19rewrite_mode.nc",87), "src/19rewrite_mode.nc", 87, 53));
    }
    else if(key==40) {
        ViWin_blinkBraceFoward(self,40,41,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/19rewrite_mode.nc",91), "src/19rewrite_mode.nc", 91, 54));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 91, 55));
    }
    else if(key==123) {
        ViWin_blinkBraceFoward(self,123,125,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/19rewrite_mode.nc",95), "src/19rewrite_mode.nc", 95, 56));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 95, 57));
    }
    else if(key==91) {
        ViWin_blinkBraceFoward(self,60,62,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/19rewrite_mode.nc",99), "src/19rewrite_mode.nc", 99, 58));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 99, 59));
    }
    else if(key==41) {
        ViWin_blinkBraceEnd(self,40,41,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/19rewrite_mode.nc",103), "src/19rewrite_mode.nc", 103, 60));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 103, 61));
    }
    else if(key==125) {
        ViWin_blinkBraceEnd(self,123,125,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/19rewrite_mode.nc",107), "src/19rewrite_mode.nc", 107, 62));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 107, 63));
    }
    else if(key==93) {
        ViWin_blinkBraceEnd(self,91,93,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/19rewrite_mode.nc",111), "src/19rewrite_mode.nc", 111, 64));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 111, 65));
    }
    else if(key==62) {
        ViWin_blinkBraceEnd(self,60,62,nvi);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/19rewrite_mode.nc",115), "src/19rewrite_mode.nc", 115, 66));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 115, 67));
    }
    else if(key==87-65+1) {
        ...
        if(cursor_y==self->cursorY) {
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            line=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","src/19rewrite_mode.nc",124)))), "src/19rewrite_mode.nc", 124, 68);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 124, 69));
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line,self->cursorX,cursor_x+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 125, 70));
            __right_value0 = (void*)0;
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count((int* )come_memdup(line, "src/19rewrite_mode.nc", 127, 71, "int* "), "src/19rewrite_mode.nc", 127, 72));
            list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(line));
            ViWin_modifyOverCursorXValue(self);
            self->cursorX++;
            (line = come_decrement_ref_count(line, (void*)0, (void*)0, 0, 0, (void*)0, "src/19rewrite_mode.nc", 144, 73));
        }
        else {
            self->cursorY=cursor_y;
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            line_6=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,self->scroll+self->cursorY,((int* )(__right_value0=__builtin_wstring("","src/19rewrite_mode.nc",134)))), "src/19rewrite_mode.nc", 134, 74);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 134, 75));
            __right_value0 = (void*)0;
            ((int* )(__right_value0=wstring_delete(line_6,0,cursor_x+1)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 136, 76));
            __right_value0 = (void*)0;
            list$1int$ph_replace(self->texts,self->scroll+self->cursorY,(int* )come_increment_ref_count((int* )come_memdup(line_6, "src/19rewrite_mode.nc", 138, 77, "int* "), "src/19rewrite_mode.nc", 138, 78));
            list$1int$_replace(self->texts_length,self->scroll+self->cursorY,wcslen(line_6));
            self->cursorX=0;
            self->cursorY=cursor_y;
            (line_6 = come_decrement_ref_count(line_6, (void*)0, (void*)0, 0, 0, (void*)0, "src/19rewrite_mode.nc", 144, 79));
        }
    }
    else if(key==86-65+1) {
        ...
        str_7[1]=0;
        __right_value0 = (void*)0;
        ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring(str_7,"src/19rewrite_mode.nc",153), "src/19rewrite_mode.nc", 153, 80));
    }
    else {
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        ViWin_insertText2(self,(int* )come_increment_ref_count(__builtin_wstring(((char* )(__right_value0=xsprintf("%c",key))),"src/19rewrite_mode.nc",156), "src/19rewrite_mode.nc", 156, 81));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "src/19rewrite_mode.nc", 156, 82));
    }
    neo_current_frame = fr.prev;
}
...
void ViWin_input_v19(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_input_v19"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    if(nvi->mode==(7)) {
...
void Vi_enterRewriteMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterRewriteMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    self->mode=(7);
...
void Vi_exitFromRewiteMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_exitFromRewiteMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    self->mode=(0);
...
struct Vi*  Vi_initialize_v19(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_initialize_v19"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct Vi*  result  ;
    struct Vi*  __result_obj__0  ;
    memset(&result, 0, sizeof(result));
    result=(struct Vi* )come_increment_ref_count(Vi_initialize_v18((struct Vi* )come_increment_ref_count(self, "src/19rewrite_mode.nc", 185, 83)), "src/19rewrite_mode.nc", 185, 84);
    result->mode=(0);
    list$1lambda$_replace(result->events,82,lambda1);
        __result_obj__0 = (struct Vi* )come_increment_ref_count(result, "src/19rewrite_mode.nc", 195, 91);
    come_call_finalizer(Vi_finalize, self, (void*)0, (void*)0, 0, 0, 0, (void*)0, "src/19rewrite_mode.nc}", 195, 145);
    come_call_finalizer(Vi_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "src/19rewrite_mode.nc}", 195, 146);
    neo_current_frame = fr.prev;
    come_call_finalizer(Vi_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "src/19rewrite_mode.nc}", 195, 147);
    return __result_obj__0;
}
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "lib/neo-c.h", 1802, 85, "struct list_item$1lambda$*"))), "lib/neo-c.h", 1802, 86);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_8=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "lib/neo-c.h", 1812, 87, "struct list_item$1lambda$*"))), "lib/neo-c.h", 1812, 88);
        ...
        __right_value0 = (void*)0;
        litem_9=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "lib/neo-c.h", 1822, 89, "struct list_item$1lambda$*"))), "lib/neo-c.h", 1822, 90);
...
static void Vi_finalize(struct Vi*  self  )
{
    ...
    if(self!=((void*)0)&&self->wins!=((void*)0)) {
        come_call_finalizer(list$1ViWin$ph$p_finalize, self->wins, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 8, 128);
    }
    if(self!=((void*)0)&&self->events!=((void*)0)) {
        come_call_finalizer(list$1lambda$$p_finalize, self->events, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 2, 130);
    }
    if(self!=((void*)0)&&self->yank!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->yank, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 4, 131);
    }
    if(self!=((void*)0)&&self->fileYank!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->fileYank, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 5, 132);
    }
    if(self!=((void*)0)&&self->registers!=((void*)0)) {
        come_call_finalizer(map$2int$list$1int$ph$ph$p_finalize, self->registers, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 137);
    }
    if(self!=((void*)0)&&self->registerKinds!=((void*)0)) {
        come_call_finalizer(map$2int$int$$p_finalize, self->registerKinds, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 141);
    }
    if(self!=((void*)0)&&self->commandHistory!=((void*)0)) {
        come_call_finalizer(list$1char$ph$p_finalize, self->commandHistory, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 144);
    }
        neo_current_frame = fr.prev;
}
...
static void list$1ViWin$ph$p_finalize(struct list$1ViWin$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1ViWin$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 127);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1ViWin$ph$p_finalize(struct list_item$1ViWin$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(ViWin_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1ViWin$ph$p_finalize}", 2, 126);
    }
            neo_current_frame = fr.prev;
}
...
static void ViWin_finalize(struct ViWin*  self  )
{
    ...
    if(self!=((void*)0)&&self->texts!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->texts, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 18, 94);
    }
    if(self!=((void*)0)&&self->texts_length!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->texts_length, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 2, 96);
    }
    if(self!=((void*)0)&&self->returnPoint!=((void*)0)) {
        come_call_finalizer(tuple3$3int$int$int$$p_finalize, self->returnPoint, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 4, 97);
    }
    if(self!=((void*)0)&&self->returnPointStack!=((void*)0)) {
        come_call_finalizer(list$1tuple3$3int$int$int$$ph$p_finalize, self->returnPointStack, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 0, 100);
    }
    if(self!=((void*)0)&&self->undo!=((void*)0)) {
        come_call_finalizer(list$1list$1int$ph$ph$p_finalize, self->undo, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 2, 103);
    }
    if(self!=((void*)0)&&self->undoScroll!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->undoScroll, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 7, 104);
    }
    if(self!=((void*)0)&&self->undoCursorX!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->undoCursorX, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 8, 105);
    }
    if(self!=((void*)0)&&self->undoCursorY!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->undoCursorY, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 9, 106);
    }
    if(self!=((void*)0)&&self->fileName!=((void*)0)) {
        (self->fileName = come_decrement_ref_count(self->fileName, (void*)0, (void*)0, 0, 0, (void*)0, "ViWin_finalize", 10, 107));
    }
    if(self!=((void*)0)&&self->inputedKeys!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->inputedKeys, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 11, 108);
    }
    if(self!=((void*)0)&&self->savedInputedKeys!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->savedInputedKeys, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 12, 109);
    }
    if(self!=((void*)0)&&self->macro!=((void*)0)) {
        come_call_finalizer(map$2int$list$1list$1int$$ph$ph$p_finalize, self->macro, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 2, 116);
    }
    if(self!=((void*)0)&&self->recordingMacro!=((void*)0)) {
        come_call_finalizer(list$1list$1int$$ph$p_finalize, self->recordingMacro, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 14, 117);
    }
    if(self!=((void*)0)&&self->runningMacro!=((void*)0)) {
        come_call_finalizer(list$1list$1int$$ph$p_finalize, self->runningMacro, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 15, 118);
    }
    if(self!=((void*)0)&&self->mark!=((void*)0)) {
        come_call_finalizer(map$2int$tuple3$3int$int$int$$ph$p_finalize, self->mark, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 2, 123);
    }
    if(self!=((void*)0)&&self->completionCandidates!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->completionCandidates, (void*)0, (void*)0, 0, 0, 0, (void*)0, "ViWin_finalize}", 17, 124);
    }
    if(self!=((void*)0)&&self->completionPrefix!=((void*)0)) {
        (self->completionPrefix = come_decrement_ref_count(self->completionPrefix, (void*)0, (void*)0, 0, 0, (void*)0, "ViWin_finalize", 18, 125));
    }
            neo_current_frame = fr.prev;
}
...
static void list$1int$ph$p_finalize(struct list$1int$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 93);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1int$ph$p_finalize(struct list_item$1int$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        (self->item = come_decrement_ref_count(self->item, (void*)0, (void*)0, 0, 0, (void*)0, "list_item$1int$ph$p_finalize", 2, 92));
    }
            neo_current_frame = fr.prev;
}
...
static void list$1int$$p_finalize(struct list$1int$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 95);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1tuple3$3int$int$int$$ph$p_finalize(struct list$1tuple3$3int$int$int$$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1tuple3$3int$int$int$$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 99);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1tuple3$3int$int$int$$ph$p_finalize(struct list_item$1tuple3$3int$int$int$$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(tuple3$3int$int$int$$p_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1tuple3$3int$int$int$$ph$p_finalize}", 2, 98);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1list$1int$ph$ph$p_finalize(struct list$1list$1int$ph$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1list$1int$ph$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 102);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1list$1int$ph$ph$p_finalize(struct list_item$1list$1int$ph$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1list$1int$ph$ph$p_finalize}", 2, 101);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$list$1list$1int$$ph$ph$p_finalize(struct map$2int$list$1list$1int$$ph$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(list$1list$1int$$ph$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 2, 112);
            }
        }
    }
    ...
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3660, 113);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3662, 114));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3663, 115));
            neo_current_frame = fr.prev;
}
...
static void list$1list$1int$$ph$p_finalize(struct list$1list$1int$$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1list$1int$$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 111);
    }
                    neo_current_frame = fr.prev;
}
...
static void list_item$1list$1int$$ph$p_finalize(struct list_item$1list$1int$$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(list$1int$$p_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1list$1int$$ph$p_finalize}", 2, 110);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$tuple3$3int$int$int$$ph$p_finalize(struct map$2int$tuple3$3int$int$int$$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(tuple3$3int$int$int$$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3645, 119);
            }
        }
    }
    come_free((char*)self->items);
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3660, 120);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3662, 121));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3663, 122));
            neo_current_frame = fr.prev;
}
...
static void list$1lambda$$p_finalize(struct list$1lambda$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1lambda$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 129);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$list$1int$ph$ph$p_finalize(struct map$2int$list$1int$ph$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(list$1int$ph$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3645, 133);
            }
        }
    }
    come_free((char*)self->items);
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3660, 134);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3662, 135));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3663, 136));
            neo_current_frame = fr.prev;
}
...
static void map$2int$int$$p_finalize(struct map$2int$int$* self)
{
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 3660, 138);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3662, 139));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "lib/neo-c.h", 3663, 140));
            neo_current_frame = fr.prev;
}
...
static void list$1char$ph$p_finalize(struct list$1char$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1char$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "lib/neo-c.h}", 1689, 143);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1char$ph$p_finalize(struct list_item$1char$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        (self->item = come_decrement_ref_count(self->item, (void*)0, (void*)0, 0, 0, (void*)0, "list_item$1char$ph$p_finalize", 2, 142));
    }
            neo_current_frame = fr.prev;
}
...
static void update_terminal_size_on_sigwinch()
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "update_terminal_size_on_sigwinch"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    struct winsize  ws  ;
    memset(&ws, 0, sizeof(ws));
    if(ioctl(1,0x5413,&ws)==0&&ws.ws_row /* uho */>0&&ws.ws_col /* uho */>0) {
        resizeterm(ws.ws_row /* uho */,ws.ws_col /* uho */);
    }
    come_call_finalizer(winsize_finalize, (&ws), (void*)0, (void*)0, 1, 0, 0, (void*)0, "src/19rewrite_mode.nc}", 210, 148);
    neo_current_frame = fr.prev;
}
...
int Vi_main_loop_v19(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_main_loop_v19"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    ...
    while(!self->appEnd) {
        if(gSigwinch) {
            ...
            for(_o2_saved_1=(struct list$1ViWin$ph*)come_increment_ref_count(self->wins, "src/19rewrite_mode.nc", 219, 149),it=list$1ViWin$ph_begin(_o2_saved_1)            ;!list$1ViWin$ph_end(_o2_saved_1);it=list$1ViWin$ph_next(_o2_saved_1)){
                ViWin_modifyOverCursorYValue(it);
            }
            come_call_finalizer(list$1ViWin$ph$p_finalize, _o2_saved_1, (void*)0, (void*)0, 0, 0, 0, (void*)0, "src/19rewrite_mode.nc}", 224, 150);
        }
        Vi_view(self);
        if(self->mode!=(1)) {
