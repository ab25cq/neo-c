...
struct ViWin*  ViWin_initialize_v8(struct ViWin*  self  , int y, int x, int width, int height, struct Vi*  vi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_initialize_v8"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct ViWin*  result  ;
    struct ViWin*  __result_obj__0  ;
    memset(&result, 0, sizeof(result));
    result=(struct ViWin* )come_increment_ref_count(ViWin_initialize_v6((struct ViWin* )come_increment_ref_count(self, "08visual.nc", 5, 1),y,x,width,height,vi), "08visual.nc", 5, 2);
    ...
    result->visualModeTailScrollBefore=-1;
        __result_obj__0 = (struct ViWin* )come_increment_ref_count(result, "08visual.nc", 13, 3);
    come_call_finalizer(ViWin_finalize, self, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 13, 38);
    come_call_finalizer(ViWin_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "08visual.nc}", 13, 39);
    neo_current_frame = fr.prev;
    come_call_finalizer(ViWin_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "08visual.nc}", 13, 40);
...
static void list$1int$ph$p_finalize(struct list$1int$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 5);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1int$$p_finalize(struct list$1int$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 7);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1tuple3$3int$int$int$$ph$p_finalize(struct list$1tuple3$3int$int$int$$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1tuple3$3int$int$int$$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 11);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1list$1int$ph$ph$p_finalize(struct list$1list$1int$ph$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1list$1int$ph$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 14);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$list$1list$1int$$ph$ph$p_finalize(struct map$2int$list$1list$1int$$ph$ph* self)
{
    ...
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3524, 25);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3526, 26));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3527, 27));
            neo_current_frame = fr.prev;
}
...
static void list$1list$1int$$ph$p_finalize(struct list$1list$1int$$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1list$1int$$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 23);
    }
                    neo_current_frame = fr.prev;
}
...
static void map$2int$tuple3$3int$int$int$$ph$p_finalize(struct map$2int$tuple3$3int$int$int$$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(tuple3$3int$int$int$$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3509, 31);
            }
        }
    }
    come_free((char*)self->items);
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3524, 32);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3526, 33));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3527, 34));
            neo_current_frame = fr.prev;
}

void ViWin_visualModeView(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_visualModeView"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int maxy;
    int maxx;
    int screen_row;
    int i;
    ...
    for(i=self->scroll    ;i<list$1int$ph_length(self->texts)&&screen_row<maxy-1;i++){
        it2=i-self->scroll;
        it=(int* )come_increment_ref_count(list$1int$ph_item(self->texts,i,((void*)0)), "08visual.nc", 27, 47);
        if(it==((void*)0)) {
            (it = come_decrement_ref_count(it, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 28, 48));
            break;
        }
        __right_value0 = (void*)0;
        printable_line=(int* )come_increment_ref_count(wstring_printable(it), "08visual.nc", 29, 49);
        line_width=wcswidth(printable_line,wstring_length(printable_line));
        if(line_width<0) {
            line_width=0;
        }
        in_selection=(it2>=(self->visualModeHead-self->scroll)&&it2<=self->cursorY)||(it2<=(self->visualModeHead-self->scroll)&&it2>=self->cursorY);
        if(line_width==0) {
            if(in_selection) {
            ...
            while(x<wstring_length(printable_line)&&cur_row<maxy-1) {
                __right_value0 = (void*)0;
                c=(int* )come_increment_ref_count(wstring_substring(printable_line,x,x+1), "08visual.nc", 60, 50);
                ...
                if(cur_col+cw>maxx-1) {
                    ...
                    cur_col=0;
                    if(cur_row>=maxy-1) {
                        (c = come_decrement_ref_count(c, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 66, 51));
                        break;
                    }
                }
                if(in_selection) {
                ...
                cur_col+=cw;
                x++;
                (c = come_decrement_ref_count(c, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 79, 52));
            }
            rows_used=({ __typeof__((maxx-1)) __neo_div_right1 = ((maxx-1)); if(__neo_div_right1 == 0) { extern void stackframe(void) __attribute__((weak)); extern void exit(int); puts("division by zero"); if(stackframe) stackframe(); else { puts("stackframe"); puts(__func__); } exit(2); } ((line_width+maxx-2)) / __neo_div_right1; });
            if(rows_used<1) {
                rows_used=1;
            }
            screen_row+=rows_used;
        }
        (it = come_decrement_ref_count(it, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 85, 53));
        (printable_line = come_decrement_ref_count(printable_line, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 85, 54));
    }
    wattr_on(self->win,(unsigned int )(((unsigned int )((1U))<<((10)+8))),((void*)0));
...
static int*  list$1int$ph_item(struct list$1int$ph* self, int position, int*  default_value  )
{
    ...
    memset(&i, 0, sizeof(i));
    if(self==((void*)0)) {
                __result_obj__0 = (int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 1806, 41);
        neo_current_frame = fr.prev;
        (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "/usr/local/include/neo-c.h", 1806, 42));
        return __result_obj__0;
    }
    if(position<0) {
        position+=self->len;
    ...
    while(it!=((void*)0)) {
        if(position==i) {
                        __result_obj__0 = (int* )come_increment_ref_count(it->item, "/usr/local/include/neo-c.h", 1817, 43);
            neo_current_frame = fr.prev;
            (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "/usr/local/include/neo-c.h", 1817, 44));
            return __result_obj__0;
        }
        it=it->next;
        i++;
    }
        __result_obj__0 = (int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 1823, 45);
    neo_current_frame = fr.prev;
    (__result_obj__0 = come_decrement_ref_count(__result_obj__0, (void*)0, (void*)0, 0, 1, (void*)0, "/usr/local/include/neo-c.h", 1823, 46));
    return __result_obj__0;
}

void ViWin_view_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_view_v8"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    if(nvi->mode==(2)&&ViWin_equals(nvi->activeWin,self)) {
        ViWin_visualModeView(self,nvi);
    }
    else {
...
void ViWin_yankOnVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_yankOnVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    void* __right_value0 = (void*)0;
    ...
    for(({(_conditional_value_X0=(_o2_saved_1=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,head,tail+1), "08visual.nc", 114, 88),it=list$1int$ph_begin(_o2_saved_1)));_conditional_value_X0;})    ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_1)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(_o2_saved_1)));_conditional_value_X2;})){
        __right_value0 = (void*)0;
        list$1int$ph_push_back(nvi->yank,(int* )come_increment_ref_count((int* )come_memdup(it, "08visual.nc", 115, 89, "int* "), "08visual.nc", 115, 90));
    }
    nvi->yankKind=(0);
    ViWin_saveYankToFile(self,nvi);
    come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_1, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 122, 91);
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_reset(struct list$1int$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1923, 55);
    }
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
...
static struct list$1int$ph* list$1int$ph_sublist(struct list$1int$ph* self, int begin, int tail)
{
    ...
    memset(&i, 0, sizeof(i));
    if(self==((void*)0)) {
                __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(self, "/usr/local/include/neo-c.h", 2171, 56);
        neo_current_frame = fr.prev;
        come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2171, 57);
        return __result_obj__0;
    }
    result=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_initialize((struct list$1int$ph*)come_increment_ref_count((struct list$1int$ph*)come_calloc(1, sizeof(struct list$1int$ph)*(1), "/usr/local/include/neo-c.h", 2174, 58, "struct list$1int$ph*"), "/usr/local/include/neo-c.h", 2174, 62)), "/usr/local/include/neo-c.h", 2174, 63);
    if(begin<0) {
        begin+=self->len;
    }
    if(tail<0) {
    ...
    if(begin>=self->len) {
        ...
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(((struct list$1int$ph*)(__right_value1=list$1int$ph_initialize((struct list$1int$ph*)come_increment_ref_count((struct list$1int$ph*)come_calloc(1, sizeof(struct list$1int$ph)*(1), "/usr/local/include/neo-c.h", 2189, 64, "struct list$1int$ph*"), "/usr/local/include/neo-c.h", 2189, 65)))), "/usr/local/include/neo-c.h", 2189, 66);
        come_call_finalizer(list$1int$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2189, 67);
        come_call_finalizer(list$1int$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0, "/usr/local/include/neo-c.h}", 2189, 68);
        neo_current_frame = fr.prev;
        come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2189, 69);
        return __result_obj__0;
    }
    if(tail>=self->len) {
        tail=self->len;
    ...
    while(it!=((void*)0)) {
        if(i>=begin&&i<tail) {
            list$1int$ph_push_back(result,(int* )come_increment_ref_count(it->item, "/usr/local/include/neo-c.h", 2200, 84));
        }
        it=it->next;
        i++;
    }
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(result, "/usr/local/include/neo-c.h", 2206, 85);
    come_call_finalizer(list$1int$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2206, 86);
    neo_current_frame = fr.prev;
    come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 2206, 87);
    return __result_obj__0;
}
...
static struct list$1int$ph* list$1int$ph_initialize(struct list$1int$ph* self)
{
    ...
    self->tail=((void*)0);
    self->len=0;
        __result_obj__0 = (struct list$1int$ph*)come_increment_ref_count(self, "/usr/local/include/neo-c.h", 1544, 59);
    come_call_finalizer(list$1int$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 1544, 60);
    neo_current_frame = fr.prev;
    come_call_finalizer(list$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/usr/local/include/neo-c.h}", 1544, 61);
    return __result_obj__0;
}
...
static struct list$1int$ph* list$1int$ph_push_back(struct list$1int$ph* self, int*  item  )
{
    ...
    if(self==((void*)0)) {
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1674, 70));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(self->len==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1678, 71, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1678, 72);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        __dec_obj1=litem->item,
        litem->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1682, 74);
        __dec_obj1 = come_decrement_ref_count(__dec_obj1, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1682, 73);
        self->tail=litem;
        self->head=litem;
    }
    else if(self->len==1) {
        __right_value0 = (void*)0;
        litem_2=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1688, 75, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1688, 76);
        litem_2->prev=self->head;
        litem_2->next=((void*)0);
        __dec_obj2=litem_2->item,
        litem_2->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1692, 78);
        __dec_obj2 = come_decrement_ref_count(__dec_obj2, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1692, 77);
        self->tail=litem_2;
        self->head->next=litem_2;
    }
    else {
        __right_value0 = (void*)0;
        litem_3=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1698, 79, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1698, 80);
        litem_3->prev=self->tail;
        litem_3->next=((void*)0);
        __dec_obj3=litem_3->item,
        litem_3->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1702, 82);
        __dec_obj3 = come_decrement_ref_count(__dec_obj3, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1702, 81);
        self->tail->next=litem_3;
        self->tail=litem_3;
    }
    self->len++;
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1710, 83));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
void ViWin_fileYankOnVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_fileYankOnVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    void* __right_value0 = (void*)0;
    ...
    for(({(_conditional_value_X0=(_o2_saved_2=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,head,tail+1), "08visual.nc", 134, 92),it=list$1int$ph_begin(_o2_saved_2)));_conditional_value_X0;})    ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_2)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(_o2_saved_2)));_conditional_value_X2;})){
        __right_value0 = (void*)0;
        list$1int$ph_push_back(nvi->fileYank,(int* )come_increment_ref_count((int* )come_memdup(it, "08visual.nc", 135, 93, "int* "), "08visual.nc", 135, 94));
    }
    nvi->yankKind=(0);
    ViWin_saveFileYankToFile(self,nvi);
    come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_2, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 142, 95);
    neo_current_frame = fr.prev;
}

void ViWin_indentVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_indentVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    int it2;
    ...
    it2=0;
    for(({(_conditional_value_X0=(_o2_saved_3=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,head,tail+1), "08visual.nc", 156, 96),it=list$1int$ph_begin(_o2_saved_3)));_conditional_value_X0;})    ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_3)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(_o2_saved_3)));_conditional_value_X2;})){
        __right_value0 = (void*)0;
        new_line=(int* )come_increment_ref_count(string_to_wstring(((char* )(__right_value1=xsprintf("%ls%ls",((int* )(__right_value0=__builtin_wstring("    ","08visual.nc",159))),it)))), "08visual.nc", 159, 97);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 159, 98));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 159, 99));
        list$1int$ph_replace(self->texts,it2+head,(int* )come_increment_ref_count(new_line, "08visual.nc", 161, 108));
        list$1int$_replace(self->texts_length,it2+head,wcslen(new_line));
        it2++;
        (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 166, 115));
    }
    ViWin_modifyOverCursorXValue(self);
    self->writed=(_Bool)1;
    come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_3, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 170, 116);
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_replace(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(self==((void*)0)) {
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2089, 100));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position<0) {
    ...
    if(self->len==0||position>=self->len) {
        ...
        for(i=0        ;i<position-len;i++){
            ...
            list$1int$ph_push_back(self,(int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 2104, 101));
            (default_value = come_decrement_ref_count(default_value, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2106, 102));
        }
        list$1int$ph_push_back(self,(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 2106, 103));
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2107, 104));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    it=self->head;
    ...
    while(it!=((void*)0)) {
        if(position==i_6) {
            __dec_obj4=it->item,
            it->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 2114, 106);
            __dec_obj4 = come_decrement_ref_count(__dec_obj4, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 2114, 105);
            break;
        }
        it=it->next;
        i_6++;
        ...
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 2121, 107));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
static struct list$1int$* list$1int$_push_back(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1678, 109, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1678, 110);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_7=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1688, 111, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1688, 112);
        ...
        __right_value0 = (void*)0;
        litem_8=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1698, 113, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1698, 114);
...
void ViWin_backIndentVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_backIndentVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    int it2;
    ...
    it2=0;
    for(({(_conditional_value_X0=(_o2_saved_4=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,head,tail+1), "08visual.nc", 184, 117),it=list$1int$ph_begin(_o2_saved_4)));_conditional_value_X0;})    ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_4)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(_o2_saved_4)));_conditional_value_X2;})){
        __right_value0 = (void*)0;
        new_line=(int* )come_increment_ref_count((int* )come_memdup(it, "08visual.nc", 185, 118, "int* "), "08visual.nc", 185, 119);
        if(__right_value0 = (void*)0,
({(_conditional_value_X3=(wstring_index(new_line,((int* )(__right_value0=__builtin_wstring("    ","08visual.nc",187))),-1)==0));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 187, 120));
_conditional_value_X3;})) {
            for(i=0            ;i<4;i++){
                __right_value0 = (void*)0;
                ((int* )(__right_value0=wstring_delete(new_line,0,1)));
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 189, 121));
            }
            list$1int$ph_replace(self->texts,it2+head,(int* )come_increment_ref_count(new_line, "08visual.nc", 192, 122));
            list$1int$_replace(self->texts_length,it2+head,wcslen(new_line));
        }
        else {
            removed=0;
            while(removed<4&&wstring_length(new_line)>0&&new_line[0]==32) {
                __right_value0 = (void*)0;
                ((int* )(__right_value0=wstring_delete(new_line,0,1)));
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 198, 123));
                removed++;
            }
            if(removed>0) {
                list$1int$ph_replace(self->texts,it2+head,(int* )come_increment_ref_count(new_line, "08visual.nc", 203, 124));
                list$1int$_replace(self->texts_length,it2+head,wcslen(new_line));
            }
        }
        it2++;
        (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 211, 125));
    }
    ViWin_modifyOverCursorXValue(self);
    self->writed=(_Bool)1;
    come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_4, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 215, 126);
    neo_current_frame = fr.prev;
}

void ViWin_changeCaseVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_changeCaseVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    int it2;
    ...
    it2=0;
    for(({(_conditional_value_X0=(_o2_saved_5=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,head,tail+1), "08visual.nc", 229, 127),it=list$1int$ph_begin(_o2_saved_5)));_conditional_value_X0;})    ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_5)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(_o2_saved_5)));_conditional_value_X2;})){
        __right_value0 = (void*)0;
        new_line=(int* )come_increment_ref_count((int* )come_memdup(it, "08visual.nc", 230, 128, "int* "), "08visual.nc", 230, 129);
        for(i=0        ;i<wstring_length(new_line);i++){
            c=new_line[i];
            if(c>=97&&c<=122) {
                c2=c-97+65;
                new_line[i]=c2;
        ...
        list$1int$ph_replace(self->texts,it2+head,(int* )come_increment_ref_count(new_line, "08visual.nc", 245, 130));
        list$1int$_replace(self->texts_length,it2+head,wcslen(new_line));
        it2++;
        (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 251, 131));
    }
    ViWin_modifyOverCursorXValue(self);
    come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_5, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 254, 132);
    neo_current_frame = fr.prev;
}

void ViWin_joinVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_joinVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    int len;
    ...
    len=0;
    for(({(_conditional_value_X0=(_o2_saved_6=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,head,tail+1), "08visual.nc", 268, 133),it=list$1int$ph_begin(_o2_saved_6)));_conditional_value_X0;})    ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_6)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(_o2_saved_6)));_conditional_value_X2;})){
        len+=wcslen(it);
        len++;
    }
    len++;
    __right_value0 = (void*)0;
    new_line=(int* )come_increment_ref_count((int *)come_calloc(1, sizeof(int )*(1*(len)), "08visual.nc", 275, 134, "int* "), "08visual.nc", 275, 135);
    new_line[0]=0;
    it2=0;
    for(__right_value0 = (void*)0,
({(_conditional_value_X0=(_o2_saved_7=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,head,tail+1), "08visual.nc", 280, 136),it_11=list$1int$ph_begin(_o2_saved_7)));_conditional_value_X0;})    ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_7)));_conditional_value_X1;});({(_conditional_value_X2=(it_11=list$1int$ph_next(_o2_saved_7)));_conditional_value_X2;})){
        wcscat(new_line,it_11);
        if(it2<tail+1-head-1) {
            __right_value0 = (void*)0;
            wcscat(new_line,((int* )(__right_value0=__builtin_wstring(" ","08visual.nc",284))));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 284, 137));
        }
        it2++;
    }
    list$1int$ph_delete(self->texts,head,tail+1);
    list$1int$_delete(self->texts_length,head,tail+1);
    list$1int$ph_insert(self->texts,head,(int* )come_increment_ref_count(new_line, "08visual.nc", 293, 163));
    list$1int$_insert(self->texts_length,head,wcslen(new_line));
    ...
    ViWin_modifyOverCursorXValue(self);
    come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_6, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 307, 170);
    (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 307, 171));
    come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_7, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 307, 172);
    neo_current_frame = fr.prev;
}
...
static struct list$1int$ph* list$1int$ph_delete(struct list$1int$ph* self, int head, int tail)
{
    ...
    int i;
    struct list_item$1int$ph* prev_it;
    struct list_item$1int$ph* it_12;
    int i_13;
    struct list_item$1int$ph* prev_it_14;
    struct list_item$1int$ph* it_15;
    struct list_item$1int$ph* head_prev_it;
    struct list_item$1int$ph* tail_it;
    int i_16;
    struct list_item$1int$ph* prev_it_17;
    memset(&tmp, 0, sizeof(tmp));
    memset(&it, 0, sizeof(it));
    memset(&i, 0, sizeof(i));
    memset(&prev_it, 0, sizeof(prev_it));
    ...
    if(head==0&&tail==self->len) {
        ...
        while(it!=((void*)0)) {
            if(i<tail) {
                ...
                it=it->next;
                i++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2001, 138);
                self->len--;
            }
            else if(i==tail) {
                self->head=it;
        ...
        while(it_12!=((void*)0)) {
            ...
            if(i_13>=head) {
                ...
                it_12=it_12->next;
                i_13++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it_14, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2031, 139);
                self->len--;
            }
            else {
                it_12=it_12->next;
        ...
        while(it_15!=((void*)0)) {
            ...
            if(i_16>=head&&i_16<tail) {
                ...
                it_15=it_15->next;
                i_16++;
                come_call_finalizer(list_item$1int$ph$p_finalize, prev_it_17, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2064, 140);
                self->len--;
            }
            else {
                it_15=it_15->next;
    ...
    if(head==0&&tail==self->len) {
        ...
        while(it!=((void*)0)) {
            if(i<tail) {
                ...
                it=it->next;
                i++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2001, 142);
                self->len--;
            }
            else if(i==tail) {
                self->head=it;
        ...
        while(it_18!=((void*)0)) {
            ...
            if(i_19>=head) {
                ...
                it_18=it_18->next;
                i_19++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it_20, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2031, 143);
                self->len--;
            }
            else {
                it_18=it_18->next;
        ...
        while(it_21!=((void*)0)) {
            ...
            if(i_22>=head&&i_22<tail) {
                ...
                it_21=it_21->next;
                i_22++;
                come_call_finalizer(list_item$1int$$p_finalize, prev_it_23, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 2064, 144);
                self->len--;
            }
            else {
                it_21=it_21->next;
...
static struct list$1int$* list$1int$_reset(struct list$1int$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1int$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1923, 141);
    }
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
...
static struct list$1int$ph* list$1int$ph_insert(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    struct list_item$1int$ph* litem;
    int*  __dec_obj5  ;
    struct list_item$1int$ph* litem_24;
    int*  __dec_obj6  ;
    struct list_item$1int$ph* it;
    int i_25;
    struct list_item$1int$ph* litem_26;
    int*  __dec_obj7  ;
    memset(&len, 0, sizeof(len));
    memset(&i, 0, sizeof(i));
    memset(&litem, 0, sizeof(litem));
    ...
    if(self==((void*)0)) {
        ...
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1847, 145));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position<0) {
    ...
    if(self->len==0||position>=self->len) {
        ...
        for(i=0        ;i<position-len;i++){
            memset(&default_value,0,sizeof(int* ));
            list$1int$ph_push_back(self,(int* )come_increment_ref_count(default_value, "/usr/local/include/neo-c.h", 1860, 146));
            (default_value = come_decrement_ref_count(default_value, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1862, 147));
        }
        list$1int$ph_push_back(self,(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1862, 148));
                __result_obj__0 = self;
        (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1863, 149));
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(position==0) {
        litem=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1867, 150, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1867, 151);
        litem->prev=((void*)0);
        litem->next=self->head;
        __dec_obj5=litem->item,
        litem->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1871, 153);
        __dec_obj5 = come_decrement_ref_count(__dec_obj5, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1871, 152);
        ...
        __right_value0 = (void*)0;
        litem_24=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1879, 154, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1879, 155);
        litem_24->prev=self->head;
        litem_24->next=self->tail;
        __dec_obj6=litem_24->item,
        litem_24->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1883, 157);
        __dec_obj6 = come_decrement_ref_count(__dec_obj6, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1883, 156);
        ...
        while(it!=((void*)0)) {
            if(position==i_25) {
                __right_value0 = (void*)0;
                litem_26=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), "/usr/local/include/neo-c.h", 1895, 158, "struct list_item$1int$ph*"))), "/usr/local/include/neo-c.h", 1895, 159);
                litem_26->prev=it->prev;
                litem_26->next=it;
                __dec_obj7=litem_26->item,
                litem_26->item=(int* )come_increment_ref_count(item, "/usr/local/include/neo-c.h", 1899, 161);
                __dec_obj7 = come_decrement_ref_count(__dec_obj7, (void*)0, (void*)0, 0,0, (void*)0, "/usr/local/include/neo-c.h", 1899, 160);
        ...
        __result_obj__0 = self;
    (item = come_decrement_ref_count(item, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 1912, 162));
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
static struct list$1int$* list$1int$_insert(struct list$1int$* self, int position, int item)
{
    ...
    if(position==0) {
        litem=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1867, 164, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1867, 165);
        litem->prev=((void*)0);
        litem->next=self->head;
        litem->item=item;
        self->head->prev=litem;
        ...
        __right_value0 = (void*)0;
        litem_27=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1879, 166, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1879, 167);
        litem_27->prev=self->head;
        litem_27->next=self->tail;
        litem_27->item=item;
        self->tail->prev=litem_27;
        ...
        while(it!=((void*)0)) {
            if(position==i_28) {
                __right_value0 = (void*)0;
                litem_29=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1895, 168, "struct list_item$1int$*"))), "/usr/local/include/neo-c.h", 1895, 169);
                litem_29->prev=it->prev;
                litem_29->next=it;
                litem_29->item=item;
                it->prev->next=litem_29;
                it->prev=litem_29;
                self->len++;
            }
            it=it->next;
...
void ViWin_equalVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_equalVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    int indent;
    ...
    int  c  ;
    int it2;
    struct list$1int$ph* _o2_saved_9;
    int*  it_30  ;
    _Bool brace_begin;
    int i_31;
    int  c_32  ;
    ...
    memset(&brace_begin, 0, sizeof(brace_begin));
    memset(&i_31, 0, sizeof(i_31));
    memset(&c_32, 0, sizeof(c_32));
    ...
    indent=0;
    for(({(_conditional_value_X0=(_o2_saved_8=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,0,head), "08visual.nc", 322, 173),it=list$1int$ph_begin(_o2_saved_8)));_conditional_value_X0;})    ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_8)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(_o2_saved_8)));_conditional_value_X2;})){
        for(i=0        ;i<wstring_length(it);i++){
            c=it[i];
            if(c==123) {
                indent++;
            }
    ...
    it2=0;
    for(__right_value0 = (void*)0,
({(_conditional_value_X0=(_o2_saved_9=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,head,tail+1), "08visual.nc", 336, 174),it_30=list$1int$ph_begin(_o2_saved_9)));_conditional_value_X0;})    ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_9)));_conditional_value_X1;});({(_conditional_value_X2=(it_30=list$1int$ph_next(_o2_saved_9)));_conditional_value_X2;})){
        brace_begin=(_Bool)0;
        for(i_31=0        ;i_31<wstring_length(it_30);i_31++){
            c_32=it_30[i_31];
            if(c_32==123) {
                brace_begin=(_Bool)1;
                indent++;
        ...
        for(i_33=0        ;i_33<wcslen(it_30);i_33++){
            if(it_30[i_33]!=32) {
                break;
            }
        }
        __right_value0 = (void*)0;
        new_line=(int* )come_increment_ref_count(wstring_substring(it_30,i_33,-1), "08visual.nc", 357, 175);
        __right_value0 = (void*)0;
        head_str=(struct buffer* )come_increment_ref_count(buffer_initialize((struct buffer* )come_increment_ref_count((struct buffer *)come_calloc(1, sizeof(struct buffer )*(1), "08visual.nc", 359, 176, "struct buffer* "), "08visual.nc", 359, 177)), "08visual.nc", 359, 178);
        indent2=indent;
        if(brace_begin) {
            indent2--;
        }
        for(i_34=0        ;i_34<indent2;i_34++){
            buffer_append_str(head_str,"    ");
        }
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        new_line2=(int* )come_increment_ref_count(string_to_wstring(((char* )(__right_value2=xsprintf("%ls%ls",((int* )(__right_value1=string_to_wstring(((char* )(__right_value0=buffer_to_string(head_str)))))),new_line)))), "08visual.nc", 370, 179);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 369, 180));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 370, 181));
        (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 370, 182));
        list$1int$ph_replace(self->texts,it2+head,(int* )come_increment_ref_count(new_line2, "08visual.nc", 372, 183));
        list$1int$_replace(self->texts_length,it2+head,wcslen(new_line2));
        it2++;
        (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 378, 184));
        come_call_finalizer(buffer_finalize, head_str, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 378, 185);
        (new_line2 = come_decrement_ref_count(new_line2, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 378, 186));
    }
    ViWin_modifyOverCursorXValue(self);
    if(self->scroll+self->cursorY>=self->visualModeHead) {
        self->cursorY-=tail-head;
    ...
    ViWin_modifyOverCursorYValue(self);
    ViWin_modifyOverCursorXValue(self);
    come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_8, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 391, 187);
    come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_9, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 391, 188);
    neo_current_frame = fr.prev;
}

void ViWin_rewriteVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_rewriteVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int key;
    int head;
    int tail;
    int tmp;
    ...
    int it2;
    void* __right_value0 = (void*)0;
    struct list$1int$ph* _o2_saved_10;
    int*  it  ;
    _Bool _conditional_value_X0;
    _Bool _conditional_value_X1;
    _Bool _conditional_value_X2;
    ...
    indent=0;
    it2=0;
    for(({(_conditional_value_X0=(_o2_saved_10=(struct list$1int$ph*)come_increment_ref_count(list$1int$ph_sublist(self->texts,head,tail+1), "08visual.nc", 409, 189),it=list$1int$ph_begin(_o2_saved_10)));_conditional_value_X0;})    ;({(_conditional_value_X1=(!list$1int$ph_end(_o2_saved_10)));_conditional_value_X1;});({(_conditional_value_X2=(it=list$1int$ph_next(_o2_saved_10)));_conditional_value_X2;})){
        len=wstring_length(it);
        c=key;
        __right_value0 = (void*)0;
        buf=(struct buffer* )come_increment_ref_count(buffer_initialize((struct buffer* )come_increment_ref_count((struct buffer *)come_calloc(1, sizeof(struct buffer )*(1), "08visual.nc", 414, 190, "struct buffer* "), "08visual.nc", 414, 191)), "08visual.nc", 414, 192);
        for(i=0        ;i<len;i++){
            __right_value0 = (void*)0;
            buffer_append_str(buf,((char* )(__right_value0=xsprintf("%lc",c))));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 417, 193));
        }
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        new_line=(int* )come_increment_ref_count(string_to_wstring(((char* )(__right_value0=buffer_to_string(buf)))), "08visual.nc", 420, 194);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0, "08visual.nc", 420, 195));
        list$1int$ph_replace(self->texts,it2+head,(int* )come_increment_ref_count(new_line, "08visual.nc", 422, 196));
        list$1int$_replace(self->texts_length,it2+head,wcslen(new_line));
        it2++;
        come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 427, 197);
        (new_line = come_decrement_ref_count(new_line, (void*)0, (void*)0, 0, 0, (void*)0, "08visual.nc", 427, 198));
    }
    ViWin_modifyOverCursorXValue(self);
    if(self->scroll+self->cursorY>=self->visualModeHead) {
        self->cursorY-=tail-head;
    ...
    ViWin_modifyOverCursorYValue(self);
    ViWin_modifyOverCursorXValue(self);
    come_call_finalizer(list$1int$ph$p_finalize, _o2_saved_10, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 440, 199);
    neo_current_frame = fr.prev;
}

void ViWin_deleteOnVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_deleteOnVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    void* __right_value0 = (void*)0;
    ...
    if(tail+1>=list$1int$ph_length(self->texts)) {
        list$1int$ph_delete(self->texts,head,-1);
        list$1int$_delete(self->texts_length,head,-1);
        list$1int$ph_push_back(self->texts,(int* )come_increment_ref_count(__builtin_wstring("","08visual.nc",458), "08visual.nc", 458, 200));
...
void ViWin_makeInputedKeyGVIndent_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_makeInputedKeyGVIndent_v8"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_makeInputedKeyGVDeIndent_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_makeInputedKeyGVDeIndent_v8"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_inputVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_inputVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    int key;
    memset(&key, 0, sizeof(key));
    key=ViWin_getKey_v14(self,(_Bool)0);
    switch (    key) {
        ...
        break;
        case 100:
        ViWin_deleteOnVisualMode(self,nvi);
        Vi_exitFromVisualMode(nvi);
        break;
        case 99:
        case 67:
        ...
        break;
        case 62:
        ViWin_indentVisualMode(self,nvi);
        Vi_exitFromVisualMode(nvi);
        Vi_clearView(nvi);
        ViWin_makeInputedKeyGVIndent_v14(self,nvi);
        break;
        case 60:
        ViWin_backIndentVisualMode(self,nvi);
        Vi_exitFromVisualMode(nvi);
        Vi_clearView(nvi);
        ViWin_makeInputedKeyGVDeIndent_v14(self,nvi);
        break;
        case 126:
        ViWin_changeCaseVisualMode(self,nvi);
        Vi_exitFromVisualMode(nvi);
        ViWin_makeInputedKeyGVIndent_v14(self,nvi);
        break;
        case 74:
        ViWin_joinVisualMode(self,nvi);
        Vi_exitFromVisualMode(nvi);
        break;
        case 61:
        ViWin_equalVisualMode(self,nvi);
        Vi_exitFromVisualMode(nvi);
        break;
        case 37:
        ViWin_gotoBraceEnd_v11(self,nvi);
        break;
        case 114:
        ViWin_rewriteVisualMode(self,nvi);
        break;
        case 27:
        Vi_exitFromVisualMode(nvi);
        break;
        case 89-65+1:
        ViWin_fileYankOnVisualMode(self,nvi);
        Vi_exitFromVisualMode(nvi);
        break;
    }
...
void ViWin_input_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_input_v8"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    if(nvi->mode==(2)) {
        ViWin_inputVisualMode(self,nvi);
    }
    else {
...
void ViWin_restoreVisualMode_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_restoreVisualMode_v8"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    nvi->mode=(2);
...
void ViWin_gotoBraceEnd_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_gotoBraceEnd_v8"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}
...
struct Vi*  Vi_initialize_v8(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_initialize_v8"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct Vi*  result  ;
    struct Vi*  __result_obj__0  ;
    memset(&result, 0, sizeof(result));
    result=(struct Vi* )come_increment_ref_count(Vi_initialize_v7((struct Vi* )come_increment_ref_count(self, "08visual.nc", 654, 201)), "08visual.nc", 654, 202);
    list$1lambda$_replace(result->events,86,lambda1);
        __result_obj__0 = (struct Vi* )come_increment_ref_count(result, "08visual.nc", 662, 209);
    come_call_finalizer(Vi_finalize, self, (void*)0, (void*)0, 0, 0, 0, (void*)0, "08visual.nc}", 662, 229);
    come_call_finalizer(Vi_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0, "08visual.nc}", 662, 230);
    neo_current_frame = fr.prev;
    come_call_finalizer(Vi_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "08visual.nc}", 662, 231);
    return __result_obj__0;
}
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    struct list_item$1lambda$* litem_35;
    struct list_item$1lambda$* litem_36;
    memset(&litem, 0, sizeof(litem));
    ...
    if(self->len==0) {
        litem=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1678, 203, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1678, 204);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_35=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1688, 205, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1688, 206);
        ...
        __right_value0 = (void*)0;
        litem_36=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), "/usr/local/include/neo-c.h", 1698, 207, "struct list_item$1lambda$*"))), "/usr/local/include/neo-c.h", 1698, 208);
...
static void Vi_finalize(struct Vi*  self  )
{
    ...
    if(self!=((void*)0)&&self->wins!=((void*)0)) {
        come_call_finalizer(list$1ViWin$ph$p_finalize, self->wins, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 8, 212);
    }
    if(self!=((void*)0)&&self->events!=((void*)0)) {
        come_call_finalizer(list$1lambda$$p_finalize, self->events, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 2, 214);
    }
    if(self!=((void*)0)&&self->yank!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->yank, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 4, 215);
    }
    if(self!=((void*)0)&&self->fileYank!=((void*)0)) {
        come_call_finalizer(list$1int$ph$p_finalize, self->fileYank, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 5, 216);
    }
    if(self!=((void*)0)&&self->registers!=((void*)0)) {
        come_call_finalizer(map$2int$list$1int$ph$ph$p_finalize, self->registers, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 221);
    }
    if(self!=((void*)0)&&self->registerKinds!=((void*)0)) {
        come_call_finalizer(map$2int$int$$p_finalize, self->registerKinds, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 225);
    }
    if(self!=((void*)0)&&self->commandHistory!=((void*)0)) {
        come_call_finalizer(list$1char$ph$p_finalize, self->commandHistory, (void*)0, (void*)0, 0, 0, 0, (void*)0, "Vi_finalize}", 0, 228);
    }
        neo_current_frame = fr.prev;
}
...
static void list$1ViWin$ph$p_finalize(struct list$1ViWin$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1ViWin$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 211);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1ViWin$ph$p_finalize(struct list_item$1ViWin$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(ViWin_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "list_item$1ViWin$ph$p_finalize}", 2, 210);
    }
            neo_current_frame = fr.prev;
}
...
static void list$1lambda$$p_finalize(struct list$1lambda$* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1lambda$$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 213);
    }
            neo_current_frame = fr.prev;
}
...
static void map$2int$list$1int$ph$ph$p_finalize(struct map$2int$list$1int$ph$ph* self)
{
    ...
    for(i=0    ;i<self->size;i++){
        if(self->item_existance[i]) {
            if(1) {
                come_call_finalizer(list$1int$ph$p_finalize, self->items[i], (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3509, 217);
            }
        }
    }
    come_free((char*)self->items);
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3524, 218);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3526, 219));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3527, 220));
            neo_current_frame = fr.prev;
}
...
static void map$2int$int$$p_finalize(struct map$2int$int$* self)
{
    ...
    come_free((char*)self->keys);
    come_call_finalizer(list$1int$$p_finalize, self->key_list, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 3524, 222);
    (self->hashes = come_decrement_ref_count(self->hashes, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3526, 223));
    (self->item_existance = come_decrement_ref_count(self->item_existance, (void*)0, (void*)0, 0, 0, (void*)0, "/usr/local/include/neo-c.h", 3527, 224));
            neo_current_frame = fr.prev;
}
...
static void list$1char$ph$p_finalize(struct list$1char$ph* self)
{
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1char$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/usr/local/include/neo-c.h}", 1565, 227);
    }
            neo_current_frame = fr.prev;
}
...
static void list_item$1char$ph$p_finalize(struct list_item$1char$ph* self)
{
    ...
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        (self->item = come_decrement_ref_count(self->item, (void*)0, (void*)0, 0, 0, (void*)0, "list_item$1char$ph$p_finalize", 2, 226));
    }
            neo_current_frame = fr.prev;
}
...
void Vi_enterVisualMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    self->mode=(2);
...
void Vi_exitFromVisualMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_exitFromVisualMode"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    self->mode=(0);
