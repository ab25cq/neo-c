...
struct ViWin*  ViWin_initialize_v8(struct ViWin*  self  , int y, int x, int width, int height, struct Vi*  vi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_initialize_v8"; neo_current_frame = &fr;
...
void ViWin_visualModeView(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_visualModeView"; neo_current_frame = &fr;
    int maxy;
    int maxx;
    int it2;
    void* __right_value0 = (void*)0;
...
void ViWin_view_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_view_v8"; neo_current_frame = &fr;
...
void ViWin_yankOnVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_yankOnVisualMode"; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    void* __right_value0 = (void*)0;
...
void ViWin_fileYankOnVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_fileYankOnVisualMode"; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    void* __right_value0 = (void*)0;
...
void ViWin_indentVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_indentVisualMode"; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    int it2;
...
static struct list$1int$* list$1int$_push_back(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        ...
        litem_7=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 714, "struct list_item$1int$*"))));
        ...
        litem_8=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 724, "struct list_item$1int$*"))));
...
void ViWin_backIndentVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_backIndentVisualMode"; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    int it2;
...
void ViWin_changeCaseVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_changeCaseVisualMode"; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    int it2;
...
void ViWin_joinVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_joinVisualMode"; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    int len;
...
static struct list$1int$ph* list$1int$ph_insert(struct list$1int$ph* self, int position, int*  item  )
{
    ...
    if(position==0) {
        ...
        litem_25=(struct list_item$1int$ph*)come_increment_ref_count((struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 891, "struct list_item$1int$ph*"));
        ...
        self->len++;
        come_call_finalizer(list_item$1int$ph$p_finalize, litem_25, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    else {
        it=self->head;
        i_26=0;
        while(it!=((void*)0)) {
            if(position==i_26) {
                litem_27=(struct list_item$1int$ph*)come_increment_ref_count(((struct list_item$1int$ph*)(__right_value0=(struct list_item$1int$ph*)come_calloc(1, sizeof(struct list_item$1int$ph)*(1), (void*)0, 907, "struct list_item$1int$ph*"))));
...
static struct list$1int$* list$1int$_insert(struct list$1int$* self, int position, int item)
{
    ...
    if(position==0) {
        ...
        litem_28=(struct list_item$1int$*)come_increment_ref_count((struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 891, "struct list_item$1int$*"));
        ...
        self->len++;
        come_call_finalizer(list_item$1int$$p_finalize, litem_28, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    else {
        it=self->head;
        i_29=0;
        while(it!=((void*)0)) {
            if(position==i_29) {
                litem_30=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 907, "struct list_item$1int$*"))));
...
void ViWin_equalVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_equalVisualMode"; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    int indent;
...
void ViWin_rewriteVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_rewriteVisualMode"; neo_current_frame = &fr;
    int key;
    int head;
    int tail;
    int tmp;
...
void ViWin_deleteOnVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_deleteOnVisualMode"; neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
    void* __right_value0 = (void*)0;
...
void ViWin_makeInputedKeyGVIndent_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_makeInputedKeyGVIndent_v8"; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_makeInputedKeyGVDeIndent_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_makeInputedKeyGVDeIndent_v8"; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}

void ViWin_inputVisualMode(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_inputVisualMode"; neo_current_frame = &fr;
    int key;
    key=ViWin_getKey_v14(self,(_Bool)0);
    switch (    key) {
        case 0405:
...
void ViWin_input_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_input_v8"; neo_current_frame = &fr;
    if(nvi->mode==(2)) {
...
void ViWin_restoreVisualMode_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_restoreVisualMode_v8"; neo_current_frame = &fr;
    nvi->mode=(2);
...
void ViWin_gotoBraceEnd_v8(struct ViWin*  self  , struct Vi*  nvi  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "ViWin_gotoBraceEnd_v8"; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
}
...
struct Vi*  Vi_initialize_v8(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_initialize_v8"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct Vi*  result  ;
...
static struct list$1lambda$* list$1lambda$_push_back(struct list$1lambda$* self, void (*item)(struct Vi* ,int))
{
    ...
    if(self->len==0) {
        ...
        litem_37=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 714, "struct list_item$1lambda$*"))));
        ...
        litem_38=(struct list_item$1lambda$*)come_increment_ref_count(((struct list_item$1lambda$*)(__right_value0=(struct list_item$1lambda$*)come_calloc(1, sizeof(struct list_item$1lambda$)*(1), (void*)0, 724, "struct list_item$1lambda$*"))));
...
void Vi_enterVisualMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_enterVisualMode"; neo_current_frame = &fr;
    self->mode=(2);
...
void Vi_exitFromVisualMode(struct Vi*  self  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Vi_exitFromVisualMode"; neo_current_frame = &fr;
    self->mode=(0);
