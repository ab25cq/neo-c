...
struct ViWin* ViWin_initialize_v18(struct ViWin* self  , int y, int x, int width, int height, struct Vi* vi  )
{
    ...
    fr.fun_name  = "ViWin_initialize_v18";
...
void ViWin_verticalVisualModeView(struct ViWin* self  , struct Vi* nvi  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "ViWin_verticalVisualModeView";
    neo_current_frame = &fr;
    int maxy;
    int maxx;
    int it2;
...
void ViWin_deleteOnVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "ViWin_deleteOnVerticalVisualMode";
    neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
...
void ViWin_deleteLinesOnVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "ViWin_deleteLinesOnVerticalVisualMode";
    neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
...
void ViWin_changeCaseVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "ViWin_changeCaseVerticalVisualMode";
    neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
...
void ViWin_rewriteOnVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "ViWin_rewriteOnVerticalVisualMode";
    neo_current_frame = &fr;
    int head;
    int tail;
    int tmp;
...
void ViWin_insertOnVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "ViWin_insertOnVerticalVisualMode";
    neo_current_frame = &fr;
    int key;
    int head;
    int tail;
...
void ViWin_inputVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "ViWin_inputVerticalVisualMode";
    neo_current_frame = &fr;
    int key;
...
void Vi_enterVerticalVisualMode(struct Vi* self  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "Vi_enterVerticalVisualMode";
    neo_current_frame = &fr;
    self->mode=(6);
