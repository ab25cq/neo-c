...
fr.fun_name = ViWin_initialize_v18; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct ViWin* result  ;
...
void ViWin_verticalVisualModeView(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_verticalVisualModeView; neo_current_frame = &fr;    int maxy;
    int maxx;
    int it2;
...
void ViWin_view_v18(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_view_v18; neo_current_frame = &fr;    if(nvi->mode==(6)&&ViWin_equals(nvi->activeWin,self)) {
...
void ViWin_deleteOnVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_deleteOnVerticalVisualMode; neo_current_frame = &fr;    int head;
    int tail;
    int tmp;
    int i;
    void* __right_value0 = (void*)0;
...
void ViWin_deleteLinesOnVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_deleteLinesOnVerticalVisualMode; neo_current_frame = &fr;    int head;
    int tail;
    int tmp;
    int i;
    void* __right_value0 = (void*)0;
...
void ViWin_changeCaseVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_changeCaseVerticalVisualMode; neo_current_frame = &fr;    int head;
    int tail;
    int tmp;
    int i;
    void* __right_value0 = (void*)0;
...
void ViWin_rewriteOnVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_rewriteOnVerticalVisualMode; neo_current_frame = &fr;    int head;
    int tail;
    int tmp;
    int key  ;
    int i;
...
void ViWin_insertOnVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_insertOnVerticalVisualMode; neo_current_frame = &fr;    int key;
    int head;
    int tail;
    int tmp;
    int i;
    ...
    key=ViWin_getKey_v14(self,0);
    if(key==3||key==27) {
        self->visualModeVerticalInserting=0;
        self->cursorY=self->visualModeVerticalStartY;
        self->scroll=self->visualModeVerticalStartScroll;
        self->cursorX=self->visualModeVerticalStartX;
...
void ViWin_inputVerticalVisualMode(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_inputVerticalVisualMode; neo_current_frame = &fr;    int key;
    if(self->visualModeVerticalInserting) {
        ...
        switch (        key) {
            ...
            case 73:
            ViWin_pushUndo_v5(self);
            self->visualModeVerticalInserting=1;
            break;
            case 36:
...
void ViWin_input_v18(struct ViWin* self  , struct Vi* nvi  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = ViWin_input_v18; neo_current_frame = &fr;    if(nvi->mode==(6)) {
...
void Vi_enterVerticalVisualMode(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_enterVerticalVisualMode; neo_current_frame = &fr;    self->mode=(6);
    ...
    self->activeWin->visualModeVerticalInserting=0;
neo_current_frame = fr.prev;}
...
static void lambda1(struct Vi* self  , int key)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = lambda1; neo_current_frame = &fr;    Vi_enterVerticalVisualMode(self);
...
struct Vi* Vi_initialize_v18(struct Vi* self  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = Vi_initialize_v18; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    struct Vi* result  ;
