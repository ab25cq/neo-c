...
;    struct sType* type_107=0;
    ...
    if(!gComeC&&charp_operator_equals(buf,"new")) {
        ...
        (come_push_stackframe("25obj.c", 1685, 67),__exception_result_var_b68=expected_next_character(44,info), come_pop_stackframe(), __exception_result_var_b68);
        ...
        while(1) {
            if(strncmp(info->p,"default",strlen("default"))==0) {
                ...
                skip_spaces_and_lf(info);
                (come_push_stackframe("25obj.c", 1696, 68),__exception_result_var_b69=expected_next_character(58,info), come_pop_stackframe(), __exception_result_var_b69);
                ...
                multiple_assign_var11=(come_push_stackframe("25obj.c", 1704, 70),__exception_result_var_b71=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,0,0))), come_pop_stackframe(), __exception_result_var_b71);
                ...
                (come_push_stackframe("25obj.c", 1708, 71),__exception_result_var_b72=expected_next_character(58,info), come_pop_stackframe(), __exception_result_var_b72);
        ...
        (come_push_stackframe("25obj.c", 1736, 72),__exception_result_var_b73=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b73);
        info->in_offsetof=1;
        multiple_assign_var12=(come_push_stackframe("25obj.c", 1739, 74),__exception_result_var_b75=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,0,0))), come_pop_stackframe(), __exception_result_var_b75);
        ...
        (come_push_stackframe("25obj.c", 1747, 75),__exception_result_var_b76=expected_next_character(44,info), come_pop_stackframe(), __exception_result_var_b76);
        word_82=(char*)come_increment_ref_count(parse_word(0,info));
        (come_push_stackframe("25obj.c", 1751, 76),__exception_result_var_b77=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b77);
        ...
        if(is_type_name_flag) {
            multiple_assign_var13=(come_push_stackframe("25obj.c", 1783, 78),__exception_result_var_b79=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b79);
        ...
        if(is_type_name_flag_93) {
            multiple_assign_var14=(come_push_stackframe("25obj.c", 1945, 80),__exception_result_var_b81=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b81);
        ...
        if(is_type_name_flag_103) {
            multiple_assign_var15=(come_push_stackframe("25obj.c", 2000, 82),__exception_result_var_b83=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b83);
...
;    struct sType* type3=0;
    ...
    if(!node->terminated(node->_protocol_obj)&&!gComeC&&parsecmp("implements",info)) {
        ...
        skip_spaces_and_lf(info);
        multiple_assign_var16=(come_push_stackframe("25obj.c", 2140, 84),__exception_result_var_b85=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,0,0))), come_pop_stackframe(), __exception_result_var_b85);
