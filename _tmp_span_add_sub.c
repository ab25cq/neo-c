...
static int* span$1int$p$p_operator_add(struct span$1int$p* self, unsigned long  rvalue  );
static int* span$1int$p_operator_add(struct span$1int$p* self, unsigned long  rvalue  );
...
int main(int argc, char** argv)
{
    ...
    p=span$1int$p_operator_add(s,1);
    q=span$1int$p_operator_add(s,3);
    r=q-2;
    printf("%d\n",*p);
    printf("%d\n",*r);
        __result_obj__0 = 0;
