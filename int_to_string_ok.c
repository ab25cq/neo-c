...
int main()
{
    ...
    char*  it_11  ;
    struct list$1char$ph* x;
    int __result_obj__0;
    li=(struct list$1int$*)come_increment_ref_count((__list_values1__[0]=1,
__list_values1__[1]=2,
__list_values1__[2]=3,
list$1int$_initialize_with_values((struct list$1int$*)come_increment_ref_count((struct list$1int$*)come_calloc(1, sizeof(struct list$1int$)*(1), "/tmp/int_to_string_ok.nc", 4, "struct list$1int$")),3,__list_values1__)));
    x=(struct list$1char$ph*)come_increment_ref_count(({__right_value0 = (void*)0;
__right_value1 = (void*)0;
_li_7=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "/tmp/int_to_string_ok.nc", 28, "struct list$1char$ph*")))); i_8=0; for(({(_conditional_value_X0=(_o2_saved_2=(struct list$1int$*)come_increment_ref_count(li),it_9=list$1int$_begin(_o2_saved_2)));_conditional_value_X0;});({(_conditional_value_X1=(!list$1int$_end(_o2_saved_2)));_conditional_value_X1;});({(_conditional_value_X2=(it_9=list$1int$_next(_o2_saved_2)));_conditional_value_X2;})){
result_10=it_9>2;
if(result_10) {
...
({}); _li_7; }));
    __right_value0 = (void*)0;
    puts(((char* )(__right_value0=list$1char$ph_to_string(x))));
    ...
    come_call_finalizer(list$1char$ph$p_finalize, x, (void*)0, (void*)0, 0, 0, 0, (void*)0);
...
static struct list$1int$* list$1int$_add(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_5=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1443, "struct list_item$1int$*"))));
        ...
        __right_value0 = (void*)0;
        litem_6=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1453, "struct list_item$1int$*"))));
