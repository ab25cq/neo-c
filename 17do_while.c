...
fr.fun_name = "sDoWhileNode_initialize"; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    ...
    neo_current_frame = fr.prev;    come_call_finalizer(sDoWhileNode_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
_Bool sDoWhileNode_no_mutex(struct sDoWhileNode* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "sDoWhileNode_no_mutex"; neo_current_frame = &fr;       neo_current_frame = fr.prev;
    return 1;
neo_current_frame = fr.prev;}
...
_Bool sDoWhileNode_terminated(struct sDoWhileNode* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "sDoWhileNode_terminated"; neo_current_frame = &fr;       neo_current_frame = fr.prev;
    return 1;
neo_current_frame = fr.prev;}
...
char* sDoWhileNode_kind(struct sDoWhileNode* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "sDoWhileNode_kind"; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
...
_Bool sDoWhileNode_compile(struct sDoWhileNode* self, struct sInfo* info  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "sDoWhileNode_compile"; neo_current_frame = &fr;    struct sBlock* block  ;
...
static void sDoWhileNode_finalize(struct sDoWhileNode* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "sDoWhileNode_finalize"; neo_current_frame = &fr;    if(self!=((void*)0)&&self->sname!=((void*)0)) {
        (self->sname = come_decrement_ref_count(self->sname, (void*)0, (void*)0, 0, 0, (void*)0));
    }
...
struct sNode* string_node_v10(char* buf, char* head, int head_sline, struct sInfo* info  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "string_node_v10"; neo_current_frame = &fr;    void* __right_value0 = (void*)0;
    char* sname  ;
    int sline;
    struct sBlock* block  ;
    char* buf2  ;
    ...
    if(charp_operator_equals(buf,"do")) {
        sname=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "17do_while.nc", 59, "char*"));
        sline=info->sline;
        ...
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 78, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value1=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), (void*)0, 78, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node),block,info))));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "sDoWhileNode_clone"; neo_current_frame = &fr;    struct sDoWhileNode* __result_obj__0;
    void* __right_value0 = (void*)0;
