...
static void sDoWhileNode_finalize(struct sDoWhileNode* self)
{
    ...
    if(self!=((void*)0)&&((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 0))->sname!=((void*)0)) {
        (((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 0))->sname = come_decrement_ref_count(((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 0))->sname, (void*)0, (void*)0, 0, 0, (void*)0));
    }
    if(self!=((void*)0)&&((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 1))->mExpressionNode!=((void*)0)) {
        ((((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 1))->mExpressionNode) ? ((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 1))->mExpressionNode = come_decrement_ref_count(((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 1))->mExpressionNode, ((struct sNode*)((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 1))->mExpressionNode)->finalize, ((struct sNode*)((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 1))->mExpressionNode)->_protocol_obj, 0, 0,(void*)0):(void*)0);
    }
    if(self!=((void*)0)&&((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 2))->mBlock!=((void*)0)) {
        come_call_finalizer(sBlock_finalize, ((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_finalize", 2))->mBlock, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    neo_current_frame = fr.prev;
}
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self)
{
    ...
    if(self!=((void*)0)) {
        ((struct sDoWhileNode* )come_null_checker(result, "sDoWhileNode_clone", 4))->sline=((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_clone", 4))->sline;
    }
    if(self!=((void*)0)&&((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_clone", 5))->sname!=((void*)0)) {
        __dec_obj48=((struct sDoWhileNode* )come_null_checker(result, "sDoWhileNode_clone", 5))->sname,
        ((struct sDoWhileNode* )come_null_checker(result, "sDoWhileNode_clone", 5))->sname=(char* )come_increment_ref_count((char* )come_memdup(((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_clone", 5))->sname, "sDoWhileNode_clone", 5, "char* "));
        __dec_obj48 = come_decrement_ref_count(__dec_obj48, (void*)0, (void*)0, 0,0, (void*)0);
    }
    if(self!=((void*)0)) {
        ((struct sDoWhileNode* )come_null_checker(result, "sDoWhileNode_clone", 6))->sline_real=((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_clone", 6))->sline_real;
    }
    if(self!=((void*)0)&&((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_clone", 7))->mExpressionNode!=((void*)0)) {
        __dec_obj49=((struct sDoWhileNode* )come_null_checker(result, "sDoWhileNode_clone", 7))->mExpressionNode,
        ((struct sDoWhileNode* )come_null_checker(result, "sDoWhileNode_clone", 7))->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_clone", 7))->mExpressionNode));
    ...
    if(self!=((void*)0)&&((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_clone", 8))->mBlock!=((void*)0)) {
        __dec_obj50=((struct sDoWhileNode* )come_null_checker(result, "sDoWhileNode_clone", 8))->mBlock,
        ((struct sDoWhileNode* )come_null_checker(result, "sDoWhileNode_clone", 8))->mBlock=(struct sBlock* )come_increment_ref_count(sBlock_clone(((struct sDoWhileNode*)come_null_checker(self, "sDoWhileNode_clone", 8))->mBlock));
