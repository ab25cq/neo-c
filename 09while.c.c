...
memset(&conditional_value_123, 0, sizeof(struct CVALUE*));
    ...
    if(normal_if_121) {
        conditional_value_122=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
...
memset(&block_129, 0, sizeof(struct sBlock*));
    if(charp_operator_equals(buf,"while")) {
        ...
        expression_node_128=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        block_129=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0));
...
memset(&result_130, 0, sizeof(struct sWhileNode*));
            ...
            result_130=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "sWhileNode"));
            if(self!=((void*)0)) {
                result_130->sline=self->sline;
            }
            if(self!=((void*)0)&&self->sname!=((void*)0)) {
                __dec_obj22=result_130->sname;
                result_130->sname=(char*)come_increment_ref_count(string_clone(self->sname));
                __dec_obj22 = come_decrement_ref_count2(__dec_obj22, (void*)0, (void*)0, 0,0,0, (void*)0);
            }
            if(self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
                __dec_obj23=result_130->mExpressionNode;
                result_130->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
                if(__dec_obj23) { __dec_obj23 = come_decrement_ref_count2(__dec_obj23, ((struct sNode*)__dec_obj23)->finalize, ((struct sNode*)__dec_obj23)->_protocol_obj, 0,0,0, (void*)0); }
            }
            if(self!=((void*)0)&&self->mBlock!=((void*)0)) {
                __dec_obj24=result_130->mBlock;
                result_130->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
