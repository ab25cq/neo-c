...
struct sWhileNode* __result90__;
memset(&__result_obj__, 0, sizeof(void*));
right_value79 = (void*)0;
right_value81 = (void*)0;
right_value108 = (void*)0;
    (come_push_stackframe("09while.c", 7, 575),__exception_result_var_b51=((struct sNodeBase*)(right_value79=sNodeBase_initialize((struct sNodeBase*)come_increment_ref_count((struct sNodeBase*)((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "09while.c", 7, 573)), "09while.c", 7, 574))),info))), come_pop_stackframe(), __exception_result_var_b51);
    come_call_finalizer3(right_value79,sNodeBase_finalize, 0, 1, 0, 0, __result_obj__);
    __dec_obj12=((struct sWhileNode*)come_null_check(self, "09while.c", 9, 580))->mExpressionNode;
    ((struct sWhileNode*)come_null_check(self, "09while.c", 9, 580))->mExpressionNode=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value81=(come_push_stackframe("09while.c", 9, 615),__exception_result_var_b52=sNode_clone(expression_node), come_pop_stackframe(), __exception_result_var_b52))));
    ...
    __dec_obj21=((struct sWhileNode*)come_null_check(self, "09while.c", 10, 616))->mBlock;
    ((struct sWhileNode*)come_null_check(self, "09while.c", 10, 616))->mBlock=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value108=(come_push_stackframe("09while.c", 10, 1296),__exception_result_var_b99=sBlock_clone(block), come_pop_stackframe(), __exception_result_var_b99))));
...
right_value109 = (void*)0;
    __result92__ = __result_obj__ = (come_push_stackframe("09while.c", 20, 1309),__exception_result_var_b100=((char*)(right_value109=__builtin_string("sWhileNode"))), come_pop_stackframe(), __exception_result_var_b100);
...
void* right_value110;
struct CVALUE* __exception_result_var_b103;
struct CVALUE* conditional_value_122;
void* right_value111;
struct CVALUE* __exception_result_var_b104;
...
memset(&num_while_conditional_stack_125, 0, sizeof(int));
    in_loop_118=((struct sInfo*)come_null_check(((struct sInfo*)come_null_check(info, "09while.c", 25, 1310)), "09while.c", 25, 1311))->in_loop;
    ((struct sInfo*)come_null_check(((struct sInfo*)come_null_check(info, "09while.c", 26, 1312)), "09while.c", 26, 1313))->in_loop=(_Bool)1;
    expression_node_119=((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "09while.c", 29, 1314)), "09while.c", 29, 1315))->mExpressionNode;
    ((struct sInfo*)come_null_check(((struct sInfo*)come_null_check(info, "09while.c", 31, 1316)), "09while.c", 31, 1317))->without_semicolon=(_Bool)1;
    if(_if_conditional122=!(come_push_stackframe("09while.c", 32, 1318),__exception_result_var_b101=node_compile(expression_node_119,info), come_pop_stackframe(), __exception_result_var_b101),    _if_conditional122) {
        __result93__ = (_Bool)0;
        return __result93__;
    }
    ((struct sInfo*)come_null_check(((struct sInfo*)come_null_check(info, "09while.c", 35, 1319)), "09while.c", 35, 1320))->without_semicolon=(_Bool)0;
    block_120=((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "09while.c", 37, 1321)), "09while.c", 37, 1322))->mBlock;
    normal_if_121=(_Bool)1;
    if(_if_conditional123=((struct sModule*)come_null_check(((struct sModule*)come_null_check(((struct sInfo*)come_null_check(((struct sInfo*)come_null_check(info, "09while.c", 40, 1323)), "09while.c", 40, 1324))->module, "09while.c", 40, 1325)), "09while.c", 40, 1326))->mLastCode||((struct sModule*)come_null_check(((struct sModule*)come_null_check(((struct sInfo*)come_null_check(((struct sInfo*)come_null_check(info, "09while.c", 40, 1327)), "09while.c", 40, 1328))->module, "09while.c", 40, 1329)), "09while.c", 40, 1330))->mLastCode2||((struct sModule*)come_null_check(((struct sModule*)come_null_check(((struct sInfo*)come_null_check(((struct sInfo*)come_null_check(info, "09while.c", 40, 1331)), "09while.c", 40, 1332))->module, "09while.c", 40, 1333)), "09while.c", 40, 1334))->mLastCode3,    _if_conditional123) {
        normal_if_121=(_Bool)0;
    }
    if(_if_conditional124=(come_push_stackframe("09while.c", 43, 1335),__exception_result_var_b102=existance_free_right_value_objects(info), come_pop_stackframe(), __exception_result_var_b102),    _if_conditional124) {
        normal_if_121=(_Bool)0;
    }
    if(normal_if_121) {
        conditional_value_122=(struct CVALUE*)come_increment_ref_count((come_push_stackframe("09while.c", 48, 1336),__exception_result_var_b103=((struct CVALUE*)(right_value110=get_value_from_stack(-1,info))), come_pop_stackframe(), __exception_result_var_b103));
        come_call_finalizer3(right_value110,CVALUE_finalize, 0, 1, 0, 0, __result_obj__);
        (come_push_stackframe("09while.c", 49,1345),dec_stack_ptr(1,info),come_pop_stackframe());
        (come_push_stackframe("09while.c", 50,1348),add_come_code(info,"while(%s) {\n",((struct CVALUE*)come_null_check(((struct CVALUE*)come_null_check(conditional_value_122, "09while.c", 50, 1346)), "09while.c", 50, 1347))->c_value),come_pop_stackframe());
        come_call_finalizer3(conditional_value_122,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
        conditional_value_123=(struct CVALUE*)come_increment_ref_count((come_push_stackframe("09while.c", 53, 1349),__exception_result_var_b104=((struct CVALUE*)(right_value111=get_value_from_stack(-1,info))), come_pop_stackframe(), __exception_result_var_b104));
        come_call_finalizer3(right_value111,CVALUE_finalize, 0, 1, 0, 0, __result_obj__);
        (come_push_stackframe("09while.c", 54,1350),dec_stack_ptr(1,info),come_pop_stackframe());
        static int num_while_condtional_124=0;
        (come_push_stackframe("09while.c", 56,1351),add_come_code_at_function_head(info,"_Bool _while_condtional%d;\n",++num_while_condtional_124),come_pop_stackframe());
        num_while_conditional_stack_125=num_while_condtional_124;
        (come_push_stackframe("09while.c", 59,1354),add_come_code(info,"while(_while_condtional%d=%s,",num_while_condtional_124,((struct CVALUE*)come_null_check(((struct CVALUE*)come_null_check(conditional_value_123, "09while.c", 59, 1352)), "09while.c", 59, 1353))->c_value),come_pop_stackframe());
        (come_push_stackframe("09while.c", 60,1355),add_last_code_to_source_with_comma(info),come_pop_stackframe());
        (come_push_stackframe("09while.c", 62,1356),free_right_value_objects(info,(_Bool)1),come_pop_stackframe());
        (come_push_stackframe("09while.c", 63,1357),add_come_code(info,"_while_condtional%d) {\n",num_while_conditional_stack_125),come_pop_stackframe());
        come_call_finalizer3(conditional_value_123,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    (come_push_stackframe("09while.c", 66, 1358),__exception_result_var_b105=transpile_block(block_120,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1), come_pop_stackframe(), __exception_result_var_b105);
    (come_push_stackframe("09while.c", 68,1359),add_come_code(info,"}\n"),come_pop_stackframe());
    (come_push_stackframe("09while.c", 70,1360),transpiler_clear_last_code(info),come_pop_stackframe());
    ((struct sInfo*)come_null_check(((struct sInfo*)come_null_check(info, "09while.c", 72, 1361)), "09while.c", 72, 1362))->in_loop=in_loop_118;
...
memset(&__result_obj__, 0, sizeof(void*));
            if(_if_conditional126=self!=((void*)0)&&((struct CVALUE*)come_null_check(((struct CVALUE*)come_null_check(self, "CVALUE_finalize", 0, 1337)), "CVALUE_finalize", 0, 1338))->c_value!=((void*)0),            _if_conditional126) {
                ((struct CVALUE*)come_null_check(((struct CVALUE*)come_null_check(self, "CVALUE_finalize", 0, 1339)), "CVALUE_finalize", 0, 1340))->c_value = come_decrement_ref_count2(((struct CVALUE*)come_null_check(((struct CVALUE*)come_null_check(self, "CVALUE_finalize", 0, 1339)), "CVALUE_finalize", 0, 1340))->c_value, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            }
            if(_if_conditional127=self!=((void*)0)&&((struct CVALUE*)come_null_check(((struct CVALUE*)come_null_check(self, "CVALUE_finalize", 1, 1341)), "CVALUE_finalize", 1, 1342))->type!=((void*)0),            _if_conditional127) {
                come_call_finalizer3(((struct CVALUE*)come_null_check(((struct CVALUE*)come_null_check(self, "CVALUE_finalize", 1, 1343)), "CVALUE_finalize", 1, 1344))->type,sType_finalize, 0, 0, 0, 0, (void*)0);
            }
}
...
void* right_value113;
struct sNode* __exception_result_var_b109;
struct sNode* expression_node_128;
int __exception_result_var_b110;
void* right_value114;
struct sBlock* __exception_result_var_b111;
struct sBlock* block_129;
void* right_value115;
void* right_value116;
struct sWhileNode* __exception_result_var_b112;
...
right_value122 = (void*)0;
    if(_if_conditional128=(come_push_stackframe("09while.c", 80, 1363),__exception_result_var_b106=charp_operator_equals(buf,"while"), come_pop_stackframe(), __exception_result_var_b106),    _if_conditional128) {
        sname_126=(char*)come_increment_ref_count(((char*)(right_value112=(come_push_stackframe("09while.c", 81, 1366),__exception_result_var_b107=string_clone(((struct sInfo*)come_null_check(((struct sInfo*)come_null_check(info, "09while.c", 81, 1364)), "09while.c", 81, 1365))->sname), come_pop_stackframe(), __exception_result_var_b107))));
        right_value112 = come_decrement_ref_count2(right_value112, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
        sline_127=((struct sInfo*)come_null_check(((struct sInfo*)come_null_check(info, "09while.c", 82, 1367)), "09while.c", 82, 1368))->sline;
        (come_push_stackframe("09while.c", 84, 1369),__exception_result_var_b108=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b108);
        expression_node_128=(struct sNode*)come_increment_ref_count((come_push_stackframe("09while.c", 87, 1370),__exception_result_var_b109=((struct sNode*)(right_value113=expression_v13(info))), come_pop_stackframe(), __exception_result_var_b109));
        ...
        (come_push_stackframe("09while.c", 89, 1371),__exception_result_var_b110=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b110);
        block_129=(struct sBlock*)come_increment_ref_count((come_push_stackframe("09while.c", 91, 1372),__exception_result_var_b111=((struct sBlock*)(right_value114=parse_block(info,(_Bool)0,(_Bool)0))), come_pop_stackframe(), __exception_result_var_b111));
        come_call_finalizer3(right_value114,sBlock_finalize, 0, 1, 0, 0, __result_obj__);
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "09while.c", 93, "struct sNode");
        _inf_obj_value1=come_increment_ref_count((come_push_stackframe("09while.c", 93, 1374),__exception_result_var_b112=((struct sWhileNode*)(right_value116=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)come_null_check(((struct sWhileNode*)(right_value115=(struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 93, "sWhileNode"))), "09while.c", 93, 1373))),(struct sNode*)come_increment_ref_count(expression_node_128),block_129,info))), come_pop_stackframe(), __exception_result_var_b112));
        ...
        __result97__ = __result_obj__ = ((struct sNode*)(right_value121=_inf_value1));
        ...
        come_call_finalizer3(right_value115,sWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
        come_call_finalizer3(right_value116,sWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result98__ = __result_obj__ = (come_push_stackframe("09while.c", 96, 1412),__exception_result_var_b116=((struct sNode*)(right_value122=string_node_v8(buf,head,head_sline,info))), come_pop_stackframe(), __exception_result_var_b116);
...
memset(&__result_obj__, 0, sizeof(void*));
            if(_if_conditional129=self!=((void*)0)&&((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 0, 1375)), "sWhileNode_finalize", 0, 1376))->sname!=((void*)0),            _if_conditional129) {
                ((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 0, 1377)), "sWhileNode_finalize", 0, 1378))->sname = come_decrement_ref_count2(((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 0, 1377)), "sWhileNode_finalize", 0, 1378))->sname, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            }
            if(_if_conditional130=self!=((void*)0)&&((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 1, 1379)), "sWhileNode_finalize", 1, 1380))->mExpressionNode!=((void*)0),            _if_conditional130) {
                if(((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 1, 1381)), "sWhileNode_finalize", 1, 1382))->mExpressionNode) { ((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 1, 1381)), "sWhileNode_finalize", 1, 1382))->mExpressionNode = come_decrement_ref_count2(((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 1, 1381)), "sWhileNode_finalize", 1, 1382))->mExpressionNode, ((struct sNode*)((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 1, 1381)), "sWhileNode_finalize", 1, 1382))->mExpressionNode)->finalize, ((struct sNode*)((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 1, 1381)), "sWhileNode_finalize", 1, 1382))->mExpressionNode)->_protocol_obj, 0, 0, 0, (void*)0); } 
            }
            if(_if_conditional131=self!=((void*)0)&&((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 2, 1383)), "sWhileNode_finalize", 2, 1384))->mBlock!=((void*)0),            _if_conditional131) {
                come_call_finalizer3(((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_finalize", 2, 1385)), "sWhileNode_finalize", 2, 1386))->mBlock,sBlock_finalize, 0, 0, 0, 0, (void*)0);
            }
}
...
struct sWhileNode* __result95__;
void* right_value117;
struct sWhileNode* result_130;
...
struct sBlock* __exception_result_var_b115;
void* right_value120;
struct sBlock* __dec_obj24;
struct sWhileNode* __result96__;
memset(&__result_obj__, 0, sizeof(void*));
right_value117 = (void*)0;
memset(&result_130, 0, sizeof(struct sWhileNode*));
...
right_value120 = (void*)0;
            ...
            result_130=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(right_value117=(struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "sWhileNode"))));
            come_call_finalizer3(right_value117,sWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
            if(_if_conditional133=self!=((void*)0),            _if_conditional133) {
                ((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(result_130, "sWhileNode_clone", 4, 1387)), "sWhileNode_clone", 4, 1388))->sline=((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_clone", 4, 1389)), "sWhileNode_clone", 4, 1390))->sline;
            }
            if(_if_conditional134=self!=((void*)0)&&((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_clone", 5, 1391)), "sWhileNode_clone", 5, 1392))->sname!=((void*)0),            _if_conditional134) {
                __dec_obj22=((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(result_130, "sWhileNode_clone", 5, 1393)), "sWhileNode_clone", 5, 1394))->sname;
                ((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(result_130, "sWhileNode_clone", 5, 1393)), "sWhileNode_clone", 5, 1394))->sname=(char*)come_increment_ref_count(((char*)(right_value118=(come_push_stackframe("sWhileNode_clone", 5, 1397),__exception_result_var_b113=string_clone(((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_clone", 5, 1395)), "sWhileNode_clone", 5, 1396))->sname), come_pop_stackframe(), __exception_result_var_b113))));
                __dec_obj22 = come_decrement_ref_count2(__dec_obj22, (void*)0, (void*)0, 0,0,0, (void*)0);
                right_value118 = come_decrement_ref_count2(right_value118, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
            }
            if(_if_conditional135=self!=((void*)0)&&((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_clone", 6, 1398)), "sWhileNode_clone", 6, 1399))->mExpressionNode!=((void*)0),            _if_conditional135) {
                __dec_obj23=((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(result_130, "sWhileNode_clone", 6, 1400)), "sWhileNode_clone", 6, 1401))->mExpressionNode;
                ((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(result_130, "sWhileNode_clone", 6, 1400)), "sWhileNode_clone", 6, 1401))->mExpressionNode=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value119=(come_push_stackframe("sWhileNode_clone", 6, 1404),__exception_result_var_b114=sNode_clone(((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_clone", 6, 1402)), "sWhileNode_clone", 6, 1403))->mExpressionNode), come_pop_stackframe(), __exception_result_var_b114))));
            ...
            if(_if_conditional136=self!=((void*)0)&&((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_clone", 7, 1405)), "sWhileNode_clone", 7, 1406))->mBlock!=((void*)0),            _if_conditional136) {
                __dec_obj24=((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(result_130, "sWhileNode_clone", 7, 1407)), "sWhileNode_clone", 7, 1408))->mBlock;
                ((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(result_130, "sWhileNode_clone", 7, 1407)), "sWhileNode_clone", 7, 1408))->mBlock=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value120=(come_push_stackframe("sWhileNode_clone", 7, 1411),__exception_result_var_b115=sBlock_clone(((struct sWhileNode*)come_null_check(((struct sWhileNode*)come_null_check(self, "sWhileNode_clone", 7, 1409)), "sWhileNode_clone", 7, 1410))->mBlock), come_pop_stackframe(), __exception_result_var_b115))));
                come_call_finalizer3(__dec_obj24,sBlock_finalize, 0, 0, 0, 0, (void*)0);
                come_call_finalizer3(right_value120,sBlock_finalize, 0, 1, 0, 0, __result_obj__);
            }
            __result96__ = __result_obj__ = result_130;
            come_call_finalizer3(result_130,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
            return __result96__;
            come_call_finalizer3(result_130,sWhileNode_finalize, 0, 0, 0, 0, (void*)0);
}
