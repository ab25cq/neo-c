...
struct map$2charphsVarph* __result48__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value90=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./neo-c.h", 1276, "char*%"))));
    __right_value90 = come_decrement_ref_count2(__right_value90, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value91=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "./neo-c.h", 1277, "sVar*%"))));
    come_call_finalizer3(__right_value91,sVar_finalize, 0, 1, 0, 0, __result_obj__);
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value92=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./neo-c.h", 1278, "bool"))));
    ...
    self->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(__right_value93=(struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./neo-c.h", 1288, "list$1charp"))))));
...
default_value_88 = (void*)0;
    ...
    keys_73=(char**)come_increment_ref_count(((char**)(__right_value101=(char**)come_calloc(1, sizeof(char*)*(1*(size_72)), "./neo-c.h", 1527, "char*%"))));
    __right_value101 = come_decrement_ref_count2(__right_value101, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    items_74=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value102=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_72)), "./neo-c.h", 1528, "sClass*%"))));
    come_call_finalizer3(__right_value102,sClass_finalize, 0, 1, 0, 0, (void*)0);
    item_existance_75=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value103=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_72)), "./neo-c.h", 1529, "bool"))));
