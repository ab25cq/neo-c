...
right_value170 = (void*)0;
            ...
            if(_if_conditional189=self!=((void*)0)&&self->mSizeNum!=((void*)0),            _if_conditional189) {
            ...
            if(_if_conditional192=self!=((void*)0)&&self->mOriginalTypeName!=((void*)0),            _if_conditional192) {
            ...
            if(_if_conditional202=self!=((void*)0)&&self->mAsmName!=((void*)0),            _if_conditional202) {
...
right_value196 = (void*)0;
                ...
                if(_if_conditional216=self!=((void*)0)&&self->mVars!=((void*)0),                _if_conditional216) {
...
memset(&it_170, 0, sizeof(unsigned int));
                                ...
                                while(_while_condtional30=(_Bool)1,                                _while_condtional30) {
                                    if(_if_conditional222=self->item_existance[it_170],                                    _if_conditional222) {
                                        ...
                                        it_170++;
                                        if(_if_conditional224=it_170>=self->size,                                        _if_conditional224) {
                                            it_170=0;
                                        }
                                        else {
                                            if(_if_conditional225=it_170==hash_169,                                            _if_conditional225) {
...
memset(&it2_186, 0, sizeof(char*));
                                if(_if_conditional226=self->len*2>=self->size,                                _if_conditional226) {
                                    map$2charphsVarph_rehash(self);
                                }
                                hash_183=string_get_hash_key(key)%self->size;
                                it_184=hash_183;
                                while(_while_condtional32=(_Bool)1,                                _while_condtional32) {
                                    if(_if_conditional230=self->item_existance[it_184],                                    _if_conditional230) {
                                        if(_if_conditional231=string_equals(self->keys[it_184],key),                                        _if_conditional231) {
                                        ...
                                        it_184++;
                                        if(_if_conditional234=it_184>=self->size,                                        _if_conditional234) {
                                            it_184=0;
                                        }
                                        else {
                                            if(_if_conditional235=it_184==hash_183,                                            _if_conditional235) {
                                                printf("unexpected error in map.insert\n");
                                                stackframe();
                                                exit(2);
                                            }
                                ...
                                for(                                it2_186=list$1charp_begin(self->key_list);                                !list$1charp_end(self->key_list);                                it2_186=list$1charp_next(self->key_list)                                ){
                                    if(_if_conditional238=string_equals(it2_186,key),                                    _if_conditional238) {
                                        same_key_exist_185=(_Bool)1;
                                    }
                                }
                                if(_if_conditional239=!same_key_exist_185,                                _if_conditional239) {
                                    list$1charp_push_back(self->key_list,key);
                                }
...
memset(&default_value_182, 0, sizeof(struct sVar*));
                                        ...
                                        for(                                        it_177=map$2charphsVarph_begin(self);                                        !map$2charphsVarph_end(self);                                        it_177=map$2charphsVarph_next(self)                                        ){
                                            ...
                                            while(_while_condtional31=(_Bool)1,                                            _while_condtional31) {
                                                if(_if_conditional227=item_existance_175[n_181],                                                _if_conditional227) {
                                                    n_181++;
                                                    if(_if_conditional228=n_181>=size_172,                                                    _if_conditional228) {
                                                        n_181=0;
                                                    }
                                                    else {
                                                        if(_if_conditional229=n_181==hash_180,                                                        _if_conditional229) {
                                                            printf("unexpected error in map.rehash(1)\n");
                                                            stackframe();
                                                            exit(2);
                                                        }
