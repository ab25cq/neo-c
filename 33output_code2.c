...
_Bool output_source_file(struct sInfo*  info  )
{
    ...
    if(gPortableC) {
        __right_value0 = (void*)0;
        portable_file=Result$1__sFILE$p_unwrap(((struct Result$1__sFILE$p*)(__right_value0=xfopen(output_file_name,"r"))));
        come_call_finalizer(Result$1__sFILE$p$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0, "33output_code2.nc}", 1047, 718);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
