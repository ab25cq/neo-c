...
;    struct sType* type  =0;
    ...
    if(charp_operator_equals(buf,"typedef")) {
        ...
        info->in_typedef=1;
        multiple_assign_var2=(come_push_stackframe("22typedef.nc", 114, 1),__exception_result_var_b2=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b2);
...
;    struct sType* type  =0;
    ...
    if(charp_operator_equals(buf,"typedef")) {
        in_typedef=info->in_typedef;
        info->in_typedef=1;
        multiple_assign_var3=(come_push_stackframe("22typedef.nc", 190, 3),__exception_result_var_b4=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b4);
