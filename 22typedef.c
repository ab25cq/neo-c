...
;    struct sType* type_31  =0;
    ...
    if(string_operator_equals(type_name,"__darwin_va_list")) {
        ...
        type=(struct sType*)come_increment_ref_count((come_push_stackframe("22typedef.nc", 48, 2),__exception_result_var_b3=(come_push_stackframe("22typedef.nc", 48, 0),__exception_result_var_b1=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "22typedef.nc", 48, "struct sType*")),(char*)come_increment_ref_count(xsprintf("__darwin_va_list")),0,info,0), come_pop_stackframe(), __exception_result_var_b1), come_pop_stackframe(), __exception_result_var_b3));
...
;    struct sType* type  =0;
    ...
    if(charp_operator_equals(buf,"typedef")) {
        ...
        info->in_typedef=1;
        multiple_assign_var2=(come_push_stackframe("22typedef.nc", 114, 4),__exception_result_var_b5=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b5);
...
;    struct sType* type  =0;
    ...
    if(charp_operator_equals(buf,"typedef")) {
        in_typedef=info->in_typedef;
        info->in_typedef=1;
        multiple_assign_var3=(come_push_stackframe("22typedef.nc", 190, 6),__exception_result_var_b7=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b7);
