...
;    struct sType*  type_31  =0;
    ...
    if(string_operator_equals(((char* )come_null_checker(type_name, "22typedef.nc", 45)),"__darwin_va_list")) {
        ...
        if(list$1sNode$ph_length(((struct list$1sNode$ph*)come_null_checker(((struct sType* )come_null_checker(type, "22typedef.nc", 54))->mArrayNum, "22typedef.nc", 54)))>0||((struct sType* )come_null_checker(type, "22typedef.nc", 54))->mAtomic) {
            map$2char$phbuffer$ph_insert(((struct map$2char$phbuffer$ph*)come_null_checker(((struct sInfo* )come_null_checker(info, "22typedef.nc", 55))->struct_definition, "22typedef.nc", 55)),(char* )come_increment_ref_count(__builtin_string(type_name)),(struct buffer* )come_increment_ref_count(charp_to_buffer(((const char*)come_null_checker("typedef __builtin_va_list __darwin_va_list;\n", "22typedef.nc", 55)))),(_Bool)0);
        }
        else {
            map$2char$phbuffer$ph_insert(((struct map$2char$phbuffer$ph*)come_null_checker(((struct sInfo* )come_null_checker(info, "22typedef.nc", 58))->typedef_definition, "22typedef.nc", 58)),(char* )come_increment_ref_count(__builtin_string(type_name)),(struct buffer* )come_increment_ref_count(charp_to_buffer(((const char*)come_null_checker("typedef __builtin_va_list __darwin_va_list;\n", "22typedef.nc", 58)))),(_Bool)0);
        }
...
static struct list$1tuple2$2sType$phchar$ph$ph* list$1tuple2$2sType$phchar$ph$ph$p_clone(struct list$1tuple2$2sType$phchar$ph$ph* self)
{
    ...
    result=(struct list$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(list$1tuple2$2sType$phchar$ph$ph_initialize((struct list$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(((struct list$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list$1tuple2$2sType$phchar$ph$ph*)come_calloc(1, sizeof(struct list$1tuple2$2sType$phchar$ph$ph)*(1), (void*)0, 1386, "struct list$1tuple2$2sType$phchar$ph$ph*"))), "/usr/local/include/neo-c.h", 1386)))));
    come_call_finalizer(list$1tuple2$2sType$phchar$ph$ph$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    it=((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1388))->head;
    while(it!=((void*)0)) {
        if(1) {
            list$1tuple2$2sType$phchar$ph$ph_add(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(result, "/usr/local/include/neo-c.h", 1391)),(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(tuple2$2sType$phchar$ph_clone(((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(it, "/usr/local/include/neo-c.h", 1391))->item)));
        }
        else {
            list$1tuple2$2sType$phchar$ph$ph_add(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(result, "/usr/local/include/neo-c.h", 1394)),(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(tuple2$2sType$phchar$ph_clone(((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(it, "/usr/local/include/neo-c.h", 1394))->item)));
        }
        it=((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(it, "/usr/local/include/neo-c.h", 1397))->next;
    }
...
static void list$1tuple2$2sType$phchar$ph$ph$p_finalize(struct list$1tuple2$2sType$phchar$ph$ph* self)
{
    ...
    it=((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1375))->head;
    while(it!=((void*)0)) {
        prev_it=it;
        it=((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(it, "/usr/local/include/neo-c.h", 1378))->next;
...
static void list_item$1tuple2$2sType$phchar$ph$ph$p_finalize(struct list_item$1tuple2$2sType$phchar$ph$ph* self)
{
    ...
    if(self!=((void*)0)&&((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "list_item$1tuple2$2sType$phchar$ph$ph$p_finalize", 0))->item!=((void*)0)) {
        come_call_finalizer(tuple2$2sType$phchar$ph$p_finalize, ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "list_item$1tuple2$2sType$phchar$ph$ph$p_finalize", 0))->item, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    neo_current_frame = fr.prev;
}
...
static struct list$1tuple2$2sType$phchar$ph$ph* list$1tuple2$2sType$phchar$ph$ph_initialize(struct list$1tuple2$2sType$phchar$ph$ph* self)
{
    ...
    struct list$1tuple2$2sType$phchar$ph$ph* __result_obj__0;
    ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1354))->head=((void*)0);
    ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1355))->tail=((void*)0);
    ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1356))->len=0;
...
static struct list$1tuple2$2sType$phchar$ph$ph* list$1tuple2$2sType$phchar$ph$ph_add(struct list$1tuple2$2sType$phchar$ph$ph* self, struct tuple2$2sType$phchar$ph* item)
{
    ...
    if(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1406))->len==0) {
        litem=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), (void*)0, 1407, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem, "/usr/local/include/neo-c.h", 1409))->prev=((void*)0);
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem, "/usr/local/include/neo-c.h", 1410))->next=((void*)0);
        __dec_obj36=((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem, "/usr/local/include/neo-c.h", 1411))->item,
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem, "/usr/local/include/neo-c.h", 1411))->item=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple2$2sType$phchar$ph$p_finalize, __dec_obj36,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1413))->tail=litem;
        ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1414))->head=litem;
    }
    else if(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1416))->len==1) {
        litem_8=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), (void*)0, 1417, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_8, "/usr/local/include/neo-c.h", 1419))->prev=((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1419))->head;
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_8, "/usr/local/include/neo-c.h", 1420))->next=((void*)0);
        __dec_obj37=((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_8, "/usr/local/include/neo-c.h", 1421))->item,
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_8, "/usr/local/include/neo-c.h", 1421))->item=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple2$2sType$phchar$ph$p_finalize, __dec_obj37,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1423))->tail=litem_8;
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1424))->head, "/usr/local/include/neo-c.h", 1424))->next=litem_8;
    }
    else {
        litem_9=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), (void*)0, 1427, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_9, "/usr/local/include/neo-c.h", 1429))->prev=((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1429))->tail;
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_9, "/usr/local/include/neo-c.h", 1430))->next=((void*)0);
        __dec_obj38=((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_9, "/usr/local/include/neo-c.h", 1431))->item,
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_9, "/usr/local/include/neo-c.h", 1431))->item=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple2$2sType$phchar$ph$p_finalize, __dec_obj38,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1433))->tail, "/usr/local/include/neo-c.h", 1433))->next=litem_9;
        ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1434))->tail=litem_9;
    }
    ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1437))->len++;
    __result_obj__0 = self;
    come_call_finalizer(tuple2$2sType$phchar$ph$p_finalize, item, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    neo_current_frame = fr.prev;
    return __result_obj__0;
...
static struct tuple2$2sType$phchar$ph* tuple2$2sType$phchar$ph_clone(struct tuple2$2sType$phchar$ph* self)
{
    ...
    if(self!=((void*)0)&&((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "tuple2$2sType$phchar$ph_clone", 4))->v1!=((void*)0)) {
        __dec_obj39=((struct tuple2$2sType$phchar$ph*)come_null_checker(result, "tuple2$2sType$phchar$ph_clone", 4))->v1,
        ((struct tuple2$2sType$phchar$ph*)come_null_checker(result, "tuple2$2sType$phchar$ph_clone", 4))->v1=(struct sType* )come_increment_ref_count(sType_clone(((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "tuple2$2sType$phchar$ph_clone", 4))->v1));
        come_call_finalizer(sType_finalize, __dec_obj39,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    if(self!=((void*)0)&&((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "tuple2$2sType$phchar$ph_clone", 5))->v2!=((void*)0)) {
        __dec_obj40=((struct tuple2$2sType$phchar$ph*)come_null_checker(result, "tuple2$2sType$phchar$ph_clone", 5))->v2,
        ((struct tuple2$2sType$phchar$ph*)come_null_checker(result, "tuple2$2sType$phchar$ph_clone", 5))->v2=(char* )come_increment_ref_count((char* )come_memdup(((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "tuple2$2sType$phchar$ph_clone", 5))->v2, "tuple2$2sType$phchar$ph_clone", 5, "char* "));
...
static void tuple2$2sType$phchar$ph_finalize(struct tuple2$2sType$phchar$ph* self)
{
    ...
    if(self!=((void*)0)&&((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "tuple2$2sType$phchar$ph_finalize", 0))->v1!=((void*)0)) {
        come_call_finalizer(sType_finalize, ((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "tuple2$2sType$phchar$ph_finalize", 0))->v1, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    if(self!=((void*)0)&&((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "tuple2$2sType$phchar$ph_finalize", 1))->v2!=((void*)0)) {
        (((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "tuple2$2sType$phchar$ph_finalize", 1))->v2 = come_decrement_ref_count(((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "tuple2$2sType$phchar$ph_finalize", 1))->v2, (void*)0, (void*)0, 0, 0, (void*)0));
    }
    neo_current_frame = fr.prev;
}
...
static void sTypedefNode_finalize(struct sTypedefNode* self)
{
    ...
    if(self!=((void*)0)&&((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_finalize", 0))->sname!=((void*)0)) {
        (((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_finalize", 0))->sname = come_decrement_ref_count(((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_finalize", 0))->sname, (void*)0, (void*)0, 0, 0, (void*)0));
    }
    if(self!=((void*)0)&&((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_finalize", 1))->mTypeName!=((void*)0)) {
        (((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_finalize", 1))->mTypeName = come_decrement_ref_count(((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_finalize", 1))->mTypeName, (void*)0, (void*)0, 0, 0, (void*)0));
    }
    if(self!=((void*)0)&&((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_finalize", 2))->mType!=((void*)0)) {
        come_call_finalizer(sType_finalize, ((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_finalize", 2))->mType, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    if(self!=((void*)0)&&((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_finalize", 3))->multiple_declare!=((void*)0)) {
        come_call_finalizer(list$1tuple2$2sType$phchar$ph$ph$p_finalize, ((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_finalize", 3))->multiple_declare, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    neo_current_frame = fr.prev;
}
    ...
    for(it=map$2char$phsClass$ph_begin(((struct map$2char$phsClass$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2664)));!map$2char$phsClass$ph_end(((struct map$2char$phsClass$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2664)));it=map$2char$phsClass$ph_next(((struct map$2char$phsClass$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2664)))){
        ...
        while((_Bool)1) {
            if(((_Bool*)come_null_checker(item_existance, "/usr/local/include/neo-c.h", 2672))[n]) {
                ...
                ((struct sClass** )come_null_checker(items, "/usr/local/include/neo-c.h", 2690))[n]=((struct sClass* )(__right_value0=map$2char$phsClass$ph_at(((struct map$2char$phsClass$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2690)),it,(struct sClass* )come_increment_ref_count(default_value_12),(_Bool)0)));
                len++;
...
static struct list$1char$ph* list$1char$ph_delete(struct list$1char$ph* self, int head, int tail)
{
    ...
    if(head==0&&tail==((struct list$1char$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1787))->len) {
        ...
        it_13=((struct list$1char$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1817))->head;
        i_14=0;
        while(it_13!=((void*)0)) {
            if(i_14==head) {
                ((struct list$1char$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1821))->tail=((struct list_item$1char$ph*)come_null_checker(it_13, "/usr/local/include/neo-c.h", 1821))->prev;
            ...
            if(i_14>=head) {
                prev_it_15=it_13;
                it_13=((struct list_item$1char$ph*)come_null_checker(it_13, "/usr/local/include/neo-c.h", 1828))->next;
                i_14++;
                ...
                it_13=((struct list_item$1char$ph*)come_null_checker(it_13, "/usr/local/include/neo-c.h", 1836))->next;
                i_14++;
            }
        }
    }
    else {
        it_16=((struct list$1char$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1842))->head;
        head_prev_it=((void*)0);
        tail_it=((void*)0);
        i_17=0;
        while(it_16!=((void*)0)) {
            if(i_17==head) {
                head_prev_it=((struct list_item$1char$ph*)come_null_checker(it_16, "/usr/local/include/neo-c.h", 1851))->prev;
            }
            if(i_17==tail) {
                tail_it=it_16;
            }
            if(i_17>=head&&i_17<tail) {
                prev_it_18=it_16;
                it_16=((struct list_item$1char$ph*)come_null_checker(it_16, "/usr/local/include/neo-c.h", 1861))->next;
                i_17++;
                ...
                it_16=((struct list_item$1char$ph*)come_null_checker(it_16, "/usr/local/include/neo-c.h", 1869))->next;
                i_17++;
            }
        }
...
static struct list$1char$ph* list$1char$ph_push_back(struct list$1char$ph* self, char*  item  )
{
    ...
    if(((struct list$1char$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1491))->len==0) {
        ...
        __dec_obj43=((struct list_item$1char$ph*)come_null_checker(litem_21, "/usr/local/include/neo-c.h", 1506))->item,
        ...
        __dec_obj44=((struct list_item$1char$ph*)come_null_checker(litem_22, "/usr/local/include/neo-c.h", 1516))->item,
    ...
    for(it=map$2char$phsType$ph_begin(((struct map$2char$phsType$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2664)));!map$2char$phsType$ph_end(((struct map$2char$phsType$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2664)));it=map$2char$phsType$ph_next(((struct map$2char$phsType$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2664)))){
        ...
        while((_Bool)1) {
            if(((_Bool*)come_null_checker(item_existance, "/usr/local/include/neo-c.h", 2672))[n]) {
                ...
                ((struct sType** )come_null_checker(items, "/usr/local/include/neo-c.h", 2690))[n]=((struct sType* )(__right_value0=map$2char$phsType$ph_at(((struct map$2char$phsType$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2690)),it,(struct sType* )come_increment_ref_count(default_value_25),(_Bool)0)));
                len++;
    ...
    for(it=map$2char$phbuffer$ph_begin(((struct map$2char$phbuffer$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2664)));!map$2char$phbuffer$ph_end(((struct map$2char$phbuffer$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2664)));it=map$2char$phbuffer$ph_next(((struct map$2char$phbuffer$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2664)))){
        ...
        while((_Bool)1) {
            if(((_Bool*)come_null_checker(item_existance, "/usr/local/include/neo-c.h", 2672))[n]) {
                ...
                ((struct buffer** )come_null_checker(items, "/usr/local/include/neo-c.h", 2690))[n]=((struct buffer* )(__right_value0=map$2char$phbuffer$ph_at(((struct map$2char$phbuffer$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2690)),it,(struct buffer* )come_increment_ref_count(default_value_28),(_Bool)0)));
                len++;
...
static struct tuple2$2sType$phchar$ph* list$1tuple2$2sType$phchar$ph$ph_begin(struct list$1tuple2$2sType$phchar$ph$ph* self)
{
    ...
    ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1560))->it=((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1560))->head;
    if(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1562))->it) {
        __result_obj__0 = ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1563))->it, "/usr/local/include/neo-c.h", 1563))->item;
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
...
static _Bool list$1tuple2$2sType$phchar$ph$ph_end(struct list$1tuple2$2sType$phchar$ph$ph* self)
{
    ...
    neo_current_frame = fr.prev;
    return self==((void*)0)||((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1590))->it==((void*)0);
    neo_current_frame = fr.prev;
}
...
static struct tuple2$2sType$phchar$ph* list$1tuple2$2sType$phchar$ph$ph_next(struct list$1tuple2$2sType$phchar$ph$ph* self)
{
    ...
    if(self==((void*)0)||((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1572))->it==((void*)0)) {
        memset(&result,0,sizeof(struct tuple2$2sType$phchar$ph*));
        __result_obj__0 = result;
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1578))->it=((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1578))->it, "/usr/local/include/neo-c.h", 1578))->next;
    if(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1580))->it) {
        __result_obj__0 = ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1581))->it, "/usr/local/include/neo-c.h", 1581))->item;
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
...
static struct tuple2$2sType$phchar$ph* tuple2$2sType$phchar$ph_initialize(struct tuple2$2sType$phchar$ph* self, struct sType*  v1  , char*  v2  )
{
    ...
    char*  __dec_obj49  ;
    struct tuple2$2sType$phchar$ph* __result_obj__0;
    __dec_obj48=((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 3248))->v1,
    ...
    __dec_obj49=((struct tuple2$2sType$phchar$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 3249))->v2,
...
static struct list$1tuple2$2sType$phchar$ph$ph* list$1tuple2$2sType$phchar$ph$ph_push_back(struct list$1tuple2$2sType$phchar$ph$ph* self, struct tuple2$2sType$phchar$ph* item)
{
    ...
    if(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1491))->len==0) {
        litem=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), (void*)0, 1492, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem, "/usr/local/include/neo-c.h", 1494))->prev=((void*)0);
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem, "/usr/local/include/neo-c.h", 1495))->next=((void*)0);
        __dec_obj50=((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem, "/usr/local/include/neo-c.h", 1496))->item,
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem, "/usr/local/include/neo-c.h", 1496))->item=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple2$2sType$phchar$ph_finalize, __dec_obj50,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1498))->tail=litem;
        ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1499))->head=litem;
    }
    else if(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1501))->len==1) {
        litem_34=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), (void*)0, 1502, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_34, "/usr/local/include/neo-c.h", 1504))->prev=((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1504))->head;
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_34, "/usr/local/include/neo-c.h", 1505))->next=((void*)0);
        __dec_obj51=((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_34, "/usr/local/include/neo-c.h", 1506))->item,
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_34, "/usr/local/include/neo-c.h", 1506))->item=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple2$2sType$phchar$ph_finalize, __dec_obj51,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1508))->tail=litem_34;
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1509))->head, "/usr/local/include/neo-c.h", 1509))->next=litem_34;
    }
    else {
        litem_35=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), (void*)0, 1512, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_35, "/usr/local/include/neo-c.h", 1514))->prev=((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1514))->tail;
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_35, "/usr/local/include/neo-c.h", 1515))->next=((void*)0);
        __dec_obj52=((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_35, "/usr/local/include/neo-c.h", 1516))->item,
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(litem_35, "/usr/local/include/neo-c.h", 1516))->item=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple2$2sType$phchar$ph_finalize, __dec_obj52,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        ((struct list_item$1tuple2$2sType$phchar$ph$ph*)come_null_checker(((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1518))->tail, "/usr/local/include/neo-c.h", 1518))->next=litem_35;
        ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1519))->tail=litem_35;
    }
    ((struct list$1tuple2$2sType$phchar$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1522))->len++;
    __result_obj__0 = self;
    come_call_finalizer(tuple2$2sType$phchar$ph$p_finalize, item, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    neo_current_frame = fr.prev;
    return __result_obj__0;
...
static struct sTypedefNode* sTypedefNode_clone(struct sTypedefNode* self)
{
    ...
    if(self!=((void*)0)) {
        ((struct sTypedefNode* )come_null_checker(result, "sTypedefNode_clone", 4))->sline=((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_clone", 4))->sline;
    }
    if(self!=((void*)0)&&((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_clone", 5))->sname!=((void*)0)) {
        __dec_obj53=((struct sTypedefNode* )come_null_checker(result, "sTypedefNode_clone", 5))->sname,
        ((struct sTypedefNode* )come_null_checker(result, "sTypedefNode_clone", 5))->sname=(char* )come_increment_ref_count((char* )come_memdup(((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_clone", 5))->sname, "sTypedefNode_clone", 5, "char* "));
        __dec_obj53 = come_decrement_ref_count(__dec_obj53, (void*)0, (void*)0, 0,0, (void*)0);
    }
    if(self!=((void*)0)) {
        ((struct sTypedefNode* )come_null_checker(result, "sTypedefNode_clone", 6))->sline_real=((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_clone", 6))->sline_real;
    }
    if(self!=((void*)0)&&((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_clone", 7))->mTypeName!=((void*)0)) {
        __dec_obj54=((struct sTypedefNode* )come_null_checker(result, "sTypedefNode_clone", 7))->mTypeName,
        ((struct sTypedefNode* )come_null_checker(result, "sTypedefNode_clone", 7))->mTypeName=(char* )come_increment_ref_count((char* )come_memdup(((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_clone", 7))->mTypeName, "sTypedefNode_clone", 7, "char* "));
        __dec_obj54 = come_decrement_ref_count(__dec_obj54, (void*)0, (void*)0, 0,0, (void*)0);
    }
    if(self!=((void*)0)&&((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_clone", 8))->mType!=((void*)0)) {
        __dec_obj55=((struct sTypedefNode* )come_null_checker(result, "sTypedefNode_clone", 8))->mType,
        ((struct sTypedefNode* )come_null_checker(result, "sTypedefNode_clone", 8))->mType=(struct sType* )come_increment_ref_count(sType_clone(((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_clone", 8))->mType));
        come_call_finalizer(sType_finalize, __dec_obj55,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    if(self!=((void*)0)&&((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_clone", 9))->multiple_declare!=((void*)0)) {
        __dec_obj56=((struct sTypedefNode* )come_null_checker(result, "sTypedefNode_clone", 9))->multiple_declare,
        ((struct sTypedefNode* )come_null_checker(result, "sTypedefNode_clone", 9))->multiple_declare=(struct list$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(list$1tuple2$2sType$phchar$ph$ph$p_clone(((struct sTypedefNode*)come_null_checker(self, "sTypedefNode_clone", 9))->multiple_declare));
