...
static struct list$1CVALUE$ph* list$1CVALUE$ph_push_back(struct list$1CVALUE$ph* self, struct CVALUE* item)
{
    ...
    if(self->len==0) {
        ...
        litem_8=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./neo-c.h", 1190, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_9=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./neo-c.h", 1200, "struct list_item$1CVALUE$ph*"))));
...
_conditional_value_X0;})) {
        ...
        if(obj_type&&obj_type->mNoSolvedGenericsType&&list$1sType$ph_length(obj_type->mNoSolvedGenericsType->mGenericsTypes)>0) {
            multiple_assign_var2=((struct tuple2$2char$phsGenericsFun$p*)(__right_value1=make_generics_function((struct sType*)come_increment_ref_count(obj_type),(char*)come_increment_ref_count(__builtin_string(fun_name)),info,1)));
            ...
            multiple_assign_var4=((struct tuple2$2char$phsGenericsFun$p*)(__right_value1=make_generics_function((struct sType*)come_increment_ref_count(obj_type),(char*)come_increment_ref_count(__builtin_string(fun_name)),info,1)));
    ...
    if(!no_infference_method_generics) {
        ...
        if(generics_fun) {
            ...
            if(method_generics&&list$1sType$ph_length(info->method_generics_types)==0) {
                multiple_assign_var7=((struct tuple2$2char$phsGenericsFun$p*)(__right_value1=make_generics_function((struct sType*)come_increment_ref_count(type),(char*)come_increment_ref_count(__builtin_string(fun_name)),info,1)));
                ...
                if(method_block) {
                    ...
                    for(o2_saved_53=(struct list$1tuple2$2char$phsNode$ph$ph*)come_increment_ref_count(params),it_54=list$1tuple2$2char$phsNode$ph$ph_begin(o2_saved_53);!list$1tuple2$2char$phsNode$ph$ph_end(o2_saved_53);it_54=list$1tuple2$2char$phsNode$ph$ph_next(o2_saved_53)){
                        ...
                        if(i_52==0) {
                            ...
                            __dec_obj75=come_value_58->type,
    ...
    if(klass->mProtocol&&calling_dynamic_method) {
        ...
        for(o2_saved_70=(struct list$1tuple2$2char$phsNode$ph$ph*)come_increment_ref_count(params),it_71=list$1tuple2$2char$phsNode$ph$ph_begin(o2_saved_70);!list$1tuple2$2char$phsNode$ph$ph_end(o2_saved_70);it_71=list$1tuple2$2char$phsNode$ph$ph_next(o2_saved_70)){
            ...
            if(i_69==0) {
                ...
                __dec_obj76=come_value_75->type,
...
_conditional_value_X0;})) {
        ...
        for(o2_saved_95=(struct list$1tuple2$2char$phsNode$ph$ph*)come_increment_ref_count(params),it_96=list$1tuple2$2char$phsNode$ph$ph_begin(o2_saved_95);!list$1tuple2$2char$phsNode$ph$ph_end(o2_saved_95);it_96=list$1tuple2$2char$phsNode$ph$ph_next(o2_saved_95)){
            ...
            if(first_param) {
                ...
                __dec_obj85=come_value_105->type,
...
_conditional_value_X5;})) {
                ...
                __dec_obj87=come_value_115->type,
...
_conditional_value_X9;})) {
                    ...
                    __dec_obj90=come_value_119->type,
...
_conditional_value_X12;})) {
        ...
        __dec_obj92=come_value2_129->c_value,
        ...
        __dec_obj93=come_value2_129->type,
        ...
        __dec_obj94=come_value2_129->c_value,
...
static struct list$1sType$ph* list$1sType$ph_push_back(struct list$1sType$ph* self, struct sType* item)
{
    ...
    if(self->len==0) {
        ...
        litem_37=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./neo-c.h", 1190, "struct list_item$1sType$ph*"))));
        ...
        litem_38=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./neo-c.h", 1200, "struct list_item$1sType$ph*"))));
...
static struct list$1CVALUE$ph* list$1CVALUE$ph_add(struct list$1CVALUE$ph* self, struct CVALUE* item)
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./neo-c.h", 1095, "struct list_item$1CVALUE$ph*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        ...
        litem_93=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./neo-c.h", 1105, "struct list_item$1CVALUE$ph*"))));
        litem_93->prev=self->head;
        litem_93->next=((void*)0);
        __dec_obj83=litem_93->item,
        ...
        litem_94=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./neo-c.h", 1115, "struct list_item$1CVALUE$ph*"))));
        litem_94->prev=self->tail;
        litem_94->next=((void*)0);
        __dec_obj84=litem_94->item,
