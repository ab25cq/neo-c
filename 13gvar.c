...
;    struct sType* result_type  =0;
    ...
    multiple_declare=0;
    {
        ...
        if(xisalpha(*info->p)||*info->p==95) {
            ...
            multiple_assign_var3=(come_push_stackframe("13gvar.nc", 139, 1),__exception_result_var_b2=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b2);
    ...
    if(multiple_declare) {
        ...
        skip_spaces_and_lf(info);
        multiple_assign_var5=(come_push_stackframe("13gvar.nc", 181, 3),__exception_result_var_b4=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b4);
        ...
        info->no_output_come_code=1;
        skip_spaces_and_lf(info);
        multiple_assign_var8=(come_push_stackframe("13gvar.nc", 291, 5),__exception_result_var_b6=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b6);
