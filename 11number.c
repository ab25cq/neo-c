...
_Bool sIntNode_compile(struct sIntNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "11number.nc", 22, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sUIntNode_compile(struct sUIntNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "11number.nc", 52, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sLongNode_compile(struct sLongNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "11number.nc", 82, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sULongNode_compile(struct sULongNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "11number.nc", 112, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sFloatNode_compile(struct sFloatNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "11number.nc", 142, "struct sType*")),(char*)come_increment_ref_count(xsprintf("float")),0,info,0));
...
_Bool sComplexNode_compile(struct sComplexNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "11number.nc", 172, "struct sType*")),(char*)come_increment_ref_count(xsprintf("double")),0,info,0));
...
_Bool sDoubleNode_compile(struct sDoubleNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "11number.nc", 202, "struct sType*")),(char*)come_increment_ref_count(xsprintf("double")),0,info,0));
...
_Bool sDigitNode_compile(struct sDigitNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "11number.nc", 232, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
