...
_Bool __result_obj__19;
    ...
    come_value->type=(struct sType*)come_increment_ref_count((come_push_stackframe("05number.c", 172, 10),__exception_result_var_b11=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "05number.c", 172, "struct sType*")),(char*)come_increment_ref_count(xsprintf("double")),0,info,0), come_pop_stackframe(), __exception_result_var_b11));
