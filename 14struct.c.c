...
right_value189 = (void*)0;
    ...
    if(_if_conditional245=map$2charphsClassph_at(info->classes,name_195,((void*)0))==((void*)0),    _if_conditional245) {
        ...
        if(_if_conditional247=list$1tuple2$2charphsTypephph_length(map$2charphsClassph_at(info->classes,name_195,((void*)0))->mFields)==0&&list$1tuple2$2charphsTypephph_length(klass_194->mFields)>0,        _if_conditional247) {
...
right_value177 = (void*)0;
        ...
        if(_if_conditional222=self!=((void*)0)&&self->mFields!=((void*)0),        _if_conditional222) {
        ...
        if(_if_conditional241=self!=((void*)0)&&self->mParentClassName!=((void*)0),        _if_conditional241) {
...
memset(&it2_218, 0, sizeof(char*));
        if(_if_conditional248=self->len*10>=self->size,        _if_conditional248) {
            map$2charphsTypeph_rehash(self);
        }
        hash_215=string_get_hash_key(key)%self->size;
        it_216=hash_215;
        while(_while_condtional34=(_Bool)1,        _while_condtional34) {
            if(_if_conditional260=self->item_existance[it_216],            _if_conditional260) {
                if(_if_conditional261=string_equals(self->keys[it_216],key),                _if_conditional261) {
                ...
                it_216++;
                if(_if_conditional264=it_216>=self->size,                _if_conditional264) {
                    it_216=0;
                }
                else {
                    if(_if_conditional265=it_216==hash_215,                    _if_conditional265) {
                        printf("unexpected error in map.insert\n");
                        stackframe();
                        exit(2);
                    }
        ...
        for(        it2_218=list$1charp_begin(self->key_list);        !list$1charp_end(self->key_list);        it2_218=list$1charp_next(self->key_list)        ){
            if(_if_conditional268=string_equals(it2_218,key),            _if_conditional268) {
                same_key_exist_217=(_Bool)1;
            }
        }
        if(_if_conditional269=!same_key_exist_217,        _if_conditional269) {
            list$1charp_push_back(self->key_list,key);
        }
...
memset(&default_value_214, 0, sizeof(struct sType*));
                ...
                for(                it_205=map$2charphsTypeph_begin(self);                !map$2charphsTypeph_end(self);                it_205=map$2charphsTypeph_next(self)                ){
                    ...
                    while(_while_condtional33=(_Bool)1,                    _while_condtional33) {
                        if(_if_conditional257=item_existance_201[n_213],                        _if_conditional257) {
                            n_213++;
                            if(_if_conditional258=n_213>=size_198,                            _if_conditional258) {
                                n_213=0;
                            }
                            else {
                                if(_if_conditional259=n_213==hash_212,                                _if_conditional259) {
                                    printf("unexpected error in map.rehash(1)\n");
                                    stackframe();
                                    exit(2);
                                }
...
memset(&it_210, 0, sizeof(unsigned int));
                        ...
                        while(_while_condtional32=(_Bool)1,                        _while_condtional32) {
                            if(_if_conditional253=self->item_existance[it_210],                            _if_conditional253) {
                                if(_if_conditional254=string_equals(self->keys[it_210],key),                                _if_conditional254) {
                                    __result151__ = __result_obj__ = self->items[it_210];
                                    come_call_finalizer3(default_value,sType_finalize, 0, 0, 1, 0, (void*)0);
                                    return __result151__;
                                }
                                it_210++;
                                if(_if_conditional255=it_210>=self->size,                                _if_conditional255) {
                                    it_210=0;
                                }
                                else {
                                    if(_if_conditional256=it_210==hash_209,                                    _if_conditional256) {
...
right_value198 = (void*)0;
    ...
    if(_if_conditional274=map$2charphsClassph_at(info->classes,name_219,((void*)0))==((void*)0),    _if_conditional274) {
    ...
    if(_if_conditional275=info->output_header_file&&string_operator_not_equals(klass_220->mDeclareSName,info->base_sname),    _if_conditional275) {
    }
    else {
...
memset(&it_229, 0, sizeof(struct sNode*));
    ...
    if(_if_conditional281=map$2charphsClassph_at(info->classes,name_223,((void*)0))==((void*)0),    _if_conditional281) {
        ...
        if(_if_conditional282=list$1tuple2$2charphsTypephph_length(map$2charphsClassph_at(info->classes,name_223,((void*)0))->mFields)==0&&list$1tuple2$2charphsTypephph_length(klass_222->mFields)>0,        _if_conditional282) {
    ...
    for(    o2_saved_226=(struct list$1sNodeph*)come_increment_ref_count((self->mMethods)),it_229=list$1sNodeph_begin((o2_saved_226));    !list$1sNodeph_end((o2_saved_226));    it_229=list$1sNodeph_next((o2_saved_226))    ){
        if(_if_conditional288=!node_compile(it_229,info),        _if_conditional288) {
...
right_value239 = (void*)0;
    if(_if_conditional289=map$2charphsClassph_at(info->classes,type_name,((void*)0))==((void*)0),    _if_conditional289) {
        output_233=(_Bool)1;
        ...
        if(_if_conditional290=list$1tuple2$2charphsTypephph_length(klass_232->mFields)>0,        _if_conditional290) {
            output_233=(_Bool)0;
        }
    }
    list$1tuple2$2charphsTypephph_reset(klass_232->mFields);
    parent_class_236=((void*)0);
    if(_if_conditional291=parsecmp("extends",info),    _if_conditional291) {
        ...
        if(_if_conditional292=parent_class_236==((void*)0),        _if_conditional292) {
    ...
    while(_while_condtional36=(_Bool)1,    _while_condtional36) {
        multiple_declare_238=(_Bool)0;
        {
            ...
            if(_if_conditional295=err_243&&*info->p==44,            _if_conditional295) {
        ...
        if(multiple_declare_238) {
            ...
            if(_if_conditional299=!info->no_output_err,            _if_conditional299) {
                list$1tuple2$2charphsTypephph_push_back(klass_232->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value223=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value222=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "14struct.c", 501, "struct tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name2_248),(struct sType*)come_increment_ref_count(type2_247))))));
            ...
            while(_while_condtional37=*info->p==44,            _while_condtional37) {
                ...
                if(_if_conditional300=!info->no_output_err,                _if_conditional300) {
                    list$1tuple2$2charphsTypephph_push_back(klass_232->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value226=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value225=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "14struct.c", 511, "struct tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name2_250),(struct sType*)come_increment_ref_count(type2_249))))));
            ...
            if(_if_conditional301=!err_253,            _if_conditional301) {
                printf("%s %d: parse_type failed\n",info->sname,info->sline);
                exit(2);
            }
            if(_if_conditional302=!info->no_output_err,            _if_conditional302) {
                list$1tuple2$2charphsTypephph_push_back(klass_232->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value229=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value228=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "14struct.c", 524, "struct tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name_252),(struct sType*)come_increment_ref_count(type2_251))))));
        ...
        parse_sharp_v5(info);
        if(_if_conditional303=*info->p==125,        _if_conditional303) {
            info->p++;
            skip_spaces_and_lf(info);
            break;
        }
...
right_value387 = (void*)0;
    if(_if_conditional314=charp_operator_equals(buf,"struct"),    _if_conditional314) {
        ...
        if(_if_conditional315=*info->p==59,        _if_conditional315) {
            info->p++;
            skip_spaces_and_lf(info);
            if(_if_conditional316=map$2charphsClassph_at(info->classes,type_name_256,((void*)0))==((void*)0),            _if_conditional316) {
            ...
            if(_if_conditional325=*info->p==60,            _if_conditional325) {
                ...
                while(_while_condtional39=(_Bool)1,                _while_condtional39) {
                    ...
                    if(_if_conditional328=*info->p==62,                    _if_conditional328) {
                        info->p++;
                        skip_spaces_and_lf(info);
                ...
                while(_while_condtional40=(_Bool)1,                _while_condtional40) {
                    ...
                    if(_if_conditional333=*info->p==44,                    _if_conditional333) {
                        ...
                        list$1tuple2$2charphsTypephph_push_back(generics_class_267->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value270=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value269=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "14struct.c", 654, "struct tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name_269),(struct sType*)come_increment_ref_count(type2_268))))));
                    ...
                    parse_sharp_v5(info);
                    if(_if_conditional335=*info->p==125,                    _if_conditional335) {
                        info->p++;
                        skip_spaces_and_lf(info);
                ...
                output_278=(_Bool)1;
                if(_if_conditional340=map$2charphsClassph_at(info->classes,type_name_256,((void*)0))==((void*)0),                _if_conditional340) {
                    ...
                    if(_if_conditional341=list$1tuple2$2charphsTypephph_length(struct_class_279->mFields)>0,                    _if_conditional341) {
                        output_278=(_Bool)0;
                    }
                }
                parent_class_280=((void*)0);
                if(_if_conditional342=parsecmp("extends",info),                _if_conditional342) {
                    ...
                    if(_if_conditional343=parent_class_280==((void*)0),                    _if_conditional343) {
                ...
                while(_while_condtional42=(_Bool)1,                _while_condtional42) {
                    ...
                    multiple_declare_282=(_Bool)0;
                    {
                        ...
                        if(_if_conditional344=err_287&&*info->p==44,                        _if_conditional344) {
                    ...
                    if(multiple_declare_282) {
                        ...
                        list$1tuple2$2charphsTypephph_push_back(struct_class_279->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value288=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value287=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "14struct.c", 734, "struct tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name2_292),(struct sType*)come_increment_ref_count(type2_291))))));
                        ...
                        while(_while_condtional43=*info->p==44,                        _while_condtional43) {
                            ...
                            list$1tuple2$2charphsTypephph_push_back(struct_class_279->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value291=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value290=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "14struct.c", 742, "struct tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name2_294),(struct sType*)come_increment_ref_count(type2_293))))));
                        ...
                        if(_if_conditional346=!err_297,                        _if_conditional346) {
                            printf("%s %d: parse_type failed\n",info->sname,info->sline);
                            exit(2);
                        }
                        list$1tuple2$2charphsTypephph_push_back(struct_class_279->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value294=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value293=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "14struct.c", 752, "struct tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name_296),(struct sType*)come_increment_ref_count(type2_295))))));
                    ...
                    parse_sharp_v5(info);
                    if(_if_conditional347=*info->p==125,                    _if_conditional347) {
                        info->p++;
                        skip_spaces_and_lf(info);
                        break;
                    }
                ...
                if(_if_conditional348=klass2_298==((void*)0)||klass2_298->mNobodyStruct,                _if_conditional348) {
                    if(klass2_298) {
        ...
        if(_if_conditional360=charp_operator_equals(buf,"class"),        _if_conditional360) {
            ...
            if(_if_conditional361=parsecmp("extends",info),            _if_conditional361) {
                ...
                if(_if_conditional362=parent_class_304==((void*)0),                _if_conditional362) {
            ...
            if(_if_conditional366=map$2charphsClassph_at(info->classes,type_name_303,((void*)0))==((void*)0),            _if_conditional366) {
                ...
                struct_class_314=(struct sClass*)come_increment_ref_count(((struct sClass*)(right_value318=sClass_initialize((struct sClass*)come_increment_ref_count(((struct sClass*)(right_value317=(struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), "14struct.c", 826, "sClass")))),type_name_303,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,(_Bool)0,-1,-1,(_Bool)0,info))));
                ...
                if(_if_conditional367=list$1tuple2$2charphsTypephph_length(struct_class_314->mFields)>0,                _if_conditional367) {
                    output_313=(_Bool)0;
                }
            }
            if(_if_conditional368=map$2charphsClassph_at(info->classes,type_name_303,((void*)0))==((void*)0),            _if_conditional368) {
                if(parent_class_304) {
                ...
                if(_if_conditional376=list$1tuple2$2charphsTypephph_length(map$2charphsClassph_at(info->classes,type_name_303,((void*)0))->mFields)==0&&list$1tuple2$2charphsTypephph_length(struct_class_314->mFields)>0,                _if_conditional376) {
            ...
            (come_push_stackframe("14struct.c", 865, 9),__exception_result_var_b7=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b7);
            head_335=info->p;
            p_saved_336=((void*)0);
            sline_saved_337=0;
            sname_saved_338=((void*)0);
            methods_339=(struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value335=list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value334=(struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "14struct.c", 873, "list$1sNodeph"))))))));
            ...
            while(_while_condtional46=(_Bool)1,            _while_condtional46) {
                if(p_saved_336) {
                    if(_if_conditional379=*info->p==0,                    _if_conditional379) {
                        info->p=p_saved_336;
                ...
                if(_if_conditional384=include__344==(_Bool)0,                _if_conditional384) {
                    p_346=info->p;
                    sline_347=info->sline;
                    if(_if_conditional385=memcmp(info->p,"new(",4)!=0,                    _if_conditional385) {
                        ...
                        if(_if_conditional386=err_350&&*info->p==44,                        _if_conditional386) {
                ...
                if(_if_conditional387=include__344==(_Bool)0,                _if_conditional387) {
                    p_352=info->p;
                    sline_353=info->sline;
                    if(_if_conditional388=memcmp(info->p,"new(",4)==0,                    _if_conditional388) {
                        ...
                        word_358=((void*)0);
                        if(_if_conditional390=xisalnum(*info->p)||*info->p==95,                        _if_conditional390) {
                            ...
                            if(_if_conditional391=string_operator_equals(word_358,"extern"),                            _if_conditional391) {
                        ...
                        if(word_358) {
                            if(_if_conditional393=is_type_name(word_358,info),                            _if_conditional393) {
                                while(_while_condtional48=*info->p==42,                                _while_condtional48) {
                                    info->p++;
                                    skip_spaces_and_lf(info);
                                }
                                if(_if_conditional394=*info->p==91&&*(info->p+1)==93,                                _if_conditional394) {
                                    info->p+=2;
                                    skip_spaces_and_lf(info);
                                }
                            ...
                            if(_if_conditional398=strlen(word_358)>0&&(*info->p==40||(*info->p==58&&*(info->p+1)==58)),                            _if_conditional398) {
                                define_function_flag_351=(_Bool)1;
                            }
                        }
                ...
                if(define_function_flag_351) {
                    ...
                    info->impl_type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value343=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value342=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "14struct.c", 976, "sType")))),type_name_303,(_Bool)0,info))));
                    ...
                    if(multiple_declare_345) {
                        ...
                        list$1tuple2$2charphsTypephph_push_back(struct_class_314->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value351=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value350=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "14struct.c", 995, "struct tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name2_369),(struct sType*)come_increment_ref_count(type2_368))))));
                        ...
                        while(_while_condtional49=*info->p==44,                        _while_condtional49) {
                            ...
                            list$1tuple2$2charphsTypephph_push_back(struct_class_314->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value354=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value353=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "14struct.c", 1003, "struct tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name2_371),(struct sType*)come_increment_ref_count(type2_370))))));
                        ...
                        (come_push_stackframe("14struct.c", 1005, 10),__exception_result_var_b8=expected_next_character(59,info), come_pop_stackframe(), __exception_result_var_b8);
                        ...
                        if(_if_conditional403=parsecmp("include",info),                        _if_conditional403) {
                            ...
                            params_373=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value358=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value357=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "14struct.c", 1012, "list$1charph"))))))));
                            ...
                            if(_if_conditional404=*info->p==60,                            _if_conditional404) {
                                info->p++;
                                skip_spaces_and_lf(info);
                            ...
                            if(_if_conditional408=*info->p==59,                            _if_conditional408) {
                                info->p++;
                            }
                            skip_spaces_and_lf(info);
                            p_saved_336=info->p;
                            ...
                            if(_if_conditional417=map$2charphsClassModulephp_operator_load_element(info->modules,module_name_372)==((void*)0),                            _if_conditional417) {
                            ...
                            module_378=((struct sClassModule*)come_null_check(map$2charphsClassModulephp_operator_load_element(info->modules,module_name_372), "14struct.c", 1056, 11));
                            if(_if_conditional419=list$1charph_length(module_378->mParams)!=list$1charph_length(params_373),                            _if_conditional419) {
                                err_msg(info,"invalid parametor number");
                                exit(1);
                            }
                            __dec_obj106=info->module_params;
                            info->module_params=(struct map$2charphcharph*)come_increment_ref_count(((struct map$2charphcharph*)(right_value367=map$2charphcharph_initialize((struct map$2charphcharph*)come_increment_ref_count(((struct map$2charphcharph*)(right_value361=(struct map$2charphcharph*)come_calloc(1, sizeof(struct map$2charphcharph)*(1), "14struct.c", 1063, "map$2charphcharph"))))))));
                            ...
                            for(                            o2_saved_383=(struct list$1charph*)come_increment_ref_count((module_378->mParams)),it_386=list$1charph_begin((o2_saved_383));                            !list$1charph_end((o2_saved_383));                            it_386=list$1charph_next((o2_saved_383))                            ){
                                ((char*)(right_value371=map$2charphcharphp_operator_store_element(info->module_params,it_386,((char*)come_null_check(list$1charphp_operator_load_element(params_373,i_382), "14struct.c", 1067, 12)))));
                            ...
                            if(_if_conditional452=!err_415,                            _if_conditional452) {
                                printf("%s %d: parse_type failed\n",info->sname,info->sline);
                                exit(2);
                            }
                            list$1tuple2$2charphsTypephph_push_back(struct_class_314->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value375=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value374=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "14struct.c", 1081, "struct tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name_414),(struct sType*)come_increment_ref_count(type2_413))))));
                            ...
                            (come_push_stackframe("14struct.c", 1082, 13),__exception_result_var_b9=expected_next_character(59,info), come_pop_stackframe(), __exception_result_var_b9);
...
memset(&__result_obj__, 0, sizeof(void*));
                ...
                if(_if_conditional319=self!=((void*)0)&&self->mClass!=((void*)0),                _if_conditional319) {
...
memset(&__result_obj__, 0, sizeof(void*));
                    ...
                    if(_if_conditional353=self!=((void*)0)&&self->mClass!=((void*)0),                    _if_conditional353) {
                        come_call_finalizer3(self->mClass,sClass_finalize, 0, 0, 0, 0, (void*)0);
                    }
}
...
right_value307 = (void*)0;
                    ...
                    if(_if_conditional358=self!=((void*)0)&&self->mClass!=((void*)0),                    _if_conditional358) {
...
memset(&it_316, 0, sizeof(struct list_item$1sClassp*));
                    result_315=(struct list$1sClassp*)come_increment_ref_count(((struct list$1sClassp*)(right_value323=list$1sClassp_initialize((struct list$1sClassp*)come_increment_ref_count(((struct list$1sClassp*)(right_value322=(struct list$1sClassp*)come_calloc(1, sizeof(struct list$1sClassp)*(1), "./neo-c.h", 943, "list$1sClassp"))))))));
...
memset(&litem_319, 0, sizeof(struct list_item$1sClassp*));
                            if(_if_conditional370=self->len==0,                            _if_conditional370) {
                                litem_317=(struct list_item$1sClassp*)come_increment_ref_count(((struct list_item$1sClassp*)(right_value324=(struct list_item$1sClassp*)come_calloc(1, sizeof(struct list_item$1sClassp)*(1), "./neo-c.h", 221, "list_item$1sClassp"))));
                                ...
                                if(_if_conditional371=self->len==1,                                _if_conditional371) {
                                    litem_318=(struct list_item$1sClassp*)come_increment_ref_count(((struct list_item$1sClassp*)(right_value325=(struct list_item$1sClassp*)come_calloc(1, sizeof(struct list_item$1sClassp)*(1), "./neo-c.h", 231, "list_item$1sClassp"))));
                                    ...
                                    litem_319=(struct list_item$1sClassp*)come_increment_ref_count(((struct list_item$1sClassp*)(right_value326=(struct list_item$1sClassp*)come_calloc(1, sizeof(struct list_item$1sClassp)*(1), "./neo-c.h", 241, "list_item$1sClassp"))));
...
memset(&result_325, 0, sizeof(struct sClass*));
                    if(_if_conditional374=self==((void*)0)||self->it==((void*)0),                    _if_conditional374) {
                        memset(&result_324,0,sizeof(struct sClass*));
...
memset(&i_341, 0, sizeof(int));
                            for(                            i_340=0;                            i_340<self->size;                            i_340++                            ){
                                if(_if_conditional380=self->item_existance[i_340],                                _if_conditional380) {
                            ...
                            for(                            i_341=0;                            i_341<self->size;                            i_341++                            ){
                                if(_if_conditional382=self->item_existance[i_341],                                _if_conditional382) {
...
memset(&litem_364, 0, sizeof(struct list_item$1sNodeph*));
                        if(_if_conditional400=self->len==0,                        _if_conditional400) {
                            litem_362=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value345=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./neo-c.h", 221, "list_item$1sNodeph"))));
                            ...
                            if(_if_conditional401=self->len==1,                            _if_conditional401) {
                                litem_363=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value346=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./neo-c.h", 231, "list_item$1sNodeph"))));
                                ...
                                litem_364=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value347=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./neo-c.h", 241, "list_item$1sNodeph"))));
...
memset(&it_377, 0, sizeof(unsigned int));
                                ...
                                while(_while_condtional51=(_Bool)1,                                _while_condtional51) {
                                    if(_if_conditional409=self->item_existance[it_377],                                    _if_conditional409) {
                                        if(_if_conditional410=string_equals(self->keys[it_377],key),                                        _if_conditional410) {
...
memset(&__result_obj__, 0, sizeof(void*));
                                                ...
                                                if(_if_conditional412=self!=((void*)0)&&self->mText!=((void*)0),                                                _if_conditional412) {
                                                    self->mText = come_decrement_ref_count2(self->mText, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                                                }
                                                if(_if_conditional413=self!=((void*)0)&&self->mParams!=((void*)0),                                                _if_conditional413) {
                                                    come_call_finalizer3(self->mParams,list$1charphp_finalize, 0, 0, 0, 0, (void*)0);
                                                }
                                                if(_if_conditional414=self!=((void*)0)&&self->mSName!=((void*)0),                                                _if_conditional414) {
...
memset(&i_381, 0, sizeof(int));
                                    for(                                    i_380=0;                                    i_380<self->size;                                    i_380++                                    ){
                                        if(_if_conditional420=self->item_existance[i_380],                                        _if_conditional420) {
                                    ...
                                    for(                                    i_381=0;                                    i_381<self->size;                                    i_381++                                    ){
                                        if(_if_conditional422=self->item_existance[i_381],                                        _if_conditional422) {
...
memset(&default_value_391, 0, sizeof(char*));
                                    if(_if_conditional428=position<0,                                    _if_conditional428) {
                                        position+=self->len;
                                    }
                                    it_389=self->head;
                                    i_390=0;
                                    while(_while_condtional52=it_389!=((void*)0),                                    _while_condtional52) {
                                        if(_if_conditional429=position==i_390,                                        _if_conditional429) {
...
memset(&it2_412, 0, sizeof(char*));
                                        ...
                                        while(_while_condtional55=(_Bool)1,                                        _while_condtional55) {
                                            if(_if_conditional442=self->item_existance[it_410],                                            _if_conditional442) {
                                                if(_if_conditional443=string_equals(self->keys[it_410],key),                                                _if_conditional443) {
                                        ...
                                        for(                                        it2_412=list$1charp_begin(self->key_list);                                        !list$1charp_end(self->key_list);                                        it2_412=list$1charp_next(self->key_list)                                        ){
                                            if(_if_conditional450=string_equals(it2_412,key),                                            _if_conditional450) {
                                                same_key_exist_411=(_Bool)1;
                                            }
                                        }
                                        if(_if_conditional451=!same_key_exist_411,                                        _if_conditional451) {
                                            list$1charp_push_back(self->key_list,key);
                                        }
...
memset(&default_value_408, 0, sizeof(char*));
                                                ...
                                                keys_393=(char**)come_increment_ref_count(((char**)(right_value368=(char**)come_calloc(1, sizeof(char*)*(1*(size_392)), "./neo-c.h", 1317, "char*%"))));
                                                right_value368 = come_decrement_ref_count2(right_value368, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                                                items_394=(char**)come_increment_ref_count(((char**)(right_value369=(char**)come_calloc(1, sizeof(char*)*(1*(size_392)), "./neo-c.h", 1318, "char*%"))));
                                                right_value369 = come_decrement_ref_count2(right_value369, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                                                item_existance_395=(_Bool*)come_increment_ref_count(((_Bool*)(right_value370=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_392)), "./neo-c.h", 1319, "bool"))));
                                                ...
                                                for(                                                it_399=map$2charphcharph_begin(self);                                                !map$2charphcharph_end(self);                                                it_399=map$2charphcharph_next(self)                                                ){
                                                    ...
                                                    while(_while_condtional54=(_Bool)1,                                                    _while_condtional54) {
                                                        if(_if_conditional439=item_existance_395[n_407],                                                        _if_conditional439) {
                                                            n_407++;
                                                            if(_if_conditional440=n_407>=size_392,                                                            _if_conditional440) {
                                                                n_407=0;
                                                            }
                                                            else {
                                                                if(_if_conditional441=n_407==hash_406,                                                                _if_conditional441) {
                                                                    printf("unexpected error in map.rehash(1)\n");
                                                                    stackframe();
                                                                    exit(2);
                                                                }
...
memset(&it_404, 0, sizeof(unsigned int));
                                                        ...
                                                        while(_while_condtional53=(_Bool)1,                                                        _while_condtional53) {
                                                            if(_if_conditional435=self->item_existance[it_404],                                                            _if_conditional435) {
                                                                if(_if_conditional436=string_equals(self->keys[it_404],key),                                                                _if_conditional436) {
...
memset(&__result_obj__, 0, sizeof(void*));
                ...
                if(_if_conditional458=self!=((void*)0)&&self->mClass!=((void*)0),                _if_conditional458) {
                    come_call_finalizer3(self->mClass,sClass_finalize, 0, 0, 0, 0, (void*)0);
                }
                if(_if_conditional459=self!=((void*)0)&&self->mMethods!=((void*)0),                _if_conditional459) {
...
right_value385 = (void*)0;
                ...
                if(_if_conditional464=self!=((void*)0)&&self->mClass!=((void*)0),                _if_conditional464) {
                ...
                if(_if_conditional465=self!=((void*)0)&&self->mMethods!=((void*)0),                _if_conditional465) {
...
right_value394 = (void*)0;
    define_struct_417=(_Bool)0;
    {
        ...
        if(_if_conditional467=charp_operator_equals(buf,"struct"),        _if_conditional467) {
            ...
            if(_if_conditional468=parsecmp("extends",info),            _if_conditional468) {
