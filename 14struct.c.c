    ...
    _conditional_value_X3;})    ) {
        ...
        while(        1        ) {
            ...
            if(            define_function_flag            ) {
                ...
                __right_value0 = (void*)0;
                __right_value1 = (void*)0;
                list$1tuple2$2char$phsType$ph$ph_push_back(struct_class_72->mFields,(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph*)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "14struct.c", 1007, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(name_106),(struct sType*)come_increment_ref_count(type2_105))));
                if(                *info->p==59                ) {
                    info->p++;
                    skip_spaces_and_lf(info);
                }
