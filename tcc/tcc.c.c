...
{
struct anonymous_typeX18 __piduid;
struct anonymous_typeX19 __timer;
};
...
{
struct anonymous_typeX21 __piduid;
struct anonymous_typeX22 __timer;
};
...
struct anonymous_typeX24 __sigchld;
};
...
{
union sigval si_value;
struct anonymous_typeX26 __sigchld;
};
struct anonymous_typeX16
{
    union anonymous_typeZ20 __first;
    union anonymous_typeZ25 __second;
};
...
{
struct anonymous_typeX29 __addr_bnd;
...
{
struct anonymous_typeX31 __addr_bnd;
unsigned int si_pkey;
};
struct anonymous_typeX27
{
    ...
    union anonymous_typeZ30 __first;
};
...
struct anonymous_typeX16 __si_common;
struct anonymous_typeX27 __sigfault;
struct anonymous_typeX32 __sigpoll;
struct anonymous_typeX33 __sigsys;
};
...
{
struct anonymous_typeX37 __piduid;
struct anonymous_typeX38 __timer;
};
...
{
union sigval si_value;
struct anonymous_typeX43 __sigchld;
};
...
{
struct anonymous_typeX48 __addr_bnd;
unsigned int si_pkey;
};
...
struct anonymous_typeX56 __sev_thread;
};
...
memset(&p_293, 0, sizeof(const char*));
memset(&c_294, 0, sizeof(int));
memset(&q_296, 0, sizeof(const unsigned char*));
    # 2601 "tccpp.c"
    # 2602 "tccpp.c"
    # 2603 "tccpp.c"
    # 2604 "tccpp.c"
...
memset(&val_209, 0, sizeof(int));
    ...
    if(_if_conditional249=tok==(363),    _if_conditional249) {
        ...
        if(_if_conditional250=tok==(365),        _if_conditional250) {
            ...
            # 1183 "tccpp.c"
            *s1->pack_stack_ptr=/*b*/(void*)val_209;
            # 1184 "tccpp.c"
            skip(41);
        }
    }
...
memset(&path_222, 0, sizeof(const char*));
    ...
    if(_if_conditional311=ch_236==46||((ch_236==101||ch_236==69)&&b_230==10)||((ch_236==112||ch_236==80)&&(b_230==16||b_230==2)),    _if_conditional311) {
        ...
        if(_if_conditional312=b_230!=10,        _if_conditional312) {
            ...
            *q_237=0;
            ...
            # 1731 "tccpp.c"
            d_239=(double)bn_238[1]*4294967296.0+(double)bn_238[0];
            # 1732 "tccpp.c"
...
memset(&ml_283, 0, sizeof(struct macro_level*));
    ...
    # 2465 "tccpp.c"
        ...
        if(_if_conditional421=s->type.t==1,        _if_conditional421) {
            ...
            if(sa_267) {
                # 2570 "tccpp.c"
                error("macro '%s' used with too few args",get_tok_str(s->v,/*b*/(void*)0));
            }
            # 2574 "tccpp.c"
...
memset(&sym_870, 0, sizeof(struct anonymous_typeX66*));
    ...
    do {
        ...
        bound_861=0;
        # 2358 "tccelf.c"
        for(        p_868=ar_names_867,i_860=0;        i_860<nsyms_862;        i_860++,p_868+=strlen(p_868)+1        ){
            # 2340 "tccelf.c"
...
memset(&tt_960, 0, sizeof(double));
    ...
    # 2261 "libtcc.c"
    printf("%d idents, %d lines, %d bytes, %0.3f s, %d lines/s, %0.1f MB/s\n",tok_ident-256,total_lines,total_bytes,tt_960,(int)(total_lines/tt_960),total_bytes/tt_960/1000000.0);
}
