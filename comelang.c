...
int fun()
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "fun"; neo_current_frame = &fr;
    int x;
    char* s;
    memset(&s, 0, sizeof(s));
    # 23 "code/comelang.nc"
...
void fun2()
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "fun2"; neo_current_frame = &fr;
    void* vp;
    long  long* llp;
...
void funX()
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "funX"; neo_current_frame = &fr;
    void* vp;
    long  double** ldpp;
    int*** ippp;
    union U  u  ;
...
int funXXX()
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "funXXX"; neo_current_frame = &fr;
    # 83 "code/comelang.nc"
...
int funUHO()
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "funUHO"; neo_current_frame = &fr;
    # 89 "code/comelang.nc"
    struct PXYZ  p  ={ .y = 10, .x = 5 };
    # 90 "code/comelang.nc"
    int a[5]={ [2] = 3, [4] = 7 };
...
int funZZ()
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "funZZ"; neo_current_frame = &fr;
...
int fun_v2(int a, int b)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "fun_v2"; neo_current_frame = &fr;
...
int funXXXXXXXX()
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "funXXXXXXXX"; neo_current_frame = &fr;
    int  a  ;
...
int funHO()
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "funHO"; neo_current_frame = &fr;
...
_Bool method_block1_codecomelangnc(struct __current_stack1__* parent, int it)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "method_block1_codecomelangnc"; neo_current_frame = &fr;
...
_Bool method_block2_codecomelangnc(struct __current_stack2__* parent, int it)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "method_block2_codecomelangnc"; neo_current_frame = &fr;
# 219 "code/comelang.nc"
neo_current_frame = fr.prev;
return it>4;
neo_current_frame = fr.prev;
...
char*  method_block4_codecomelangnc(struct __current_stack4__* parent, int it)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "method_block4_codecomelangnc"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
...
static _Bool list$1char$ph$p_operator_equals(struct list$1char$ph* left, struct list$1char$ph* right)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1char$ph$p_operator_equals"; neo_current_frame = &fr;
    struct list_item$1char$ph* it;
...
char*  method_block6_codecomelangnc(struct __current_stack6__* parent, int it)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "method_block6_codecomelangnc"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    char*  __result_obj__0  ;
    # 247 "code/comelang.nc"
...
static _Bool list$1char$ph_operator_equals(struct list$1char$ph* left, struct list$1char$ph* right)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1char$ph_operator_equals"; neo_current_frame = &fr;
    struct list_item$1char$ph* it;
    struct list_item$1char$ph* it2;
    # 2227 "./neo-c.h"
    if(left==((void*)0)&&right==((void*)0)) {
...
_Bool method_block7_codecomelangnc(struct __current_stack7__* parent, int it)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "method_block7_codecomelangnc"; neo_current_frame = &fr;
    # 249 "code/comelang.nc"
        neo_current_frame = fr.prev;
    return it<4;
        neo_current_frame = fr.prev;
...
char*  method_block9_codecomelangnc(struct __current_stack9__* parent, int it)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "method_block9_codecomelangnc"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    char*  __result_obj__0  ;
    # 249 "code/comelang.nc"
...
int method_block11_codecomelangnc(struct __current_stack11__* parent, char*  it  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "method_block11_codecomelangnc"; neo_current_frame = &fr;
    int __result_obj__0;
    # 249 "code/comelang.nc"
...
static _Bool list$1int$$p_operator_equals(struct list$1int$* left, struct list$1int$* right)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$$p_operator_equals"; neo_current_frame = &fr;
    struct list_item$1int$* it;
...
_Bool method_block12_codecomelangnc(struct __current_stack12__* parent, int it)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "method_block12_codecomelangnc"; neo_current_frame = &fr;
    # 249 "code/comelang.nc"
        neo_current_frame = fr.prev;
    return it<4;
        neo_current_frame = fr.prev;
...
static struct list$1char$ph* list$1int$_map(struct list$1int$* self, void* parent, char*  (*block)(void*,int))
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$_map"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct list$1char$ph* __result_obj__0;
...
char*  method_block14_codecomelangnc(struct __current_stack14__* parent, int it)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "method_block14_codecomelangnc"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    char*  __result_obj__0  ;
    # 249 "code/comelang.nc"
...
static struct list$1int$* list$1char$ph_map(struct list$1char$ph* self, void* parent, int (*block)(void*,char* ))
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1char$ph_map"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct list$1int$* __result_obj__0;
    struct list$1int$* result;
...
int method_block16_codecomelangnc(struct __current_stack16__* parent, char*  it  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "method_block16_codecomelangnc"; neo_current_frame = &fr;
    int __result_obj__0;
    # 249 "code/comelang.nc"
        __result_obj__0 = atoi(it);
...
static _Bool list$1int$_operator_equals(struct list$1int$* left, struct list$1int$* right)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "list$1int$_operator_equals"; neo_current_frame = &fr;
    struct list_item$1int$* it;
    struct list_item$1int$* it2;
    # 2227 "./neo-c.h"
    if(left==((void*)0)&&right==((void*)0)) {
