    ...
    if(*info->p==34&&*(info->p+1)==34&&*(info->p+2)==34&&*(info->p+3)==10) {
        ...
        if(*info->p==58) {
            ...
            if(*info->p==93) {
                ...
                (come_push_stackframe("10str.nc", 2005, 0),__exception_result_var_b1=expected_next_character(44,info), come_pop_stackframe(), __exception_result_var_b1);
                while(1) {
                    ...
                    (come_push_stackframe("10str.nc", 2017, 1),__exception_result_var_b2=expected_next_character(58,info), come_pop_stackframe(), __exception_result_var_b2);
                    no_comma_111=info->no_comma;
                    info->no_comma=1;
...
struct sNode* parse_tuple(struct sInfo* info  , _Bool named_tuple)
{
    ...
    while(1) {
        ...
        if(named_tuple) {
            ...
            (come_push_stackframe("10str.nc", 2122, 2),__exception_result_var_b3=expected_next_character(58,info), come_pop_stackframe(), __exception_result_var_b3);
        }
        no_comma=info->no_comma;
        info->no_comma=1;
