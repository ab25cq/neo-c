...
static struct __neo_FILE*  Result$1__neo_FILE$p_unwrap(struct Result$1__neo_FILE$p* self);
static _Bool  Result$1__neo_FILE$p_is_err(struct Result$1__neo_FILE$p* self);
static _Bool  Result$1__neo_FILE$p_is_ok(struct Result$1__neo_FILE$p* self);
static _Bool Result$1__neo_FILE$p_is_Some(struct Result$1__neo_FILE$p* self);
static struct __neo_FILE*  Result$1__neo_FILE$p_get_Some(struct Result$1__neo_FILE$p* self);
...
struct sNode* top_level_v91(char* buf, char* head, int head_sline, struct sInfo*  info  )
{
    ...
    if(charp_operator_equals(buf,"__c__")&&*info->p==123) {
        ...
        sline=info->sline;
        __right_value0 = (void*)0;
        ccpp_tmp=Result$1__neo_FILE$p_unwrap(((struct Result$1__neo_FILE$p*)(__right_value0=xfopen("__ccpp_tmp","r"))));
        come_call_finalizer(Result$1__neo_FILE$p$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0, "41module2.nc}", 1572, 1358);
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
...
static struct __neo_FILE*  Result$1__neo_FILE$p_unwrap(struct Result$1__neo_FILE$p* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Result$1__neo_FILE$p_unwrap"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    struct __neo_FILE*  __result_obj__0  ;
    if(Result$1__neo_FILE$p_is_err(self)) {
        puts("exception");
        stackframe2(self);
        exit(2);
    }
        __result_obj__0 = Result$1__neo_FILE$p_get_Some(self);
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
static _Bool  Result$1__neo_FILE$p_is_err(struct Result$1__neo_FILE$p* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Result$1__neo_FILE$p_is_err"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
        neo_current_frame = fr.prev;
    return !Result$1__neo_FILE$p_is_ok(self);
        neo_current_frame = fr.prev;
}

static _Bool  Result$1__neo_FILE$p_is_ok(struct Result$1__neo_FILE$p* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Result$1__neo_FILE$p_is_ok"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
        neo_current_frame = fr.prev;
    return self!=((void*)0)&&Result$1__neo_FILE$p_is_Some(self);
        neo_current_frame = fr.prev;
}

static _Bool Result$1__neo_FILE$p_is_Some(struct Result$1__neo_FILE$p* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Result$1__neo_FILE$p_is_Some"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
        neo_current_frame = fr.prev;
    return self->tag==1;
        neo_current_frame = fr.prev;
}
...
static struct __neo_FILE*  Result$1__neo_FILE$p_get_Some(struct Result$1__neo_FILE$p* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "Result$1__neo_FILE$p_get_Some"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    struct __neo_FILE*  __result_obj__0  ;
