...
struct optional$1int$p* make_opt();
...
struct optional$1int$p* make_opt()
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "make_opt"; neo_current_frame = &fr;
    int x;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct optional$1int$p* __result_obj__0;
    x=123;
        __result_obj__0 = (struct optional$1int$p*)come_increment_ref_count(((struct optional$1int$p*)(__right_value1=optional$1int$p_initialize((struct optional$1int$p*)come_increment_ref_count((struct optional$1int$p*)come_calloc(1, sizeof(struct optional$1int$p)*(1), (void*)0, 6, "struct optional$1int$p*")),&x,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop))));
    come_call_finalizer(optional$1int$p$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
...
int main(int argc, char** argv)
{
    ...
    int __result_obj__0;
    o=(struct optional$1int$p*)come_increment_ref_count(make_opt());
