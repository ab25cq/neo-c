...
fr.fun_name = "parsecmp"; neo_current_frame = &fr;
    _Bool terminated;
    char* p3;
    int i;
    unsigned char c;
...
int err_msg(struct sInfo* info  , const char* msg, ...)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "err_msg"; neo_current_frame = &fr;
    char* msg2;
...
int err_msg2(struct sInfo* info  , const char* msg, ...)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "err_msg2"; neo_current_frame = &fr;
    char* msg2;
    __builtin_va_list args  ;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
...
int expected_next_character(char c, struct sInfo* info  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "expected_next_character"; neo_current_frame = &fr;
    parse_sharp_v5(info);
    if(*info->p!=c) {
        if(!info->no_output_come_code) {
...
char* parse_word(_Bool digits, struct sInfo* info  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "parse_word"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct buffer* buf  ;
...
char* backtrace_parse_word(struct sInfo* info  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "backtrace_parse_word"; neo_current_frame = &fr;
    char* p;
    int sline;
    char* buf  ;
    void* __right_value0 = (void*)0;
...
static _Bool skip_comment(struct sInfo* info  , _Bool skip_space_after)
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "skip_comment"; neo_current_frame = &fr;
    int nest;
...
void skip_spaces_and_lf(struct sInfo* info  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "skip_spaces_and_lf"; neo_current_frame = &fr;
    while(1) {
...
void skip_spaces_and_lf2(struct sInfo* info  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "skip_spaces_and_lf2"; neo_current_frame = &fr;
    while(1) {
        if(*info->p==32||*info->p==9) {
            info->p++;
        }
...
void skip_spaces_and_tabs(struct sInfo* info  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "skip_spaces_and_tabs"; neo_current_frame = &fr;
    while(1) {
        if(*info->p==32||*info->p==9) {
            info->p++;
        }
...
void parse_sharp_v5(struct sInfo* info  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "parse_sharp_v5"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct buffer* buf  ;
    _Bool _conditional_value_X0;
...
void skip_paren(struct sInfo* info  )
{
    struct neo_frame fr;
fr.prev = neo_current_frame;
fr.fun_name = "skip_paren"; neo_current_frame = &fr;
    int nest;
    nest=0;
    while(1) {
        if(*info->p==40) {
