...
static void anonymous_typeX19_finalize(struct anonymous_typeX19* self);
void stackframe();
...
int main(int argc, char** argv)
{
    ...
    struct anonymous_typeX19 aaa;
    int __result_obj__0;
    memset(&aaa, 0, sizeof(aaa));
    # 10 "/tmp/repro_hang_outer_anon_inner_named.nc"
    # 12 "/tmp/repro_hang_outer_anon_inner_named.nc"
        __result_obj__0 = 0;
    come_call_finalizer(anonymous_typeX19_finalize, (&aaa), (void*)0, (void*)0, 1, 0, 0, (void*)0, "/tmp/repro_hang_outer_anon_inner_named.nc}", 12, 1);
...
static void anonymous_typeX19_finalize(struct anonymous_typeX19* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "anonymous_typeX19_finalize"; neo_current_frame = &fr;
    # 1 "anonymous_typeX19_finalize"
        neo_current_frame = fr.prev;
}
