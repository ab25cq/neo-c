...
static struct list$1sNode$ph* list$1sNode$ph_add(struct list$1sNode$ph* self, struct sNode* item)
{
    ...
    if(self->len==0) {
        ...
        litem_0=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./neo-c.h", 972, "struct list_item$1sNode$ph*"))));
        ...
        litem_1=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./neo-c.h", 982, "struct list_item$1sNode$ph*"))));
...
static struct list$1sType$ph* list$1sType$ph_add(struct list$1sType$ph* self, struct sType* item)
{
    ...
    if(self->len==0) {
        ...
        litem_16=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "./neo-c.h", 972, "struct list_item$1sType$ph*"))));
        ...
        litem_17=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "./neo-c.h", 982, "struct list_item$1sType$ph*"))));
...
static struct list$1int$* list$1int$_add(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        ...
        litem_18=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "./neo-c.h", 972, "struct list_item$1int$*"))));
        ...
        litem_19=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "./neo-c.h", 982, "struct list_item$1int$*"))));
...
static struct list$1char$ph* list$1char$ph_add(struct list$1char$ph* self, char* item)
{
    ...
    if(self->len==0) {
        ...
        litem_20=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 972, "struct list_item$1char$ph*"))));
        ...
        litem_21=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 982, "struct list_item$1char$ph*"))));
...
static struct list$1sBlock$ph* list$1sBlock$ph_add(struct list$1sBlock$ph* self, struct sBlock* item)
{
    ...
    if(self->len==0) {
        ...
        litem_23=(struct list_item$1sBlock$ph*)come_increment_ref_count(((struct list_item$1sBlock$ph*)(__right_value0=(struct list_item$1sBlock$ph*)come_calloc(1, sizeof(struct list_item$1sBlock$ph)*(1), "./neo-c.h", 972, "struct list_item$1sBlock$ph*"))));
        ...
        litem_24=(struct list_item$1sBlock$ph*)come_increment_ref_count(((struct list_item$1sBlock$ph*)(__right_value0=(struct list_item$1sBlock$ph*)come_calloc(1, sizeof(struct list_item$1sBlock$ph)*(1), "./neo-c.h", 982, "struct list_item$1sBlock$ph*"))));
        ...
        while(1) {
            ...
            if(string_operator_equals(buf_33,"else")) {
                ...
                if(parsecmp("if",info)) {
                    ...
                    info->p+=strlen("if");
                    skip_spaces_and_lf(info);
                    (come_push_stackframe("14if.c", 355, 2),__exception_result_var_b3=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b3);
                    ...
                    (come_push_stackframe("14if.c", 362, 3),__exception_result_var_b4=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b4);
                    skip_spaces_and_lf(info);
...
static struct list$1sNode$ph* list$1sNode$ph_push_back(struct list$1sNode$ph* self, struct sNode* item)
{
    ...
    if(self->len==0) {
        ...
        litem_36=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./neo-c.h", 1057, "struct list_item$1sNode$ph*"))));
        ...
        litem_37=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./neo-c.h", 1067, "struct list_item$1sNode$ph*"))));
...
static struct list$1sBlock$ph* list$1sBlock$ph_push_back(struct list$1sBlock$ph* self, struct sBlock* item)
{
    ...
    if(self->len==0) {
        litem=(struct list_item$1sBlock$ph*)come_increment_ref_count(((struct list_item$1sBlock$ph*)(__right_value0=(struct list_item$1sBlock$ph*)come_calloc(1, sizeof(struct list_item$1sBlock$ph)*(1), "./neo-c.h", 1047, "struct list_item$1sBlock$ph*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        ...
        litem_38=(struct list_item$1sBlock$ph*)come_increment_ref_count(((struct list_item$1sBlock$ph*)(__right_value0=(struct list_item$1sBlock$ph*)come_calloc(1, sizeof(struct list_item$1sBlock$ph)*(1), "./neo-c.h", 1057, "struct list_item$1sBlock$ph*"))));
        ...
        litem_39=(struct list_item$1sBlock$ph*)come_increment_ref_count(((struct list_item$1sBlock$ph*)(__right_value0=(struct list_item$1sBlock$ph*)come_calloc(1, sizeof(struct list_item$1sBlock$ph)*(1), "./neo-c.h", 1067, "struct list_item$1sBlock$ph*"))));
...
struct sNode* parse_match(struct sNode* expression_node, struct sInfo* info)
{
    ...
    sline=info->sline;
    (come_push_stackframe("14if.c", 435, 4),__exception_result_var_b5=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b5);
    ...
    (come_push_stackframe("14if.c", 439, 5),__exception_result_var_b6=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b6);
    conditional_value=(struct sNode*)come_increment_ref_count(expression_v13(info,0));
    (come_push_stackframe("14if.c", 443, 6),__exception_result_var_b7=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b7);
    skip_spaces_and_lf(info);
    if_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
    ...
    while(1) {
        ...
        if(strncmp(info->p,"else",strlen("else"))==0) {
            ...
            (come_push_stackframe("14if.c", 474, 7),__exception_result_var_b8=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b8);
            ...
            (come_push_stackframe("14if.c", 480, 8),__exception_result_var_b9=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b9);
            skip_spaces_and_lf(info);
            elif_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
    ...
    while(1) {
        ...
        if(string_operator_equals(buf,"else")) {
            if(parsecmp("if",info)) {
                ...
                info->p+=strlen("if");
                skip_spaces_and_lf(info);
                (come_push_stackframe("14if.c", 565, 9),__exception_result_var_b10=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b10);
                ...
                (come_push_stackframe("14if.c", 572, 10),__exception_result_var_b11=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b11);
                skip_spaces_and_lf(info);
                elif_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
                list$1sBlock$ph_push_back(elif_blocks,(struct sBlock*)come_increment_ref_count(elif_block));
                elif_num++;
    ...
    while(1) {
        ...
        if(string_operator_equals(buf,"else")) {
            if(parsecmp("if",info)) {
                ...
                info->p+=strlen("if");
                skip_spaces_and_lf(info);
                (come_push_stackframe("14if.c", 671, 11),__exception_result_var_b12=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b12);
                ...
                (come_push_stackframe("14if.c", 678, 12),__exception_result_var_b13=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b13);
                skip_spaces_and_lf(info);
                elif_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
                list$1sBlock$ph_push_back(elif_blocks,(struct sBlock*)come_increment_ref_count(elif_block));
                elif_num++;
    ...
    while(1) {
        ...
        if(string_operator_equals(buf,"else")) {
            if(parsecmp("if",info)) {
                ...
                info->p+=strlen("if");
                skip_spaces_and_lf(info);
                (come_push_stackframe("14if.c", 777, 13),__exception_result_var_b14=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b14);
                ...
                (come_push_stackframe("14if.c", 784, 14),__exception_result_var_b15=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b15);
                skip_spaces_and_lf(info);
                elif_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
                list$1sBlock$ph_push_back(elif_blocks,(struct sBlock*)come_increment_ref_count(elif_block));
                elif_num++;
