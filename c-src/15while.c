...
struct sWhileNode* sWhileNode_initialize(struct sWhileNode* self, struct sNode* expression_node, struct sBlock*  block  , struct sInfo*  info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sWhileNode_initialize"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct sNode* __dec_obj1;
    struct sBlock*  __dec_obj48  ;
    struct sWhileNode* __result_obj__0;
    ((struct sNodeBase*)(__right_value0=sNodeBase_initialize((struct sNodeBase*)come_increment_ref_count(((struct sNodeBase*)self), "15while.nc", 7, 1),info)));
...
_Bool sWhileNode_terminated(struct sWhileNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sWhileNode_terminated"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
        neo_current_frame = fr.prev;
    return (_Bool)1;
    neo_current_frame = fr.prev;
}
...
char*  sWhileNode_kind(struct sWhileNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sWhileNode_kind"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
...
_Bool sWhileNode_compile(struct sWhileNode* self, struct sInfo*  info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sWhileNode_compile"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
...
static void sWhileNode_finalize(struct sWhileNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sWhileNode_finalize"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    if(self!=((void*)0)&&self->sname!=((void*)0)) {
...
struct sNode* string_node_v9(char* buf, char* head, int head_sline, struct sInfo*  info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "string_node_v9"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    char*  sname  ;
    int sline;
    struct sNode* expression_node;
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sWhileNode_clone"; fr.frame_id = ++neo_frame_id; neo_current_frame = &fr;
    struct sWhileNode* __result_obj__0;
    void* __right_value0 = (void*)0;
