...
#line 22 "/usr/local/include/neo-c.h"
typedef char*% string;

#line 32 "/usr/local/include/neo-c.h"
...
#line 105 "/usr/local/include/neo-c.h"
...
#line 110 "/usr/local/include/neo-c.h"

    using neo-c;
    using unsafe;
#line 114 "/usr/local/include/neo-c.h"
...
#line 163 "/usr/local/include/neo-c.h"
...
#line 346 "/usr/local/include/neo-c.h"
    size2 = (size2 + 7 & ~0x7);
#line 348 "/usr/local/include/neo-c.h"
...
uniq _Bool come_is_alive(void* mem)
{
    sMemHeader* it = (sMemHeader*)((char*)mem - sizeof(size_t) - sizeof(size_t) - sizeof(sMemHeader));
...
#line 674 "/usr/local/include/neo-c.h"
...
#line 857 "/usr/local/include/neo-c.h"
...
impl span<T>
{
    span<T>*% initialize(span<T>*% self, void* head, size_t len, _Bool local, _Bool heap, _Bool global, void* stacktop) {
        using unsafe; 
...
#line 2788 "/usr/local/include/neo-c.h"
...
#line 4178 "/usr/local/include/neo-c.h"
    uniq buffer* buffer*::append_format(buffer* self, const char* msg, ...)
    {
...
#line 4217 "/usr/local/include/neo-c.h"
...
#line 5767 "/usr/local/include/neo-c.h"
...
#line 5786 "/usr/local/include/neo-c.h"
...
#line 5846 "/usr/local/include/neo-c.h"

#line 5849 "/usr/local/include/neo-c.h"
...
#line 5867 "/usr/local/include/neo-c.h"
...
{
#line 6716 "/usr/local/include/neo-c.h"
  return c != '\n' && c != '\r';
#line 6718 "/usr/local/include/neo-c.h"
}
...
#line 6835 "/usr/local/include/neo-c.h"
...
#line 7024 "/usr/local/include/neo-c.h"
...
#line 7038 "/usr/local/include/neo-c.h"
...
#line 7558 "/usr/local/include/neo-c.h"
...
#line 7561 "/usr/local/include/neo-c.h"
...
#line 7562 "/usr/local/include/neo-c.h"
...
#line 8383 "/usr/local/include/neo-c.h"




#line 8388 "/usr/local/include/neo-c.h"
...
#line 8571 "/usr/local/include/neo-c.h"
#line 4 "./common.h"
struct sInfo;
...
extern _Bool sNode*::equals(sNode* self,sNode* right);
extern int gNodeID;
extern void skip_spaces(sInfo* info);
extern int ZVALUE*::get_hash_key(ZVALUE* self);
extern _Bool ZVALUE*::equals(ZVALUE* self,ZVALUE* right);
extern int ZVALUE*::compare(ZVALUE* self,ZVALUE* right);
extern _Bool ZVALUE*::operator_equals(ZVALUE* self,ZVALUE* right);
extern _Bool ZVALUE*::operator_not_equals(ZVALUE* self,ZVALUE* right);
extern string ZVALUE*::to_string(ZVALUE* self);
extern ZVALUE*% ZVALUE*::initialize(ZVALUE*% self,int kind,int int_value=0,wstring str_value=null,_Bool bool_value=false,FILE* file_value=null,list<ZVALUE*%>*% list_value=null,map<ZVALUE*%,ZVALUE*%>*% map_value=null);
extern sIntNode*% sIntNode*::initialize(sIntNode*% self,int value);
extern int sIntNode*::id(sIntNode* self);
extern _Bool sIntNode*::compile(sIntNode* self,sInfo* info);
extern sNode*% exp_node(sInfo* info) version 1;
extern sNode*% expression(sInfo* info) version 1;
extern _Bool parse(sInfo* info) version 1;
extern void arrange_stack(sInfo* info);
extern _Bool vm(sInfo* info) version 1;
extern sAddNode*% sAddNode*::initialize(sAddNode*% self,sNode*% left,sNode*% right);
extern int sAddNode*::id(sAddNode* self);
extern _Bool sAddNode*::compile(sAddNode* self,sInfo* info);
extern sSubNode*% sSubNode*::initialize(sSubNode*% self,sNode*% left,sNode*% right);
extern int sSubNode*::id(sSubNode* self);
extern _Bool sSubNode*::compile(sSubNode* self,sInfo* info);
...
extern _Bool sStrNode*::compile(sStrNode* self,sInfo* info);
extern _Bool vm(sInfo* info) version 4;
...
extern _Bool sListNode*::compile(sListNode* self,sInfo* info);
extern sMapNode*% sMapNode*::initialize(sMapNode*% self,list<tuple2<sNode*%,sNode*%>*%>*% value);
extern int sMapNode*::id(sMapNode* self);
extern _Bool sMapNode*::compile(sMapNode* self,sInfo* info);
extern _Bool vm(sInfo* info) version 5;
extern sNode*% exp_node(sInfo* info) version 3;
extern _Bool vm(sInfo* info) version 6;
...
extern _Bool sStoreNode*::compile(sStoreNode* self,sInfo* info);
extern int sStoreNode*::id(sStoreNode* self);
extern sLoadNode*% sLoadNode*::initialize(sLoadNode*% self,wstring var_name);
extern _Bool sLoadNode*::compile(sLoadNode* self,sInfo* info);
...
extern _Bool sLoadElementNode*::compile(sLoadElementNode* self,sInfo* info);
...
extern _Bool sStoreElementNode*::compile(sStoreElementNode* self,sInfo* info);
...
extern _Bool vm(sInfo* info) version 7;
extern sNode*% exp_node(sInfo* info) version 5;
extern void append_var(wstring name,ZVALUE* value);
extern _Bool compile_block(sNodeBlock block,sInfo* info);
...
extern _Bool sIfNode*::compile(sIfNode* self,sInfo* info);
extern sTrueNode*% sTrueNode*::initialize(sTrueNode*% self);
extern int sTrueNode*::id(sTrueNode* self);
extern _Bool sTrueNode*::compile(sTrueNode* self,sInfo* info);
extern sFalseNode*% sFalseNode*::initialize(sFalseNode*% self);
extern int sFalseNode*::id(sFalseNode* self);
extern _Bool sFalseNode*::compile(sFalseNode* self,sInfo* info);
extern _Bool vm(sInfo* info) version 8;
extern sNodeBlock parse_block(sInfo* info);
extern _Bool is_word(const char* str,sInfo* info);
...
extern _Bool sWhileNode*::compile(sWhileNode* self,sInfo* info);
extern sBreakNode*% sBreakNode*::initialize(sBreakNode*% self);
extern int sBreakNode*::id(sBreakNode* self);
extern _Bool sBreakNode*::compile(sBreakNode* self,sInfo* info);
...
extern _Bool sFunNode*::compile(sFunNode* self,sInfo* info);
extern sNode*% exp_node(sInfo* info) version 9;
extern tuple2<ZVALUE*%,_Bool>*% str_method(string fun_name,ZVALUE* obj,list<ZVALUE*%>* params,buffer* codes,sInfo* info) version 1;
extern _Bool vm(sInfo* info) version 10;
extern tuple2<ZVALUE*%,_Bool>*% str_method(string fun_name,ZVALUE* obj,list<ZVALUE*%>* params,buffer* codes,sInfo* info) version 2;
extern tuple2<ZVALUE*%,_Bool>*% str_method(string fun_name,ZVALUE* obj,list<ZVALUE*%>* params,buffer* codes,sInfo* info) version 3;
...
_Bool parse(sInfo* info) version 1
{
