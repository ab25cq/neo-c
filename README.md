...
Available methods are `count`, `any`, `all`, `position`, `find_value`, `nth`, `last`, `sum`, `product`, `min`, and `max`.

使えるメソッドは `count`, `any`, `all`, `position`, `find_value`, `nth`, `last`, `sum`, `product`, `min`, `max` です。
...
vector also supports the same terminal helpers as list: `count`, `any`, `all`, `position`, `find_value`, `nth`, `last`, `sum`, `product`, `min`, `max`.

vector でも list と同じ終端ヘルパー `count`, `any`, `all`, `position`, `find_value`, `nth`, `last`, `sum`, `product`, `min`, `max` が使えます。
