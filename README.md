...
1.2.7b Optimize output code.
1.2.7a Optimize output code.
1.2.7 Sort out output code.
1.2.6a Optimize output code.
1.2.6 Optimize output code.
1.2.5a Optimize output code.
1.2.5 Optimize output code.
1.2.4a Optimize output code.
...
1.2.0 More Compatibility to C. Passed 9cc,lcc and tcc in some contents.
1.1.6 More Compatibility to C
1.1.5h More Compatibility to C
1.1.5f Refactoring
1.1.5d Refactoring
1.1.5c More Compatibility to C
1.1.5b More Compatibility to C
1.1.5a More Compatibility to C
...
1.0.5.0.0 More Compatibility to C
1.0.3.0.0 user finalize
1.0.2.0.1 bug fiexed.
1.0.2.0.0 remove tmp files.
1.0.1.0.2 remove bash. changed zed bug.
1.0.1.0.0 Fixed wide-character value bug.
1.0.0.9.5 Refactoring.
1.0.0.9.4 Refactoring.
1.0.0.9.3 Refactoring.
