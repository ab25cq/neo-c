...
;    struct sType* type_18=0;
    ...
    if(self->multiple_declare) {
        ...
        type->mPointerNum=0;
        buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "07var.c", 44, "struct buffer*"))));
...
_conditional_value_X0;})) {
        ...
        come_call_finalizer(list$1tuple3$3sType$phchar$phsNode$ph$ph$p_finalize, o2_saved, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_value_20=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 96, "struct CVALUE*"))));
        ...
        come_value_20->type=(struct sType*)come_increment_ref_count((come_push_stackframe("07var.c", 98, 2),__exception_result_var_b3=(come_push_stackframe("07var.c", 98, 0),__exception_result_var_b1=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "07var.c", 98, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0), come_pop_stackframe(), __exception_result_var_b1), come_pop_stackframe(), __exception_result_var_b3));
        ...
        buf_23=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "07var.c", 106, "struct buffer*"))));
        ...
        for(o2_saved_33=(struct list$1char$ph*)come_increment_ref_count(self->multiple_assign),it_34=list$1char$ph_begin(o2_saved_33);!list$1char$ph_end(o2_saved_33);it_34=list$1char$ph_next(o2_saved_33)){
            if(i<list$1sType$ph_length(right_type->mGenericsTypes)) {
                ...
                right_value2=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 159, "struct CVALUE*"))));
                ...
                come_value_38=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 165, "struct CVALUE*"))));
...
_conditional_value_X1;})) {
            come_value_39=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 189, "struct CVALUE*"))));
...
_conditional_value_X4;})) {
        ...
        come_value_45=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 248, "struct CVALUE*"))));
        ...
        if(left_type_52->mHeap&&(left_type_52->mConstant||left_type_52->mStatic||left_type_52->mRegister)) {
            ...
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            come_value_54=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 310, "struct CVALUE*"))));
...
_conditional_value_X5;})) {
            ...
            come_value_55=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 327, "struct CVALUE*"))));
            ...
            come_value_55->type=(struct sType*)come_increment_ref_count((come_push_stackframe("07var.c", 329, 5),__exception_result_var_b6=(come_push_stackframe("07var.c", 329, 3),__exception_result_var_b4=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "07var.c", 329, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0), come_pop_stackframe(), __exception_result_var_b4), come_pop_stackframe(), __exception_result_var_b6));
            ...
            add_come_code_at_function_head(info,"%s;\n",((char*)(__right_value0=make_define_var(left_type_52,var__46->mCValueName,info,0,0))));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            come_value_56=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 354, "struct CVALUE*"))));
...
_conditional_value_X6;})) {
            ...
            if(parent_var!=((void*)0)) {
                if(string_operator_not_equals(parent_var->mFunName,info->come_fun->mName)) {
                    ...
                    come_value_63=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 401, "struct CVALUE*"))));
        ...
        if(var__64==((void*)0)) {
            ...
            if(var__64==((void*)0)) {
                ...
                come_value_65=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 424, "struct CVALUE*"))));
        ...
        if(left_type_66->mChannel&&new_channel_58) {
            come_value_67=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 445, "struct CVALUE*"))));
            ...
            come_value_67->type=(struct sType*)come_increment_ref_count((come_push_stackframe("07var.c", 448, 8),__exception_result_var_b9=(come_push_stackframe("07var.c", 448, 6),__exception_result_var_b7=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "07var.c", 448, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0), come_pop_stackframe(), __exception_result_var_b7), come_pop_stackframe(), __exception_result_var_b9));
            ...
            come_value_68=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 473, "struct CVALUE*"))));
...
_Bool sWriteChannelNode_compile(struct sWriteChannelNode* self, struct sInfo* info)
{
    ...
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "07var.c", 556, "struct buffer*"))));
    ...
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    come_value2=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 564, "struct CVALUE*"))));
    ...
    come_value2->type=(struct sType*)come_increment_ref_count((come_push_stackframe("07var.c", 568, 11),__exception_result_var_b12=(come_push_stackframe("07var.c", 568, 9),__exception_result_var_b10=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "07var.c", 568, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0), come_pop_stackframe(), __exception_result_var_b10), come_pop_stackframe(), __exception_result_var_b12));
...
_Bool sReadChannelNode_compile(struct sReadChannelNode* self, struct sInfo* info)
{
    ...
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    come_value2=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 619, "struct CVALUE*"))));
...
struct sNode* store_var(char* name, struct list$1char$ph* multiple_assign, struct list$1tuple3$3sType$phchar$phsNode$ph$ph* multiple_declare, struct sType* type, _Bool alloc, struct sNode* right_value, struct sInfo* info)
{
    ...
    void* __right_value2 = (void*)0;
    struct sNode* __result_obj__0;
    _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 636, "struct sNode");
    _inf_obj_value1=(struct sStoreNode*)come_increment_ref_count(((struct sStoreNode*)(__right_value1=sStoreNode_initialize((struct sStoreNode*)come_increment_ref_count((struct sStoreNode*)come_calloc(1, sizeof(struct sStoreNode)*(1), "07var.c", 636, "struct sStoreNode*")),(char*)come_increment_ref_count(name),multiple_assign,multiple_declare,type,alloc,right_value,info,(char*)come_increment_ref_count(xsprintf(""))))));
...
_conditional_value_X0;})) {
        ...
        if(parent_var!=((void*)0)) {
            if(string_operator_not_equals(parent_var->mFunName,info->come_fun->mName)) {
                come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 666, "struct CVALUE*"))));
    ...
    if(var_==((void*)0)) {
        ...
        if(var_==((void*)0)) {
            ...
            (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
            if(fun) {
                come_value_70=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 693, "struct CVALUE*"))));
                ...
                if(var_==((void*)0)) {
                    ...
                    come_value_71=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 707, "struct CVALUE*"))));
                    ...
                    come_value_71->type=(struct sType*)come_increment_ref_count((come_push_stackframe("07var.c", 710, 14),__exception_result_var_b15=(come_push_stackframe("07var.c", 710, 12),__exception_result_var_b13=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "07var.c", 710, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0), come_pop_stackframe(), __exception_result_var_b13), come_pop_stackframe(), __exception_result_var_b15));
    ...
    come_value_72=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 728, "struct CVALUE*"))));
...
struct sNode* create_load_var(char* var_name, struct sInfo* info)
{
    ...
    struct sNode* node;
    struct sNode* __result_obj__0;
    _inf_value2=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 763, "struct sNode");
    _inf_obj_value2=(struct sLoadNode*)come_increment_ref_count(((struct sLoadNode*)(__right_value2=sLoadNode_initialize((struct sLoadNode*)come_increment_ref_count((struct sLoadNode*)come_calloc(1, sizeof(struct sLoadNode)*(1), "07var.c", 763, "struct sLoadNode*")),(char*)come_increment_ref_count(__builtin_string(var_name)),info))));
...
_Bool sFunLoadNode_compile(struct sFunLoadNode* self, struct sInfo* info)
{
    ...
    if(fun==((void*)0)) {
        ...
        come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "07var.c", 791, "struct CVALUE*"))));
...
void add_variable_to_table(char* name, struct sType* type, struct sInfo* info, _Bool function_param, _Bool comma)
{
    ...
    char* __dec_obj115;
    char* __dec_obj116;
    self=(struct sVar*)come_increment_ref_count((struct sVar*)come_calloc(1, sizeof(struct sVar)*(1), "07var.c", 806, "struct sVar*"));
...
void add_variable_to_global_table(char* name, struct sType* type, struct sInfo* info)
{
    ...
    char* __dec_obj125;
    self=(struct sVar*)come_increment_ref_count((struct sVar*)come_calloc(1, sizeof(struct sVar)*(1), "07var.c", 852, "struct sVar*"));
...
void add_variable_to_global_table_with_int_value(char* name, struct sType* type, char* c_value, struct sInfo* info)
{
    ...
    char* __dec_obj128;
    self=(struct sVar*)come_increment_ref_count((struct sVar*)come_calloc(1, sizeof(struct sVar)*(1), "07var.c", 869, "struct sVar*"));
...
;    struct sType* type_129=0;
    ...
    if((!gComeC&&charp_operator_equals(buf,"var"))||charp_operator_equals(buf,"auto")||charp_operator_equals(buf,"__auto_type")) {
        ...
        if(*info->p==44) {
            ...
            multiple_assign=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "07var.c", 979, "struct list$1char$ph*"))));
        ...
        if(*info->p==61&&*(info->p+1)!=61&&*(info->p+1)!=62&&!info->no_assign) {
            ...
            skip_spaces_and_lf(info);
            _inf_value3=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 1007, "struct sNode");
            _inf_obj_value3=(struct sStoreNode*)come_increment_ref_count(((struct sStoreNode*)(__right_value2=sStoreNode_initialize((struct sStoreNode*)come_increment_ref_count((struct sStoreNode*)come_calloc(1, sizeof(struct sStoreNode)*(1), "07var.c", 1007, "struct sStoreNode*")),(char*)come_increment_ref_count(__builtin_string(buf2)),multiple_assign,((void*)0),((void*)0),1,right_value,info,(char*)come_increment_ref_count(xsprintf(""))))));
        ...
        _inf_value4=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 1017, "struct sNode");
        _inf_obj_value4=(struct sNewChannel*)come_increment_ref_count(((struct sNewChannel*)(__right_value1=sNewChannel_initialize((struct sNewChannel*)come_increment_ref_count((struct sNewChannel*)come_calloc(1, sizeof(struct sNewChannel)*(1), "07var.c", 1017, "struct sNewChannel*")),info))));
        ...
        if(*info->p==61&&*(info->p+1)!=61) {
            ...
            if(type2->mClass->mStruct&&list$1sNode$ph_length(type2->mArrayNum)==0) {
                ...
                list$1tuple3$3sType$phchar$phsNode$ph$ph_push_back(multiple_declare_101,(struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count(tuple3$3sType$phchar$phsNode$ph_initialize((struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count((struct tuple3$3sType$phchar$phsNode$ph*)come_calloc(1, sizeof(struct tuple3$3sType$phchar$phsNode$ph)*(1), "07var.c", 1052, "struct tuple3$3sType$phchar$phsNode$ph")),(struct sType*)come_increment_ref_count(type2),(char*)come_increment_ref_count(var_name),(struct sNode*)come_increment_ref_count(exp_105))));
                ...
                info->array_initializer=0;
                list$1tuple3$3sType$phchar$phsNode$ph$ph_push_back(multiple_declare_101,(struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count(tuple3$3sType$phchar$phsNode$ph_initialize((struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count((struct tuple3$3sType$phchar$phsNode$ph*)come_calloc(1, sizeof(struct tuple3$3sType$phchar$phsNode$ph)*(1), "07var.c", 1062, "struct tuple3$3sType$phchar$phsNode$ph")),(struct sType*)come_increment_ref_count(type2),(char*)come_increment_ref_count(var_name),(struct sNode*)come_increment_ref_count(exp_109))));
            ...
            list$1tuple3$3sType$phchar$phsNode$ph$ph_push_back(multiple_declare_101,(struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count(tuple3$3sType$phchar$phsNode$ph_initialize((struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count((struct tuple3$3sType$phchar$phsNode$ph*)come_calloc(1, sizeof(struct tuple3$3sType$phchar$phsNode$ph)*(1), "07var.c", 1066, "struct tuple3$3sType$phchar$phsNode$ph")),(struct sType*)come_increment_ref_count(type2),(char*)come_increment_ref_count(var_name),(struct sNode*)come_increment_ref_count((struct sNode*)((void*)0)))));
        }
        while(*info->p==44) {
            info->p++;
            skip_spaces_and_lf(info);
            ...
            if(*info->p==61&&*(info->p+1)!=61) {
                ...
                if(type2_110->mClass->mStruct&&list$1sNode$ph_length(type2_110->mArrayNum)==0) {
                    ...
                    info->array_initializer=0;
                    list$1tuple3$3sType$phchar$phsNode$ph$ph_push_back(multiple_declare_101,(struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count(tuple3$3sType$phchar$phsNode$ph_initialize((struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count((struct tuple3$3sType$phchar$phsNode$ph*)come_calloc(1, sizeof(struct tuple3$3sType$phchar$phsNode$ph)*(1), "07var.c", 1087, "struct tuple3$3sType$phchar$phsNode$ph")),(struct sType*)come_increment_ref_count(type2_110),(char*)come_increment_ref_count(var_name_111),(struct sNode*)come_increment_ref_count(exp_113))));
                    ...
                    info->array_initializer=0;
                    list$1tuple3$3sType$phchar$phsNode$ph$ph_push_back(multiple_declare_101,(struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count(tuple3$3sType$phchar$phsNode$ph_initialize((struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count((struct tuple3$3sType$phchar$phsNode$ph*)come_calloc(1, sizeof(struct tuple3$3sType$phchar$phsNode$ph)*(1), "07var.c", 1099, "struct tuple3$3sType$phchar$phsNode$ph")),(struct sType*)come_increment_ref_count(type2_110),(char*)come_increment_ref_count(var_name_111),(struct sNode*)come_increment_ref_count(exp_115))));
                ...
                list$1tuple3$3sType$phchar$phsNode$ph$ph_push_back(multiple_declare_101,(struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count(tuple3$3sType$phchar$phsNode$ph_initialize((struct tuple3$3sType$phchar$phsNode$ph*)come_increment_ref_count((struct tuple3$3sType$phchar$phsNode$ph*)come_calloc(1, sizeof(struct tuple3$3sType$phchar$phsNode$ph)*(1), "07var.c", 1103, "struct tuple3$3sType$phchar$phsNode$ph")),(struct sType*)come_increment_ref_count(type2_110),(char*)come_increment_ref_count(var_name_111),(struct sNode*)come_increment_ref_count((struct sNode*)((void*)0)))));
            }
        ...
        _inf_obj_value5=(struct sStoreNode*)come_increment_ref_count(((struct sStoreNode*)(__right_value2=sStoreNode_initialize((struct sStoreNode*)come_increment_ref_count((struct sStoreNode*)come_calloc(1, sizeof(struct sStoreNode)*(1), "07var.c", 1110, "struct sStoreNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),((void*)0),multiple_declare_101,base_type,1,((void*)0),info,(char*)come_increment_ref_count(xsprintf(""))))));
        ...
        skip_spaces_and_lf(info);
        list$1tuple2$2char$phsType$ph$ph_add(info->defining_class->mFields,(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph*)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "07var.c", 1133, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(name_118),(struct sType*)come_increment_ref_count(type_117))));
        if(*info->p==61&&*(info->p+1)!=61&&*(info->p+1)!=62) {
            info->p++;
            skip_spaces_and_lf(info);
            _inf_value6=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 1140, "struct sNode");
            _inf_obj_value6=(struct sLoadNode*)come_increment_ref_count(((struct sLoadNode*)(__right_value2=sLoadNode_initialize((struct sLoadNode*)come_increment_ref_count((struct sLoadNode*)come_calloc(1, sizeof(struct sLoadNode)*(1), "07var.c", 1140, "struct sLoadNode*")),(char*)come_increment_ref_count(__builtin_string("self")),info))));
        ...
        skip_spaces_and_lf(info);
        _inf_value7=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 1164, "struct sNode");
        _inf_obj_value7=(struct sStoreNode*)come_increment_ref_count(((struct sStoreNode*)(__right_value2=sStoreNode_initialize((struct sStoreNode*)come_increment_ref_count((struct sStoreNode*)come_calloc(1, sizeof(struct sStoreNode)*(1), "07var.c", 1164, "struct sStoreNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),((void*)0),((void*)0),((void*)0),0,right_value_124,info,(char*)come_increment_ref_count(xsprintf(""))))));
...
_conditional_value_X0;})) {
        _inf_value8=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 1169, "struct sNode");
        _inf_obj_value8=(struct sLoadNode*)come_increment_ref_count(((struct sLoadNode*)(__right_value2=sLoadNode_initialize((struct sLoadNode*)come_increment_ref_count((struct sLoadNode*)come_calloc(1, sizeof(struct sLoadNode)*(1), "07var.c", 1169, "struct sLoadNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),info))));
        ...
        _inf_value9=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 1178, "struct sNode");
        _inf_obj_value9=(struct sLoadNode*)come_increment_ref_count(((struct sLoadNode*)(__right_value2=sLoadNode_initialize((struct sLoadNode*)come_increment_ref_count((struct sLoadNode*)come_calloc(1, sizeof(struct sLoadNode)*(1), "07var.c", 1178, "struct sLoadNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),info))));
        ...
        if(is_type_name_flag_128) {
            ...
            skip_spaces_and_lf(info);
            if(*info->p==61&&*(info->p+1)!=61&&*(info->p+1)!=62&&info->no_assign) {
                _inf_value10=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 1215, "struct sNode");
                _inf_obj_value10=(struct sLoadNode*)come_increment_ref_count(((struct sLoadNode*)(__right_value1=sLoadNode_initialize((struct sLoadNode*)come_increment_ref_count((struct sLoadNode*)come_calloc(1, sizeof(struct sLoadNode)*(1), "07var.c", 1215, "struct sLoadNode*")),(char*)come_increment_ref_count(name_130),info))));
                ...
                _inf_value11=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 1248, "struct sNode");
                _inf_obj_value11=(struct sStoreNode*)come_increment_ref_count(((struct sStoreNode*)(__right_value1=sStoreNode_initialize((struct sStoreNode*)come_increment_ref_count((struct sStoreNode*)come_calloc(1, sizeof(struct sStoreNode)*(1), "07var.c", 1248, "struct sStoreNode*")),(char*)come_increment_ref_count(name_130),((void*)0),((void*)0),type_129,1,right_value_133,info,(char*)come_increment_ref_count(xsprintf(""))))));
                ...
                _inf_value12=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 1253, "struct sNode");
                _inf_obj_value12=(struct sStoreNode*)come_increment_ref_count(((struct sStoreNode*)(__right_value1=sStoreNode_initialize((struct sStoreNode*)come_increment_ref_count((struct sStoreNode*)come_calloc(1, sizeof(struct sStoreNode)*(1), "07var.c", 1253, "struct sStoreNode*")),(char*)come_increment_ref_count(name_130),((void*)0),((void*)0),type_129,1,((void*)0),info,(char*)come_increment_ref_count(xsprintf(""))))));
...
struct sNode* post_position_operator_v7(struct sNode* node, struct sInfo* info)
{
    ...
    if(!node->terminated(node->_protocol_obj)&&strncmp(info->p,"<-",strlen("<-"))==0) {
        ...
        skip_spaces_and_lf(info);
        _inf_value14=(struct sNode*)come_calloc(1, sizeof(struct sNode), "07var.c", 1299, "struct sNode");
