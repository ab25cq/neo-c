...
_Bool sIntNode_compile(struct sIntNode* self, struct sInfo* info  )
{
    ...
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc_v2(1, sizeof(struct CVALUE)*(1), "11number.c", 19, "struct CVALUE*"))));
    ...
    come_value->type=(struct sType*)come_increment_ref_count((come_push_stackframe("11number.c", 22, 2),__exception_result_var_b3=(come_push_stackframe("11number.c", 22, 0),__exception_result_var_b1=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "11number.c", 22, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0), come_pop_stackframe(), __exception_result_var_b1), come_pop_stackframe(), __exception_result_var_b3));
...
_Bool sUIntNode_compile(struct sUIntNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc_v2(1, sizeof(struct CVALUE)*(1), "11number.c", 49, "struct CVALUE*"))));
    ...
    come_value->type=(struct sType*)come_increment_ref_count((come_push_stackframe("11number.c", 52, 5),__exception_result_var_b6=(come_push_stackframe("11number.c", 52, 3),__exception_result_var_b4=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "11number.c", 52, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0), come_pop_stackframe(), __exception_result_var_b4), come_pop_stackframe(), __exception_result_var_b6));
...
_Bool sLongNode_compile(struct sLongNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc_v2(1, sizeof(struct CVALUE)*(1), "11number.c", 79, "struct CVALUE*"))));
    __dec_obj11=come_value->c_value,
    come_value->c_value=(char*)come_increment_ref_count(xsprintf("%s",self->value));
    __dec_obj11 = come_decrement_ref_count(__dec_obj11, (void*)0, (void*)0, 0,0, (void*)0);
    __dec_obj12=come_value->type,
    come_value->type=(struct sType*)come_increment_ref_count((come_push_stackframe("11number.c", 82, 8),__exception_result_var_b9=(come_push_stackframe("11number.c", 82, 6),__exception_result_var_b7=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "11number.c", 82, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0), come_pop_stackframe(), __exception_result_var_b7), come_pop_stackframe(), __exception_result_var_b9));
...
_Bool sULongNode_compile(struct sULongNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc_v2(1, sizeof(struct CVALUE)*(1), "11number.c", 109, "struct CVALUE*"))));
    ...
    come_value->type=(struct sType*)come_increment_ref_count((come_push_stackframe("11number.c", 112, 11),__exception_result_var_b12=(come_push_stackframe("11number.c", 112, 9),__exception_result_var_b10=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "11number.c", 112, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0), come_pop_stackframe(), __exception_result_var_b10), come_pop_stackframe(), __exception_result_var_b12));
...
_Bool sFloatNode_compile(struct sFloatNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc_v2(1, sizeof(struct CVALUE)*(1), "11number.c", 139, "struct CVALUE*"))));
    ...
    come_value->type=(struct sType*)come_increment_ref_count((come_push_stackframe("11number.c", 142, 14),__exception_result_var_b15=(come_push_stackframe("11number.c", 142, 12),__exception_result_var_b13=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "11number.c", 142, "struct sType*")),(char*)come_increment_ref_count(xsprintf("float")),0,info,0), come_pop_stackframe(), __exception_result_var_b13), come_pop_stackframe(), __exception_result_var_b15));
...
_Bool sComplexNode_compile(struct sComplexNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc_v2(1, sizeof(struct CVALUE)*(1), "11number.c", 169, "struct CVALUE*"))));
    ...
    come_value->type=(struct sType*)come_increment_ref_count((come_push_stackframe("11number.c", 172, 17),__exception_result_var_b18=(come_push_stackframe("11number.c", 172, 15),__exception_result_var_b16=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "11number.c", 172, "struct sType*")),(char*)come_increment_ref_count(xsprintf("double")),0,info,0), come_pop_stackframe(), __exception_result_var_b16), come_pop_stackframe(), __exception_result_var_b18));
...
_Bool sDoubleNode_compile(struct sDoubleNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc_v2(1, sizeof(struct CVALUE)*(1), "11number.c", 199, "struct CVALUE*"))));
    ...
    come_value->type=(struct sType*)come_increment_ref_count((come_push_stackframe("11number.c", 202, 20),__exception_result_var_b21=(come_push_stackframe("11number.c", 202, 18),__exception_result_var_b19=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "11number.c", 202, "struct sType*")),(char*)come_increment_ref_count(xsprintf("double")),0,info,0), come_pop_stackframe(), __exception_result_var_b19), come_pop_stackframe(), __exception_result_var_b21));
...
_Bool sDigitNode_compile(struct sDigitNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc_v2(1, sizeof(struct CVALUE)*(1), "11number.c", 229, "struct CVALUE*"))));
    ...
    come_value->type=(struct sType*)come_increment_ref_count((come_push_stackframe("11number.c", 232, 23),__exception_result_var_b24=(come_push_stackframe("11number.c", 232, 21),__exception_result_var_b22=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "11number.c", 232, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0), come_pop_stackframe(), __exception_result_var_b22), come_pop_stackframe(), __exception_result_var_b24));
...
struct sNode* create_int_node(char* value  , struct sInfo* info  )
{
    ...
    _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 245, "struct sNode");
    _inf_obj_value1=(struct sIntNode*)come_increment_ref_count(((struct sIntNode*)(__right_value1=sIntNode_initialize((struct sIntNode*)come_increment_ref_count((struct sIntNode*)come_calloc_v2(1, sizeof(struct sIntNode)*(1), "11number.c", 245, "struct sIntNode*")),(char*)come_increment_ref_count(value),info))));
            ...
            *p2=0;
            ...
            if(*info->p==76||*info->p==108) {
                ...
                *p2=0;
                info->p++;
                skip_spaces_and_lf(info);
                _inf_value2=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 271, "struct sNode");
                _inf_obj_value2=(struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(__right_value2=sULongNode_initialize((struct sULongNode*)come_increment_ref_count((struct sULongNode*)come_calloc_v2(1, sizeof(struct sULongNode)*(1), "11number.c", 271, "struct sULongNode*")),(char*)come_increment_ref_count(charp_to_string(buf)),info))));
                ...
                _inf_value3=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 274, "struct sNode");
                _inf_obj_value3=(struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(__right_value2=sULongNode_initialize((struct sULongNode*)come_increment_ref_count((struct sULongNode*)come_calloc_v2(1, sizeof(struct sULongNode)*(1), "11number.c", 274, "struct sULongNode*")),(char*)come_increment_ref_count(charp_to_string(buf)),info))));
            ...
            _inf_value4=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 278, "struct sNode");
            _inf_obj_value4=(struct sUIntNode*)come_increment_ref_count(((struct sUIntNode*)(__right_value2=sUIntNode_initialize((struct sUIntNode*)come_increment_ref_count((struct sUIntNode*)come_calloc_v2(1, sizeof(struct sUIntNode)*(1), "11number.c", 278, "struct sUIntNode*")),(char*)come_increment_ref_count(charp_to_string(buf)),info))));
        ...
        *p2=0;
        ...
        if(*info->p==76||*info->p==108) {
            ...
            *p2=0;
            ...
            if(*info->p==117||*info->p==85) {
                ...
                *p2=0;
                info->p++;
                skip_spaces_and_lf(info);
                _inf_value5=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 300, "struct sNode");
                _inf_obj_value5=(struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(__right_value2=sLongNode_initialize((struct sLongNode*)come_increment_ref_count((struct sLongNode*)come_calloc_v2(1, sizeof(struct sLongNode)*(1), "11number.c", 300, "struct sLongNode*")),(char*)come_increment_ref_count(charp_to_string(buf)),info))));
                ...
                _inf_value6=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 303, "struct sNode");
                _inf_obj_value6=(struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(__right_value2=sLongNode_initialize((struct sLongNode*)come_increment_ref_count((struct sLongNode*)come_calloc_v2(1, sizeof(struct sLongNode)*(1), "11number.c", 303, "struct sLongNode*")),(char*)come_increment_ref_count(charp_to_string(buf)),info))));
            ...
            *p2=0;
            info->p++;
            skip_spaces_and_lf(info);
            _inf_value7=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 313, "struct sNode");
            _inf_obj_value7=(struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(__right_value2=sULongNode_initialize((struct sULongNode*)come_increment_ref_count((struct sULongNode*)come_calloc_v2(1, sizeof(struct sULongNode)*(1), "11number.c", 313, "struct sULongNode*")),(char*)come_increment_ref_count(charp_to_string(buf)),info))));
            ...
            _inf_value8=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 316, "struct sNode");
            _inf_obj_value8=(struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(__right_value2=sLongNode_initialize((struct sLongNode*)come_increment_ref_count((struct sLongNode*)come_calloc_v2(1, sizeof(struct sLongNode)*(1), "11number.c", 316, "struct sLongNode*")),(char*)come_increment_ref_count(charp_to_string(buf)),info))));
        ...
        _inf_value9=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 320, "struct sNode");
        _inf_obj_value9=(struct sIntNode*)come_increment_ref_count(((struct sIntNode*)(__right_value2=sIntNode_initialize((struct sIntNode*)come_increment_ref_count((struct sIntNode*)come_calloc_v2(1, sizeof(struct sIntNode)*(1), "11number.c", 320, "struct sIntNode*")),(char*)come_increment_ref_count(charp_to_string(buf)),info))));
    ...
    if(is_float) {
        if(*info->p==102||*info->p==70) {
            ...
            *p=0;
            info->p++;
            skip_spaces_and_lf(info);
            _inf_value11=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 445, "struct sNode");
            _inf_obj_value11=(struct sDoubleNode*)come_increment_ref_count(((struct sDoubleNode*)(__right_value2=sDoubleNode_initialize((struct sDoubleNode*)come_increment_ref_count((struct sDoubleNode*)come_calloc_v2(1, sizeof(struct sDoubleNode)*(1), "11number.c", 445, "struct sDoubleNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),info))));
            ...
            *p=0;
            info->p++;
            skip_spaces_and_lf(info);
            _inf_value12=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 454, "struct sNode");
            _inf_obj_value12=(struct sComplexNode*)come_increment_ref_count(((struct sComplexNode*)(__right_value2=sComplexNode_initialize((struct sComplexNode*)come_increment_ref_count((struct sComplexNode*)come_calloc_v2(1, sizeof(struct sComplexNode)*(1), "11number.c", 454, "struct sComplexNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),info))));
            ...
            _inf_value13=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "11number.c", 457, "struct sNode");
            _inf_obj_value13=(struct sDoubleNode*)come_increment_ref_count(((struct sDoubleNode*)(__right_value2=sDoubleNode_initialize((struct sDoubleNode*)come_increment_ref_count((struct sDoubleNode*)come_calloc_v2(1, sizeof(struct sDoubleNode)*(1), "11number.c", 457, "struct sDoubleNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),info))));
