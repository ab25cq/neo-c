...
struct list_item$1tuple2$2int$char$ph$ph
{
    struct tuple2$2int$char$ph* item;
    struct list_item$1tuple2$2int$char$ph$ph* prev;
    struct list_item$1tuple2$2int$char$ph$ph* next;
};

struct list$1tuple2$2int$char$ph$ph
{
    struct list_item$1tuple2$2int$char$ph$ph* head;
    struct list_item$1tuple2$2int$char$ph$ph* tail;
    int len;
    struct list_item$1tuple2$2int$char$ph$ph* it;
};
...
int main();
static void list$1tuple2$2int$char$ph$ph$p_finalize(struct list$1tuple2$2int$char$ph$ph* self);
static void list_item$1tuple2$2int$char$ph$ph$p_finalize(struct list_item$1tuple2$2int$char$ph$ph* self);
...
int main()
{
    ...
    struct list$1tuple2$2int$char$ph$ph* x;
    int __result_obj__0;
    x=((void*)0);
        __result_obj__0 = 0;
    come_call_finalizer(list$1tuple2$2int$char$ph$ph$p_finalize, x, (void*)0, (void*)0, 0, 0, 0, (void*)0);
...
static void list$1tuple2$2int$char$ph$ph$p_finalize(struct list$1tuple2$2int$char$ph$ph* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "list$1tuple2$2int$char$ph$ph$p_finalize"; neo_current_frame = &fr;
    struct list_item$1tuple2$2int$char$ph$ph* it;
    struct list_item$1tuple2$2int$char$ph$ph* prev_it;
    if(self==((void*)0)) {
                neo_current_frame = fr.prev;
        return;
    }
    ...
    while(it!=((void*)0)) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1tuple2$2int$char$ph$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
        neo_current_frame = fr.prev;
}
...
static void list_item$1tuple2$2int$char$ph$ph$p_finalize(struct list_item$1tuple2$2int$char$ph$ph* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "list_item$1tuple2$2int$char$ph$ph$p_finalize"; neo_current_frame = &fr;
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        come_call_finalizer(tuple2$2int$char$ph$p_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
            neo_current_frame = fr.prev;
}
...
static void tuple2$2int$char$ph$p_finalize(struct tuple2$2int$char$ph* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "tuple2$2int$char$ph$p_finalize"; neo_current_frame = &fr;
