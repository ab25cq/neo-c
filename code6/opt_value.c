...
int main(int argc, char** argv)
{
    ...
    int __result_obj__0;
    x=9;
    o=(struct optional$1int$p*)come_increment_ref_count(optional$1int$p_initialize((struct optional$1int$p*)come_increment_ref_count((struct optional$1int$p*)come_calloc(1, sizeof(struct optional$1int$p)*(1), (void*)0, 6, "struct optional$1int$p*")),&x,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop));
