...
static void  __attribute__((destructor))  on_unload();
static void  __attribute__((format(printf, 1, 2)))  my_log(const char* fmt, ...);
static void cleanup_FILEp(struct _IO_FILE**  fp  );
static int  __attribute__((hot))  hot_add(int a, int b);
