...
int main(int argc, char** argv)
{
    ...
    int x[3]={ 111, 222, 333 };
    q=&x[0];
    p=(struct ref$1int$p*)come_increment_ref_count(ref$1int$p_initialize((struct ref$1int$p*)come_increment_ref_count((struct ref$1int$p*)come_calloc(1, sizeof(struct ref$1int$p)*(1), (void*)0, 6, "struct ref$1int$p*")),q,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop));
        __result_obj__0 = 0;
