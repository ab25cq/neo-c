...
int main()
{
    do {
        if(!(1==1)) {
            fprintf(stderr,"FAIL: %s at %s:%d\n","PP_DEFINED_ALIAS == 1","code/c_test_compat83.nc",47);
            g_ok=(_Bool)0;
        }
    } while(0);
    do {
        if(!(0==0)) {
            fprintf(stderr,"FAIL: %s at %s:%d\n","PP_DEFINED_TARGET == 0","code/c_test_compat83.nc",48);
            g_ok=(_Bool)0;
        }
    } while(0);
    do {
        if(!(1==1)) {
            fprintf(stderr,"FAIL: %s at %s:%d\n","PP_FUNC_EXPR_OK == 1","code/c_test_compat83.nc",49);
            g_ok=(_Bool)0;
        }
    } while(0);
    do {
        if(!(1==1)) {
            fprintf(stderr,"FAIL: %s at %s:%d\n","PP_LOGICAL_DEFINED_OK == 1","code/c_test_compat83.nc",50);
            g_ok=(_Bool)0;
        }
    } while(0);
    do {
        if(!(1==1)) {
            fprintf(stderr,"FAIL: %s at %s:%d\n","PP_RADIX_OK == 1","code/c_test_compat83.nc",51);
            g_ok=(_Bool)0;
        }
    } while(0);
    puts(((g_ok)?("OK"):("NG")));
