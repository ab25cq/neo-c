...
int main(int argc, char** argv)
{
    ...
    *hp=777;
    o=(struct optional$1int$p*)come_increment_ref_count(optional$1int$p_initialize((struct optional$1int$p*)come_increment_ref_count((struct optional$1int$p*)come_calloc(1, sizeof(struct optional$1int$p)*(1), (void*)0, 8, "struct optional$1int$p*")),hp,(_Bool)0,(_Bool)1,(_Bool)0,neo_current_frame->stacktop));
