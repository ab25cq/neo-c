...
static int g_line=333;
static const char* g_file="compat194_virtual_file.nc";
static int g_line2=777;
static const char* g_file2="c_test_compat194.nc";
// source head
...
int main()
{
    ...
    if(strcmp(g_file,"compat194_virtual_file.nc")!=0) {
                __result_obj__0 = 2;
        neo_current_frame = fr.prev;
        come_heap_final();
        return __result_obj__0;
    ...
    if(strcmp(g_file2,"c_test_compat194.nc")!=0) {
                __result_obj__0 = 4;
        neo_current_frame = fr.prev;
        come_heap_final();
        return __result_obj__0;
