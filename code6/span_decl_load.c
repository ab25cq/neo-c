...
static int span$1int$$p_operator_load_element(struct span$1int$* self, int position);
static int span$1int$_operator_load_element(struct span$1int$* self, int position);
void stackframe();
...
int main(int argc, char** argv)
{
    ...
    printf("%d\n",span$1int$_operator_load_element(s,0));
        __result_obj__0 = 0;
