...
const struct formation rv32i[] = {
    ...
    { "mul", &form_rtype, &parse_rtype, { 4, OP_OP, 0x0, 0x01 } },
    { "mulh", &form_rtype, &parse_rtype, { 4, OP_OP, 0x1, 0x01 } },
    { "mulhsu", &form_rtype, &parse_rtype, { 4, OP_OP, 0x2, 0x01 } },
    { "mulhu", &form_rtype, &parse_rtype, { 4, OP_OP, 0x3, 0x01 } },
    { "div", &form_rtype, &parse_rtype, { 4, OP_OP, 0x4, 0x01 } },
    { "divu", &form_rtype, &parse_rtype, { 4, OP_OP, 0x5, 0x01 } },
    { "rem", &form_rtype, &parse_rtype, { 4, OP_OP, 0x6, 0x01 } },
    { "remu", &form_rtype, &parse_rtype, { 4, OP_OP, 0x7, 0x01 } },
...
const struct formation rv64i[] = {
    ...
    { "rem", &form_rtype, &parse_rtype, { 4, OP_OP, 0x6, 0x01 } },
    { "remu", &form_rtype, &parse_rtype, { 4, OP_OP, 0x7, 0x01 } },
    { "mulw", &form_rtype, &parse_rtype, { 4, OP_OP32, 0x0, 0x01 } },
    { "divw", &form_rtype, &parse_rtype, { 4, OP_OP32, 0x4, 0x01 } },
    { "divuw", &form_rtype, &parse_rtype, { 4, OP_OP32, 0x5, 0x01 } },
    { "remw", &form_rtype, &parse_rtype, { 4, OP_OP32, 0x6, 0x01 } },
    { "remuw", &form_rtype, &parse_rtype, { 4, OP_OP32, 0x7, 0x01 } },
