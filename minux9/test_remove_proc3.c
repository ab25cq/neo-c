...
int main()
{
    ...
    memset(&p, 0, sizeof(p));
    # 14 "/tmp/test_remove_proc3.nc"
    xs=(struct list$1proc$p*)come_increment_ref_count(list$1proc$p_initialize((struct list$1proc$p*)come_increment_ref_count((struct list$1proc$p*)come_calloc(1, sizeof(struct list$1proc$p)*(1), "/tmp/test_remove_proc3.nc", 14, 1, "struct list$1proc$p*"), "/tmp/test_remove_proc3.nc", 14, 6)), "/tmp/test_remove_proc3.nc", 14, 7);
    # 15 "/tmp/test_remove_proc3.nc"
    p=((void*)0);
    # 16 "/tmp/test_remove_proc3.nc"
    list$1proc$p_remove(xs,p,(_Bool)0);
    # 17 "/tmp/test_remove_proc3.nc"
    list$1proc$p_remove(xs,p,(_Bool)1);
    # 18 "/tmp/test_remove_proc3.nc"
        __result_obj__0 = 0;
    come_call_finalizer(list$1proc$p$p_finalize, xs, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/tmp/test_remove_proc3.nc}", 18, 12);
...
static struct list$1proc$p* list$1proc$p_initialize(struct list$1proc$p* self)
{
    ...
    come_call_finalizer(list$1proc$p$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 13, 4);
    neo_current_frame = fr.prev;
    come_call_finalizer(list$1proc$p$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 13, 5);
    return __result_obj__0;
}
...
static _Bool context_t_equals(struct context_t  left  , struct context_t  right  )
{
    ...
    # 1 "context_t_equals"
    if(!int_equals(left.x,right.x)) {
        # 0 "context_t_equals"
                neo_current_frame = fr.prev;
        return (_Bool)0;
    }
    # 2 "context_t_equals"
    if(!int_equals(left.y,right.y)) {
        # 1 "context_t_equals"
                neo_current_frame = fr.prev;
        return (_Bool)0;
    }
...
static struct list$1char$* list$1char$_initialize_with_values(struct list$1char$* self, int num_value, char* values)
{
    ...
    come_call_finalizer(list$1char$$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 1, 227);
    neo_current_frame = fr.prev;
    come_call_finalizer(list$1char$$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 1, 228);
    return __result_obj__0;
}
