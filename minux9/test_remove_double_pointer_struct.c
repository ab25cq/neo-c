...
struct list_item$1process_pages$pp
{
    struct process_pages**  item  ;
    struct list_item$1process_pages$pp* prev;
    struct list_item$1process_pages$pp* next;
};

struct list$1process_pages$pp
{
    struct list_item$1process_pages$pp* head;
    struct list_item$1process_pages$pp* tail;
    int len;
    struct list_item$1process_pages$pp* it;
};
...
int main();
static struct list$1process_pages$pp* list$1process_pages$pp_initialize(struct list$1process_pages$pp* self);
static void list$1process_pages$pp$p_finalize(struct list$1process_pages$pp* self);
static void list_item$1process_pages$pp$p_finalize(struct list_item$1process_pages$pp* self);
static struct list$1process_pages$pp* list$1process_pages$pp_remove(struct list$1process_pages$pp* self, struct process_pages**  item  , _Bool by_pointer);
static _Bool process_pages_equals(struct process_pages**  left  , struct process_pages**  right  );
static struct list$1process_pages$pp* list$1process_pages$pp_delete(struct list$1process_pages$pp* self, int head, int tail);
static struct list$1process_pages$pp* list$1process_pages$pp_reset(struct list$1process_pages$pp* self);
void stackframe();
...
int main()
{
    ...
    struct list$1process_pages$pp* xs;
    struct process_pages**  pages  ;
    int __result_obj__0;
    memset(&xs, 0, sizeof(xs));
    memset(&pages, 0, sizeof(pages));
    # 10 "/home/ab25cq/neo-c/code/test_remove_double_pointer_struct.nc"
    xs=(struct list$1process_pages$pp*)come_increment_ref_count(list$1process_pages$pp_initialize((struct list$1process_pages$pp*)come_increment_ref_count((struct list$1process_pages$pp*)come_calloc(1, sizeof(struct list$1process_pages$pp)*(1), "/home/ab25cq/neo-c/code/test_remove_double_pointer_struct.nc", 10, 1, "struct list$1process_pages$pp*"), "/home/ab25cq/neo-c/code/test_remove_double_pointer_struct.nc", 10, 6)), "/home/ab25cq/neo-c/code/test_remove_double_pointer_struct.nc", 10, 7);
    # 11 "/home/ab25cq/neo-c/code/test_remove_double_pointer_struct.nc"
    pages=((void*)0);
    # 13 "/home/ab25cq/neo-c/code/test_remove_double_pointer_struct.nc"
    list$1process_pages$pp_remove(xs,pages,(_Bool)0);
    # 14 "/home/ab25cq/neo-c/code/test_remove_double_pointer_struct.nc"
    list$1process_pages$pp_remove(xs,pages,(_Bool)1);
    # 16 "/home/ab25cq/neo-c/code/test_remove_double_pointer_struct.nc"
        __result_obj__0 = 0;
    come_call_finalizer(list$1process_pages$pp$p_finalize, xs, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/home/ab25cq/neo-c/code/test_remove_double_pointer_struct.nc}", 16, 12);
...
static struct list$1process_pages$pp* list$1process_pages$pp_initialize(struct list$1process_pages$pp* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "list$1process_pages$pp_initialize"; neo_current_frame = &fr;
    struct list$1process_pages$pp* __result_obj__0;
    ...
    # 1485 "/home/ab25cq/neo-c/neo-c.h"
        __result_obj__0 = (struct list$1process_pages$pp*)come_increment_ref_count(self, "/home/ab25cq/neo-c/neo-c.h", 1485, 2);
    come_call_finalizer(list$1process_pages$pp$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 9, 4);
    neo_current_frame = fr.prev;
    come_call_finalizer(list$1process_pages$pp$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 9, 5);
    return __result_obj__0;
}

static void list$1process_pages$pp$p_finalize(struct list$1process_pages$pp* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "list$1process_pages$pp$p_finalize"; neo_current_frame = &fr;
    struct list_item$1process_pages$pp* it;
    struct list_item$1process_pages$pp* prev_it;
    ...
    while(it!=((void*)0)) {
        ...
        come_call_finalizer(list_item$1process_pages$pp$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 1506, 3);
    }
        neo_current_frame = fr.prev;
}
...
static void list_item$1process_pages$pp$p_finalize(struct list_item$1process_pages$pp* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "list_item$1process_pages$pp$p_finalize"; neo_current_frame = &fr;
    # 1 "list_item$1process_pages$pp$p_finalize"
            neo_current_frame = fr.prev;
}

static struct list$1process_pages$pp* list$1process_pages$pp_remove(struct list$1process_pages$pp* self, struct process_pages**  item  , _Bool by_pointer)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "list$1process_pages$pp_remove"; neo_current_frame = &fr;
    struct list$1process_pages$pp* __result_obj__0;
    int it2;
    struct list_item$1process_pages$pp* it;
    ...
    while(it!=((void*)0)) {
        ...
        if((!by_pointer&&process_pages_equals(it->item,item))||(by_pointer&&it->item==item)) {
            # 1883 "/home/ab25cq/neo-c/neo-c.h"
            list$1process_pages$pp_delete(self,it2,it2+1);
...
static _Bool process_pages_equals(struct process_pages**  left  , struct process_pages**  right  )
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "process_pages_equals"; neo_current_frame = &fr;
    # 0 "process_pages_equals"
        neo_current_frame = fr.prev;
    return left==right;
    # 1 "process_pages_equals"
        neo_current_frame = fr.prev;
    return (_Bool)1;
            neo_current_frame = fr.prev;
}
...
static struct list$1process_pages$pp* list$1process_pages$pp_delete(struct list$1process_pages$pp* self, int head, int tail)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "list$1process_pages$pp_delete"; neo_current_frame = &fr;
    struct list$1process_pages$pp* __result_obj__0;
    int tmp;
    struct list_item$1process_pages$pp* it;
    int i;
    struct list_item$1process_pages$pp* prev_it;
    struct list_item$1process_pages$pp* it_0;
    int i_1;
    struct list_item$1process_pages$pp* prev_it_2;
    struct list_item$1process_pages$pp* it_3;
    struct list_item$1process_pages$pp* head_prev_it;
    struct list_item$1process_pages$pp* tail_it;
    int i_4;
    struct list_item$1process_pages$pp* prev_it_5;
    ...
    if(head==0&&tail==self->len) {
        ...
        list$1process_pages$pp_reset(self);
    }
    else if(head==0) {
        ...
        while(it!=((void*)0)) {
            ...
            if(i<tail) {
                ...
                come_call_finalizer(list_item$1process_pages$pp$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 1942, 9);
        ...
        while(it_0!=((void*)0)) {
            ...
            if(i_1>=head) {
                ...
                come_call_finalizer(list_item$1process_pages$pp$p_finalize, prev_it_2, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 1972, 10);
        ...
        while(it_3!=((void*)0)) {
            ...
            if(i_4>=head&&i_4<tail) {
                ...
                come_call_finalizer(list_item$1process_pages$pp$p_finalize, prev_it_5, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 2005, 11);
...
static struct list$1process_pages$pp* list$1process_pages$pp_reset(struct list$1process_pages$pp* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "list$1process_pages$pp_reset"; neo_current_frame = &fr;
    struct list$1process_pages$pp* __result_obj__0;
    struct list_item$1process_pages$pp* it;
    struct list_item$1process_pages$pp* prev_it;
    memset(&it, 0, sizeof(it));
    ...
    while(it!=((void*)0)) {
        ...
        come_call_finalizer(list_item$1process_pages$pp$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/home/ab25cq/neo-c/neo-c.h}", 1864, 8);
    }
    # 1867 "/home/ab25cq/neo-c/neo-c.h"
    self->head=((void*)0);
