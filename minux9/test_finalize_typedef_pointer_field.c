...
int main()
{
    ...
    int __result_obj__0;
    memset(&p, 0, sizeof(p));
    # 12 "/home/ab25cq/neo-c/code/test_finalize_typedef_pointer_field.nc"
    p=(struct proc* )come_increment_ref_count((struct proc *)come_calloc(1, sizeof(struct proc )*(1), "/home/ab25cq/neo-c/code/test_finalize_typedef_pointer_field.nc", 12, 1, "struct proc* "), "/home/ab25cq/neo-c/code/test_finalize_typedef_pointer_field.nc", 12, 2);
    # 14 "/home/ab25cq/neo-c/code/test_finalize_typedef_pointer_field.nc"
    __right_value0 = (void*)0;
    __dec_obj1=p->program,
    p->program=(char* )come_increment_ref_count(__builtin_string("hello","/home/ab25cq/neo-c/code/test_finalize_typedef_pointer_field.nc",14), "/home/ab25cq/neo-c/code/test_finalize_typedef_pointer_field.nc", 14, 4);
    __dec_obj1 = come_decrement_ref_count(__dec_obj1, (void*)0, (void*)0, 0,0, (void*)0, "/home/ab25cq/neo-c/code/test_finalize_typedef_pointer_field.nc", 14, 3);
    # 16 "/home/ab25cq/neo-c/code/test_finalize_typedef_pointer_field.nc"
        __result_obj__0 = 0;
    come_call_finalizer(proc_finalize, p, (void*)0, (void*)0, 0, 0, 0, (void*)0, "/home/ab25cq/neo-c/code/test_finalize_typedef_pointer_field.nc}", 16, 6);
...
static void proc_finalize(struct proc*  self  )
{
    ...
    # 1 "proc_finalize"
    # 3 "proc_finalize"
    if(self!=((void*)0)&&self->program!=((void*)0)) {
        # 2 "proc_finalize"
        (self->program = come_decrement_ref_count(self->program, (void*)0, (void*)0, 0, 0, (void*)0, "proc_finalize", 2, 5));
    }
        neo_current_frame = fr.prev;
}
