...
string,sGenericsFun* make_generics_function(sType*% type, string fun_name, sInfo* info, bool array_equal_pointer=true)
{
    ...
    if(generics_fun) {
        ...
        if(!err) {
            ...
            return new tuple2<string,sGenericsFun*>(string(""), (sGenericsFun*)null);
        }
        
        type = type_before;
    }
    
    return new tuple2<string,sGenericsFun*>(clone fun_name2, generics_fun);
}
...
string,sGenericsFun* make_method_generics_function(string fun_name, list<sType*%>*% method_generics_types, sInfo* info)
{
    ...
    return new tuple2<string, sGenericsFun*>(clone fun_name3, generics_fun);
}
...
string, sFun*,sGenericsFun* get_method(char* fun_name, sType*% obj_type, sInfo* info) 
{
            ...
            if(obj_array_type && obj_array_type.mArrayNum.length() > 0) {
                ...
                if(fun) {
                    ...
                    if(fun == null) {
                        ...
                        fun = borrow info.funcs.at(string(generics_fun_name), null);
                        if(fun == null) {
                            return new tuple3<string, sFun*, sGenericsFun*>((string)null, (sFun*)null, (sGenericsFun*)null);
                        }
                    }
                }
            }
                ...
                if(fun == null) {
                    ...
                    if(fun == null) {
                        return new tuple3<string, sFun*, sGenericsFun*>(generics_fun_name, (sFun*)null, (sGenericsFun*)null);
                    }
                }
            }
        }
    ...
    return new tuple3<string, sFun*, sGenericsFun*>(generics_fun_name, fun, generics_fun);
}
...
sNode*% parse_method_call(sNode*% obj, string fun_name, sInfo* info) version 20
{
    ...
    params.push_back(new tuple2<string,sNode*%>((string)null,clone obj));
