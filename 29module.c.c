...
static struct list$1char$ph* list$1char$ph_add(struct list$1char$ph* self, char* item)
{
    ...
    if(self->len==0) {
        ...
        litem_0=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 972, "struct list_item$1char$ph*"))));
        ...
        litem_1=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 982, "struct list_item$1char$ph*"))));
...
static struct list$1sType$ph* list$1sType$ph_add(struct list$1sType$ph* self, struct sType* item)
{
    ...
    if(self->len==0) {
        ...
        litem_13=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "./neo-c.h", 972, "struct list_item$1sType$ph*"))));
        ...
        litem_14=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "./neo-c.h", 982, "struct list_item$1sType$ph*"))));
...
static struct list$1sNode$ph* list$1sNode$ph_add(struct list$1sNode$ph* self, struct sNode* item)
{
    ...
    if(self->len==0) {
        ...
        litem_15=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./neo-c.h", 972, "struct list_item$1sNode$ph*"))));
        ...
        litem_16=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./neo-c.h", 982, "struct list_item$1sNode$ph*"))));
...
static struct list$1int$* list$1int$_add(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        ...
        litem_17=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "./neo-c.h", 972, "struct list_item$1int$*"))));
        ...
        litem_18=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "./neo-c.h", 982, "struct list_item$1int$*"))));
...
;    char* name=0;
    ...
    if(parsecmp("sizeof",info)) {
        ...
        info->p++;
        sline=info->sline;
        value=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "29module.c", 1006, "struct buffer*"))));
        while(1) {
            if(*info->p==34) {
                info->p++;
                p=info->p;
                ...
                if(*info->p==123) {
                    ...
                    (come_push_stackframe("29module.c", 1036, 3),__exception_result_var_b4=expected_next_character(125,info), come_pop_stackframe(), __exception_result_var_b4);
        ...
        buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "29module.c", 1085, "struct buffer*"))));
...
struct sNode* top_level_v91(char* buf, char* head, int head_sline, struct sInfo* info)
{
    ...
    if(charp_operator_equals(buf,"module")) {
        ...
        sline=info->sline;
        params=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "29module.c", 1389, "struct list$1char$ph*"))));
        if(*info->p==60) {
            info->p++;
            skip_spaces_and_lf(info);
            while(1) {
        ...
        (come_push_stackframe("29module.c", 1420, 4),__exception_result_var_b5=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b5);
        source_head=info->p;
        source_tail=((void*)0);
        buf_101=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "29module.c", 1425, "struct buffer*"))));
        squort=0;
        dquort=0;
        nest=1;
        while(1) {
        ...
        module=(struct sClassModule*)come_increment_ref_count(sClassModule_initialize((struct sClassModule*)come_increment_ref_count((struct sClassModule*)come_calloc(1, sizeof(struct sClassModule)*(1), "29module.c", 1491, "struct sClassModule*")),(char*)come_increment_ref_count(type_name),(char*)come_increment_ref_count(buffer_to_string(buf_101)),(char*)come_increment_ref_count(sname),sline));
        ...
        _inf_value2=(struct sNode*)come_calloc(1, sizeof(struct sNode), "29module.c", 1497, "struct sNode");
        _inf_obj_value2=(struct sModuleNode*)come_increment_ref_count(((struct sModuleNode*)(__right_value2=sModuleNode_initialize((struct sModuleNode*)come_increment_ref_count((struct sModuleNode*)come_calloc(1, sizeof(struct sModuleNode)*(1), "29module.c", 1497, "struct sModuleNode*")),(char*)come_increment_ref_count(__builtin_string(type_name)),(struct sClassModule*)come_increment_ref_count(module),info))));
        ...
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        _inf_value3=(struct sNode*)come_calloc(1, sizeof(struct sNode), "29module.c", 1516, "struct sNode");
        _inf_obj_value3=(struct sNothingNode*)come_increment_ref_count(((struct sNothingNode*)(__right_value1=sNothingNode_initialize((struct sNothingNode*)come_increment_ref_count((struct sNothingNode*)come_calloc(1, sizeof(struct sNothingNode)*(1), "29module.c", 1516, "struct sNothingNode*")),info))));
        ...
        (come_push_stackframe("29module.c", 1519, 5),__exception_result_var_b6=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b6);
        no_comma=info->no_comma;
        info->no_comma=1;
        exp=(struct sNode*)come_increment_ref_count(expression_v13(info,0));
        info->no_comma=no_comma;
        (come_push_stackframe("29module.c", 1526, 6),__exception_result_var_b7=expected_next_character(44,info), come_pop_stackframe(), __exception_result_var_b7);
        exp2=(struct sNode*)come_increment_ref_count(expression_v13(info,0));
        (come_push_stackframe("29module.c", 1530, 7),__exception_result_var_b8=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b8);
        _inf_value4=(struct sNode*)come_calloc(1, sizeof(struct sNode), "29module.c", 1532, "struct sNode");
        _inf_obj_value4=(struct sStaticAssert*)come_increment_ref_count(((struct sStaticAssert*)(__right_value1=sStaticAssert_initialize((struct sStaticAssert*)come_increment_ref_count((struct sStaticAssert*)come_calloc(1, sizeof(struct sStaticAssert)*(1), "29module.c", 1532, "struct sStaticAssert*")),(struct sNode*)come_increment_ref_count(exp),(struct sNode*)come_increment_ref_count(exp2),info))));
        ...
        _inf_value5=(struct sNode*)come_calloc(1, sizeof(struct sNode), "29module.c", 1542, "struct sNode");
        _inf_obj_value5=(struct sUndefNode*)come_increment_ref_count(((struct sUndefNode*)(__right_value1=sUndefNode_initialize((struct sUndefNode*)come_increment_ref_count((struct sUndefNode*)come_calloc(1, sizeof(struct sUndefNode)*(1), "29module.c", 1542, "struct sUndefNode*")),(char*)come_increment_ref_count(word_112),info))));
        ...
        if(string_operator_not_equals(reflection_condtional,"false")) {
            (come_push_stackframe("29module.c", 1557, 8),__exception_result_var_b9=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b9);
        ...
        while(1) {
            if(parsecmp("elif",info)) {
                ...
                if(!match_&&string_operator_not_equals(reflection_condtional_113,"false")) {
                    (come_push_stackframe("29module.c", 1584, 9),__exception_result_var_b10=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b10);
                    transpile_toplevel(1,info);
                    match_=1;
                }
                else {
        ...
        if(parsecmp("else",info)) {
            ...
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
            if(!match_) {
                (come_push_stackframe("29module.c", 1601, 10),__exception_result_var_b11=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b11);
                transpile_toplevel(1,info);
            }
            else {
                ((char*)(__right_value0=skip_block(info,0)));
        ...
        _inf_value6=(struct sNode*)come_calloc(1, sizeof(struct sNode), "29module.c", 1609, "struct sNode");
        _inf_obj_value6=(struct sNothingNode*)come_increment_ref_count(((struct sNothingNode*)(__right_value1=sNothingNode_initialize((struct sNothingNode*)come_increment_ref_count((struct sNothingNode*)come_calloc(1, sizeof(struct sNothingNode)*(1), "29module.c", 1609, "struct sNothingNode*")),info))));
        ...
        _inf_value7=(struct sNode*)come_calloc(1, sizeof(struct sNode), "29module.c", 1641, "struct sNode");
        _inf_obj_value7=(struct sNothingNode*)come_increment_ref_count(((struct sNothingNode*)(__right_value1=sNothingNode_initialize((struct sNothingNode*)come_increment_ref_count((struct sNothingNode*)come_calloc(1, sizeof(struct sNothingNode)*(1), "29module.c", 1641, "struct sNothingNode*")),info))));
        ...
        var_name=(char*)come_increment_ref_count(parse_word(0,info));
        (come_push_stackframe("29module.c", 1646, 11),__exception_result_var_b12=expected_next_character(61,info), come_pop_stackframe(), __exception_result_var_b12);
        ...
        _inf_value8=(struct sNode*)come_calloc(1, sizeof(struct sNode), "29module.c", 1652, "struct sNode");
        _inf_obj_value8=(struct sNothingNode*)come_increment_ref_count(((struct sNothingNode*)(__right_value1=sNothingNode_initialize((struct sNothingNode*)come_increment_ref_count((struct sNothingNode*)come_calloc(1, sizeof(struct sNothingNode)*(1), "29module.c", 1652, "struct sNothingNode*")),info))));
        ...
        _inf_value9=(struct sNode*)come_calloc(1, sizeof(struct sNode), "29module.c", 1669, "struct sNode");
        _inf_obj_value9=(struct sNothingNode*)come_increment_ref_count(((struct sNothingNode*)(__right_value1=sNothingNode_initialize((struct sNothingNode*)come_increment_ref_count((struct sNothingNode*)come_calloc(1, sizeof(struct sNothingNode)*(1), "29module.c", 1669, "struct sNothingNode*")),info))));
...
static void map$2char$phsClassModule$ph_rehash(struct map$2char$phsClassModule$ph* self)
{
    ...
    items=(struct sClassModule**)come_increment_ref_count(((struct sClassModule**)(__right_value0=(struct sClassModule**)come_calloc(1, sizeof(struct sClassModule*)*(1*(size)), "./neo-c.h", 2308, "struct sClassModule**"))));
...
static struct list$1char$ph* list$1char$ph_push_back(struct list$1char$ph* self, char* item)
{
    ...
    if(self->len==0) {
        ...
        litem_107=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 1057, "struct list_item$1char$ph*"))));
        ...
        litem_108=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 1067, "struct list_item$1char$ph*"))));
...
static void map$2char$phchar$ph_rehash(struct map$2char$phchar$ph* self)
{
    ...
    size=self->size*10;
    keys=(char**)come_increment_ref_count(((char**)(__right_value0=(char**)come_calloc(1, sizeof(char*)*(1*(size)), "./neo-c.h", 2307, "char**"))));
    items=(char**)come_increment_ref_count(((char**)(__right_value0=(char**)come_calloc(1, sizeof(char*)*(1*(size)), "./neo-c.h", 2308, "char**"))));
    item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value0=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size)), "./neo-c.h", 2309, "_Bool*"))));
    len=0;
