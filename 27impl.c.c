    ...
    if(!gComeC&&charp_operator_equals(buf,"impl")) {
        ...
        if(*info->p==60) {
            ...
            while(1) {
                ...
                list$1char$ph_push_back(info->generics_type_names,(char*)come_increment_ref_count((char*)come_memdup(generics_name, "27impl.c", 18, "char*")));
                if(*info->p==44) {
                    info->p++;
                    skip_spaces_and_lf(info);
                }
        ...
        (come_push_stackframe("27impl.c", 43, 0),__exception_result_var_b1=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b1);
        __dec_obj4=info->impl_type,
        info->impl_type=(struct sType*)come_increment_ref_count((come_push_stackframe("27impl.c", 45, 3),__exception_result_var_b4=(come_push_stackframe("27impl.c", 45, 1),__exception_result_var_b2=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "27impl.c", 45, "struct sType*")),(char*)come_increment_ref_count(word),0,info,0), come_pop_stackframe(), __exception_result_var_b2), come_pop_stackframe(), __exception_result_var_b4));
        ...
        (come_push_stackframe("27impl.c", 81, 4),__exception_result_var_b5=expected_next_character(125,info), come_pop_stackframe(), __exception_result_var_b5);
        list$1char$ph_reset(info->generics_type_names);
        __dec_obj7=info->impl_type,
        info->impl_type=((void*)0);
        come_call_finalizer(sType_finalize, __dec_obj7,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        source_tail=info->p;
        header=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "27impl.c", 87, "struct buffer*"))));
...
static struct list$1char$ph* list$1char$ph_push_back(struct list$1char$ph* self, char* item  )
{
    ...
    if(self->len==0) {
        ...
        litem_0=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1009, "struct list_item$1char$ph*"))));
        ...
        litem_1=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1019, "struct list_item$1char$ph*"))));
