...
_conditional_value_X0;})) {
    ...
    while(1) {
        multiple_assign_var2=(come_push_stackframe("20union.nc", 153, 2),__exception_result_var_b3=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b3);
        ...
        if(*info->p==44) {
            ...
            (come_push_stackframe("20union.nc", 172, 3),__exception_result_var_b4=expected_next_character(59,info), come_pop_stackframe(), __exception_result_var_b4);
        }
        else {
            (come_push_stackframe("20union.nc", 175, 4),__exception_result_var_b5=expected_next_character(59,info), come_pop_stackframe(), __exception_result_var_b5);
            skip_spaces_and_lf(info);
...
_conditional_value_X0;})) {
        ...
        (come_push_stackframe("20union.nc", 256, 5),__exception_result_var_b6=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b6);
        while(1) {
            multiple_assign_var3=(come_push_stackframe("20union.nc", 259, 7),__exception_result_var_b8=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b8);
            ...
            if(*info->p==44) {
                ...
                (come_push_stackframe("20union.nc", 278, 8),__exception_result_var_b9=expected_next_character(59,info), come_pop_stackframe(), __exception_result_var_b9);
                skip_spaces_and_lf(info);
            }
            else {
                (come_push_stackframe("20union.nc", 283, 9),__exception_result_var_b10=expected_next_character(59,info), come_pop_stackframe(), __exception_result_var_b10);
                skip_spaces_and_lf(info);
