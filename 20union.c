    ...
    for(it=map$2char$phbuffer$ph_begin(((struct map$2char$phbuffer$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2325)));!map$2char$phbuffer$ph_end(((struct map$2char$phbuffer$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2325)));it=map$2char$phbuffer$ph_next(((struct map$2char$phbuffer$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2325)))){
        ...
        while((_Bool)1) {
            if(((_Bool*)come_null_checker(item_existance, "/usr/local/include/neo-c.h", 2333))[n]) {
                ...
                ((struct buffer** )come_null_checker(items, "/usr/local/include/neo-c.h", 2351))[n]=((struct buffer* )(__right_value0=map$2char$phbuffer$ph_at(((struct map$2char$phbuffer$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2351)),it,(struct buffer* )come_increment_ref_count(default_value_26),(_Bool)0)));
                len++;
...
struct sUnionNode* sUnionNode_initialize(struct sUnionNode* self, char*  name  , struct sClass*  klass  , struct sInfo*  info  , _Bool anonymous)
{
    ...
    __dec_obj38=((struct sUnionNode*)come_null_checker(self, "20union.nc", 86))->name,
    ...
    __dec_obj39=((struct sUnionNode*)come_null_checker(self, "20union.nc", 88))->pragma,
...
_conditional_value_X0;})) {
        ...
        if(((struct sInfo* )come_null_checker(info, "20union.nc", 123))->parse_struct_recursive_count>=2) {
            ...
            __dec_obj40=((struct sType* )come_null_checker(type, "20union.nc", 125))->mInnerStructName,
        ...
        if(((struct sInfo* )come_null_checker(info, "20union.nc", 141))->parse_struct_recursive_count>=2) {
            ...
            __dec_obj41=((struct sType* )come_null_checker(type_30, "20union.nc", 143))->mInnerStructName,
    ...
    if(string_operator_equals(((char* )come_null_checker(union_attribute, "20union.nc", 152)),"")) {
        ...
        __dec_obj42=((struct sClass* )come_null_checker(klass, "20union.nc", 155))->mAttribute,
    ...
    if(string_operator_equals(((char* )come_null_checker(struct_attribute, "20union.nc", 202)),"")) {
        ...
        if(string_operator_equals(((char* )come_null_checker(union_attribute, "20union.nc", 205)),"")) {
            __dec_obj48=((struct sClass* )come_null_checker(klass, "20union.nc", 206))->mAttribute,
            ...
            __dec_obj49=((struct sClass* )come_null_checker(klass, "20union.nc", 209))->mAttribute,
    ...
    for(it=map$2char$phsClass$ph_begin(((struct map$2char$phsClass$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2325)));!map$2char$phsClass$ph_end(((struct map$2char$phsClass$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2325)));it=map$2char$phsClass$ph_next(((struct map$2char$phsClass$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2325)))){
        ...
        while((_Bool)1) {
            if(((_Bool*)come_null_checker(item_existance, "/usr/local/include/neo-c.h", 2333))[n]) {
                ...
                ((struct sClass** )come_null_checker(items, "/usr/local/include/neo-c.h", 2351))[n]=((struct sClass* )(__right_value0=map$2char$phsClass$ph_at(((struct map$2char$phsClass$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2351)),it,(struct sClass* )come_increment_ref_count(default_value_29),(_Bool)0)));
                len++;
...
static struct list$1tuple2$2char$phsType$ph$ph* list$1tuple2$2char$phsType$ph$ph_push_back(struct list$1tuple2$2char$phsType$ph$ph* self, struct tuple2$2char$phsType$ph* item)
{
    ...
    if(((struct list$1tuple2$2char$phsType$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1122))->len==0) {
        ...
        __dec_obj43=((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(litem, "/usr/local/include/neo-c.h", 1127))->item,
        ...
        ((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(litem_31, "/usr/local/include/neo-c.h", 1135))->prev=((struct list$1tuple2$2char$phsType$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1135))->head;
        ((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(litem_31, "/usr/local/include/neo-c.h", 1136))->next=((void*)0);
        __dec_obj44=((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(litem_31, "/usr/local/include/neo-c.h", 1137))->item,
        ((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(litem_31, "/usr/local/include/neo-c.h", 1137))->item=(struct tuple2$2char$phsType$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple2$2char$phsType$ph$p_finalize, __dec_obj44,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        ((struct list$1tuple2$2char$phsType$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1139))->tail=litem_31;
        ((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(((struct list$1tuple2$2char$phsType$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1140))->head, "/usr/local/include/neo-c.h", 1140))->next=litem_31;
    }
    else {
        litem_32=(struct list_item$1tuple2$2char$phsType$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2char$phsType$ph$ph*)(__right_value0=(struct list_item$1tuple2$2char$phsType$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple2$2char$phsType$ph$ph)*(1), (void*)0, 1143, "struct list_item$1tuple2$2char$phsType$ph$ph*"))));
        ((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(litem_32, "/usr/local/include/neo-c.h", 1145))->prev=((struct list$1tuple2$2char$phsType$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1145))->tail;
        ((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(litem_32, "/usr/local/include/neo-c.h", 1146))->next=((void*)0);
        __dec_obj45=((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(litem_32, "/usr/local/include/neo-c.h", 1147))->item,
        ((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(litem_32, "/usr/local/include/neo-c.h", 1147))->item=(struct tuple2$2char$phsType$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple2$2char$phsType$ph$p_finalize, __dec_obj45,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        ((struct list_item$1tuple2$2char$phsType$ph$ph*)come_null_checker(((struct list$1tuple2$2char$phsType$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1149))->tail, "/usr/local/include/neo-c.h", 1149))->next=litem_32;
        ((struct list$1tuple2$2char$phsType$ph$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 1150))->tail=litem_32;
    }
...
static struct tuple2$2char$phsType$ph* tuple2$2char$phsType$ph_initialize(struct tuple2$2char$phsType$ph* self, char*  v1  , struct sType*  v2  )
{
    ...
    struct tuple2$2char$phsType$ph* __result_obj__0;
    __dec_obj46=((struct tuple2$2char$phsType$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2929))->v1,
    ...
    __dec_obj47=((struct tuple2$2char$phsType$ph*)come_null_checker(self, "/usr/local/include/neo-c.h", 2930))->v2,
...
static struct sUnionNode* sUnionNode_clone(struct sUnionNode* self)
{
    ...
    if(self!=((void*)0)&&((struct sUnionNode*)come_null_checker(self, "sUnionNode_clone", 7))->sname!=((void*)0)) {
        __dec_obj50=((struct sUnionNode* )come_null_checker(result, "sUnionNode_clone", 7))->sname,
    ...
    if(self!=((void*)0)&&((struct sUnionNode*)come_null_checker(self, "sUnionNode_clone", 9))->name!=((void*)0)) {
        __dec_obj51=((struct sUnionNode* )come_null_checker(result, "sUnionNode_clone", 9))->name,
    ...
    if(self!=((void*)0)&&((struct sUnionNode*)come_null_checker(self, "sUnionNode_clone", 11))->pragma!=((void*)0)) {
        __dec_obj52=((struct sUnionNode* )come_null_checker(result, "sUnionNode_clone", 11))->pragma,
...
_conditional_value_X0;})) {
            ...
            if(((struct sInfo* )come_null_checker(info, "20union.nc", 238))->parse_struct_recursive_count>=2) {
                ...
                __dec_obj53=((struct sType* )come_null_checker(type, "20union.nc", 240))->mInnerStructName,
            ...
            if(((struct sInfo* )come_null_checker(info, "20union.nc", 254))->parse_struct_recursive_count>=2) {
                ...
                __dec_obj54=((struct sType* )come_null_checker(type_33, "20union.nc", 256))->mInnerStructName,
        ...
        if(string_operator_equals(((char* )come_null_checker(struct_attribute, "20union.nc", 312)),"")&&string_operator_equals(((char* )come_null_checker(struct_attribute2, "20union.nc", 312)),"")) {
            ...
            __dec_obj55=((struct sClass* )come_null_checker(klass, "20union.nc", 315))->mAttribute,
            ...
            __dec_obj56=((struct sClass* )come_null_checker(klass, "20union.nc", 318))->mAttribute,
            ...
            __dec_obj57=((struct sClass* )come_null_checker(klass, "20union.nc", 321))->mAttribute,
