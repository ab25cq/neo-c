...
struct sForNode* sForNode_initialize(struct sForNode* self, struct sNode* expression_node, struct sNode* expression_node2, struct sNode* expression_node3, struct sBlock*  block  , struct sInfo*  info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sForNode_initialize"; neo_current_frame = &fr;
...
_Bool sForNode_terminated(struct sForNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sForNode_terminated"; neo_current_frame = &fr;
    neo_current_frame = fr.prev;
    return (_Bool)1;
    neo_current_frame = fr.prev;
}
...
char*  sForNode_kind(struct sForNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sForNode_kind"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
...
_Bool sForNode_compile(struct sForNode* self, struct sInfo*  info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sForNode_compile"; neo_current_frame = &fr;
    struct sBlock*  block  ;
    struct sVarTable*  lv_table  ;
    void* __right_value0 = (void*)0;
    ...
    for_var_table=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable* )come_increment_ref_count((struct sVarTable *)come_calloc(1, sizeof(struct sVarTable )*(1), (void*)0, 49, "struct sVarTable* ")),(_Bool)0,lv_table));
...
static struct sBlock*  sBlock_clone(struct sBlock*  self  )
{
    ...
    if(self!=((void*)0)&&self->mVarTable!=((void*)0)) {
        __dec_obj50=result->mVarTable,
        result->mVarTable=(struct sVarTable* )come_increment_ref_count(sVarTable_clone(self->mVarTable));
        come_call_finalizer(sVarTable_finalize, __dec_obj50,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    if(self!=((void*)0)) {
...
static struct list$1sNode$ph* list$1sNode$ph_add(struct list$1sNode$ph* self, struct sNode* item)
{
    ...
    if(self->len==0) {
        ...
        litem_0=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), (void*)0, 629, "struct list_item$1sNode$ph*"))));
        ...
        litem_1=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), (void*)0, 639, "struct list_item$1sNode$ph*"))));
...
static struct sVarTable*  sVarTable_clone(struct sVarTable*  self  )
{
    ...
    struct map$2char$phsVar$ph* __dec_obj49;
    if(self==(void*)0) {
    ...
    if(self!=((void*)0)&&self->mVars!=((void*)0)) {
        __dec_obj49=result->mVars,
        result->mVars=(struct map$2char$phsVar$ph*)come_increment_ref_count(map$2char$phsVar$ph$p_clone(self->mVars));
        come_call_finalizer(map$2char$phsVar$ph_finalize, __dec_obj49,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    if(self!=((void*)0)) {
...
static struct sType*  sType_clone(struct sType*  self  )
{
    ...
    if(self!=((void*)0)&&self->mAnonymousName!=((void*)0)) {
        __dec_obj31=result->mAnonymousName,
    ...
    if(self!=((void*)0)&&self->mInnerStructName!=((void*)0)) {
        __dec_obj32=result->mInnerStructName,
...
static struct list$1int$* list$1int$_add(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        ...
        litem_18=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 629, "struct list_item$1int$*"))));
        ...
        litem_19=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), (void*)0, 639, "struct list_item$1int$*"))));
...
static struct list$1char$ph* list$1char$ph_add(struct list$1char$ph* self, char*  item  )
{
    ...
    if(self->len==0) {
        ...
        litem_20=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), (void*)0, 629, "struct list_item$1char$ph*"))));
        litem_20->prev=self->head;
        litem_20->next=((void*)0);
        __dec_obj42=litem_20->item,
        ...
        litem_21=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), (void*)0, 639, "struct list_item$1char$ph*"))));
        litem_21->prev=self->tail;
        litem_21->next=((void*)0);
        __dec_obj43=litem_21->item,
...
static void sForNode_finalize(struct sForNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sForNode_finalize"; neo_current_frame = &fr;
    if(self!=((void*)0)&&self->sname!=((void*)0)) {
        (self->sname = come_decrement_ref_count(self->sname, (void*)0, (void*)0, 0, 0, (void*)0));
    }
...
struct sNode* string_node_v11(char* buf, char* head, int head_sline, struct sInfo*  info  )
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "string_node_v11"; neo_current_frame = &fr;
    struct sNode* expression_node;
    ...
    if(charp_operator_equals(buf,"for")) {
        ...
        list$1tuple2$2char$phsNode$ph$ph_add(params,(struct tuple2$2char$phsNode$ph*)come_increment_ref_count(tuple2$2char$phsNode$ph_initialize((struct tuple2$2char$phsNode$ph*)come_increment_ref_count((struct tuple2$2char$phsNode$ph*)come_calloc(1, sizeof(struct tuple2$2char$phsNode$ph)*(1), "16for.nc", 177, "struct tuple2$2char$phsNode$ph")),(char*)come_increment_ref_count(xsprintf("self")),(struct sNode*)come_increment_ref_count(create_load_var(((char*)(__right_value1=xsprintf("o2_saved"))),info)))));
        ...
        list$1tuple2$2char$phsNode$ph$ph_add(params2,(struct tuple2$2char$phsNode$ph*)come_increment_ref_count(tuple2$2char$phsNode$ph_initialize((struct tuple2$2char$phsNode$ph*)come_increment_ref_count((struct tuple2$2char$phsNode$ph*)come_calloc(1, sizeof(struct tuple2$2char$phsNode$ph)*(1), "16for.nc", 184, "struct tuple2$2char$phsNode$ph")),(char*)come_increment_ref_count(xsprintf("self")),(struct sNode*)come_increment_ref_count(create_load_var(((char*)(__right_value1=xsprintf("o2_saved"))),info)))));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        list$1tuple2$2char$phsNode$ph$ph_add(params3,(struct tuple2$2char$phsNode$ph*)come_increment_ref_count(tuple2$2char$phsNode$ph_initialize((struct tuple2$2char$phsNode$ph*)come_increment_ref_count((struct tuple2$2char$phsNode$ph*)come_calloc(1, sizeof(struct tuple2$2char$phsNode$ph)*(1), "16for.nc", 191, "struct tuple2$2char$phsNode$ph")),(char*)come_increment_ref_count(xsprintf("self")),(struct sNode*)come_increment_ref_count(create_load_var(((char*)(__right_value1=xsprintf("o2_saved"))),info)))));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
...
static struct sForNode* sForNode_clone(struct sForNode* self)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "sForNode_clone"; neo_current_frame = &fr;
    struct sForNode* __result_obj__0;
    void* __right_value0 = (void*)0;
    ...
    if(self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj59=result->mExpressionNode,
    ...
    if(self!=((void*)0)&&self->mExpressionNode2!=((void*)0)) {
        __dec_obj60=result->mExpressionNode2,
    ...
    if(self!=((void*)0)&&self->mExpressionNode3!=((void*)0)) {
        __dec_obj61=result->mExpressionNode3,
