...
struct list$1tuple2$2sType$phchar$ph$ph* __dec_obj35;
struct sTypedefNode* __result_obj__27;
    ...
    come_call_finalizer(list$1tuple2$2sType$phchar$ph$ph_finalize, __dec_obj35,(void*)0, (void*)0, 0, 0, 0, (void*)0);
...
_Bool __result_obj__79;
    ...
    if(    string_operator_equals(type_name,"__darwin_va_list")    ) {
        ...
        __right_value0 = (void*)0;
        __dec_obj39=type->mOriginalTypeName,
        ...
        if(        list$1sNode$ph_length(type->mArrayNum)>0        ) {
            ...
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            map$2char$phbuffer$ph_insert(info->previous_struct_definition,(char*)come_increment_ref_count(__builtin_string(type_name)),(struct buffer*)come_increment_ref_count(charp_to_buffer("typedef __builtin_va_list __darwin_va_list;\n")));
        }
        come_call_finalizer(sType_finalize, type, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
        ...
        for(        o2_saved=(struct list$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(self->multiple_declare),it=list$1tuple2$2sType$phchar$ph$ph_begin(o2_saved)        ;        !list$1tuple2$2sType$phchar$ph$ph_end(o2_saved)        ;        it=list$1tuple2$2sType$phchar$ph$ph_next(o2_saved)        ){
            ...
            if(            string_operator_not_equals(type_name_32,"va_list")            ) {
                __right_value0 = (void*)0;
                __dec_obj40=type_31->mOriginalTypeName,
            ...
            if(            list$1sNode$ph_length(type_31->mArrayNum)>0            ) {
                ...
                __right_value2 = (void*)0;
                __right_value3 = (void*)0;
                map$2char$phbuffer$ph_insert(info->previous_struct_definition,(char*)come_increment_ref_count(__builtin_string(type_name_32)),(struct buffer*)come_increment_ref_count(charp_to_buffer(((char*)(__right_value2=xsprintf("typedef %s;\n",((char*)(__right_value1=make_define_var(type_31,type_name_32,info,(_Bool)0,(_Bool)1)))))))));
                (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
                (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0));
            }
        ...
        if(        string_operator_not_equals(type_name,"va_list")        ) {
            __right_value0 = (void*)0;
            __dec_obj41=type_33->mOriginalTypeName,
        ...
        if(        list$1sNode$ph_length(type_33->mArrayNum)>0        ) {
            ...
            __right_value2 = (void*)0;
            __right_value3 = (void*)0;
            map$2char$phbuffer$ph_insert(info->previous_struct_definition,(char*)come_increment_ref_count(__builtin_string(type_name)),(struct buffer*)come_increment_ref_count(charp_to_buffer(((char*)(__right_value2=xsprintf("typedef %s;\n",((char*)(__right_value1=make_define_var(type_33,type_name,info,(_Bool)0,(_Bool)1)))))))));
            (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
            (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0));
        }
...
struct tuple2$2sType$phchar$ph* __dec_obj30;
/*a*/struct list_item$1tuple2$2sType$phchar$ph$ph* litem_8;
struct tuple2$2sType$phchar$ph* __dec_obj31;
...
struct list$1tuple2$2sType$phchar$ph$ph* __result_obj__23;
    if(    self->len==0    ) {
        ...
        come_call_finalizer(tuple2$2sType$phchar$ph$p_finalize, __dec_obj30,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        self->tail=litem;
        self->head=litem;
    }
    else if(    self->len==1    ) {
        ...
        come_call_finalizer(tuple2$2sType$phchar$ph$p_finalize, __dec_obj31,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        self->tail=litem_8;
...
struct sNode* __result_obj__88;
    ...
    if(    charp_operator_equals(buf,"typedef")    ) {
        ...
        if(        *info->p==44        ) {
            ...
            __right_value0 = (void*)0;
            variable_name2=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(parse_variable_name((struct sType*)come_increment_ref_count(base_type),(_Bool)1,info));
            ...
            while(            *info->p==44            ) {
                ...
                skip_spaces_and_lf(info);
                __right_value0 = (void*)0;
                variable_name_36=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(parse_variable_name((struct sType*)come_increment_ref_count(base_type),(_Bool)0,info));
            ...
            if(            !Value_40            ) {
                __result_obj__86 = (void*)come_increment_ref_count(((void*)0));
...
struct tuple2$2sType$phchar$ph* __dec_obj45;
...
struct list$1tuple2$2sType$phchar$ph$ph* __result_obj__81;
    if(    self->len==0    ) {
        ...
        litem->item=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple2$2sType$phchar$ph_finalize, __dec_obj44,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        self->tail=litem;
        self->head=litem;
    }
    else if(    self->len==1    ) {
        ...
        __dec_obj45=litem_34->item,
        litem_34->item=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(item);
        come_call_finalizer(tuple2$2sType$phchar$ph_finalize, __dec_obj45,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        self->tail=litem_34;
...
struct list$1tuple2$2sType$phchar$ph$ph* __dec_obj50;
struct sTypedefNode* __result_obj__83;
    ...
    if(    self!=((void*)0)&&self->multiple_declare!=((void*)0)    ) {
        __right_value0 = (void*)0;
        __dec_obj50=result->multiple_declare,
        ...
        come_call_finalizer(list$1tuple2$2sType$phchar$ph$ph_finalize, __dec_obj50,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    ...
    if(    charp_operator_equals(buf,"typedef")    ) {
        ...
        if(        *info->p==44        ) {
            ...
            while(            *info->p==44            ) {
                ...
                skip_spaces_and_lf(info);
                __right_value0 = (void*)0;
                variable_name_41=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(parse_variable_name((struct sType*)come_increment_ref_count(base_type),(_Bool)0,info));
            ...
            if(            !Value_45            ) {
                __result_obj__91 = (void*)come_increment_ref_count(((void*)0));
