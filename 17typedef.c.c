    ...
    if(    string_operator_equals(type_name,"__darwin_va_list")    ) {
        ...
        for(        o2_saved=(struct list$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(self->multiple_declare),it=list$1tuple2$2sType$phchar$ph$ph_begin(o2_saved)        ;        !list$1tuple2$2sType$phchar$ph$ph_end(o2_saved)        ;        it=list$1tuple2$2sType$phchar$ph$ph_next(o2_saved)        ){
            ...
            if(            string_operator_not_equals(type_name_32,"va_list")            ) {
                __right_value0 = (void*)0;
                __dec_obj44=type_31->mOriginalTypeName,
        ...
        if(        string_operator_not_equals(type_name,"va_list")        ) {
            __right_value0 = (void*)0;
            __dec_obj45=type_33->mOriginalTypeName,
...
struct list$1tuple2$2sType$phchar$ph$ph* __result_obj__26;
    ...
    result=(struct list$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(list$1tuple2$2sType$phchar$ph$ph_initialize((struct list$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count((struct list$1tuple2$2sType$phchar$ph$ph*)come_calloc_v2(1, sizeof(struct list$1tuple2$2sType$phchar$ph$ph)*(1), "./neo-c.h", 1066, "struct list$1tuple2$2sType$phchar$ph$ph*"))));
    it=self->head;
    while(    it!=((void*)0)    ) {
        if(        1        ) {
            __right_value0 = (void*)0;
...
struct list$1tuple2$2sType$phchar$ph$ph* __result_obj__23;
    if(    self->len==0    ) {
        litem=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc_v2(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), "./neo-c.h", 1085, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        ...
        __right_value0 = (void*)0;
        litem_8=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc_v2(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), "./neo-c.h", 1095, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_9=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc_v2(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), "./neo-c.h", 1105, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
...
struct list$1char$ph* __result_obj__49;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_21=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 1173, "struct list_item$1char$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_22=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 1183, "struct list_item$1char$ph*"))));
...
struct sType* default_value_25;
    ...
    keys=(char**)come_increment_ref_count(((char**)(__right_value0=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size)), "./neo-c.h", 2281, "char**"))));
    __right_value0 = (void*)0;
    items=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value0=(struct sType**)come_calloc_v2(1, sizeof(struct sType*)*(1*(size)), "./neo-c.h", 2282, "struct sType**"))));
    __right_value0 = (void*)0;
    item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value0=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size)), "./neo-c.h", 2283, "_Bool*"))));
    len=0;
...
struct buffer* default_value_28;
    ...
    keys=(char**)come_increment_ref_count(((char**)(__right_value0=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size)), "./neo-c.h", 2281, "char**"))));
    __right_value0 = (void*)0;
    items=(struct buffer**)come_increment_ref_count(((struct buffer**)(__right_value0=(struct buffer**)come_calloc_v2(1, sizeof(struct buffer*)*(1*(size)), "./neo-c.h", 2282, "struct buffer**"))));
    __right_value0 = (void*)0;
    item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value0=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size)), "./neo-c.h", 2283, "_Bool*"))));
    len=0;
    for(    it=map$2char$phbuffer$ph_begin(self)    ;    !map$2char$phbuffer$ph_end(self)    ;    it=map$2char$phbuffer$ph_next(self)    ){
        ...
        while(        1        ) {
            if(            item_existance[n]            ) {
                ...
                item_existance[n]=1;
                keys[n]=it;
                memset(&default_value_28,0,sizeof(struct buffer*));
                __right_value0 = (void*)0;
...
struct sNode* __result_obj__88;
    ...
    if(    charp_operator_equals(buf,"typedef")    ) {
        ...
        info->in_typedef=1;
        multiple_assign_var2=(come_push_stackframe("17typedef.c", 94, 4),__exception_result_var_b5=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b5);
        ...
        if(        *info->p==44        ) {
            ...
            __right_value0 = (void*)0;
            variable_name2=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(parse_variable_name_on_multiple_declare((struct sType*)come_increment_ref_count(base_type),1,info));
            ...
            while(            *info->p==44            ) {
                ...
                skip_spaces_and_lf(info);
                __right_value0 = (void*)0;
                variable_name_36=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(parse_variable_name_on_multiple_declare((struct sType*)come_increment_ref_count(base_type),0,info));
...
struct list$1tuple2$2sType$phchar$ph$ph* __result_obj__81;
    if(    self->len==0    ) {
        litem=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc_v2(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), "./neo-c.h", 1163, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        ...
        __right_value0 = (void*)0;
        litem_34=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc_v2(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), "./neo-c.h", 1173, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        ...
        come_call_finalizer(tuple2$2sType$phchar$ph_finalize, __dec_obj49,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        self->tail=litem_34;
        self->head->next=litem_34;
    }
    else {
        __right_value0 = (void*)0;
        litem_35=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2sType$phchar$ph$ph*)(__right_value0=(struct list_item$1tuple2$2sType$phchar$ph$ph*)come_calloc_v2(1, sizeof(struct list_item$1tuple2$2sType$phchar$ph$ph)*(1), "./neo-c.h", 1183, "struct list_item$1tuple2$2sType$phchar$ph$ph*"))));
        ...
        come_call_finalizer(tuple2$2sType$phchar$ph_finalize, __dec_obj50,(void*)0, (void*)0, 0, 0, 0, (void*)0);
...
struct sTypedefNode* __result_obj__83;
    ...
    if(    self!=((void*)0)&&self->multiple_declare!=((void*)0)    ) {
        ...
        come_call_finalizer(list$1tuple2$2sType$phchar$ph$ph_finalize, __dec_obj54,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
...
struct sNode* __result_obj__93;
    if(    charp_operator_equals(buf,"typedef")    ) {
        in_typedef=info->in_typedef;
        info->in_typedef=1;
        multiple_assign_var3=(come_push_stackframe("17typedef.c", 164, 6),__exception_result_var_b7=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b7);
        ...
        if(        *info->p==44        ) {
            ...
            while(            *info->p==44            ) {
                ...
                skip_spaces_and_lf(info);
                __right_value0 = (void*)0;
                variable_name_41=(struct tuple2$2sType$phchar$ph*)come_increment_ref_count(parse_variable_name_on_multiple_declare((struct sType*)come_increment_ref_count(base_type),0,info));
