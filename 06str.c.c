...
memset(&litem_114, 0, sizeof(struct list_item$1sNodeph*));
        ...
        if(_if_conditional159=self->len==0,        _if_conditional159) {
            # 217 "/usr/local/include/neo-c.h"
            litem_112=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value184=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/neo-c.h", 217, "list_item$1sNodeph"))));
            ...
            if(_if_conditional160=self->len==1,            _if_conditional160) {
                # 227 "/usr/local/include/neo-c.h"
                litem_113=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value185=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/neo-c.h", 227, "list_item$1sNodeph"))));
                ...
                # 237 "/usr/local/include/neo-c.h"
                litem_114=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value186=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/neo-c.h", 237, "list_item$1sNodeph"))));
...
memset(&litem_132, 0, sizeof(struct list_item$1sTypeph*));
        ...
        if(_if_conditional169=self->len==0,        _if_conditional169) {
            # 217 "/usr/local/include/neo-c.h"
            litem_130=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value198=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/neo-c.h", 217, "list_item$1sTypeph"))));
            ...
            if(_if_conditional170=self->len==1,            _if_conditional170) {
                # 227 "/usr/local/include/neo-c.h"
                litem_131=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value199=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/neo-c.h", 227, "list_item$1sTypeph"))));
                ...
                # 237 "/usr/local/include/neo-c.h"
                litem_132=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value200=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/neo-c.h", 237, "list_item$1sTypeph"))));
                    ...
                    if(_if_conditional268=*info->p==76&&*(info->p+1)==39,                    _if_conditional268) {
                        ...
                        if(_if_conditional269=*info->p==92,                        _if_conditional269) {
                            ...
                            if(_if_conditional272=p2_267>127,                            _if_conditional272) {
                                ...
                                # 1341 "06str.c"
                                char str_269[6+1];
                                memset(&str_269, 0, sizeof(char)                                *(6+1)                                );
                                # 1343 "06str.c"
                                size_268=((p2_267&128)>>7)+((p2_267&64)>>6)+((p2_267&32)>>5)+((p2_267&16)>>4);
                                # 1362 "06str.c"
                                # 1345 "06str.c"
                                if(_if_conditional273=size_268>6,                                _if_conditional273) {
                                    # 1346 "06str.c"
                        ...
                        if(_if_conditional281=*info->p==76&&*(info->p+1)==34,                        _if_conditional281) {
                            ...
                            # 1511 "06str.c"
                            wstr_283=(int*)come_increment_ref_count(((int*)(right_value386=(int*)come_calloc(1, sizeof(int)*(1*(len_282+1)), "06str.c", 1511, "int"))));
                            ...
                            _inf_obj_value6=come_increment_ref_count(((struct sWStringNode*)(right_value388=sWStringNode_initialize((struct sWStringNode*)come_increment_ref_count(((struct sWStringNode*)(right_value387=(struct sWStringNode*)come_calloc(1, sizeof(struct sWStringNode)*(1), "06str.c", 1522, "sWStringNode")))),(int*)come_increment_ref_count(wstr_283),sline_271,info))));
...
right_value391 = (void*)0;
                                ...
                                if(_if_conditional295=self!=((void*)0)&&self->value!=((void*)0),                                _if_conditional295) {
                                    ...
                                    result_285->value=(int*)come_increment_ref_count(((int*)(right_value391=(int*)come_memdup(self->value, "sWStringNode_clone", 6, "int*"))));
