...
struct sNode* string_node_v9(char* buf, char* head, int head_sline, struct sInfo* info  )
{
    ...
    if(charp_operator_equals(buf,"while")) {
        ...
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "15while.c", 70, "struct sNode");
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value1=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "15while.c", 70, "struct sWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node),block,info))));
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self)
{
    ...
    result=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode*"));
    if(self!=((void*)0)) {
        result->sline=self->sline;
    }
    if(self!=((void*)0)&&self->sname!=((void*)0)) {
