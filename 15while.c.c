...
struct sWhileNode* sWhileNode_initialize(struct sWhileNode* self, struct sNode* expression_node, struct sBlock* block  , struct sInfo* info  )
{
    ...
    __result_obj__0 = (struct sWhileNode*)come_increment_ref_count(self);
    ...
    come_call_finalizer(sWhileNode_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* sWhileNode_kind(struct sWhileNode* self)
{
    ...
    __result_obj__0 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string("sWhileNode"))));
...
struct sNode* string_node_v9(char* buf, char* head, int head_sline, struct sInfo* info  )
{
    ...
    if(charp_operator_equals(buf,"while")) {
        sname=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "15while.c", 58, "char*"));
        sline=info->sline;
        (come_push_stackframe("15while.c", 61, 0),__exception_result_var_b1=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b1);
        expression_node=(struct sNode*)come_increment_ref_count(expression_v13(info,0));
        (come_push_stackframe("15while.c", 66, 1),__exception_result_var_b2=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b2);
        block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
        _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "15while.c", 70, "struct sNode");
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value1=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc_v2(1, sizeof(struct sWhileNode)*(1), "15while.c", 70, "struct sWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node),block,info))));
    ...
    __result_obj__0 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value0=string_node_v8(buf,head,head_sline,info))));
