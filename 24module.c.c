...
_Bool sStaticAssert_compile(struct sStaticAssert* self, struct sInfo* info)
{
    ...
    come_value3=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "24module.c", 56, "struct CVALUE*"))));
...
struct sNode* static_assert_node(struct sNode* exp, struct sNode* exp2, struct sInfo* info)
{
    ...
    _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "24module.c", 113, "struct sNode");
...
;    char* name=0;
    ...
    if(parsecmp("sizeof",info)) {
        ...
        info->p++;
        sline=info->sline;
        value=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "24module.c", 1006, "struct buffer*"))));
        while(1) {
            if(*info->p==34) {
                info->p++;
                p=info->p;
        ...
        buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "24module.c", 1085, "struct buffer*"))));
...
struct sNode* top_level_v91(char* buf, char* head, int head_sline, struct sInfo* info)
{
    ...
    if(charp_operator_equals(buf,"module")) {
        ...
        sline=info->sline;
        params=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "24module.c", 1389, "struct list$1char$ph*"))));
        if(*info->p==60) {
            info->p++;
            skip_spaces_and_lf(info);
            while(1) {
        ...
        source_head=info->p;
        source_tail=((void*)0);
        buf_101=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "24module.c", 1425, "struct buffer*"))));
        squort=0;
        dquort=0;
        nest=1;
        while(1) {
        ...
        _inf_value2=(struct sNode*)come_calloc(1, sizeof(struct sNode), "24module.c", 1497, "struct sNode");
        ...
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        _inf_value3=(struct sNode*)come_calloc(1, sizeof(struct sNode), "24module.c", 1516, "struct sNode");
        _inf_obj_value3=(struct sNothingNode*)come_increment_ref_count(((struct sNothingNode*)(__right_value1=sNothingNode_initialize((struct sNothingNode*)come_increment_ref_count((struct sNothingNode*)come_calloc(1, sizeof(struct sNothingNode)*(1), "24module.c", 1516, "struct sNothingNode*")),info))));
        ...
        _inf_value4=(struct sNode*)come_calloc(1, sizeof(struct sNode), "24module.c", 1532, "struct sNode");
        ...
        _inf_value5=(struct sNode*)come_calloc(1, sizeof(struct sNode), "24module.c", 1542, "struct sNode");
        _inf_obj_value5=(struct sUndefNode*)come_increment_ref_count(((struct sUndefNode*)(__right_value1=sUndefNode_initialize((struct sUndefNode*)come_increment_ref_count((struct sUndefNode*)come_calloc(1, sizeof(struct sUndefNode)*(1), "24module.c", 1542, "struct sUndefNode*")),(char*)come_increment_ref_count(word_112),info))));
        ...
        _inf_value6=(struct sNode*)come_calloc(1, sizeof(struct sNode), "24module.c", 1609, "struct sNode");
        _inf_obj_value6=(struct sNothingNode*)come_increment_ref_count(((struct sNothingNode*)(__right_value1=sNothingNode_initialize((struct sNothingNode*)come_increment_ref_count((struct sNothingNode*)come_calloc(1, sizeof(struct sNothingNode)*(1), "24module.c", 1609, "struct sNothingNode*")),info))));
        ...
        _inf_value7=(struct sNode*)come_calloc(1, sizeof(struct sNode), "24module.c", 1641, "struct sNode");
        _inf_obj_value7=(struct sNothingNode*)come_increment_ref_count(((struct sNothingNode*)(__right_value1=sNothingNode_initialize((struct sNothingNode*)come_increment_ref_count((struct sNothingNode*)come_calloc(1, sizeof(struct sNothingNode)*(1), "24module.c", 1641, "struct sNothingNode*")),info))));
        ...
        _inf_value8=(struct sNode*)come_calloc(1, sizeof(struct sNode), "24module.c", 1652, "struct sNode");
        _inf_obj_value8=(struct sNothingNode*)come_increment_ref_count(((struct sNothingNode*)(__right_value1=sNothingNode_initialize((struct sNothingNode*)come_increment_ref_count((struct sNothingNode*)come_calloc(1, sizeof(struct sNothingNode)*(1), "24module.c", 1652, "struct sNothingNode*")),info))));
        ...
        _inf_value9=(struct sNode*)come_calloc(1, sizeof(struct sNode), "24module.c", 1669, "struct sNode");
        _inf_obj_value9=(struct sNothingNode*)come_increment_ref_count(((struct sNothingNode*)(__right_value1=sNothingNode_initialize((struct sNothingNode*)come_increment_ref_count((struct sNothingNode*)come_calloc(1, sizeof(struct sNothingNode)*(1), "24module.c", 1669, "struct sNothingNode*")),info))));
