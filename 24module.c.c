...
struct sClassModule* default_value_84;
    ...
    __right_value0 = (void*)0;
    items=(struct sClassModule**)come_increment_ref_count(((struct sClassModule**)(__right_value0=(struct sClassModule**)come_calloc_v2(1, sizeof(struct sClassModule*)*(1*(size)), "./neo-c.h", 2281, "struct sClassModule**"))));
    __right_value0 = (void*)0;
