...
static struct list$1char$ph* list$1char$ph_add(struct list$1char$ph* self, char* item)
{
    ...
    if(self->len==0) {
        ...
        litem_0=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 1103, "struct list_item$1char$ph*"))));
        ...
        litem_1=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 1113, "struct list_item$1char$ph*"))));
...
static void map$2char$phsClassModule$ph_rehash(struct map$2char$phsClassModule$ph* self)
{
    ...
    items=(struct sClassModule**)come_increment_ref_count(((struct sClassModule**)(__right_value0=(struct sClassModule**)come_calloc_v2(1, sizeof(struct sClassModule*)*(1*(size)), "./neo-c.h", 2439, "struct sClassModule**"))));
...
static struct list$1char$ph* list$1char$ph_push_back(struct list$1char$ph* self, char* item)
{
    ...
    if(self->len==0) {
        ...
        litem_99=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 1188, "struct list_item$1char$ph*"))));
        ...
        litem_100=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 1198, "struct list_item$1char$ph*"))));
