...
_conditional_value_X0;})) {
        ...
        come_value_20->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "12var.nc", 98, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0));
...
_conditional_value_X5;})) {
            ...
            come_value_55->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "12var.nc", 329, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0));
...
_conditional_value_X6;})) {
        ...
        if(left_type_66->mChannel&&new_channel_58) {
            ...
            come_value_67->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "12var.nc", 448, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0));
...
_Bool sWriteChannelNode_compile(struct sWriteChannelNode* self, struct sInfo* info  )
{
    ...
    come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "12var.nc", 568, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0));
        ...
        if(var_==((void*)0)) {
            ...
            if(fun) {
                ...
                if(var_==((void*)0)) {
                    ...
                    come_value_71->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "12var.nc", 710, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0));
...
;    struct sType* type_129  =0;
    ...
    if(is_type_name_flag&&!info->in_offsetof) {
        ...
        if(xisalpha(*info->p)||*info->p==95) {
            ...
            multiple_assign_var2=(come_push_stackframe("12var.nc", 905, 1),__exception_result_var_b2=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b2);
    ...
    if(is_type_name_flag&&info->defining_class&&!info->in_offsetof) {
        ...
        info->sline=head_sline;
        skip_spaces_and_lf(info);
        multiple_assign_var4=(come_push_stackframe("12var.nc", 955, 3),__exception_result_var_b4=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b4);
        ...
        come_call_finalizer(tuple3$3sType$phchar$ph_Bool$$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
        skip_spaces_and_lf(info);
        if(err_98&&(come_push_stackframe("12var.nc", 958, 4),__exception_result_var_b5=parsecmp("self",info), come_pop_stackframe(), __exception_result_var_b5)) {
            attr_define=1;
        }
        info->p=p_93;
        info->sline=sline_94;
    ...
    if((!gComeC&&charp_operator_equals(buf,"var"))||charp_operator_equals(buf,"auto")||charp_operator_equals(buf,"__auto_type")) {
        ...
        skip_spaces_and_lf(info);
        multiple_assign_var5=(come_push_stackframe("12var.nc", 1028, 6),__exception_result_var_b7=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b7);
        ...
        info->sline=head_sline;
        skip_spaces_and_lf(info);
        multiple_assign_var8=(come_push_stackframe("12var.nc", 1120, 8),__exception_result_var_b9=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b9);
...
_conditional_value_X0;})) {
        ...
        if(is_type_name_flag_128) {
            skip_spaces_and_lf(info);
            multiple_assign_var9=(come_push_stackframe("12var.nc", 1205, 10),__exception_result_var_b11=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b11);
