...
class sFunCallNode extends sNodeBase
{
    ...
    bool compile(sInfo* info)
    {
        ...
        if(fun_name === "__builtin_types_compatible_p") {
            ...
            || fun_name === "__c11_atomic_compare_exchange_strong"
            || fun_name === "__c11_atomic_compare_exchange_weak"
            || fun_name === "__c11_atomic_compare_exchange_strong_explicit"
            || fun_name === "__c11_atomic_compare_exchange_weak_explicit"
            ...
            || fun_name === "__c11_atomic_fetch_add_explicit"
