...
int main()
{
    ...
    struct A*  __dec_obj2  ;
    int __result_obj__0;
    a=(struct A* )come_increment_ref_count(({__new_obj__2 = (struct A *)come_calloc(1, sizeof(struct A )*(1), "/tmp/cycle_warn_weak.nc", 14, "struct A* ");__new_obj__2->b = ((void*)0);__new_obj__2; }));
    __right_value0 = (void*)0;
    b=(B* )come_increment_ref_count(({__new_obj__3 = (B *)come_calloc(1, sizeof(B )*(1), "/tmp/cycle_warn_weak.nc", 15, "B* ");__new_obj__3->a = ((void*)0);__new_obj__3; }));
    __dec_obj1=a->b,
