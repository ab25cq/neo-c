...
list$1int$_initialize_with_values((struct list$1int$*)come_increment_ref_count((struct list$1int$*)come_calloc(1, sizeof(struct list$1int$)*(1), "/tmp/find_expected.nc", 5, "struct list$1int$")),7,__list_values1__)));
    n=3;
    li2=(struct list$1char$ph*)come_increment_ref_count(({__right_value0 = (void*)0;
__right_value1 = (void*)0;
_li_7=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "/tmp/find_expected.nc", 33, "struct list$1char$ph*")))); i_8=0; for(({(_conditional_value_X0=(_o2_saved_2=(struct list$1int$*)come_increment_ref_count(li),it_9=list$1int$_begin(_o2_saved_2)));_conditional_value_X0;});({(_conditional_value_X1=(!list$1int$_end(_o2_saved_2)));_conditional_value_X1;});({(_conditional_value_X2=(it_9=list$1int$_next(_o2_saved_2)));_conditional_value_X2;})){
if(i_8<n) {
result_10=it_9>2;
if(result_10) {
