...
int main();
static void A_finalize(struct A*  self  );
void stackframe();
...
int main()
{
    ...
    struct A*  __dec_obj2  ;
    int __result_obj__0;
    a=(struct A* )come_increment_ref_count(({__new_obj__2 = (struct A *)come_calloc(1, sizeof(struct A )*(1), "/tmp/cycle_warn_plain.nc", 14, "struct A* ");__new_obj__2->b = ((void*)0);__new_obj__2; }));
    __right_value0 = (void*)0;
    b=(B* )come_increment_ref_count(({__new_obj__3 = (B *)come_calloc(1, sizeof(B )*(1), "/tmp/cycle_warn_plain.nc", 15, "B* ");__new_obj__3->a = ((void*)0);__new_obj__3; }));
    __dec_obj1=a->b,
    a->b=(B* )come_increment_ref_count(b);
    __dec_obj1 = come_decrement_ref_count(__dec_obj1, (void*)0, (void*)0, 0,0, (void*)0);
    __dec_obj2=b->a,
    b->a=(struct A* )come_increment_ref_count(a);
    come_call_finalizer(A_finalize, __dec_obj2,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        __result_obj__0 = 0;
    come_call_finalizer(A_finalize, a, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (b = come_decrement_ref_count(b, (void*)0, (void*)0, 0, 0, (void*)0));
...
static void A_finalize(struct A*  self  )
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "A_finalize"; neo_current_frame = &fr;
    if(self!=((void*)0)&&self->b!=((void*)0)) {
        (self->b = come_decrement_ref_count(self->b, (void*)0, (void*)0, 0, 0, (void*)0));
    }
        neo_current_frame = fr.prev;
}
...
char*  charp_sub_block(char* self, const char* reg, _Bool global, _Bool ignore_case, void* parent, char* (*block)(void*,char*,struct list$1char$ph*))
{
    ...
    while((_Bool)1) {
        ...
        if(regex_result>=0&&group_count==0) {
            ...
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            group_strings_36=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 7560, "struct list$1char$ph*"))));
            for(i=0            ;i<group_count;i++){
                cp=&captures[i];
                __right_value0 = (void*)0;
...
struct list$1char$ph* charp_scan_block(const char* self, const char* reg, _Bool ignore_case, void* parent, char* (*block)(void*,char*,struct list$1char$ph*))
{
    ...
    while((_Bool)1) {
        ...
        if(regex_result>=0&&group_count==0) {
            ...
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            group_strings_41=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 7636, "struct list$1char$ph*"))));
            for(i=0            ;i<group_count;i++){
                cp=&captures[i];
                __right_value0 = (void*)0;
