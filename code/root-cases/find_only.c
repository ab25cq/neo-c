...
list$1int$_initialize_with_values((struct list$1int$*)come_increment_ref_count((struct list$1int$*)come_calloc(1, sizeof(struct list$1int$)*(1), "/tmp/find_only.nc", 3, "struct list$1int$")),4,__list_values1__)));
    r=(struct list$1int$*)come_increment_ref_count(({__right_value0 = (void*)0;
__right_value1 = (void*)0;
_li_6=(struct list$1int$*)come_increment_ref_count(list$1int$_initialize((struct list$1int$*)come_increment_ref_count((struct list$1int$*)come_calloc(1, sizeof(struct list$1int$)*(1), "/tmp/find_only.nc", 25, "struct list$1int$*")))); i_7=0; for(({(_conditional_value_X0=(_o2_saved_2=(struct list$1int$*)come_increment_ref_count(li),it_8=list$1int$_begin(_o2_saved_2)));_conditional_value_X0;});({(_conditional_value_X1=(!list$1int$_end(_o2_saved_2)));_conditional_value_X1;});({(_conditional_value_X2=(it_8=list$1int$_next(_o2_saved_2)));_conditional_value_X2;})){
result_9=it_8>2;
if(result_9) {
...
({}); _li_6; }));
    ...
    puts(((char* )(__right_value0=list$1int$_to_string(r))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        __result_obj__0 = 0;
    come_call_finalizer(list$1int$$p_finalize, li, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    come_call_finalizer(list$1int$$p_finalize, _li_6, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    come_call_finalizer(list$1int$$p_finalize, _o2_saved_2, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    come_call_finalizer(list$1int$$p_finalize, r, (void*)0, (void*)0, 0, 0, 0, (void*)0);
...
static char*  list$1int$_to_string(struct list$1int$* self)
{
    ...
    __right_value0 = (void*)0;
    result=(struct buffer* )come_increment_ref_count(buffer_initialize((struct buffer* )come_increment_ref_count((struct buffer *)come_calloc(1, sizeof(struct buffer )*(1), "/usr/local/include/neo-c.h", 1559, "struct buffer* "))));
...
static struct list$1char$* list$1char$_push_back(struct list$1char$* self, char item)
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_16=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value0=(struct list_item$1char$*)come_calloc(1, sizeof(struct list_item$1char$)*(1), "/usr/local/include/neo-c.h", 1528, "struct list_item$1char$*"))));
        ...
        __right_value0 = (void*)0;
        litem_17=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value0=(struct list_item$1char$*)come_calloc(1, sizeof(struct list_item$1char$)*(1), "/usr/local/include/neo-c.h", 1538, "struct list_item$1char$*"))));
...
static struct list$1char$p* list$1char$p_push_back(struct list$1char$p* self, char* item)
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_18=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value0=(struct list_item$1char$p*)come_calloc(1, sizeof(struct list_item$1char$p)*(1), "/usr/local/include/neo-c.h", 1528, "struct list_item$1char$p*"))));
        ...
        __right_value0 = (void*)0;
        litem_19=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value0=(struct list_item$1char$p*)come_calloc(1, sizeof(struct list_item$1char$p)*(1), "/usr/local/include/neo-c.h", 1538, "struct list_item$1char$p*"))));
...
static struct list$1short$* list$1short$_push_back(struct list$1short$* self, short item)
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_20=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value0=(struct list_item$1short$*)come_calloc(1, sizeof(struct list_item$1short$)*(1), "/usr/local/include/neo-c.h", 1528, "struct list_item$1short$*"))));
        ...
        __right_value0 = (void*)0;
        litem_21=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value0=(struct list_item$1short$*)come_calloc(1, sizeof(struct list_item$1short$)*(1), "/usr/local/include/neo-c.h", 1538, "struct list_item$1short$*"))));
...
static struct list$1long$* list$1long$_push_back(struct list$1long$* self, long item)
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_22=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value0=(struct list_item$1long$*)come_calloc(1, sizeof(struct list_item$1long$)*(1), "/usr/local/include/neo-c.h", 1528, "struct list_item$1long$*"))));
        ...
        __right_value0 = (void*)0;
        litem_23=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value0=(struct list_item$1long$*)come_calloc(1, sizeof(struct list_item$1long$)*(1), "/usr/local/include/neo-c.h", 1538, "struct list_item$1long$*"))));
...
static struct list$1float$* list$1float$_push_back(struct list$1float$* self, float item)
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_24=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value0=(struct list_item$1float$*)come_calloc(1, sizeof(struct list_item$1float$)*(1), "/usr/local/include/neo-c.h", 1528, "struct list_item$1float$*"))));
        ...
        __right_value0 = (void*)0;
        litem_25=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value0=(struct list_item$1float$*)come_calloc(1, sizeof(struct list_item$1float$)*(1), "/usr/local/include/neo-c.h", 1538, "struct list_item$1float$*"))));
...
static struct list$1double$* list$1double$_push_back(struct list$1double$* self, double item)
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_26=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value0=(struct list_item$1double$*)come_calloc(1, sizeof(struct list_item$1double$)*(1), "/usr/local/include/neo-c.h", 1528, "struct list_item$1double$*"))));
        ...
        __right_value0 = (void*)0;
        litem_27=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value0=(struct list_item$1double$*)come_calloc(1, sizeof(struct list_item$1double$)*(1), "/usr/local/include/neo-c.h", 1538, "struct list_item$1double$*"))));
...
static struct list$1char$ph* list$1char$ph_push_back(struct list$1char$ph* self, char*  item  )
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_28=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1528, "struct list_item$1char$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_29=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1538, "struct list_item$1char$ph*"))));
    ...
    *matchlength=0;
    ...
    if(start->type==(2)) {
        ...
        while(1) {
            ...
            const char* end_30=matchpattern(start,cursor,&ctx);
            if(end_30!=0) {
    ...
    while(pattern[*pos]!=0) {
        ...
        switch (        c) {
            ...
            case 40:
            {
                ...
                tail_31=inner;
                while((tail_31!=0)&&(tail_31->type!=(0))) {
                    tail_31=tail_31->next;
                }
                if(tail_31==0) {
                                        __result_obj__0 = ((void*)0);
                    neo_current_frame = fr.prev;
                ...
                token->u.group.last=tail_31;
                token->u.group.id=++st->group_count;
                tail_31->type=(17);
                tail_31->u.group.first=token;
                (*pos)++;
            }
            break;
            case 41:
...
const char* matchpattern(struct regex_t*  pattern  , const char* text, struct anonymous_typeX25*  ctx  )
{
    ...
    while(current!=0&&current->type!=(0)) {
        ...
        if((next!=0)&&(next->type==(4))) {
            ...
            const char* result_32=matchstar(current,next->next,cursor,ctx);
            if(result_32!=0) {
            ...
            const char* result_33=matchplus(current,next->next,cursor,ctx);
            if(result_33!=0) {
            ...
            const char* result_34=matchgroup(current,next,cursor,ctx);
            if(result_34!=0) {
...
int charp_rindex_regex(const char* self, const char* reg, int default_value, _Bool ignore_case)
{
    ...
    while((_Bool)1) {
        ...
        if(regex_result>=0) {
            result_36=strlen(self)-matchlength;
            break;
        }
        {
            break;
...
static struct list$1char$ph* list$1char$ph_add(struct list$1char$ph* self, char*  item  )
{
    ...
    if(self->len==0) {
        ...
        __right_value0 = (void*)0;
        litem_37=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1443, "struct list_item$1char$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_38=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1453, "struct list_item$1char$ph*"))));
        litem_38->prev=self->tail;
        litem_38->next=((void*)0);
        __dec_obj18=litem_38->item,
...
struct list$1char$ph* charp_split(const char* self, const char* reg, _Bool ignore_case)
{
    ...
    if(offset<charp_length(self)) {
        ...
        list$1char$ph_push_back(result,(char* )come_increment_ref_count(str_39));
...
char*  charp_sub_block(char* self, const char* reg, _Bool global, _Bool ignore_case, void* parent, char* (*block)(void*,char*,struct list$1char$ph*))
{
    ...
    while((_Bool)1) {
        ...
        if(regex_result>=0&&group_count==0) {
            ...
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            group_strings_44=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 7504, "struct list$1char$ph*"))));
            for(i=0            ;i<group_count;i++){
                cp=&captures[i];
                __right_value0 = (void*)0;
...
struct list$1char$ph* charp_scan_block(const char* self, const char* reg, _Bool ignore_case, void* parent, char* (*block)(void*,char*,struct list$1char$ph*))
{
    ...
    while((_Bool)1) {
        ...
        if(regex_result>=0&&group_count==0) {
            ...
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            group_strings_49=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 7580, "struct list$1char$ph*"))));
            for(i=0            ;i<group_count;i++){
                cp=&captures[i];
                __right_value0 = (void*)0;
