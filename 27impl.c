...
struct sNode* top_level_v93(char* buf, char* head, int head_sline, struct sInfo* info  )
{
    ...
    if(!gComeC&&charp_operator_equals(buf,"impl")) {
        ...
        info->impl_type=(struct sType*)come_increment_ref_count((come_push_stackframe("27impl.nc", 45, 3),__exception_result_var_b4=(come_push_stackframe("27impl.nc", 45, 1),__exception_result_var_b2=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "27impl.nc", 45, "struct sType*")),(char*)come_increment_ref_count(word),0,info,0), come_pop_stackframe(), __exception_result_var_b2), come_pop_stackframe(), __exception_result_var_b4));
        ...
        (come_push_stackframe("27impl.nc", 81, 4),__exception_result_var_b5=expected_next_character(125,info), come_pop_stackframe(), __exception_result_var_b5);
        list$1char$ph_reset(info->generics_type_names);
