...
struct tuple2$2int$_Bool$* f(_Bool ok)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "f"; neo_current_frame = &fr;
...
struct tuple2$2int$_Bool$* g(_Bool ok)
{
    struct neo_frame fr; fr.prev = neo_current_frame; fr.fun_name = "g"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
