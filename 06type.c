...
;    struct list$1sType$ph* param_types=0;
    ...
    if(lambda_) {
        ...
        if(*info->p==91) {
            ...
            (come_push_stackframe("06type.nc", 1279, 26),__exception_result_var_b27=expected_next_character(93,info), come_pop_stackframe(), __exception_result_var_b27);
            ((node) ? node = come_decrement_ref_count(node, ((struct sNode*)node)->finalize, ((struct sNode*)node)->_protocol_obj, 0, 0,(void*)0):(void*)0);
        }
        (come_push_stackframe("06type.nc", 1282, 27),__exception_result_var_b28=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b28);
    ...
    while(*info->p==91) {
        ...
        (come_push_stackframe("06type.nc", 1356, 28),__exception_result_var_b29=expected_next_character(93,info), come_pop_stackframe(), __exception_result_var_b29);
...
;    struct sType* type  =0;
    ...
    multiple_assign_var3=(come_push_stackframe("06type.nc", 1424, 30),__exception_result_var_b31=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,parse_variable_name,1,0))), come_pop_stackframe(), __exception_result_var_b31);
...
struct tuple3$3sType$phchar$ph_Bool$* parse_type(struct sInfo* info  , _Bool parse_variable_name, _Bool parse_multiple_type, _Bool in_function_parametor)
{
    ...
    struct tuple3$3sType$phchar$ph_Bool$* __exception_result_var_b36;
...
;    char* asm_name  =0;
    ...
    while(1) {
        if(string_operator_equals(type_name,"__type__")) {
            ...
            if(*info->p==40) {
                (come_push_stackframe("06type.nc", 1485, 31),__exception_result_var_b32=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b32);
            }
            ...
            (come_push_stackframe("06type.nc", 1532, 32),__exception_result_var_b33=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b33);
            ...
            (come_push_stackframe("06type.nc", 1543, 33),__exception_result_var_b34=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b34);
            ...
            if(*info->p==58) {
                info->p++;
                skip_spaces_and_lf(info);
                multiple_assign_var4=(come_push_stackframe("06type.nc", 1751, 35),__exception_result_var_b36=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b36);
            ...
            if(*info->p==58) {
                info->p++;
                skip_spaces_and_lf(info);
                multiple_assign_var5=(come_push_stackframe("06type.nc", 1791, 37),__exception_result_var_b38=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b38);
            ...
            if(*info->p==40) {
                ...
                (come_push_stackframe("06type.nc", 2035, 38),__exception_result_var_b39=expected_next_character(58,info), come_pop_stackframe(), __exception_result_var_b39);
            }
    ...
    if((string_operator_equals(type_name,"typeof")||string_operator_equals(type_name,"__typeof__"))&&*info->p==40) {
        ...
        info->no_comma=no_comma;
        (come_push_stackframe("06type.nc", 2098, 39),__exception_result_var_b40=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b40);
    ...
    if(atomic_&&*info->p==41) {
        (come_push_stackframe("06type.nc", 2220, 40),__exception_result_var_b41=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b41);
    }
    if(type_name_&&*info->p==41) {
        (come_push_stackframe("06type.nc", 2223, 41),__exception_result_var_b42=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b42);
    }
    lambda_flag=0;
    {
        pX=info->p;
...
_conditional_value_X2;})) {
        ...
        (come_push_stackframe("06type.nc", 2629, 42),__exception_result_var_b43=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b43);
        skip_pointer_attribute(info);
        pointer_paren=0;
        paren_num=1;
        if(*info->p==40) {
...
_conditional_value_X5;})) {
        ...
        (come_push_stackframe("06type.nc", 2878, 43),__exception_result_var_b44=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b44);
...
_conditional_value_X9;})) {
            ...
            while(1) {
                multiple_assign_var8=(come_push_stackframe("06type.nc", 3018, 45),__exception_result_var_b46=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,0,0))), come_pop_stackframe(), __exception_result_var_b46);
        ...
        if(parse_multiple_type&&*info->p==44&&!info->in_offsetof) {
            ...
            while(*info->p==44) {
                info->p++;
                skip_spaces_and_lf(info);
                multiple_assign_var9=(come_push_stackframe("06type.nc", 3241, 47),__exception_result_var_b48=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,0,0))), come_pop_stackframe(), __exception_result_var_b48);
    ...
    while(*info->p==91) {
        ...
        array_restrict=0;
        while(1) {
            if((come_push_stackframe("06type.nc", 3410, 48),__exception_result_var_b49=parsecmp("static",info), come_pop_stackframe(), __exception_result_var_b49)) {
                info->p+=strlen("static");
                skip_spaces_and_lf(info);
                array_static=1;
            }
            else if((come_push_stackframe("06type.nc", 3416, 49),__exception_result_var_b50=parsecmp("restrict",info), come_pop_stackframe(), __exception_result_var_b50)) {
        ...
        (come_push_stackframe("06type.nc", 3444, 50),__exception_result_var_b51=expected_next_character(93,info), come_pop_stackframe(), __exception_result_var_b51);
