...
right_value130 = (void*)0;
    ...
    if(_if_conditional162=!klass_122->mOutputed,    _if_conditional162) {
        klass_122->mOutputed=(_Bool)1;
        if(_if_conditional164=list$1tuple2$2charphsTypephph_length(klass_122->mFields)>0,        _if_conditional164) {
            ...
            if(_if_conditional172=info->output_header_file&&string_operator_not_equals(klass_122->mDeclareSName,info->base_sname),            _if_conditional172) {
            }
            else {
                if(self->mOutput) {
...
memset(&it2_115, 0, sizeof(char*));
        ...
        while(_while_condtional18=(_Bool)1,        _while_condtional18) {
            if(_if_conditional125=self->item_existance[it_95],            _if_conditional125) {
                if(_if_conditional126=string_equals(self->keys[it_95],key),                _if_conditional126) {
                ...
                it_95++;
                if(_if_conditional148=it_95>=self->size,                _if_conditional148) {
                    it_95=0;
                }
                else {
                    if(_if_conditional149=it_95==hash_94,                    _if_conditional149) {
        ...
        for(        it2_115=list$1charp_begin(self->key_list);        !list$1charp_end(self->key_list);        it2_115=list$1charp_next(self->key_list)        ){
            if(_if_conditional156=string_equals(it2_115,key),            _if_conditional156) {
                same_key_exist_112=(_Bool)1;
            }
        }
        if(_if_conditional157=!same_key_exist_112,        _if_conditional157) {
...
memset(&default_value_93, 0, sizeof(struct sType*));
                ...
                keys_78=(char**)come_increment_ref_count(((char**)(right_value116=(char**)come_calloc(1, sizeof(char*)*(1*(size_77)), "./neo-c.h", 1317, "char*%"))));
                right_value116 = come_decrement_ref_count2(right_value116, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                items_79=(struct sType**)come_increment_ref_count(((struct sType**)(right_value117=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_77)), "./neo-c.h", 1318, "sType*%"))));
                come_call_finalizer3(right_value117,sType_finalize, 0, 1, 0, 0, __result_obj__);
                item_existance_80=(_Bool*)come_increment_ref_count(((_Bool*)(right_value118=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_77)), "./neo-c.h", 1319, "bool"))));
                ...
                for(                it_84=map$2charphsTypeph_begin(self);                !map$2charphsTypeph_end(self);                it_84=map$2charphsTypeph_next(self)                ){
                    ...
                    while(_while_condtional17=(_Bool)1,                    _while_condtional17) {
                        if(_if_conditional122=item_existance_80[n_92],                        _if_conditional122) {
                            n_92++;
                            if(_if_conditional123=n_92>=size_77,                            _if_conditional123) {
                                n_92=0;
                            }
                            else {
                                if(_if_conditional124=n_92==hash_91,                                _if_conditional124) {
...
memset(&result_86, 0, sizeof(char*));
                    if(_if_conditional116=self==((void*)0)||self->key_list->it==((void*)0),                    _if_conditional116) {
                        memset(&result_85,0,sizeof(char*));
...
memset(&it_89, 0, sizeof(unsigned int));
                        ...
                        while(_while_condtional16=(_Bool)1,                        _while_condtional16) {
                            if(_if_conditional118=self->item_existance[it_89],                            _if_conditional118) {
                                if(_if_conditional119=string_equals(self->keys[it_89],key),                                _if_conditional119) {
                                    __result77__ = __result_obj__ = self->items[it_89];
                                    come_call_finalizer3(default_value,sType_finalize, 0, 0, 1, 0, (void*)0);
                                    return __result77__;
                                }
                                it_89++;
                                if(_if_conditional120=it_89>=self->size,                                _if_conditional120) {
                                    it_89=0;
                                }
                                else {
                                    if(_if_conditional121=it_89==hash_88,                                    _if_conditional121) {
...
memset(&it_97, 0, sizeof(struct list_item$1charp*));
                            ...
                            while(_while_condtional19=it_97!=((void*)0),                            _while_condtional19) {
                                if(_if_conditional128=string_equals(it_97->item,item),                                _if_conditional128) {
...
memset(&prev_it_111, 0, sizeof(struct list_item$1charp*));
                                        ...
                                        if(_if_conditional133=tail>self->len,                                        _if_conditional133) {
                                            tail=self->len;
                                        }
                                        ...
                                        if(_if_conditional135=head==0&&tail==self->len,                                        _if_conditional135) {
                                            ...
                                            if(_if_conditional136=head==0,                                            _if_conditional136) {
                                                ...
                                                while(_while_condtional21=it_101!=((void*)0),                                                _while_condtional21) {
                                                    if(_if_conditional137=i_102<tail,                                                    _if_conditional137) {
                                                        prev_it_103=it_101;
                                                        it_101=it_101->next;
                                                        i_102++;
                                                        ...
                                                        if(_if_conditional138=i_102==tail,                                                        _if_conditional138) {
                                                            self->head=it_101;
                                                ...
                                                if(_if_conditional139=tail==self->len,                                                _if_conditional139) {
                                                    ...
                                                    while(_while_condtional22=it_104!=((void*)0),                                                    _while_condtional22) {
                                                        if(_if_conditional140=i_105==head,                                                        _if_conditional140) {
                                                            self->tail=it_104->prev;
                                                            self->tail->next=((void*)0);
                                                        }
                                                        if(_if_conditional141=i_105>=head,                                                        _if_conditional141) {
                                                            prev_it_106=it_104;
                                                            it_104=it_104->next;
                                                            i_105++;
                                                    ...
                                                    while(_while_condtional23=it_107!=((void*)0),                                                    _while_condtional23) {
                                                        if(_if_conditional142=i_110==head,                                                        _if_conditional142) {
                                                            head_prev_it_108=it_107->prev;
                                                        }
                                                        if(_if_conditional143=i_110==tail,                                                        _if_conditional143) {
                                                            tail_it_109=it_107;
                                                        }
                                                        if(_if_conditional144=i_110>=head&&i_110<tail,                                                        _if_conditional144) {
                                                            prev_it_111=it_107;
                                                            it_107=it_107->next;
                                                            i_110++;
                                                    ...
                                                    if(_if_conditional145=head_prev_it_108!=((void*)0),                                                    _if_conditional145) {
                                                        head_prev_it_108->next=tail_it_109;
                                                    }
                                                    if(_if_conditional146=tail_it_109!=((void*)0),                                                    _if_conditional146) {
...
memset(&litem_120, 0, sizeof(struct list_item$1charp*));
                if(_if_conditional158=self->len==0,                _if_conditional158) {
                    litem_118=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value119=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "./neo-c.h", 221, "list_item$1charp"))));
                    ...
                    if(_if_conditional159=self->len==1,                    _if_conditional159) {
                        litem_119=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value120=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "./neo-c.h", 231, "list_item$1charp"))));
                        ...
                        litem_120=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value121=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "./neo-c.h", 241, "list_item$1charp"))));
...
right_value167 = (void*)0;
    if(_if_conditional182=map$2charphsClassph_at(info->classes,type_name,((void*)0))==((void*)0),    _if_conditional182) {
        output_135=(_Bool)1;
    ...
    while(_while_condtional31=(_Bool)1,    _while_condtional31) {
        ...
        if(_if_conditional235=!err_171,        _if_conditional235) {
...
memset(&it_137, 0, sizeof(unsigned int));
        ...
        while(_while_condtional25=(_Bool)1,        _while_condtional25) {
            if(_if_conditional174=self->item_existance[it_137],            _if_conditional174) {
                if(_if_conditional175=string_equals(self->keys[it_137],key),                _if_conditional175) {
                    __result107__ = __result_obj__ = self->items[it_137];
                    come_call_finalizer3(default_value,sClass_finalize, 0, 0, 1, 0, (void*)0);
                    return __result107__;
                }
                it_137++;
                if(_if_conditional180=it_137>=self->size,                _if_conditional180) {
                    it_137=0;
                }
                else {
                    if(_if_conditional181=it_137==hash_136,                    _if_conditional181) {
...
memset(&it2_156, 0, sizeof(char*));
            if(_if_conditional183=self->len*10>=self->size,            _if_conditional183) {
                map$2charphsClassph_rehash(self);
            }
            hash_153=string_get_hash_key(key)%self->size;
            it_154=hash_153;
            while(_while_condtional27=(_Bool)1,            _while_condtional27) {
                if(_if_conditional191=self->item_existance[it_154],                _if_conditional191) {
                    if(_if_conditional192=string_equals(self->keys[it_154],key),                    _if_conditional192) {
                    ...
                    it_154++;
                    if(_if_conditional195=it_154>=self->size,                    _if_conditional195) {
                        it_154=0;
                    }
                    else {
                        if(_if_conditional196=it_154==hash_153,                        _if_conditional196) {
                            printf("unexpected error in map.insert\n");
                            stackframe();
                            exit(2);
                        }
            ...
            for(            it2_156=list$1charp_begin(self->key_list);            !list$1charp_end(self->key_list);            it2_156=list$1charp_next(self->key_list)            ){
                if(_if_conditional199=string_equals(it2_156,key),                _if_conditional199) {
                    same_key_exist_155=(_Bool)1;
                }
            }
            if(_if_conditional200=!same_key_exist_155,            _if_conditional200) {
                list$1charp_push_back(self->key_list,key);
            }
...
memset(&default_value_152, 0, sizeof(struct sClass*));
                    ...
                    keys_139=(char**)come_increment_ref_count(((char**)(right_value134=(char**)come_calloc(1, sizeof(char*)*(1*(size_138)), "./neo-c.h", 1317, "char*%"))));
                    right_value134 = come_decrement_ref_count2(right_value134, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                    items_140=(struct sClass**)come_increment_ref_count(((struct sClass**)(right_value135=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_138)), "./neo-c.h", 1318, "sClass*%"))));
                    come_call_finalizer3(right_value135,sClass_finalize, 0, 1, 0, 0, __result_obj__);
                    item_existance_141=(_Bool*)come_increment_ref_count(((_Bool*)(right_value136=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_138)), "./neo-c.h", 1319, "bool"))));
                    ...
                    for(                    it_145=map$2charphsClassph_begin(self);                    !map$2charphsClassph_end(self);                    it_145=map$2charphsClassph_next(self)                    ){
                        ...
                        while(_while_condtional26=(_Bool)1,                        _while_condtional26) {
                            if(_if_conditional188=item_existance_141[n_151],                            _if_conditional188) {
                                n_151++;
                                if(_if_conditional189=n_151>=size_138,                                _if_conditional189) {
                                    n_151=0;
                                }
                                else {
                                    if(_if_conditional190=n_151==hash_150,                                    _if_conditional190) {
                                        printf("unexpected error in map.rehash(1)\n");
                                        stackframe();
                                        exit(2);
                                    }
...
memset(&result_147, 0, sizeof(char*));
                        if(_if_conditional186=self==((void*)0)||self->key_list->it==((void*)0),                        _if_conditional186) {
                            memset(&result_146,0,sizeof(char*));
...
right_value148 = (void*)0;
                    ...
                    result_158=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list$1tuple2$2charphsTypephph*)(right_value141=list$1tuple2$2charphsTypephph_initialize((struct list$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list$1tuple2$2charphsTypephph*)(right_value140=(struct list$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list$1tuple2$2charphsTypephph)*(1), "./neo-c.h", 137, "list$1tuple2$2charphsTypephph"))))))));
...
memset(&litem_162, 0, sizeof(struct list_item$1tuple2$2charphsTypephph*));
                            if(_if_conditional215=self->len==0,                            _if_conditional215) {
                                litem_160=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value142=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./neo-c.h", 151, "list_item$1tuple2$2charphsTypephph"))));
                                ...
                                if(_if_conditional218=self->len==1,                                _if_conditional218) {
                                    litem_161=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value143=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./neo-c.h", 161, "list_item$1tuple2$2charphsTypephph"))));
                                    ...
                                    litem_162=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value144=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./neo-c.h", 171, "list_item$1tuple2$2charphsTypephph"))));
...
memset(&litem_174, 0, sizeof(struct list_item$1tuple2$2charphsTypephph*));
                if(_if_conditional237=self->len==0,                _if_conditional237) {
                    litem_172=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value157=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./neo-c.h", 221, "list_item$1tuple2$2charphsTypephph"))));
                    ...
                    if(_if_conditional238=self->len==1,                    _if_conditional238) {
                        litem_173=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value158=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./neo-c.h", 231, "list_item$1tuple2$2charphsTypephph"))));
                        ...
                        litem_174=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value159=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./neo-c.h", 241, "list_item$1tuple2$2charphsTypephph"))));
...
right_value192 = (void*)0;
    if(_if_conditional247=charp_operator_equals(buf,"union"),    _if_conditional247) {
        ...
        output_178=(_Bool)1;
        if(_if_conditional248=map$2charphsClassph_at(info->classes,type_name_177,((void*)0))==((void*)0),        _if_conditional248) {
        ...
        while(_while_condtional32=(_Bool)1,        _while_condtional32) {
            ...
            if(_if_conditional249=!err_182,            _if_conditional249) {
                printf("%s %d: parse_type failed\n",info->sname,info->sline);
                exit(2);
            }
...
memset(&__result_obj__, 0, sizeof(void*));
            ...
            if(_if_conditional252=self!=((void*)0)&&self->mType!=((void*)0),            _if_conditional252) {
...
right_value190 = (void*)0;
            ...
            if(_if_conditional256=self!=((void*)0)&&self->mType!=((void*)0),            _if_conditional256) {
...
right_value197 = (void*)0;
    define_union_186=(_Bool)0;
    {
        ...
        if(_if_conditional258=charp_operator_equals(buf,"union"),        _if_conditional258) {
            if(_if_conditional259=*info->p==95||xisalpha(*info->p),            _if_conditional259) {
                __dec_obj56=type_name_189;
                type_name_189=(char*)come_increment_ref_count(((char*)(right_value193=parse_word(info))));
                __dec_obj56 = come_decrement_ref_count2(__dec_obj56, (void*)0, (void*)0, 0,0,0, (void*)0);
                right_value193 = come_decrement_ref_count2(right_value193, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                if(_if_conditional260=*info->p==123,                _if_conditional260) {
