...
struct list$1tuple2$2char$phsType$ph$ph* __result_obj__82;
    if(    self->len==0    ) {
        ...
        come_call_finalizer(tuple2$2char$phsType$ph$p_finalize, __dec_obj34,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        self->tail=litem_31;
