...
right_value130 = (void*)0;
    ...
    if(_if_conditional161=!klass_122->mOutputed,    _if_conditional161) {
        ...
        if(_if_conditional163=list$1tuple2$2charphsTypephph_length(klass_122->mFields)>0,        _if_conditional163) {
            ...
            if(_if_conditional171=info->output_header_file&&string_operator_not_equals(klass_122->mDeclareSName,info->base_sname),            _if_conditional171) {
            }
            else {
                if(self->mOutput) {
...
memset(&it2_115, 0, sizeof(char*));
        if(_if_conditional112=self->len*10>=self->size,        _if_conditional112) {
            map$2charphsTypeph_rehash(self);
        }
        hash_94=string_get_hash_key(key)%self->size;
        it_95=hash_94;
        while(_while_condtional18=(_Bool)1,        _while_condtional18) {
            if(_if_conditional124=self->item_existance[it_95],            _if_conditional124) {
                if(_if_conditional125=string_equals(self->keys[it_95],key),                _if_conditional125) {
                ...
                it_95++;
                if(_if_conditional147=it_95>=self->size,                _if_conditional147) {
                    it_95=0;
                }
                else {
                    if(_if_conditional148=it_95==hash_94,                    _if_conditional148) {
        ...
        for(        it2_115=list$1charp_begin(self->key_list);        !list$1charp_end(self->key_list);        it2_115=list$1charp_next(self->key_list)        ){
            if(_if_conditional155=string_equals(it2_115,key),            _if_conditional155) {
                same_key_exist_112=(_Bool)1;
            }
        }
        if(_if_conditional156=!same_key_exist_112,        _if_conditional156) {
...
memset(&default_value_93, 0, sizeof(struct sType*));
                ...
                for(                it_84=map$2charphsTypeph_begin(self);                !map$2charphsTypeph_end(self);                it_84=map$2charphsTypeph_next(self)                ){
                    ...
                    while(_while_condtional17=(_Bool)1,                    _while_condtional17) {
                        if(_if_conditional121=item_existance_80[n_92],                        _if_conditional121) {
                            n_92++;
                            if(_if_conditional122=n_92>=size_77,                            _if_conditional122) {
                                n_92=0;
                            }
                            else {
                                if(_if_conditional123=n_92==hash_91,                                _if_conditional123) {
...
memset(&result_86, 0, sizeof(char*));
                    if(_if_conditional115=self==((void*)0)||self->key_list->it==((void*)0),                    _if_conditional115) {
                        memset(&result_85,0,sizeof(char*));
...
memset(&it_89, 0, sizeof(unsigned int));
                        ...
                        while(_while_condtional16=(_Bool)1,                        _while_condtional16) {
                            if(_if_conditional117=self->item_existance[it_89],                            _if_conditional117) {
                                if(_if_conditional118=string_equals(self->keys[it_89],key),                                _if_conditional118) {
                                    __result77__ = __result_obj__ = self->items[it_89];
                                    come_call_finalizer3(default_value,sType_finalize, 0, 0, 1, 0, (void*)0);
                                    return __result77__;
                                }
                                it_89++;
                                if(_if_conditional119=it_89>=self->size,                                _if_conditional119) {
                                    it_89=0;
                                }
                                else {
                                    if(_if_conditional120=it_89==hash_88,                                    _if_conditional120) {
...
memset(&it_97, 0, sizeof(struct list_item$1charp*));
                            ...
                            while(_while_condtional19=it_97!=((void*)0),                            _while_condtional19) {
                                if(_if_conditional127=string_equals(it_97->item,item),                                _if_conditional127) {
...
memset(&prev_it_111, 0, sizeof(struct list_item$1charp*));
                                        ...
                                        if(_if_conditional132=tail>self->len,                                        _if_conditional132) {
                                            tail=self->len;
                                        }
                                        ...
                                        if(_if_conditional134=head==0&&tail==self->len,                                        _if_conditional134) {
                                            ...
                                            if(_if_conditional135=head==0,                                            _if_conditional135) {
                                                ...
                                                if(_if_conditional138=tail==self->len,                                                _if_conditional138) {
                                                    ...
                                                    while(_while_condtional23=it_107!=((void*)0),                                                    _while_condtional23) {
                                                        if(_if_conditional141=i_110==head,                                                        _if_conditional141) {
                                                            head_prev_it_108=it_107->prev;
                                                        }
                                                        if(_if_conditional142=i_110==tail,                                                        _if_conditional142) {
                                                            tail_it_109=it_107;
                                                        }
                                                        if(_if_conditional143=i_110>=head&&i_110<tail,                                                        _if_conditional143) {
                                                            prev_it_111=it_107;
                                                            it_107=it_107->next;
                                                            i_110++;
                                                    ...
                                                    if(_if_conditional144=head_prev_it_108!=((void*)0),                                                    _if_conditional144) {
                                                        head_prev_it_108->next=tail_it_109;
                                                    }
                                                    if(_if_conditional145=tail_it_109!=((void*)0),                                                    _if_conditional145) {
...
right_value167 = (void*)0;
    ...
    while(_while_condtional31=(_Bool)1,    _while_condtional31) {
        ...
        if(_if_conditional234=!err_171,        _if_conditional234) {
...
memset(&it_137, 0, sizeof(unsigned int));
        ...
        while(_while_condtional25=(_Bool)1,        _while_condtional25) {
            if(_if_conditional173=self->item_existance[it_137],            _if_conditional173) {
                if(_if_conditional174=string_equals(self->keys[it_137],key),                _if_conditional174) {
                    __result107__ = __result_obj__ = self->items[it_137];
                    come_call_finalizer3(default_value,sClass_finalize, 0, 0, 1, 0, (void*)0);
                    return __result107__;
                }
                it_137++;
                if(_if_conditional179=it_137>=self->size,                _if_conditional179) {
                    it_137=0;
                }
                else {
                    if(_if_conditional180=it_137==hash_136,                    _if_conditional180) {
...
memset(&it2_156, 0, sizeof(char*));
            if(_if_conditional182=self->len*10>=self->size,            _if_conditional182) {
                map$2charphsClassph_rehash(self);
            }
            hash_153=string_get_hash_key(key)%self->size;
            it_154=hash_153;
            while(_while_condtional27=(_Bool)1,            _while_condtional27) {
                if(_if_conditional190=self->item_existance[it_154],                _if_conditional190) {
                    if(_if_conditional191=string_equals(self->keys[it_154],key),                    _if_conditional191) {
                    ...
                    it_154++;
                    if(_if_conditional194=it_154>=self->size,                    _if_conditional194) {
                        it_154=0;
                    }
                    else {
                        if(_if_conditional195=it_154==hash_153,                        _if_conditional195) {
                            printf("unexpected error in map.insert\n");
                            stackframe();
                            exit(2);
                        }
            ...
            for(            it2_156=list$1charp_begin(self->key_list);            !list$1charp_end(self->key_list);            it2_156=list$1charp_next(self->key_list)            ){
                if(_if_conditional198=string_equals(it2_156,key),                _if_conditional198) {
                    same_key_exist_155=(_Bool)1;
                }
            }
            if(_if_conditional199=!same_key_exist_155,            _if_conditional199) {
                list$1charp_push_back(self->key_list,key);
            }
...
memset(&default_value_152, 0, sizeof(struct sClass*));
                    ...
                    for(                    it_145=map$2charphsClassph_begin(self);                    !map$2charphsClassph_end(self);                    it_145=map$2charphsClassph_next(self)                    ){
                        ...
                        while(_while_condtional26=(_Bool)1,                        _while_condtional26) {
                            if(_if_conditional187=item_existance_141[n_151],                            _if_conditional187) {
                                n_151++;
                                if(_if_conditional188=n_151>=size_138,                                _if_conditional188) {
                                    n_151=0;
                                }
                                else {
                                    if(_if_conditional189=n_151==hash_150,                                    _if_conditional189) {
                                        printf("unexpected error in map.rehash(1)\n");
                                        stackframe();
                                        exit(2);
                                    }
...
memset(&result_147, 0, sizeof(char*));
                        if(_if_conditional185=self==((void*)0)||self->key_list->it==((void*)0),                        _if_conditional185) {
                            memset(&result_146,0,sizeof(char*));
...
right_value151 = (void*)0;
            ...
            if(_if_conditional212=self!=((void*)0)&&self->mFields!=((void*)0),            _if_conditional212) {
            ...
            if(_if_conditional231=self!=((void*)0)&&self->mParentClassName!=((void*)0),            _if_conditional231) {
...
right_value192 = (void*)0;
    if(_if_conditional246=charp_operator_equals(buf,"union"),    _if_conditional246) {
        ...
        while(_while_condtional32=(_Bool)1,        _while_condtional32) {
            ...
            if(_if_conditional248=!err_182,            _if_conditional248) {
                printf("%s %d: parse_type failed\n",info->sname,info->sline);
                exit(2);
            }
...
right_value197 = (void*)0;
    define_union_186=(_Bool)0;
    {
        ...
        if(_if_conditional257=charp_operator_equals(buf,"union"),        _if_conditional257) {
            if(_if_conditional258=*info->p==95||xisalpha(*info->p),            _if_conditional258) {
                ...
                if(_if_conditional259=*info->p==123,                _if_conditional259) {
