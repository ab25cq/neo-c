...
static struct span$1int$p* vector$1int$_to_span(struct vector$1int$* self);
...
int main()
{
    ...
    int __result_obj__0;
    v=(struct vector$1int$*)come_increment_ref_count(vector$1int$_initialize((struct vector$1int$*)come_increment_ref_count((struct vector$1int$*)come_calloc(1, sizeof(struct vector$1int$)*(1), "mytest/vector_to_span_test.nc", 4, "struct vector$1int$*"))));
    vector$1int$_add(v,10);
    vector$1int$_add(v,20);
    __right_value0 = (void*)0;
    s=(struct span$1int$p*)come_increment_ref_count(vector$1int$_to_span(v));
    printf("%d %d\n",span$1int$p_unwrap(s)[0],span$1int$p_unwrap(s)[1]);
        __result_obj__0 = 0;
...
static struct span$1int$p* vector$1int$_to_span(struct vector$1int$* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "vector$1int$_to_span"; neo_current_frame = &fr;
    struct span$1int$p* __result_obj__0;
    struct span$1int$p* __new_obj__2;
    void* __right_value0 = (void*)0;
    if(self==((void*)0)||self->items==((void*)0)) {
                __result_obj__0 = (struct span$1int$p*)come_increment_ref_count(((void*)0));
        neo_current_frame = fr.prev;
        come_call_finalizer(span$1int$p$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
        return __result_obj__0;
    }
        __result_obj__0 = (struct span$1int$p*)come_increment_ref_count(((struct span$1int$p*)(__right_value0=({__new_obj__2 = (struct span$1int$p*)come_calloc(1, sizeof(struct span$1int$p)*(1), "/usr/local/include/neo-c.h", 1947, "struct span$1int$p*");__new_obj__2->memory = (char*)self->items;__new_obj__2->p = self->items;__new_obj__2->len = sizeof(int)*self->len;__new_obj__2->local = (_Bool)0;__new_obj__2->heap = (_Bool)1;__new_obj__2->global = (_Bool)0;__new_obj__2->stacktop = (void*)0;__new_obj__2; }))));
    come_call_finalizer(span$1int$p$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    neo_current_frame = fr.prev;
    come_call_finalizer(span$1int$p$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__0;
}
