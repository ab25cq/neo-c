; ModuleID = 'Module native7'
source_filename = "Module native7"
...
@global_string = private constant [5 x i8] c"type\00", align 1
@global_string.1 = private constant [24 x i8] c"type error on type.name\00", align 1
@global_string.2 = private constant [11 x i8] c"type.class\00", align 1
...
entry:
  ...
  %2 = call i8* @string(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @global_string.2, i32 0, i32 0))
  call void @"insert_charp_lambdap0_src/native7"(%map__charp_lambdap* %gNativeMethods, i8* %2, i1 (%CLVALUE**, %sVMInfo*)* @sevenstars_type_class_)
...
define i1 @sevenstars_type_class_(%CLVALUE** %stack_ptr, %sVMInfo* %info) {
entry:
  %andand_result_var = alloca i1
  %andand_result_var1 = alloca i1
  %lvtable = alloca [8192 x i8*]
  ...
  %8 = call i1 @check_type(i32 %self5, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @global_string, i32 0, i32 0), %sVMInfo* %info6)
...
cond_jump_then:                                   ; preds = %entry
  ...
  call void @vm_err_msg(%CLVALUE** %stack_ptr7, %sVMInfo* %info8, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @global_string.1, i32 0, i32 0))
...
cond_end:                                         ; preds = %entry
  ...
  %15 = call %sCLHeapMem* @get_object_pointer(i32 %self9)
  %16 = bitcast %sCLHeapMem* %15 to %sCLTypeObject*
  %self_type_data = alloca %sCLTypeObject*
  %17 = bitcast %sCLTypeObject** %self_type_data to i8*
  store i8* %17, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 455), align 8
  store %sCLTypeObject* %16, %sCLTypeObject** %self_type_data, align 8
  %self_type_data10 = load %sCLTypeObject*, %sCLTypeObject** %self_type_data, align 8
  %18 = getelementptr inbounds %sCLTypeObject, %sCLTypeObject* %self_type_data10, i32 0, i32 3
  %19 = load %sCLType*, %sCLType** %18, align 8
  %20 = call i8* @create_type_name(%sCLType* %19)
  %name = alloca i8*
  %21 = bitcast i8** %name to i8*
  store i8* %21, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 456), align 8
  store i8* %20, i8** %name, align 8
  %name11 = load i8*, i8** %name, align 8
  %info12 = load %sVMInfo*, %sVMInfo** %info3, align 8
  %22 = call i32 @create_class_object(i8* %name11, %sVMInfo* %info12)
  %obj = alloca i32
  %23 = bitcast i32* %obj to i8*
  store i8* %23, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 457), align 8
  ...
  %24 = bitcast %CLVALUE* %derefference_value14 to i32*
  ...
  %30 = icmp ne i64 %29, 0
  br i1 %30, label %cond_then_block, label %cond_end18

cond_then_block:                                  ; preds = %cond_end
  br label %cond_end18

cond_end18:                                       ; preds = %cond_then_block, %cond_end
  call void @ncfree(i8* %28)
  ret i1 true
}

define void @"insert_charp_lambdap0_src/native7"(%map__charp_lambdap* %self, i8* %key, i1 (%CLVALUE**, %sVMInfo*)* %item) {
entry:
  %andand_result_var = alloca i1
  %andand_result_var1 = alloca i1
  %lvtable = alloca [8192 x i8*]
...
cond_jump_then:                                   ; preds = %entry
  ...
  call void @"rehash_charp_lambdap1_src/native7"(%map__charp_lambdap* %self7)
  br label %cond_end
...
"cond_jump_elif_then0\0A":                        ; preds = %"cond_jump_elif0\0A"
  ...
  %113 = call i32 (%_IO_FILE*, i8*, ...) @fprintf(%_IO_FILE* %stderr, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @global_string.5, i32 0, i32 0))
...
define void @"rehash_charp_lambdap1_src/native7"(%map__charp_lambdap* %self) {
entry:
  %andand_result_var = alloca i1
  %andand_result_var1 = alloca i1
  %lvtable = alloca [8192 x i8*]
  ...
  %self9 = load %map__charp_lambdap*, %map__charp_lambdap** %self2, align 8
  call void @"each_charp_lambdap2_src/native7"(%map__charp_lambdap* %self9, void (i8*, i1 (%CLVALUE**, %sVMInfo*)*, i1*)* @native7_lambda0)
...
define void @native7_lambda0(i8* %it, i1 (%CLVALUE**, %sVMInfo*)* %it2, i1* %it3) {
entry:
  %andand_result_var = alloca i1
  %andand_result_var1 = alloca i1
  %lvtable = alloca [8192 x i8*]
...
define void @"each_charp_lambdap2_src/native7"(%map__charp_lambdap* %self, void (i8*, i1 (%CLVALUE**, %sVMInfo*)*, i1*)* %block_) {
entry:
  %andand_result_var = alloca i1
  %andand_result_var1 = alloca i1
  %lvtable = alloca [8192 x i8*]
...
!1 = !DIFile(filename: "src/native7.nc", directory: "/home/ab25cq/repo/neo-c/clover3")
!2 = !{}
