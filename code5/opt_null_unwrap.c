...
int main(int argc, char** argv)
{
    ...
    int __result_obj__0;
    p=((void*)0);
    o=(struct optional$1int$p*)come_increment_ref_count(optional$1int$p_initialize((struct optional$1int$p*)come_increment_ref_count((struct optional$1int$p*)come_calloc(1, sizeof(struct optional$1int$p)*(1), (void*)0, 6, "struct optional$1int$p*")),p,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop));
    q=optional$1int$p_unwrap(o);
    printf("%p\n",q);
        __result_obj__0 = 0;
