...
int main(int argc, char** argv)
{
    ...
    int __result_obj__0;
    int x[4]={ 1, 2, 3, 4 };
    s=(struct span$1int$*)come_increment_ref_count(span$1int$_initialize((struct span$1int$*)come_increment_ref_count((struct span$1int$*)come_calloc(1, sizeof(struct span$1int$)*(1), (void*)0, 6, "struct span$1int$*")),(struct ref$1int$*)come_increment_ref_count(ref$1int$_initialize((struct ref$1int$*)come_increment_ref_count((struct ref$1int$*)come_calloc(1, sizeof(struct ref$1int$)*(1), (void*)0, 6, "struct ref$1int$*")),x,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop)),x,sizeof(x)));
    span$1int$p_operator_plus_equal(s,1);
    span$1int$p_operator_minus_equal(s,2);
