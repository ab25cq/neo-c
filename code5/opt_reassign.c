...
static struct optional$1int$p* optional$1int$p_initialize(struct optional$1int$p* self, int* p, _Bool global_, _Bool heap_, _Bool local_, void* stacktop);
static void optional$1int$p$p_finalize(struct optional$1int$p* self);
static int optional$1int$p$p_operator_derefference(struct optional$1int$p* self);
static int optional$1int$p_operator_derefference(struct optional$1int$p* self);
static int* optional$1int$p_unwrap(struct optional$1int$p* self);
void stackframe();
...
int main(int argc, char** argv)
{
    ...
    struct optional$1int$p* o;
    struct optional$1int$p* __dec_obj1;
    int __result_obj__0;
    x=9;
    y=42;
    o=(struct optional$1int$p*)come_increment_ref_count(optional$1int$p_initialize((struct optional$1int$p*)come_increment_ref_count((struct optional$1int$p*)come_calloc(1, sizeof(struct optional$1int$p)*(1), (void*)0, 8, "struct optional$1int$p*")),&x,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop));
    printf("%d\n",optional$1int$p_operator_derefference(o));
    __dec_obj1=o,
    o=(struct optional$1int$p*)come_increment_ref_count(optional$1int$p_initialize((struct optional$1int$p*)come_increment_ref_count((struct optional$1int$p*)come_calloc(1, sizeof(struct optional$1int$p)*(1), (void*)0, 11, "struct optional$1int$p*")),&y,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop));
    come_call_finalizer(optional$1int$p$p_finalize, __dec_obj1,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    printf("%d\n",*optional$1int$p_unwrap(o));
        __result_obj__0 = 0;
    come_call_finalizer(optional$1int$p$p_finalize, o, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    neo_current_frame = fr.prev;
    come_heap_final();
...
static struct optional$1int$p* optional$1int$p_initialize(struct optional$1int$p* self, int* p, _Bool global_, _Bool heap_, _Bool local_, void* stacktop)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "optional$1int$p_initialize"; neo_current_frame = &fr;
    struct optional$1int$p* __result_obj__0;
    self->p=p;
    self->global=global_;
    self->heap=heap_;
    self->local=local_;
    self->stacktop=stacktop;
        __result_obj__0 = (struct optional$1int$p*)come_increment_ref_count(self);
    come_call_finalizer(optional$1int$p$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    neo_current_frame = fr.prev;
    come_call_finalizer(optional$1int$p$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__0;
}

static void optional$1int$p$p_finalize(struct optional$1int$p* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "optional$1int$p$p_finalize"; neo_current_frame = &fr;
        neo_current_frame = fr.prev;
}
