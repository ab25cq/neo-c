...
static int* span$1int$p$p_operator_add(struct span$1int$p* self, unsigned long  int  rvalue  );
static int* span$1int$p_operator_add(struct span$1int$p* self, unsigned long  int  rvalue  );
