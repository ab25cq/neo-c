...
static int* ref$1int$p_unwrap(struct ref$1int$p* self);
void stackframe();
...
int main(int argc, char** argv)
{
    ...
    x=10;
    p=&x;
    r=(struct ref$1int$p*)come_increment_ref_count(ref$1int$p_initialize((struct ref$1int$p*)come_increment_ref_count((struct ref$1int$p*)come_calloc(1, sizeof(struct ref$1int$p)*(1), (void*)0, 8, "struct ref$1int$p*")),p,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop));
    printf("%d\n",ref$1int$p_operator_derefference(r));
    q=ref$1int$p_unwrap(r);
    *q=20;
    printf("%d\n",x);
        __result_obj__0 = 0;
