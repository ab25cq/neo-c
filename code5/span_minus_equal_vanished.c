...
struct span$1int$p* make_span();
static struct span$1int$* span$1int$_initialize(struct span$1int$* self, struct ref$1void$p* refference, void* head, unsigned long  int  len  );
static void span$1int$$p_finalize(struct span$1int$* self);
static void ref$1void$p$p_finalize(struct ref$1void$p* self);
static struct ref$1int$* ref$1int$_initialize(struct ref$1int$* self, int (*p), _Bool global_, _Bool heap_, _Bool local_, void* stacktop);
static void ref$1int$$p_finalize(struct ref$1int$* self);
static void span$1int$p$p_finalize(struct span$1int$p* self);
int main(int argc, char** argv);
static struct span$1int$p* span$1int$p$p_operator_plus_equal(struct span$1int$p* self, unsigned long  int  value  );
static struct span$1int$p* span$1int$p_operator_plus_equal(struct span$1int$p* self, unsigned long  int  value  );
static struct span$1int$p* span$1int$p$p_operator_minus_equal(struct span$1int$p* self, unsigned long  int  value  );
static struct span$1int$p* span$1int$p_operator_minus_equal(struct span$1int$p* self, unsigned long  int  value  );
static int span$1int$p$p_operator_derefference(struct span$1int$p* self);
static int span$1int$p_operator_derefference(struct span$1int$p* self);
void stackframe();
...
struct span$1int$p* make_span()
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "make_span"; neo_current_frame = &fr;
    ...
    int x[4]={ 1, 2, 3, 4 };
        __result_obj__0 = (struct span$1int$p*)come_increment_ref_count(((struct span$1int$*)(__right_value3=span$1int$_initialize((struct span$1int$*)come_increment_ref_count((struct span$1int$*)come_calloc(1, sizeof(struct span$1int$)*(1), (void*)0, 6, "struct span$1int$*")),(struct ref$1int$*)come_increment_ref_count(ref$1int$_initialize((struct ref$1int$*)come_increment_ref_count((struct ref$1int$*)come_calloc(1, sizeof(struct ref$1int$)*(1), (void*)0, 6, "struct ref$1int$*")),x,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop)),x,sizeof(x)))));
    come_call_finalizer(span$1int$$p_finalize, __right_value3, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    neo_current_frame = fr.prev;
...
static struct span$1int$* span$1int$_initialize(struct span$1int$* self, struct ref$1void$p* refference, void* head, unsigned long  int  len  )
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "span$1int$_initialize"; neo_current_frame = &fr;
    struct span$1int$* __result_obj__0;
    if(!1) {
        puts("invalid span");
        stackframe();
        exit(2);
    ...
    self->stacktop=refference->stacktop;
        __result_obj__0 = (struct span$1int$*)come_increment_ref_count(self);
    come_call_finalizer(span$1int$$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(ref$1void$p$p_finalize, refference, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    neo_current_frame = fr.prev;
    come_call_finalizer(span$1int$$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__0;
}

static void span$1int$$p_finalize(struct span$1int$* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "span$1int$$p_finalize"; neo_current_frame = &fr;
        neo_current_frame = fr.prev;
}
...
static struct ref$1int$* ref$1int$_initialize(struct ref$1int$* self, int (*p), _Bool global_, _Bool heap_, _Bool local_, void* stacktop)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "ref$1int$_initialize"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    struct ref$1int$* __result_obj__0;
    if(!1||p==((void*)0)) {
    ...
    self->stacktop=stacktop;
        __result_obj__0 = (struct ref$1int$*)come_increment_ref_count(self);
    come_call_finalizer(ref$1int$$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    neo_current_frame = fr.prev;
    come_call_finalizer(ref$1int$$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__0;
}

static void ref$1int$$p_finalize(struct ref$1int$* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "ref$1int$$p_finalize"; neo_current_frame = &fr;
        neo_current_frame = fr.prev;
}
...
int main(int argc, char** argv)
{
    ...
    void* __right_value0 = (void*)0;
    struct span$1int$p* s;
    int __result_obj__0;
    s=(struct span$1int$p*)come_increment_ref_count(make_span());
    span$1int$p_operator_plus_equal(s,2);
    span$1int$p_operator_minus_equal(s,1);
    printf("%d\n",span$1int$p_operator_derefference(s));
        __result_obj__0 = 0;
    come_call_finalizer(span$1int$p$p_finalize, s, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    neo_current_frame = fr.prev;
    come_heap_final();
    return __result_obj__0;
}
...
struct buffer*  FILE_read(struct __sFILE*  f  )
{
    ...
    int size;
    if(f==((void*)0)) {
                __result_obj__0 = (struct buffer* )come_increment_ref_count(((struct buffer*)(__right_value0=buffer_initialize_with_value((struct buffer*)come_increment_ref_count(come_calloc(1, sizeof(struct buffer), "../neo-c.h", 8267, "buffer")), "", 0))));
...
struct buffer*  charp_read(const char* file_name)
{
    ...
    f=fopen(file_name,"r");
    if(f==0) {
                __result_obj__0 = (struct buffer* )come_increment_ref_count(((struct buffer*)(__right_value0=buffer_initialize_with_value((struct buffer*)come_increment_ref_count(come_calloc(1, sizeof(struct buffer), "../neo-c.h", 8373, "buffer")), "", 0))));
        come_call_finalizer(buffer_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
        neo_current_frame = fr.prev;
        come_call_finalizer(buffer_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
        return __result_obj__0;
    ...
    result2=fclose(f);
    if(result2<0) {
                __result_obj__0 = (struct buffer* )come_increment_ref_count(((struct buffer*)(__right_value0=buffer_initialize_with_value((struct buffer*)come_increment_ref_count(come_calloc(1, sizeof(struct buffer), "../neo-c.h", 8393, "buffer")), "", 0))));
        come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer(buffer_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
        neo_current_frame = fr.prev;
        come_call_finalizer(buffer_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
