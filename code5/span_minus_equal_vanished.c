...
static struct span$1int$* span$1int$_initialize(struct span$1int$* self, struct ref$1void$p* refference, void* head, unsigned long  len  );
...
static struct span$1int$p* span$1int$p$p_operator_plus_equal(struct span$1int$p* self, unsigned long  value  );
static struct span$1int$p* span$1int$p_operator_plus_equal(struct span$1int$p* self, unsigned long  value  );
static struct span$1int$p* span$1int$p$p_operator_minus_equal(struct span$1int$p* self, unsigned long  value  );
static struct span$1int$p* span$1int$p_operator_minus_equal(struct span$1int$p* self, unsigned long  value  );
