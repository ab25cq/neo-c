...
int main(int argc, char** argv)
{
    ...
    int __result_obj__0;
    p=((void*)0);
    r=(struct ref$1int$p*)come_increment_ref_count(ref$1int$p_initialize((struct ref$1int$p*)come_increment_ref_count((struct ref$1int$p*)come_calloc(1, sizeof(struct ref$1int$p)*(1), (void*)0, 7, "struct ref$1int$p*")),p,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop));
