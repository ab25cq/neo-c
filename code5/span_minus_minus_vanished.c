...
static struct span$1int$p* span$1int$p$p_operator_minus_minus(struct span$1int$p* self);
static struct span$1int$p* span$1int$p_operator_minus_minus(struct span$1int$p* self);
...
int main(int argc, char** argv)
{
    ...
    span$1int$p_operator_minus_minus(s);
