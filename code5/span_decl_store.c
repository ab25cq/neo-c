...
int main(int argc, char** argv)
{
    ...
    struct span$1int$p* __dec_obj1;
    int __result_obj__0;
    memset(&s, 0, sizeof(s));
    int x[4]={ 1, 2, 3, 4 };
    __dec_obj1=s,
    s=(struct span$1int$*)come_increment_ref_count(span$1int$_initialize((struct span$1int$*)come_increment_ref_count((struct span$1int$*)come_calloc(1, sizeof(struct span$1int$)*(1), (void*)0, 8, "struct span$1int$*")),(struct ref$1int$*)come_increment_ref_count(ref$1int$_initialize((struct ref$1int$*)come_increment_ref_count((struct ref$1int$*)come_calloc(1, sizeof(struct ref$1int$)*(1), (void*)0, 8, "struct ref$1int$*")),x,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop)),x,sizeof(x)));
    come_call_finalizer(span$1int$p$p_finalize, __dec_obj1,(void*)0, (void*)0, 0, 0, 0, (void*)0);
