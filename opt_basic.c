...
int main(int argc, char** argv)
{
    ...
    x=33;
    p=&x;
    o=(struct optional$1int$p*)come_increment_ref_count(optional$1int$p_initialize((struct optional$1int$p*)come_increment_ref_count((struct optional$1int$p*)come_calloc(1, sizeof(struct optional$1int$p)*(1), (void*)0, 8, "struct optional$1int$p*")),p,(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop));
