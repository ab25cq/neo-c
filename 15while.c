...
static void sWhileNode_finalize(struct sWhileNode* self)
{
    ...
    if(self!=((void*)0)&&((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 0))->sname!=((void*)0)) {
        (((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 0))->sname = come_decrement_ref_count(((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 0))->sname, (void*)0, (void*)0, 0, 0, (void*)0));
    }
    if(self!=((void*)0)&&((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 1))->mExpressionNode!=((void*)0)) {
        ((((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 1))->mExpressionNode) ? ((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 1))->mExpressionNode = come_decrement_ref_count(((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 1))->mExpressionNode, ((struct sNode*)((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 1))->mExpressionNode)->finalize, ((struct sNode*)((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 1))->mExpressionNode)->_protocol_obj, 0, 0,(void*)0):(void*)0);
    }
    if(self!=((void*)0)&&((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 2))->mBlock!=((void*)0)) {
        come_call_finalizer(sBlock_finalize, ((struct sWhileNode*)come_null_checker(self, "sWhileNode_finalize", 2))->mBlock, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    neo_current_frame = fr.prev;
}
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self)
{
    ...
    if(self!=((void*)0)) {
        ((struct sWhileNode* )come_null_checker(result, "sWhileNode_clone", 4))->sline=((struct sWhileNode*)come_null_checker(self, "sWhileNode_clone", 4))->sline;
    }
    if(self!=((void*)0)&&((struct sWhileNode*)come_null_checker(self, "sWhileNode_clone", 5))->sname!=((void*)0)) {
        __dec_obj48=((struct sWhileNode* )come_null_checker(result, "sWhileNode_clone", 5))->sname,
        ((struct sWhileNode* )come_null_checker(result, "sWhileNode_clone", 5))->sname=(char* )come_increment_ref_count((char* )come_memdup(((struct sWhileNode*)come_null_checker(self, "sWhileNode_clone", 5))->sname, "sWhileNode_clone", 5, "char* "));
        __dec_obj48 = come_decrement_ref_count(__dec_obj48, (void*)0, (void*)0, 0,0, (void*)0);
    }
    if(self!=((void*)0)) {
        ((struct sWhileNode* )come_null_checker(result, "sWhileNode_clone", 6))->sline_real=((struct sWhileNode*)come_null_checker(self, "sWhileNode_clone", 6))->sline_real;
    }
    if(self!=((void*)0)&&((struct sWhileNode*)come_null_checker(self, "sWhileNode_clone", 7))->mExpressionNode!=((void*)0)) {
        __dec_obj49=((struct sWhileNode* )come_null_checker(result, "sWhileNode_clone", 7))->mExpressionNode,
        ((struct sWhileNode* )come_null_checker(result, "sWhileNode_clone", 7))->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(((struct sWhileNode*)come_null_checker(self, "sWhileNode_clone", 7))->mExpressionNode));
    ...
    if(self!=((void*)0)&&((struct sWhileNode*)come_null_checker(self, "sWhileNode_clone", 8))->mBlock!=((void*)0)) {
        __dec_obj50=((struct sWhileNode* )come_null_checker(result, "sWhileNode_clone", 8))->mBlock,
        ((struct sWhileNode* )come_null_checker(result, "sWhileNode_clone", 8))->mBlock=(struct sBlock* )come_increment_ref_count(sBlock_clone(((struct sWhileNode*)come_null_checker(self, "sWhileNode_clone", 8))->mBlock));
