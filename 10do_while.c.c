...
struct sNode* __result_obj__70;
    if(    charp_operator_equals(buf,"do")    ) {
        ...
        (come_push_stackframe("10do_while.c", 68, 0),__exception_result_var_b1=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b1);
        __right_value0 = (void*)0;
        expression_node=(struct sNode*)come_increment_ref_count(expression_v13(info,0));
        (come_push_stackframe("10do_while.c", 73, 1),__exception_result_var_b2=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b2);
        __right_value0 = (void*)0;
