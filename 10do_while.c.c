...
memset(&num_while_conditional_stack_125, 0, sizeof(int));
    ...
    if(normal_if_121) {
        conditional_value_122=(struct CVALUE*)come_increment_ref_count((come_push_stackframe("10do_while.c", 57, 0),__exception_result_var_b1=((struct CVALUE*)(right_value110=get_value_from_stack(-1,info))), come_pop_stackframe(), __exception_result_var_b1));
        ...
        conditional_value_123=(struct CVALUE*)come_increment_ref_count((come_push_stackframe("10do_while.c", 62, 1),__exception_result_var_b2=((struct CVALUE*)(right_value111=get_value_from_stack(-1,info))), come_pop_stackframe(), __exception_result_var_b2));
...
right_value123 = (void*)0;
    if(_if_conditional127=charp_operator_equals(buf,"do"),    _if_conditional127) {
        ...
        (come_push_stackframe("10do_while.c", 99, 2),__exception_result_var_b3=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b3);
        ...
        (come_push_stackframe("10do_while.c", 104, 3),__exception_result_var_b4=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b4);
