...
int main(int argc, char** argv)
{
    ...
    # 10 "/tmp/repro_hang_struct_nested.nc"
    # 12 "/tmp/repro_hang_struct_nested.nc"
        __result_obj__0 = 0;
    come_call_finalizer(anonymous_typeX29_finalize, (&aaa), (void*)0, (void*)0, 1, 0, 0, (void*)0, "/tmp/repro_hang_struct_nested.nc}", 12, 1);
