...
# 17 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/arm/_types.h" 3 4
...
# 69 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/assert.h" 3 4
...
# 351 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/_ctype.h" 3 4
int isalnum(int);
int isalpha(int);
int isblank(int);
int iscntrl(int);
...
void yyerror(char *fmt, ...) {
 ...
 if (yylineno > 0)
  fprintf(__stderrp, "line %d: ", yylineno);
...
int yylex(void) {
 ...
 while ((c = get()) != (-1)) {
  ...
  && isspace(bp[5])) {
   ...
   ((void) ((p) ? ((void)0) : ((void)printf ("%s:%d: failed assertion `%s'\n", "gram.y", 158, "p"), abort())));
   yylval.string = alloc(p - bp + 1);
   strncpy(yylval.string, bp, p - bp);
   yylval.string[p - bp] = 0;
   bp = *p == '"' ? p + 1 : p;
