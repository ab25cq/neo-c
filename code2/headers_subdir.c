...
int rl_read_key();
char** completion_matches(const char* , char* (*(*anonymous_var_nameY681))(const char*,int)  );
void rl_display_match_list(char** , int , int );
int rl_insert(int , int );
int rl_insert_text(const char* );
void rl_reset_terminal(const char* );
int rl_bind_key(int , int (*(*anonymous_var_nameY690))(int,int)  );
int rl_newline(int , int );
void rl_callback_read_char();
void rl_callback_handler_install(const char* , void (*(*anonymous_var_nameY694))(char*)  );
...
int rl_add_defun(const char* , int (*(*anonymous_var_nameY704))(const char*,int)  , int );
...
char** rl_completion_matches(const char* , char* (*(*anonymous_var_nameY715))(const char*,int)  );
...
int rl_bind_key_in_map(int , int (*(*anonymous_var_nameY725))(int,int)  , struct _keymap_entry*    );
...
int waitid(enum anonymous_typeY23    , unsigned int    , struct __siginfo*    , int ) ;
