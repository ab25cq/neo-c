...
int aio_suspend(const struct aiocb* const  aiocblist[]  , int nent, const struct timespec*  timeoutp  ) __asm("_" "aio_suspend"  );
...
int closedir(struct anonymous_typeX7*    ) __asm("_" "closedir" );
struct anonymous_typeX7*  opendir(const char* ) __asm("_" "opendir"  );
struct dirent*  readdir(struct anonymous_typeX7*    ) __asm("_" "readdir" );
int readdir_r(struct anonymous_typeX7*    , struct dirent*    , struct dirent**    ) __asm("_" "readdir_r" );
void rewinddir(struct anonymous_typeX7*    ) __asm("_" "rewinddir"  );
void seekdir(struct anonymous_typeX7*    , long ) __asm("_" "seekdir"  );
long telldir(struct anonymous_typeX7*    ) __asm("_" "telldir"  );
struct anonymous_typeX7*  fdopendir(int ) __asm("_" "fdopendir"  );
int alphasort(const struct dirent**    , const struct dirent**    ) __asm("_" "alphasort" );
int dirfd(struct anonymous_typeX7*  dirp  );
int scandir(const char* , struct dirent***    , int (*anonymous_lambda_var_nameZ7)(const struct dirent* ), int (*anonymous_lambda_var_nameZ8)(const struct dirent** ,const struct dirent** )) __asm("_" "scandir" );
...
;
struct anonymous_typeX7*  __opendir2(const char* , int ) __asm("_" "__opendir2"  );
...
struct _ftsent*  fts_children(struct anonymous_typeX10*    , int ) __asm("_" "fts_children" );
int fts_close(struct anonymous_typeX10*    ) __asm("_" "fts_close" );
struct anonymous_typeX10*  fts_open(char** const , int , int (*anonymous_lambda_var_nameZ10)(const struct _ftsent** ,const struct _ftsent** )) __asm("_" "fts_open" );
struct _ftsent*  fts_read(struct anonymous_typeX10*    ) __asm("_" "fts_read" );
int fts_set(struct anonymous_typeX10*    , struct _ftsent*    , int ) __asm("_" "fts_set" );
...
int ftw(const char* , int (*anonymous_lambda_var_nameZ11)(const char*,const struct stat* ,int), int ) __asm("_" "ftw"  );
int nftw(const char* , int (*anonymous_lambda_var_nameZ12)(const char*,const struct stat* ,int,struct FTW* ), int , int ) __asm("_" "nftw"  );
...
int glob(const char* restrict , int , int (*anonymous_lambda_var_nameZ13)(const char*,int), struct anonymous_typeX11* restrict    ) __asm("_" "glob" );
...
unsigned long  int  strftime_l(char* restrict , unsigned long  int  __n  , const char* restrict , const struct tm* restrict    , struct _xlocale*    ) __asm("_" "strftime_l" ) __attribute__((__format__ (__strftime__, 3, 0)));
char* strptime_l(const char* restrict , const char* restrict , struct tm* restrict    , struct _xlocale*    ) __asm("_" "strptime_l" ) __attribute__((__format__ (__strftime__, 2, 0)));
...
unsigned long  int  wcsftime_l(int* restrict    , unsigned long  int  __n  , const int* restrict    , const struct tm* restrict    , struct _xlocale*    ) __asm("_" "wcsftime_l" );
...
int regcomp(struct anonymous_typeX34* restrict    , const char* restrict , int ) __asm("_" "regcomp" );
...
int sem_wait(int*    ) __asm("_" "sem_wait"  );
...
int waitid(enum anonymous_typeY79    , unsigned int    , struct __siginfo*    , int ) __asm("_" "waitid"  );
...
double strtod_l(const char* , char** , struct _xlocale*    ) __asm("_" "strtod_l" );
float strtof_l(const char* , char** , struct _xlocale*    ) __asm("_" "strtof_l" );
