...
typedef struct anonymous_typeX109 __pthread_unwind_buf_t __attribute__ ((__aligned__));
...
typedef union anonymous_typeZ169 La_x86_64_vector __attribute__ ((__aligned__ (16)));
...
int mbsinit(const struct anonymous_typeX20* __ps  );
...
int vidputs(unsigned int   , int (*anonymous_var_nameX438)(int)  );
...
int use_screen(struct screen*   , int (*anonymous_var_nameX639)(struct screen*,void*)  , void* );
int use_window(struct _win_st*   , int (*anonymous_var_nameX642)(struct _win_st*,void*)  , void* );
...
int vidputs_sp(struct screen*   , unsigned int   , int (*anonymous_var_nameX799)(struct screen*,int)  );
...
int vid_puts(unsigned int   , short , void* , int (*anonymous_var_nameX1071)(int)  );
...
int vid_puts_sp(struct screen*   , unsigned int   , short , void* , int (*anonymous_var_nameX1151)(struct screen*,int)  );
...
int set_form_init(struct formnode*   , void (*anonymous_var_nameX1340)(struct formnode*)  );
int set_form_term(struct formnode*   , void (*anonymous_var_nameX1342)(struct formnode*)  );
int set_field_init(struct formnode*   , void (*anonymous_var_nameX1344)(struct formnode*)  );
int set_field_term(struct formnode*   , void (*anonymous_var_nameX1346)(struct formnode*)  );
...
struct anonymous_typeX97 imaxdiv(long  int __numer  , long  int __denom  );
...
int set_item_init(struct tagMENU*   , void (*anonymous_var_nameX1684)(struct tagMENU*)  );
int set_item_opts(struct tagITEM*   , int   );
int set_item_term(struct tagMENU*   , void (*anonymous_var_nameX1688)(struct tagMENU*)  );
...
int set_menu_init(struct tagMENU*   , void (*anonymous_var_nameX1703)(struct tagMENU*)  );
...
int set_menu_term(struct tagMENU*   , void (*anonymous_var_nameX1717)(struct tagMENU*)  );
...
long  int strfmon_l(char* __s, unsigned long __maxsize  , struct __locale_struct* __loc  , const char* __format, ...);
...
void __pthread_unwind_next(struct anonymous_typeX109* __buf  );
...
int ns_sprintrr(const struct __ns_msg*   , const struct __ns_rr*   , const char* , const char* , char* , unsigned long   );
...
void __fp_resstat(const struct __res_state*   , struct _IO_FILE*   );
const char* __res_hostalias(const struct __res_state*   , const char* , char* , unsigned long   );
...
struct anonymous_typeX156 div(int __numer, int __denom);
struct anonymous_typeX157 ldiv(long  int __numer, long  int __denom);
struct anonymous_typeX158 lldiv(long long int __numer, long long int __denom);
...
int tputs_sp(struct screen*   , const char* , int , int (*anonymous_var_nameX2356)(struct screen*,int)  );
