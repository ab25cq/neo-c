...
int closedir(struct anonymous_typeX2*    ) ;
struct anonymous_typeX2*  opendir(const char* ) ;
struct dirent*  readdir(struct anonymous_typeX2*    ) ;
int readdir_r(struct anonymous_typeX2*    , struct dirent*    , struct dirent**    ) ;
void rewinddir(struct anonymous_typeX2*    ) ;
void seekdir(struct anonymous_typeX2*    , long ) ;
long telldir(struct anonymous_typeX2*    ) ;
struct anonymous_typeX2*  fdopendir(int ) ;
int alphasort(const struct dirent**    , const struct dirent**    ) ;
int dirfd(struct anonymous_typeX2*  dirp  );
int scandir(const char* , struct dirent***    , int (*anonymous_lambda_var_nameZ1)(const struct dirent* ), int (*anonymous_lambda_var_nameZ2)(const struct dirent** ,const struct dirent** )) ;
...
;
struct anonymous_typeX2*  __opendir2(const char* , int ) ;
...
int regcomp(struct anonymous_typeX3* restrict    , const char* restrict , int ) ;
...
void* mmap(void* , unsigned long  int    , int , int , int , long long int    ) ;
int mprotect(void* , unsigned long  int    , int ) ;
int msync(void* , unsigned long  int    , int ) ;
int munlock(const void* , unsigned long  int    );
int munmap(void* , unsigned long  int    ) ;
...
long  preadv(int , const struct iovec*    , int , long long int    )  ;
long  pwritev(int , const struct iovec*    , int , long long int    )  ;
int uname(struct utsname*    );
void (*signal(int _function_pointer_result_var_name_a1, void (*_function_pointer_result_var_name_a2)(int)))(int);
int  wait(int* ) ;
int  waitpid(int    , int* , int ) ;
int waitid(enum anonymous_typeY14    , unsigned int    , struct __siginfo*    , int ) ;
...
int lockf(int , int , long long int    ) ;
int nice(int ) ;
long  pread(int __fd, void* __buf, unsigned long  int  __nbyte  , long long int  __offset  ) ;
long  pwrite(int __fd, const void* __buf, unsigned long  int  __nbyte  , long long int  __offset  ) ;
int  setpgrp() ;
