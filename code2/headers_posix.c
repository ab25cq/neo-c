...
void* mmap(void* , unsigned long  int    , int , int , int , long long    ) ;
...
long  preadv(int , const struct iovec*    , int , long long    )  ;
long  pwritev(int , const struct iovec*    , int , long long    )  ;
