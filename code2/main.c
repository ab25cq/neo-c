...
typedef struct anonymous_typeX6 imaxdiv_t;
...
typedef enum anonymous_typeY18 idtype_t;
...
typedef struct anonymous_typeX25 div_t;

typedef struct anonymous_typeX26 ldiv_t;

typedef struct anonymous_typeX27 lldiv_t;
...
typedef enum anonymous_typeY27 clockid_t;
...
enum  anonymous_typeY27 { _CLOCK_REALTIME=(0),
_CLOCK_MONOTONIC=(6),
...
struct anonymous_typeX6  imaxdiv(long  int  __numer  , long  int  __denom  );
...
int waitid(enum anonymous_typeY18    , unsigned int    , struct __siginfo*    , int ) __asm("_" "waitid"  );
...
int atexit(void (*anonymous_lambda_var_nameZ8)());
int at_quick_exit(void (*anonymous_lambda_var_nameZ9)());
double atof(const char* );
int atoi(const char* );
long atol(const char* );
long long atoll(const char* );
void* bsearch(const void* __key, const void* __base, unsigned long  int  __nel  , unsigned long  int  __width  , int (*__compar)(const void*,const void*));
struct anonymous_typeX25  div(int , int ) __attribute__((__const__));
void exit(int ) __attribute__((__noreturn__));
char* getenv(const char* );
long labs(long ) __attribute__((__const__));
struct anonymous_typeX26  ldiv(long , long ) __attribute__((__const__));
long long llabs(long  long );
struct anonymous_typeX27  lldiv(long  long , long  long );
...
int clock_getres(enum anonymous_typeY27  __clock_id  , struct timespec*  __res  );
int clock_gettime(enum anonymous_typeY27  __clock_id  , struct timespec*  __tp  );
unsigned long long int  clock_gettime_nsec_np(enum anonymous_typeY27  __clock_id  );
int clock_settime(enum anonymous_typeY27  __clock_id  , const struct timespec*  __tp  );
