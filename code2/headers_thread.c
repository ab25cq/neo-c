...
int sem_timedwait(union anonymous_typeZ18* __restrict  __sem  , const struct timespec* __restrict  __abstime  );
int sem_clockwait(union anonymous_typeZ18* __restrict  __sem  , int  clock  , const struct timespec* __restrict  __abstime  );
int sem_trywait(union anonymous_typeZ18*  __sem  );
int sem_post(union anonymous_typeZ18*  __sem  );
int sem_getvalue(union anonymous_typeZ18* __restrict  __sem  , int* __restrict __sval);
...
int mtx_timedlock(union anonymous_typeZ19* __restrict  __mutex  , const struct timespec* __restrict  __time_point  );
...
int cnd_timedwait(union anonymous_typeZ20* __restrict  __cond  , union anonymous_typeZ19* __restrict  __mutex  , const struct timespec* __restrict  __time_point  );
