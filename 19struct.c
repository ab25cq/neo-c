...
_conditional_value_X0;})) {
    ...
    while(1) {
        ...
        if(multiple_declare) {
            multiple_assign_var5=(come_push_stackframe("19struct.nc", 412, 3),__exception_result_var_b4=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b4);
            ...
            skip_spaces_and_lf(info);
            multiple_assign_var8=(come_push_stackframe("19struct.nc", 429, 5),__exception_result_var_b6=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b6);
...
_conditional_value_X1;})) {
            ...
            (come_push_stackframe("19struct.nc", 561, 6),__exception_result_var_b7=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b7);
            while(1) {
                skip_spaces_and_lf(info);
                if(*info->p==125) {
                    info->p++;
                ...
                skip_spaces_and_lf(info);
                multiple_assign_var9=(come_push_stackframe("19struct.nc", 574, 8),__exception_result_var_b9=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b9);
...
_conditional_value_X2;})) {
            ...
            parent_class=((void*)0);
            if((come_push_stackframe("19struct.nc", 664, 9),__exception_result_var_b10=parsecmp("extends",info), come_pop_stackframe(), __exception_result_var_b10)) {
                ((char*)(__right_value0=parse_word(0,info)));
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
                parent_class_name=(char*)come_increment_ref_count(parse_word(0,info));
                parent_class=((struct sClass*)(__right_value0=map$2char$phsClass$ph_operator_load_element(info->classes,parent_class_name)));
            ...
            (come_push_stackframe("19struct.nc", 677, 10),__exception_result_var_b11=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b11);
            while(1) {
                skip_spaces_and_lf(info);
                if(*info->p==125) {
                    info->p++;
                ...
                if(multiple_declare) {
                    multiple_assign_var11=(come_push_stackframe("19struct.nc", 704, 12),__exception_result_var_b13=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b13);
                    ...
                    multiple_assign_var14=(come_push_stackframe("19struct.nc", 720, 14),__exception_result_var_b15=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b15);
...
_conditional_value_X3;})) {
        ...
        if((come_push_stackframe("19struct.nc", 785, 15),__exception_result_var_b16=parsecmp("extends",info), come_pop_stackframe(), __exception_result_var_b16)) {
            ((char*)(__right_value0=parse_word(0,info)));
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
_conditional_value_X4;})) {
        ...
        (come_push_stackframe("19struct.nc", 832, 16),__exception_result_var_b17=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b17);
        head_77=info->p;
        p_saved=((void*)0);
        sline_saved=0;
        sname_saved=((void*)0);
        ...
        while(1) {
            ...
            skip_spaces_and_lf(info);
            include_=(come_push_stackframe("19struct.nc", 864, 17),__exception_result_var_b18=parsecmp("include",info), come_pop_stackframe(), __exception_result_var_b18);
            ...
            if(define_function_flag) {
                ...
                info->class_type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "19struct.nc", 951, "struct sType*")),(char*)come_increment_ref_count(type_name_66),0,info,0));
                ...
                multiple_assign_var17=(come_push_stackframe("19struct.nc", 964, 19),__exception_result_var_b20=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b20);
                ...
                (come_push_stackframe("19struct.nc", 978, 20),__exception_result_var_b21=expected_next_character(59,info), come_pop_stackframe(), __exception_result_var_b21);
            ...
            else if((come_push_stackframe("19struct.nc", 980, 21),__exception_result_var_b22=parsecmp("include",info), come_pop_stackframe(), __exception_result_var_b22)) {
                ((char*)(__right_value0=parse_word(0,info)));
                (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
_conditional_value_X8;})) {
                ...
                multiple_assign_var20=(come_push_stackframe("19struct.nc", 1052, 23),__exception_result_var_b24=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,1,1,0))), come_pop_stackframe(), __exception_result_var_b24);
...
struct sNode* string_node_v14(char* buf, char* head, int head_sline, struct sInfo* info  )
{
    ...
    define_struct=0;
    {
        ...
        if(charp_operator_equals(buf,"struct")) {
            if(xisalpha(*info->p)||*info->p==95) {
                type_name=(char*)come_increment_ref_count(parse_word(0,info));
                if((come_push_stackframe("19struct.nc", 1113, 24),__exception_result_var_b25=parsecmp("extends",info), come_pop_stackframe(), __exception_result_var_b25)) {
                    ((char*)(__right_value0=parse_word(0,info)));
                    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
                    ((char*)(__right_value0=parse_word(0,info)));
                    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
