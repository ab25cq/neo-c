...
default_value_74 = (void*)0;
    ...
    result_68=(struct map$2charphsVarph*)come_increment_ref_count(map$2charphsVarph_initialize((struct map$2charphsVarph*)come_increment_ref_count(((struct map$2charphsVarph*)(__right_value93=(struct map$2charphsVarph*)come_calloc(1, sizeof(struct map$2charphsVarph)*(1), "./neo-c.h", 1370, "map$2charphsVarph"))))));
    come_call_finalizer3(__right_value93,map$2charphsVarphp_finalize, 0, 1, 0, 0, __result_obj__);
    __dec_obj23=result_68->key_list;
    result_68->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(__right_value100=(struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./neo-c.h", 1372, "list$1charp"))))));
...
struct map$2charphsVarph* __result55__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value94=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./neo-c.h", 1276, "char*%"))));
    __right_value94 = come_decrement_ref_count2(__right_value94, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value95=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "./neo-c.h", 1277, "sVar*%"))));
    come_call_finalizer3(__right_value95,sVar_finalize, 0, 1, 0, 0, __result_obj__);
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value96=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./neo-c.h", 1278, "bool"))));
    ...
    self->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(__right_value97=(struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./neo-c.h", 1288, "list$1charp"))))));
...
default_value_88 = (void*)0;
    ...
    keys_79=(char**)come_increment_ref_count(((char**)(__right_value102=(char**)come_calloc(1, sizeof(char*)*(1*(size_78)), "./neo-c.h", 1527, "char*%"))));
    __right_value102 = come_decrement_ref_count2(__right_value102, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    items_80=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value103=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_78)), "./neo-c.h", 1528, "sVar*%"))));
    come_call_finalizer3(__right_value103,sVar_finalize, 0, 1, 0, 0, (void*)0);
    item_existance_81=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value104=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_78)), "./neo-c.h", 1529, "bool"))));
