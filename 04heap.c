...
struct sType* solve_generics(struct sType* type  , struct sType* generics_type  , struct sInfo* info  )
{
    ...
    if(string_operator_equals(klass->mName,"lambda")) {
        ...
        if(generics_number_18!=generics_number2) {
            ...
            if(const__28) {
                result->mConstant=result->mConstant||const__28;
            }
            if(record__27) {
        ...
        for(o2_saved_29=(struct list$1sType$ph*)come_increment_ref_count(type->mGenericsTypes),it_30=list$1sType$ph_begin(o2_saved_29);!list$1sType$ph_end(o2_saved_29);it_30=list$1sType$ph_next(o2_saved_29)){
            type_31=(struct sType*)come_increment_ref_count(solve_generics(it_30,generics_type,info));
            list$1sType$ph_push_back(result->mGenericsTypes,(struct sType*)come_increment_ref_count(type_31));
...
struct sType* solve_method_generics(struct sType* type  , struct sInfo* info  )
{
    ...
    come_call_finalizer(list$1sType$ph$p_finalize, o2_saved, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    i=0;
    for(o2_saved_33=(struct list$1sType$ph*)come_increment_ref_count(type->mParamTypes),it_34=list$1sType$ph_begin(o2_saved_33);!list$1sType$ph_end(o2_saved_33);it_34=list$1sType$ph_next(o2_saved_33)){
        list$1sType$ph_operator_store_element(result->mParamTypes,i,(struct sType*)come_increment_ref_count(solve_method_generics(it_34,info)));
        i++;
    }
...
void append_object_to_right_values(struct CVALUE* come_value  , struct sType* type  , struct sInfo* info  , _Bool decrement_ref_count, struct sType* obj_type  , char* obj_value, struct sVar* obj_var  )
{
    ...
    new_value=(struct sRightValueObject*)come_increment_ref_count((struct sRightValueObject*)come_calloc(1, sizeof(struct sRightValueObject)*(1), (void*)0, 318, "struct sRightValueObject*"));
    ...
    if(type->mPointerNum>0) {
        ...
        come_value->c_value_without_right_value_objects=(char*)come_increment_ref_count((char*)come_memdup(come_value->c_value, "04heap.nc", 349, "char*"));
...
static struct list$1sRightValueObject$ph* list$1sRightValueObject$ph_push_back(struct list$1sRightValueObject$ph* self, struct sRightValueObject* item  )
{
    ...
    struct list_item$1sRightValueObject$ph* litem_36;
    ...
    if(self->len==0) {
        ...
        litem_35=(struct list_item$1sRightValueObject$ph*)come_increment_ref_count(((struct list_item$1sRightValueObject$ph*)(__right_value0=(struct list_item$1sRightValueObject$ph*)come_calloc(1, sizeof(struct list_item$1sRightValueObject$ph)*(1), (void*)0, 711, "struct list_item$1sRightValueObject$ph*"))));
        ...
        litem_36=(struct list_item$1sRightValueObject$ph*)come_increment_ref_count(((struct list_item$1sRightValueObject$ph*)(__right_value0=(struct list_item$1sRightValueObject$ph*)come_calloc(1, sizeof(struct list_item$1sRightValueObject$ph)*(1), (void*)0, 721, "struct list_item$1sRightValueObject$ph*"))));
        litem_36->prev=self->tail;
        litem_36->next=((void*)0);
        __dec_obj54=litem_36->item,
        litem_36->item=(struct sRightValueObject*)come_increment_ref_count(item);
...
;    struct sFun* fun  =0;
    ...
    if(type->mPointerNum>0||type->mArrayPointerNum) {
        ...
        if(finalizer!=((void*)0)) {
            if(klass_43->mProtocol&&type_->mPointerNum==1) {
            ...
            if(klass_43->mProtocol&&type_->mPointerNum==1) {
                type_name_46=(char*)come_increment_ref_count(make_type_name_string(type_,info,0,0,0));
    ...
    if(type_->mPointerNum>0||type_->mClass->mProtocol||list$1sType$ph_length(type_->mGenericsTypes)>0) {
        ...
        if(finalizer!=((void*)0)) {
            ...
            if(klass->mStruct&&type_->mPointerNum==0) {
                for(o2_saved=(struct list$1tuple2$2char$phsType$ph$ph*)come_increment_ref_count(klass->mFields),it=list$1tuple2$2char$phsType$ph$ph_begin(o2_saved);!list$1tuple2$2char$phsType$ph$ph_end(o2_saved);it=list$1tuple2$2char$phsType$ph$ph_next(o2_saved)){
                    ...
                    if(field_type->mHeap&&field_type->mPointerNum>0) {
                        obj_52=(char*)come_increment_ref_count(xsprintf("(((%s)%s).%s)",((char*)(__right_value0=make_type_name_string(type_,info,0,0,0))),c_value,name_51));
                        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
                        free_object(field_type,obj_52,no_decrement,no_free,info,0);
                ...
                for(o2_saved_53=(struct list$1tuple2$2char$phsType$ph$ph*)come_increment_ref_count(klass->mFields),it_54=list$1tuple2$2char$phsType$ph$ph_begin(o2_saved_53);!list$1tuple2$2char$phsType$ph$ph_end(o2_saved_53);it_54=list$1tuple2$2char$phsType$ph$ph_next(o2_saved_53)){
                    ...
                    if(field_type_56->mHeap&&field_type_56->mPointerNum>0) {
                        obj_57=(char*)come_increment_ref_count(xsprintf("(((%s)%s)->%s)",((char*)(__right_value0=make_type_name_string(type_,info,0,0,0))),c_value,name_55));
                        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
                        free_object(field_type_56,obj_57,no_decrement,no_free,info,0);
            ...
            if(!type_->mAllocaValue) {
                if(klass->mProtocol&&type_->mPointerNum==1) {
                    if(c_value) {
                        type_name_58=(char*)come_increment_ref_count(make_type_name_string(type_,info,0,0,0));
...
;    struct sFun* fun  =0;
    ...
    if(list$1sType$ph_length(type_->mGenericsTypes)>0) {
        ...
        if(generics_fun) {
            ...
            if(!err) {
                __result_obj__0 = (struct tuple2$2sType$phchar$ph*)come_increment_ref_count(((struct tuple2$2sType$phchar$ph*)(__right_value5=tuple2$2sType$phchar$ph_initialize((struct tuple2$2sType$phchar$ph*)come_increment_ref_count((struct tuple2$2sType$phchar$ph*)come_calloc(1, sizeof(struct tuple2$2sType$phchar$ph)*(1), "04heap.nc", 760, "struct tuple2$2sType$phchar$ph")),(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 760, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0)),(char*)come_increment_ref_count(__builtin_string(""))))));
                (name = come_decrement_ref_count(name, (void*)0, (void*)0, 0, 0, (void*)0));
                (none_generics_name = come_decrement_ref_count(none_generics_name, (void*)0, (void*)0, 0, 0, (void*)0));
    ...
    if(cloner!=((void*)0)) {
        type__60=(struct sType*)come_increment_ref_count(sType_clone(cloner->mResultType));
        __dec_obj72=result_type,
        result_type=(struct sType*)come_increment_ref_count(solve_generics(type__60,type__60,info));
        ...
        come_call_finalizer(sType_finalize, type__60, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    else {
    ...
    __result_obj__0 = (struct tuple2$2sType$phchar$ph*)come_increment_ref_count(((struct tuple2$2sType$phchar$ph*)(__right_value1=tuple2$2sType$phchar$ph_initialize((struct tuple2$2sType$phchar$ph*)come_increment_ref_count((struct tuple2$2sType$phchar$ph*)come_calloc(1, sizeof(struct tuple2$2sType$phchar$ph)*(1), "04heap.nc", 815, "struct tuple2$2sType$phchar$ph")),(struct sType*)come_increment_ref_count(result_type),(char*)come_increment_ref_count(result)))));
    come_call_finalizer(sType_finalize, type2, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    come_call_finalizer(sType_finalize, type_, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 0, (void*)0));
    come_call_finalizer(sType_finalize, result_type, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    ...
    for(o2_saved_61=right_value_objects,it_62=list$1sRightValueObject$ph_begin(o2_saved_61);!list$1sRightValueObject$ph_end(o2_saved_61);it_62=list$1sRightValueObject$ph_next(o2_saved_61)){
        if(it_62&&!it_62->mFreed) {
            if(string_operator_equals(it_62->mFunName,info->come_fun->mName)&&it_62->mBlockLevel==info->block_level&&!it_62->mStored&&!it_62->mNoFree) {
                ...
                free_object(type,it_62->mVarName,!it_62->mDecrementRefCount,0,info,0);
                it_62->mFreed=1;
                free_right_value=1;
        ...
        if(type->mChannel) {
            ...
            if(list$1sNode$ph_length(type->mArrayNum)>0) {
                if(list$1sNode$ph_length(type->mArrayNum)==1) {
                    ...
                    node_69=(struct sNode*)come_increment_ref_count(list$1sNode$ph_operator_load_element(type->mArrayNum,0));
                    ...
                    for(i_74=0;i_74<n_72;i_74++){
                        for(j=0;j<m;j++){
                            c_value_75=(char*)come_increment_ref_count(string_operator_add(((char*)(__right_value97=string_operator_add(((char*)(__right_value95=string_operator_add(((char*)(__right_value94=string_operator_add(((char*)(__right_value93=string_operator_add(((char*)(__right_value91=string_operator_add(p->mCValueName,"["))),((char*)(__right_value92=int_to_string(i_74)))))),"]"))),"["))),((char*)(__right_value96=int_to_string(j)))))),"]"));
                            (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0));
                            (__right_value3 = come_decrement_ref_count(__right_value3, (void*)0, (void*)0, 1, 0, (void*)0));
                            (__right_value7 = come_decrement_ref_count(__right_value7, (void*)0, (void*)0, 1, 0, (void*)0));
                            (__right_value8 = come_decrement_ref_count(__right_value8, (void*)0, (void*)0, 1, 0, (void*)0));
                            ...
                            element_type_76=(struct sType*)come_increment_ref_count(sType_clone(type));
                            list$1sNode$ph_reset(element_type_76->mArrayNum);
                            free_object(element_type_76,c_value_75,0,0,info,0);
                            (c_value_75 = come_decrement_ref_count(c_value_75, (void*)0, (void*)0, 0, 0, (void*)0));
                            come_call_finalizer(sType_finalize, element_type_76, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                        }
                    }
                    ...
                    node_77=(struct sNode*)come_increment_ref_count(list$1sNode$ph_operator_load_element(type->mArrayNum,0));
                    ...
                    n_80=atoi(come_value_79->c_value);
                    node2_81=(struct sNode*)come_increment_ref_count(list$1sNode$ph_operator_load_element(type->mArrayNum,1));
                    Value_82=node_compile(node2_81,info);
                    if(!Value_82) {
                        err_msg(info,"invalid array number");
                        exit(1);
                    }
                    come_value2_83=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
                    m_84=atoi(come_value2_83->c_value);
                    node3=(struct sNode*)come_increment_ref_count(list$1sNode$ph_operator_load_element(type->mArrayNum,2));
                    Value_85=node_compile(node3,info);
                    if(!Value_85) {
                        err_msg(info,"invalid array number");
                        exit(1);
                    }
                    ...
                    for(i_86=0;i_86<n_80;i_86++){
                        for(j_87=0;j_87<m_84;j_87++){
                            for(k=0;k<l;k++){
                                c_value_88=(char*)come_increment_ref_count(string_operator_add(((char*)(__right_value801=string_operator_add(((char*)(__right_value799=string_operator_add(((char*)(__right_value798=string_operator_add(((char*)(__right_value797=string_operator_add(((char*)(__right_value795=string_operator_add(((char*)(__right_value794=string_operator_add(((char*)(__right_value793=string_operator_add(((char*)(__right_value791=string_operator_add(p->mCValueName,"["))),((char*)(__right_value792=int_to_string(i_86)))))),"]"))),"["))),((char*)(__right_value796=int_to_string(j_87)))))),"]"))),"["))),((char*)(__right_value800=int_to_string(k)))))),"]"));
                                (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0));
                                (__right_value3 = come_decrement_ref_count(__right_value3, (void*)0, (void*)0, 1, 0, (void*)0));
                                (__right_value7 = come_decrement_ref_count(__right_value7, (void*)0, (void*)0, 1, 0, (void*)0));
                                (__right_value8 = come_decrement_ref_count(__right_value8, (void*)0, (void*)0, 1, 0, (void*)0));
                                ...
                                free_object(element_type_89,c_value_88,0,0,info,0);
                    ...
                    come_call_finalizer(CVALUE_finalize, come_value2_83, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            ...
            c_value_90=(char*)come_increment_ref_count(xsprintf("(&%s)",p->mCValueName));
            type2=(struct sType*)come_increment_ref_count(sType_clone(type));
            type2->mPointerNum++;
            free_object(type2,c_value_90,0,0,info,0);
            (c_value_90 = come_decrement_ref_count(c_value_90, (void*)0, (void*)0, 0, 0, (void*)0));
            come_call_finalizer(sType_finalize, type2, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        }
    }
...
static struct sNode* list$1sNode$ph_operator_load_element(struct list$1sNode$ph* self, int position)
{
    ...
    memset(&default_value_68,0,sizeof(struct sNode*));
    __result_obj__0 = (struct sNode*)come_increment_ref_count(default_value_68);
    ((default_value_68) ? default_value_68 = come_decrement_ref_count(default_value_68, ((struct sNode*)default_value_68)->finalize, ((struct sNode*)default_value_68)->_protocol_obj, 0, 1,(void*)0):(void*)0);
    neo_current_frame = fr.prev;
    ((__result_obj__0) ? __result_obj__0 = come_decrement_ref_count(__result_obj__0, ((struct sNode*)__result_obj__0)->finalize, ((struct sNode*)__result_obj__0)->_protocol_obj, 0, 1,(void*)0):(void*)0);
    return __result_obj__0;
}
