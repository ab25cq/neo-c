    ...
    if(type->mPointerNum > 0) {
        ...
        if(finalizer != null) {
            if(klass->mProtocol && type->mPointerNum == 1) {
                ...
                if(c_value) {
                    add_come_last_code2(info, xsprintf("come_call_finalizer3(%s,%s, %d, %d, %d, %d, (void*)0);\n", c_value, fun_name2, type->mAllocaValue, no_decrement, no_free, force_delete_));
                }
            }
        }
        else {
            ...
            if(finalizer != null) {
                if(klass->mProtocol && type->mPointerNum == 1) {
                    ...
                    if(c_value) {
                        if(no_decrement) {
                            if(comma) {
                                add_come_code(info, "come_call_finalizer2(%s, %s, ((%s)%s)->finalize, ((%s)%s)->_protocol_obj, %d, %d, %d, %d, %s),\n",  fun_name2, c_value, type_name, c_value, type_name, c_value, type->mAllocaValue, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "__result_obj__": "__result_obj__");
                            }
                            else {
                                add_come_code(info, "come_call_finalizer2(%s, %s, ((%s)%s)->finalize, ((%s)%s)->_protocol_obj, %d, %d, %d, %d, %s);\n", fun_name2, c_value, type_name, c_value, type_name, c_value, type->mAllocaValue, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "__result_obj__": "__result_obj__");
                            }
                    ...
                    if(c_value) {
                        if(no_decrement) {
                            if(comma) {
                                add_come_code(info, xsprintf("come_call_finalizer3(%s,%s, %d, %d, %d, %d, %s),\n", c_value, fun_name2, type->mAllocaValue, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "__result_obj__":"__result_obj__"));
                            }
                            else {
                                add_come_code(info, xsprintf("come_call_finalizer3(%s,%s, %d, %d, %d, %d, %s);\n", c_value, fun_name2, type->mAllocaValue, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "__result_obj__": "__result_obj__"));
                            }
                            ...
                            if(comma) {
                                add_come_code(info, xsprintf("come_call_finalizer3(%s,%s, %d, %d, %d, %d, (void*)0),\n", c_value, fun_name2, type->mAllocaValue, no_decrement, no_free, force_delete_));
                            }
                            else {
                                add_come_code(info, xsprintf("come_call_finalizer3(%s,%s, %d, %d, %d, %d, (void*)0);\n", c_value, fun_name2, type->mAllocaValue, no_decrement, no_free, force_delete_));
                            }
                ...
                if(!type->mAllocaValue) {
                    if(klass->mProtocol && type->mPointerNum == 1) {
                        if(c_value) {
                            ...
                            if(no_decrement) {
                                if(comma) {
                                    add_come_code(info, "(%s) ? %s = come_decrement_ref_count2(%s, ((%s)%s)->finalize, ((%s)%s)->_protocol_obj, %d, %d,%d, %s):0,\n", c_value, c_value, c_value, type_name, c_value, type_name, c_value, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "(void*)0":"__result_obj__");
                                }
                                else {
                        ...
                        if(c_value) {
                            if(no_decrement) {
                                if(comma) {
                                    add_come_code(info, "%s = come_decrement_ref_count2(%s, (void*)0, (void*)0, %d, %d, %d, %s),\n", c_value, c_value, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "(void*)0":"__result_obj__");
                                }
                                else {
                                    add_come_code(info, "%s = come_decrement_ref_count2(%s, (void*)0, (void*)0, %d, %d, %d, %s);\n", c_value, c_value, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "(void*)0" : "__result_obj__");
                                }
            ...
            if(finalizer != null) {
                if(klass->mProtocol && type->mPointerNum == 1) {
                    ...
                    if(c_value) {
                        if(no_decrement) {
                            if(comma) {
                                add_come_code(info, "come_call_finalizer2(%s, %s, ((%s)%s)->finalize, ((%s)%s)->_protocol_obj, %d, %d, %d, %d, %s),\n", fun_name2, c_value, type_name, c_value, type_name, c_value, type->mAllocaValue, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "(void*)0": "__result_obj__");
                            }
                            else {
                                add_come_code(info, "come_call_finalizer2(%s, %s, ((%s)%s)->finalize, ((%s)%s)->_protocol_obj, %d, %d, %d, %d, %s);\n", fun_name2, c_value, type_name, c_value, type_name, c_value, type->mAllocaValue, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "(void*)0":"__result_obj__");
                            }
                    ...
                    if(c_value) {
                        if(no_decrement) {
                            if(comma) {
                                add_come_code(info, xsprintf("come_call_finalizer3(%s,%s, %d, %d, %d, %d, %s),\n", c_value, fun_name2, type->mAllocaValue, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "(void*)0":"__result_obj__"));
                            }
                            else {
                                add_come_code(info, xsprintf("come_call_finalizer3(%s,%s, %d, %d, %d, %d, %s);\n", c_value, fun_name2, type->mAllocaValue, no_decrement, no_free, force_delete_, info.come_fun.mNoResultType ? "(void*)0":"__result_obj__"));
                            }
                    ...
                    if(klass->mProtocol && type->mPointerNum == 1) {
                        ...
                        if(c_value) {
                            if(no_decrement) {
                                ...
                                if(comma) {
                                    add_come_code(info, "%s = come_decrement_ref_count2(%s, (void*)0, (void*)0, %d, %d, %d, (void*)0),\n", c_value, no_decrement, no_free, force_delete_);
                                }
                                else {
                                    add_come_code(info, "%s = come_decrement_ref_count2(%s, (void*)0, (void*)0, %d, %d, %d, (void*)0);\n", c_value, c_value, no_decrement, no_free, force_delete_);
                                }
