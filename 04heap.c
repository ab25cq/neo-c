...
;    struct sFun* fun  =0;
    ...
    if(type->mPointerNum>0||type->mArrayPointerNum) {
        ...
        if(finalizer!=((void*)0)) {
            ...
            if(klass_43->mProtocol&&type_->mPointerNum==1) {
                type_name_46=(char*)come_increment_ref_count(make_type_name_string(type_,info,(_Bool)0,(_Bool)0,(_Bool)0));
    ...
    if(type_->mPointerNum>0||type_->mClass->mProtocol||list$1sType$ph_length(type_->mGenericsTypes)>0) {
        ...
        if(finalizer!=((void*)0)) {
            ...
            if(klass->mStruct&&type_->mPointerNum==0) {
                for(o2_saved=(struct list$1tuple2$2char$phsType$ph$ph*)come_increment_ref_count(klass->mFields),it=list$1tuple2$2char$phsType$ph$ph_begin(o2_saved);!list$1tuple2$2char$phsType$ph$ph_end(o2_saved);it=list$1tuple2$2char$phsType$ph$ph_next(o2_saved)){
                    ...
                    if(field_type->mHeap&&field_type->mPointerNum>0) {
                        obj_52=(char*)come_increment_ref_count(xsprintf("(((%s)%s).%s)",((char*)(__right_value0=make_type_name_string(type_,info,(_Bool)0,(_Bool)0,(_Bool)0))),c_value,name_51));
                        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
                        free_object(field_type,obj_52,no_decrement,no_free,info,(_Bool)0);
                ...
                for(o2_saved_53=(struct list$1tuple2$2char$phsType$ph$ph*)come_increment_ref_count(klass->mFields),it_54=list$1tuple2$2char$phsType$ph$ph_begin(o2_saved_53);!list$1tuple2$2char$phsType$ph$ph_end(o2_saved_53);it_54=list$1tuple2$2char$phsType$ph$ph_next(o2_saved_53)){
                    ...
                    if(field_type_56->mHeap&&field_type_56->mPointerNum>0) {
                        obj_57=(char*)come_increment_ref_count(xsprintf("(((%s)%s)->%s)",((char*)(__right_value0=make_type_name_string(type_,info,(_Bool)0,(_Bool)0,(_Bool)0))),c_value,name_55));
                        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
                        free_object(field_type_56,obj_57,no_decrement,no_free,info,(_Bool)0);
            ...
            if(!type_->mAllocaValue) {
                if(klass->mProtocol&&type_->mPointerNum==1) {
                    if(c_value) {
                        type_name_58=(char*)come_increment_ref_count(make_type_name_string(type_,info,(_Bool)0,(_Bool)0,(_Bool)0));
...
;    struct sFun* fun  =0;
    ...
    if(list$1sType$ph_length(type_->mGenericsTypes)>0) {
        ...
        if(generics_fun) {
            ...
            if(!err) {
                __result_obj__0 = (struct tuple2$2sType$phchar$ph*)come_increment_ref_count(((struct tuple2$2sType$phchar$ph*)(__right_value5=tuple2$2sType$phchar$ph_initialize((struct tuple2$2sType$phchar$ph*)come_increment_ref_count((struct tuple2$2sType$phchar$ph*)come_calloc(1, sizeof(struct tuple2$2sType$phchar$ph)*(1), "04heap.nc", 774, "struct tuple2$2sType$phchar$ph")),(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 774, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),(_Bool)0,info,(_Bool)0)),(char*)come_increment_ref_count(__builtin_string(""))))));
                (name = come_decrement_ref_count(name, (void*)0, (void*)0, 0, 0, (void*)0));
                (none_generics_name = come_decrement_ref_count(none_generics_name, (void*)0, (void*)0, 0, 0, (void*)0));
    ...
    __result_obj__0 = (struct tuple2$2sType$phchar$ph*)come_increment_ref_count(((struct tuple2$2sType$phchar$ph*)(__right_value1=tuple2$2sType$phchar$ph_initialize((struct tuple2$2sType$phchar$ph*)come_increment_ref_count((struct tuple2$2sType$phchar$ph*)come_calloc(1, sizeof(struct tuple2$2sType$phchar$ph)*(1), "04heap.nc", 829, "struct tuple2$2sType$phchar$ph")),(struct sType*)come_increment_ref_count(result_type),(char*)come_increment_ref_count(result)))));
    come_call_finalizer(sType_finalize, type2, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    come_call_finalizer(sType_finalize, type_, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 0, (void*)0));
    come_call_finalizer(sType_finalize, result_type, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    ...
    for(o2_saved_61=right_value_objects,it_62=list$1sRightValueObject$ph_begin(o2_saved_61);!list$1sRightValueObject$ph_end(o2_saved_61);it_62=list$1sRightValueObject$ph_next(o2_saved_61)){
        if(it_62&&!it_62->mFreed) {
            if(string_operator_equals(it_62->mFunName,info->come_fun->mName)&&it_62->mBlockLevel==info->block_level&&!it_62->mStored&&!it_62->mNoFree) {
                ...
                free_object(type,it_62->mVarName,!it_62->mDecrementRefCount,(_Bool)0,info,(_Bool)0);
                it_62->mFreed=(_Bool)1;
...
void free_objects(struct sVarTable* table  , struct sVar* ret_value  , struct sInfo* info  )
{
    ...
    for(o2_saved=(struct map$2char$phsVar$ph*)come_increment_ref_count(table->mVars),it=map$2char$phsVar$ph_begin(o2_saved);!map$2char$phsVar$ph_end(o2_saved);it=map$2char$phsVar$ph_next(o2_saved)){
        ...
        if(type->mChannel) {
                ...
                if(list$1sNode$ph_length(type->mArrayNum)==1) {
                    ...
                    for(i_74=0;i_74<n_72;i_74++){
                        for(j=0;j<m;j++){
                            ...
                            free_object(element_type_76,c_value_75,(_Bool)0,(_Bool)0,info,(_Bool)0);
            ...
            type2=(struct sType*)come_increment_ref_count(sType_clone(type));
            type2->mPointerNum++;
            free_object(type2,c_value_90,(_Bool)0,(_Bool)0,info,(_Bool)0);
