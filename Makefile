...
05pre_op.c.o: 05pre_op.c
	neo-c -Sc -C  -o 05pre_op.c.o -c 05pre_op.c $(CFLAGS) 

05call.c.o: 05call.c
	neo-c -Sc -C -o 05call.c.o -c 05call.c $(CFLAGS) 

05function.c.o: 05function.c
	neo-c -Sc -C -o 05function.c.o -c 05function.c $(CFLAGS) 

05number.c.o: 05number.c
	neo-c -Sc -C -o 05number.c.o -c 05number.c $(CFLAGS) 

05type.c.o: 05type.c
	neo-c -Sc -C -o 05type.c.o -c 05type.c $(CFLAGS) 

05parse.c.o: 05parse.c
	neo-c -Sc -C -o 05parse.c.o -c 05parse.c $(CFLAGS) 

06str.c.o: 06str.c
	neo-c -Sc -C -o 06str.c.o -c 06str.c $(CFLAGS) 

07var.c.o: 07var.c
	neo-c -Sc -C -o 07var.c.o -c 07var.c $(CFLAGS) 

07gvar.c.o: 07gvar.c
	neo-c -Sc -C -o 07gvar.c.o -c 07gvar.c $(CFLAGS) 

08if.c.o: 08if.c
	neo-c -Sc -C -o 08if.c.o -c 08if.c $(CFLAGS) 

09while.c.o: 09while.c
	neo-c -Sc -C -o 09while.c.o -c 09while.c $(CFLAGS) 

10do_while.c.o: 10do_while.c
	neo-c -Sc -C -o 10do_while.c.o -c 10do_while.c $(CFLAGS) 

11for.c.o: 11for.c
	neo-c -Sc -C -o 11for.c.o -c 11for.c $(CFLAGS) 

12switch.c.o: 12switch.c
	neo-c -Sc -C -o 12switch.c.o -c 12switch.c $(CFLAGS) 

13op.c.o: 13op.c
	neo-c -Sc -C -o 13op.c.o -c 13op.c $(CFLAGS) 

14struct.c.o: 14struct.c
	neo-c -Sc -C -o 14struct.c.o -c 14struct.c $(CFLAGS) 

15union.c.o: 15union.c
	neo-c -Sc -C -o 15union.c.o -c 15union.c $(CFLAGS) 

16enum.c.o: 16enum.c
	neo-c -Sc -C -o 16enum.c.o -c 16enum.c $(CFLAGS) 

17typedef.c.o: 17typedef.c
	neo-c -Sc -C -o 17typedef.c.o -c 17typedef.c $(CFLAGS) 

18field.c.o: 18field.c
	neo-c -Sc -C -o 18field.c.o -c 18field.c $(CFLAGS) 

19eq.c.o: 19eq.c
	neo-c -Sc -C -o 19eq.c.o -c 19eq.c $(CFLAGS) 

20method.c.o: 20method.c
	neo-c -Sc -C -o 20method.c.o -c 20method.c $(CFLAGS) 

21obj.c.o: 21obj.c
	neo-c -Sc -C -o 21obj.c.o -c 21obj.c $(CFLAGS) 

22impl.c.o: 22impl.c
	neo-c -Sc -C -o 22impl.c.o -c 22impl.c $(CFLAGS) 

23interface.c.o: 23interface.c
	neo-c -Sc -C -o 23interface.c.o -c 23interface.c $(CFLAGS) 

24module.c.o: 24module.c
	neo-c -Sc -C -o 24module.c.o -c 24module.c $(CFLAGS) 
...
05pre_op.valgrind: 05pre_op.c
	valgrind neo-c -Sc -C  -o 05pre_op.c.o -c 05pre_op.c $(CFLAGS) 2> 05pre_op.valgrind

05call.valgrind: 05call.c
	valgrind neo-c -Sc -C -o 05call.c.o -c 05call.c $(CFLAGS) 2> 05call.valgrind

05function.valgrind: 05function.c
	valgrind neo-c -Sc -C -o 05function.c.o -c 05function.c $(CFLAGS) 2> 05function.valgrind

05number.valgrind: 05number.c
	valgrind neo-c -Sc -C -o 05number.c.o -c 05number.c $(CFLAGS) 2> 05number.valgrind

05type.valgrind: 05type.c
	valgrind neo-c -Sc -C -o 05type.c.o -c 05type.c $(CFLAGS) 2> 05type.valgrind

05parse.valgrind: 05parse.c
	valgrind neo-c -Sc -C -o 05parse.c.o -c 05parse.c $(CFLAGS) 2> 05parse.valgrind

06str.valgrind: 06str.c
	valgrind neo-c -Sc -C -o 06str.c.o -c 06str.c $(CFLAGS) 2> 06str.valgrind

07var.valgrind: 07var.c
	valgrind neo-c -Sc -C -o 07var.c.o -c 07var.c $(CFLAGS) 2> 07var.valgrind

07gvar.valgrind: 07gvar.c
	valgrind neo-c -Sc -C -o 07gvar.c.o -c 07gvar.c $(CFLAGS) 2> 07gvar.valgrind

08if.valgrind: 08if.c
	valgrind neo-c -Sc -C -o 08if.c.o -c 08if.c $(CFLAGS) 2> 08if.valgrind

09while.valgrind: 09while.c
	valgrind neo-c -Sc -C -o 09while.c.o -c 09while.c $(CFLAGS) 2> 09while.valgrind

10do_while.valgrind: 10do_while.c
	valgrind neo-c -Sc -C -o 10do_while.c.o -c 10do_while.c $(CFLAGS) 2> 10do_while.valgrind

11for.valgrind: 11for.c
	valgrind neo-c -Sc -C -o 11for.c.o -c 11for.c $(CFLAGS) 2> 11for.valgrind

12switch.valgrind: 12switch.c
	valgrind neo-c -Sc -C -o 12switch.c.o -c 12switch.c $(CFLAGS) 2> 12switch.valgrind

13op.valgrind: 13op.c
	valgrind neo-c -Sc -C -o 13op.c.o -c 13op.c $(CFLAGS) 2> 13op.valgrind

14struct.valgrind: 14struct.c
	valgrind neo-c -Sc -C -o 14struct.c.o -c 14struct.c $(CFLAGS) 2> 14struct.valgrind

15union.valgrind: 15union.c
	valgrind neo-c -Sc -C -o 15union.c.o -c 15union.c $(CFLAGS) 2> 15union.valgrind
...
19eq.valgrind: 19eq.c
	valgrind neo-c -Sc -C -o 19eq.c.o -c 19eq.c $(CFLAGS) 2> 19eq.valgrind

20method.valgrind: 20method.c
	valgrind neo-c -Sc -C -o 20method.c.o -c 20method.c $(CFLAGS) 2> 20method.valgrind

21obj.valgrind: 21obj.c
	valgrind neo-c -Sc -C -o 21obj.c.o -c 21obj.c $(CFLAGS) 2> 21obj.valgrind

22impl.valgrind: 22impl.c
	valgrind neo-c -Sc -C -o 22impl.c.o -c 22impl.c $(CFLAGS) 2> 22impl.valgrind

23interface.valgrind: 23interface.c
	valgrind neo-c -Sc -C -o 23interface.c.o -c 23interface.c $(CFLAGS) 2> 23interface.valgrind
