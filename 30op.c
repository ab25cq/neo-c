...
;    struct sType*  type1  =0;
    ...
    if(type_name_exp&&(*info->p==95||xisalpha(*info->p))) {
        ...
        if(is_type_name(word,info)&&!fun_call) {
            ...
            __right_value0 = (void*)0;
            _inf_value47=(struct sNode*)come_calloc(1, sizeof(struct sNode), "30op.nc", 2217, "struct sNode");
            _inf_obj_value47=(struct sTypeNode*)come_increment_ref_count(((struct sTypeNode*)(__right_value1=sTypeNode_initialize((struct sTypeNode* )come_increment_ref_count((struct sTypeNode *)come_calloc(1, sizeof(struct sTypeNode )*(1), "30op.nc", 2217, "struct sTypeNode* ")),type2,info))));
...
struct sNode* string_node_v13(char* buf, char* head, int head_sline, struct sInfo*  info  )
{
    ...
    if(!gComeC&&charp_operator_equals(buf,"null")) {
                _inf_value48=(struct sNode*)come_calloc(1, sizeof(struct sNode), "30op.nc", 2233, "struct sNode");
        _inf_obj_value48=(struct sNullNode*)come_increment_ref_count(((struct sNullNode*)(__right_value1=sNullNode_initialize((struct sNullNode* )come_increment_ref_count((struct sNullNode *)come_calloc(1, sizeof(struct sNullNode )*(1), "30op.nc", 2233, "struct sNullNode* ")),info))));
...
struct sNode* create_less(struct sNode* node, struct sNode* right, struct sInfo*  info  )
{
    ...
    void* __right_value2 = (void*)0;
    struct sNode* __result_obj__0;
        _inf_value49=(struct sNode*)come_calloc(1, sizeof(struct sNode), "30op.nc", 2241, "struct sNode");
    _inf_obj_value49=(struct sLtNode*)come_increment_ref_count(((struct sLtNode*)(__right_value1=sLtNode_initialize((struct sLtNode* )come_increment_ref_count((struct sLtNode *)come_calloc(1, sizeof(struct sLtNode )*(1), "30op.nc", 2241, "struct sLtNode* ")),(struct sNode*)come_increment_ref_count(node),(struct sNode*)come_increment_ref_count(right),(_Bool)0,info))));
