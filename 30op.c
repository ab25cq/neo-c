...
_Bool sNullNode_compile(struct sNullNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 76, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void*")),0,info,0));
...
static struct list$1CVALUE$ph* list$1CVALUE$ph_push_back(struct list$1CVALUE$ph* self, struct CVALUE* item  )
{
    ...
    if(self->len==0) {
        ...
        litem_3=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc(1, sizeof(struct list_item$1CVALUE$ph)*(1), "/usr/local/include/neo-c.h", 1046, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_4=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc(1, sizeof(struct list_item$1CVALUE$ph)*(1), "/usr/local/include/neo-c.h", 1056, "struct list_item$1CVALUE$ph*"))));
...
static struct list$1sType$ph* list$1sType$ph_add(struct list$1sType$ph* self, struct sType* item  )
{
    ...
    if(self->len==0) {
        ...
        litem_6=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/neo-c.h", 961, "struct list_item$1sType$ph*"))));
        ...
        litem_7=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/neo-c.h", 971, "struct list_item$1sType$ph*"))));
...
static struct list$1sNode$ph* list$1sNode$ph_add(struct list$1sNode$ph* self, struct sNode* item)
{
    ...
    if(self->len==0) {
        ...
        litem_8=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "/usr/local/include/neo-c.h", 961, "struct list_item$1sNode$ph*"))));
        ...
        litem_9=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "/usr/local/include/neo-c.h", 971, "struct list_item$1sNode$ph*"))));
...
static struct list$1int$* list$1int$_add(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        ...
        litem_10=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 961, "struct list_item$1int$*"))));
        ...
        litem_11=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 971, "struct list_item$1int$*"))));
...
static struct list$1char$ph* list$1char$ph_add(struct list$1char$ph* self, char* item  )
{
    ...
    if(self->len==0) {
        ...
        litem_12=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 961, "struct list_item$1char$ph*"))));
        ...
        litem_13=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 971, "struct list_item$1char$ph*"))));
...
_Bool sSubNode_compile(struct sSubNode* self, struct sInfo* info  )
{
    ...
    if(!calling_fun) {
        ...
        if(left_value->type->mPointerNum>0&&right_value->type->mPointerNum>0) {
            ...
            result_type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 209, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sGtEqNode_compile(struct sGtEqNode* self, struct sInfo* info  )
{
    ...
    if(!calling_fun) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 594, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sLtEqNode_compile(struct sLtEqNode* self, struct sInfo* info  )
{
    ...
    if(!calling_fun) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 656, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sLtNode_compile(struct sLtNode* self, struct sInfo* info  )
{
    ...
    if(!calling_fun) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 718, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sGtNode_compile(struct sGtNode* self, struct sInfo* info  )
{
    ...
    if(!calling_fun) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 780, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sEqNode_compile(struct sEqNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 830, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sNotEqNode_compile(struct sNotEqNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 879, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sEq2Node_compile(struct sEq2Node* self, struct sInfo* info  )
{
    ...
    if(!calling_fun) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 941, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sNotEq2Node_compile(struct sNotEq2Node* self, struct sInfo* info  )
{
    ...
    if(!calling_fun) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 1003, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sAndAndNode_compile(struct sAndAndNode* self, struct sInfo* info  )
{
    ...
    if(!calling_fun) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 1257, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sOrOrNode_compile(struct sOrOrNode* self, struct sInfo* info  )
{
    ...
    if(!calling_fun) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 1319, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
struct sNode* conditional_exp(struct sInfo* info  )
{
    ...
    while(*info->p) {
        if(*info->p==63) {
            ...
            (come_push_stackframe("30op.nc", 2143, 0),__exception_result_var_b1=expected_next_character(58,info), come_pop_stackframe(), __exception_result_var_b1);
...
_Bool sTypeNode_compile(struct sTypeNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "30op.nc", 2181, "struct sType*")),(char*)come_increment_ref_count(xsprintf("__typename")),0,info,0));
...
;    struct sType* type1  =0;
    ...
    if(type_name_exp&&(*info->p==95||xisalpha(*info->p))) {
        ...
        if(is_type_name(word,info)&&!fun_call) {
            multiple_assign_var2=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,0,0)));
