...
;    struct sType* type1  =0;
    ...
    if(type_name_exp&&(*info->p==95||xisalpha(*info->p))) {
        ...
        if(is_type_name(word,info)&&!fun_call) {
            multiple_assign_var2=(come_push_stackframe("30op.nc", 2208, 2),__exception_result_var_b3=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,0,0))), come_pop_stackframe(), __exception_result_var_b3);
