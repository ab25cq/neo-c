...
static struct span$1int$ph* span$1int$ph_initialize(struct span$1int$ph* self, struct ref$1void$ph* refference, void* head, unsigned long  len  );
static void span$1int$ph$p_finalize(struct span$1int$ph* self);
static void ref$1void$ph$p_finalize(struct ref$1void$ph* self);
static struct ref$1int$ph* ref$1int$ph_initialize(struct ref$1int$ph* self, int* p, _Bool global_, _Bool heap_, _Bool local_, void* stacktop);
static void ref$1int$ph$p_finalize(struct ref$1int$ph* self);
...
int main(int argc, char** argv)
{
    ...
    int __result_obj__0;
    p=(int*)come_increment_ref_count((int*)come_calloc(1, sizeof(int)*(1*(4)), (void*)0, 5, "int*"));
    p[0]=10;
    p[1]=20;
    p[2]=30;
    p[3]=40;
    s=(struct span$1int$ph*)come_increment_ref_count(span$1int$ph_initialize((struct span$1int$ph*)come_increment_ref_count((struct span$1int$ph*)come_calloc(1, sizeof(struct span$1int$ph)*(1), (void*)0, 11, "struct span$1int$ph*")),(struct ref$1int$ph*)come_increment_ref_count(ref$1int$ph_initialize((struct ref$1int$ph*)come_increment_ref_count((struct ref$1int$ph*)come_calloc(1, sizeof(struct ref$1int$ph)*(1), (void*)0, 11, "struct ref$1int$ph*")),(int*)come_increment_ref_count(p),(_Bool)0,(_Bool)1,(_Bool)0,neo_current_frame->stacktop)),__tmp_heap1=(int*)come_increment_ref_count(p),dynamic_sizeof(__tmp_heap1)));
    ++s;
    ...
    (__tmp_heap1 = come_decrement_ref_count(__tmp_heap1, (void*)0, (void*)0, 0, 0, (void*)0));
...
static struct span$1int$ph* span$1int$ph_initialize(struct span$1int$ph* self, struct ref$1void$ph* refference, void* head, unsigned long  len  )
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "span$1int$ph_initialize"; neo_current_frame = &fr;
    struct span$1int$ph* __result_obj__0;
    if(!1) {
        puts("invalid span");
        stackframe();
        exit(2);
    ...
    self->stacktop=refference->stacktop;
        __result_obj__0 = (struct span$1int$ph*)come_increment_ref_count(self);
    come_call_finalizer(span$1int$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(ref$1void$ph$p_finalize, refference, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    neo_current_frame = fr.prev;
    come_call_finalizer(span$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__0;
}

static void span$1int$ph$p_finalize(struct span$1int$ph* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "span$1int$ph$p_finalize"; neo_current_frame = &fr;
        neo_current_frame = fr.prev;
}
...
static struct ref$1int$ph* ref$1int$ph_initialize(struct ref$1int$ph* self, int* p, _Bool global_, _Bool heap_, _Bool local_, void* stacktop)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "ref$1int$ph_initialize"; neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    int* __dec_obj1;
    struct ref$1int$ph* __result_obj__0;
    if(!1||p==((void*)0)) {
    ...
    __dec_obj1=self->p,
    self->p=(int*)come_increment_ref_count(p);
    __dec_obj1 = come_decrement_ref_count(__dec_obj1, (void*)0, (void*)0, 0,0, (void*)0);
    self->global=global_;
    self->heap=heap_;
    self->local=local_;
    self->stacktop=stacktop;
        __result_obj__0 = (struct ref$1int$ph*)come_increment_ref_count(self);
    come_call_finalizer(ref$1int$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    (p = come_decrement_ref_count(p, (void*)0, (void*)0, 0, 0, (void*)0));
    neo_current_frame = fr.prev;
    come_call_finalizer(ref$1int$ph$p_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__0;
}

static void ref$1int$ph$p_finalize(struct ref$1int$ph* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "ref$1int$ph$p_finalize"; neo_current_frame = &fr;
    if(self!=((void*)0)&&self->p!=((void*)0)) {
        (self->p = come_decrement_ref_count(self->p, (void*)0, (void*)0, 0, 0, (void*)0));
    }
        neo_current_frame = fr.prev;
