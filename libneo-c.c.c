...
int i_50;
    ...
    for(    i_50=0;    i_50<gHeapPages.mSizePages;    i_50++    ){
        gHeapPages.mPages[i_50]=calloc(1,sizeof(char)*2048*2);
    }
...
void* __result48__;
    ...
    if(size<2048*2) {
        ...
        if(result_58==((void*)0)) {
            free_area_59=gHeapPages.mPages[gHeapPages.mCurrentPages]+2048*2-gHeapPages.mTop;
            if(size>=free_area_59) {
                ...
                if(gHeapPages.mCurrentPages==gHeapPages.mSizePages) {
                    ...
                    for(                    ;                    i_62<new_size_pages_60;                    i_62++                    ){
                        new_pages_61[i_62]=calloc(1,sizeof(char)*2048*2);
                    }
                    free(gHeapPages.mPages);
