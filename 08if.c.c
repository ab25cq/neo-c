...
struct sNode* string_node_v8(char* buf, char* head, int head_sline, struct sInfo* info)
{
    ...
    if(charp_operator_equals(buf,"if")) {
        sname=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "08if.c", 298, "char*"));
        sline=info->sline;
        sline_real=info->sline_real;
        info->sline_real=info->sline;
        (come_push_stackframe("08if.c", 304, 0),__exception_result_var_b1=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b1);
        expression_node=(struct sNode*)come_increment_ref_count(expression_v13(info,0));
        (come_push_stackframe("08if.c", 309, 1),__exception_result_var_b2=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b2);
        skip_spaces_and_lf(info);
        if_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
        elif_expression_nodes=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc(1, sizeof(struct list$1sNode$ph)*(1), "08if.c", 321, "struct list$1sNode$ph*"))));
        elif_blocks=(struct list$1sBlock$ph*)come_increment_ref_count(list$1sBlock$ph_initialize((struct list$1sBlock$ph*)come_increment_ref_count((struct list$1sBlock$ph*)come_calloc(1, sizeof(struct list$1sBlock$ph)*(1), "08if.c", 323, "struct list$1sBlock$ph*"))));
        elif_num=0;
        else_block=((void*)0);
        while(1) {
            saved_p=info->p;
            ...
            if(string_operator_equals(buf_33,"else")) {
                ...
                if(parsecmp("if",info)) {
                    ...
                    info->p+=strlen("if");
                    skip_spaces_and_lf(info);
                    (come_push_stackframe("08if.c", 355, 2),__exception_result_var_b3=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b3);
                    ...
                    (come_push_stackframe("08if.c", 362, 3),__exception_result_var_b4=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b4);
                    skip_spaces_and_lf(info);
        ...
        _inf_obj_value1=(struct sIfNode*)come_increment_ref_count(((struct sIfNode*)(__right_value1=sIfNode_initialize((struct sIfNode*)come_increment_ref_count((struct sIfNode*)come_calloc(1, sizeof(struct sIfNode)*(1), "08if.c", 397, "struct sIfNode*")),(struct sNode*)come_increment_ref_count(expression_node),if_block,elif_expression_nodes,elif_blocks,elif_num,else_block,0,info))));
...
struct sNode* parse_or_statment(struct sNode* expression_node, struct sInfo* info)
{
    ...
    skip_spaces_and_lf(info);
    if_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
    _inf_value2=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 415, "struct sNode");
    _inf_obj_value2=(struct sOrStatmentNode*)come_increment_ref_count(((struct sOrStatmentNode*)(__right_value1=sOrStatmentNode_initialize((struct sOrStatmentNode*)come_increment_ref_count((struct sOrStatmentNode*)come_calloc(1, sizeof(struct sOrStatmentNode)*(1), "08if.c", 415, "struct sOrStatmentNode*")),(struct sNode*)come_increment_ref_count(expression_node),if_block,info))));
...
struct sNode* parse_and_statment(struct sNode* expression_node, struct sInfo* info)
{
    ...
    skip_spaces_and_lf(info);
    if_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
    _inf_value3=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 427, "struct sNode");
    _inf_obj_value3=(struct sAndStatmentNode*)come_increment_ref_count(((struct sAndStatmentNode*)(__right_value1=sAndStatmentNode_initialize((struct sAndStatmentNode*)come_increment_ref_count((struct sAndStatmentNode*)come_calloc(1, sizeof(struct sAndStatmentNode)*(1), "08if.c", 427, "struct sAndStatmentNode*")),(struct sNode*)come_increment_ref_count(expression_node),if_block,info))));
...
struct sNode* parse_match(struct sNode* expression_node, struct sInfo* info)
{
    ...
    skip_spaces_and_lf(info);
    if_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
    elif_expression_nodes=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc(1, sizeof(struct list$1sNode$ph)*(1), "08if.c", 454, "struct list$1sNode$ph*"))));
    elif_blocks=(struct list$1sBlock$ph*)come_increment_ref_count(list$1sBlock$ph_initialize((struct list$1sBlock$ph*)come_increment_ref_count((struct list$1sBlock$ph*)come_calloc(1, sizeof(struct list$1sBlock$ph)*(1), "08if.c", 455, "struct list$1sBlock$ph*"))));
    elif_num=0;
    else_block=((void*)0);
    while(1) {
        skip_spaces_and_lf(info);
        if(strncmp(info->p,"else",strlen("else"))==0) {
            ...
            (come_push_stackframe("08if.c", 474, 7),__exception_result_var_b8=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b8);
            ...
            (come_push_stackframe("08if.c", 480, 8),__exception_result_var_b9=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b9);
            skip_spaces_and_lf(info);
            elif_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
    ...
    if(else_block==((void*)0)) {
        ...
        else_block=(struct sBlock*)come_increment_ref_count(sBlock_initialize((struct sBlock*)come_increment_ref_count((struct sBlock*)come_calloc(1, sizeof(struct sBlock)*(1), "08if.c", 505, "struct sBlock*"))));
    ...
    _inf_value4=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 511, "struct sNode");
    _inf_obj_value4=(struct sIfNode*)come_increment_ref_count(((struct sIfNode*)(__right_value2=sIfNode_initialize((struct sIfNode*)come_increment_ref_count((struct sIfNode*)come_calloc(1, sizeof(struct sIfNode)*(1), "08if.c", 511, "struct sIfNode*")),(struct sNode*)come_increment_ref_count(conditional_value),if_block,elif_expression_nodes,elif_blocks,elif_num,else_block,0,info))));
    ...
    _inf_value5=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 511, "struct sNode");
    _inf_obj_value5=(struct sMatchNode*)come_increment_ref_count(((struct sMatchNode*)(__right_value4=sMatchNode_initialize((struct sMatchNode*)come_increment_ref_count((struct sMatchNode*)come_calloc(1, sizeof(struct sMatchNode)*(1), "08if.c", 511, "struct sMatchNode*")),(struct sNode*)come_increment_ref_count(it_node),(struct sNode*)come_increment_ref_count(_inf_value4),info))));
...
struct sNode* parse_if_method_call(struct sNode* expression_node, struct sInfo* info)
{
    ...
    skip_spaces_and_lf(info);
    if_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
    elif_expression_nodes=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc(1, sizeof(struct list$1sNode$ph)*(1), "08if.c", 533, "struct list$1sNode$ph*"))));
    elif_blocks=(struct list$1sBlock$ph*)come_increment_ref_count(list$1sBlock$ph_initialize((struct list$1sBlock$ph*)come_increment_ref_count((struct list$1sBlock$ph*)come_calloc(1, sizeof(struct list$1sBlock$ph)*(1), "08if.c", 535, "struct list$1sBlock$ph*"))));
    elif_num=0;
    else_block=((void*)0);
    while(1) {
        saved_p=info->p;
        ...
        if(string_operator_equals(buf,"else")) {
            if(parsecmp("if",info)) {
                ...
                info->p+=strlen("if");
                skip_spaces_and_lf(info);
                (come_push_stackframe("08if.c", 565, 9),__exception_result_var_b10=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b10);
                ...
                (come_push_stackframe("08if.c", 572, 10),__exception_result_var_b11=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b11);
                skip_spaces_and_lf(info);
                elif_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
                list$1sBlock$ph_push_back(elif_blocks,(struct sBlock*)come_increment_ref_count(elif_block));
                elif_num++;
    ...
    if(else_block==((void*)0)) {
        ...
        else_block=(struct sBlock*)come_increment_ref_count(sBlock_initialize((struct sBlock*)come_increment_ref_count((struct sBlock*)come_calloc(1, sizeof(struct sBlock)*(1), "08if.c", 607, "struct sBlock*"))));
        come_call_finalizer(sBlock_finalize, __dec_obj86,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        else_block->mOmitSemicolon=1;
        list$1sNode$ph_push_back(else_block->mNodes,(struct sNode*)come_increment_ref_count(create_load_var("Value",info)));
    }
    _inf_value6=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 613, "struct sNode");
    _inf_obj_value6=(struct sIfNode*)come_increment_ref_count(((struct sIfNode*)(__right_value1=sIfNode_initialize((struct sIfNode*)come_increment_ref_count((struct sIfNode*)come_calloc(1, sizeof(struct sIfNode)*(1), "08if.c", 613, "struct sIfNode*")),(struct sNode*)come_increment_ref_count(conditional_node),if_block,elif_expression_nodes,elif_blocks,elif_num,else_block,0,info))));
    ...
    come_call_finalizer(sIfNode_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    _inf_value7=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 614, "struct sNode");
    _inf_obj_value7=(struct sIfMethodNode*)come_increment_ref_count(((struct sIfMethodNode*)(__right_value1=sIfMethodNode_initialize((struct sIfMethodNode*)come_increment_ref_count((struct sIfMethodNode*)come_calloc(1, sizeof(struct sIfMethodNode)*(1), "08if.c", 614, "struct sIfMethodNode*")),(struct sNode*)come_increment_ref_count(it_node),(struct sNode*)come_increment_ref_count(if_node),info))));
...
struct sNode* parse_elif_method_call(struct sNode* expression_node, struct sInfo* info)
{
    ...
    skip_spaces_and_lf(info);
    if_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
    elif_expression_nodes=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc(1, sizeof(struct list$1sNode$ph)*(1), "08if.c", 639, "struct list$1sNode$ph*"))));
    elif_blocks=(struct list$1sBlock$ph*)come_increment_ref_count(list$1sBlock$ph_initialize((struct list$1sBlock$ph*)come_increment_ref_count((struct list$1sBlock$ph*)come_calloc(1, sizeof(struct list$1sBlock$ph)*(1), "08if.c", 641, "struct list$1sBlock$ph*"))));
    elif_num=0;
    else_block=((void*)0);
    while(1) {
        saved_p=info->p;
        ...
        if(string_operator_equals(buf,"else")) {
            if(parsecmp("if",info)) {
                ...
                info->p+=strlen("if");
                skip_spaces_and_lf(info);
                (come_push_stackframe("08if.c", 671, 11),__exception_result_var_b12=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b12);
                ...
                (come_push_stackframe("08if.c", 678, 12),__exception_result_var_b13=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b13);
                skip_spaces_and_lf(info);
                elif_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
                list$1sBlock$ph_push_back(elif_blocks,(struct sBlock*)come_increment_ref_count(elif_block));
                elif_num++;
    ...
    if(else_block==((void*)0)) {
        ...
        else_block=(struct sBlock*)come_increment_ref_count(sBlock_initialize((struct sBlock*)come_increment_ref_count((struct sBlock*)come_calloc(1, sizeof(struct sBlock)*(1), "08if.c", 713, "struct sBlock*"))));
        come_call_finalizer(sBlock_finalize, __dec_obj91,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        else_block->mOmitSemicolon=1;
        list$1sNode$ph_push_back(else_block->mNodes,(struct sNode*)come_increment_ref_count(create_load_var("Value",info)));
    }
    _inf_value8=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 719, "struct sNode");
    _inf_obj_value8=(struct sIfNode*)come_increment_ref_count(((struct sIfNode*)(__right_value1=sIfNode_initialize((struct sIfNode*)come_increment_ref_count((struct sIfNode*)come_calloc(1, sizeof(struct sIfNode)*(1), "08if.c", 719, "struct sIfNode*")),(struct sNode*)come_increment_ref_count(conditional_node2),if_block,elif_expression_nodes,elif_blocks,elif_num,else_block,0,info))));
    ...
    come_call_finalizer(sIfNode_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    _inf_value9=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 720, "struct sNode");
    _inf_obj_value9=(struct sIfMethodNode*)come_increment_ref_count(((struct sIfMethodNode*)(__right_value1=sIfMethodNode_initialize((struct sIfMethodNode*)come_increment_ref_count((struct sIfMethodNode*)come_calloc(1, sizeof(struct sIfMethodNode)*(1), "08if.c", 720, "struct sIfMethodNode*")),(struct sNode*)come_increment_ref_count(it_node),(struct sNode*)come_increment_ref_count(if_node),info))));
...
struct sNode* parse_less_method_call(struct sNode* expression_node, struct sInfo* info)
{
    ...
    skip_spaces_and_lf(info);
    if_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
    elif_expression_nodes=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc(1, sizeof(struct list$1sNode$ph)*(1), "08if.c", 745, "struct list$1sNode$ph*"))));
    elif_blocks=(struct list$1sBlock$ph*)come_increment_ref_count(list$1sBlock$ph_initialize((struct list$1sBlock$ph*)come_increment_ref_count((struct list$1sBlock$ph*)come_calloc(1, sizeof(struct list$1sBlock$ph)*(1), "08if.c", 747, "struct list$1sBlock$ph*"))));
    elif_num=0;
    else_block=((void*)0);
    while(1) {
        saved_p=info->p;
        ...
        if(string_operator_equals(buf,"else")) {
            if(parsecmp("if",info)) {
                ...
                info->p+=strlen("if");
                skip_spaces_and_lf(info);
                (come_push_stackframe("08if.c", 777, 13),__exception_result_var_b14=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b14);
                ...
                (come_push_stackframe("08if.c", 784, 14),__exception_result_var_b15=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b15);
                skip_spaces_and_lf(info);
                elif_block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
                list$1sBlock$ph_push_back(elif_blocks,(struct sBlock*)come_increment_ref_count(elif_block));
                elif_num++;
    ...
    if(else_block==((void*)0)) {
        ...
        else_block=(struct sBlock*)come_increment_ref_count(sBlock_initialize((struct sBlock*)come_increment_ref_count((struct sBlock*)come_calloc(1, sizeof(struct sBlock)*(1), "08if.c", 819, "struct sBlock*"))));
        come_call_finalizer(sBlock_finalize, __dec_obj93,(void*)0, (void*)0, 0, 0, 0, (void*)0);
        else_block->mOmitSemicolon=1;
        list$1sNode$ph_push_back(else_block->mNodes,(struct sNode*)come_increment_ref_count(create_load_var("Value",info)));
    }
    _inf_value10=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 825, "struct sNode");
    _inf_obj_value10=(struct sIfNode*)come_increment_ref_count(((struct sIfNode*)(__right_value1=sIfNode_initialize((struct sIfNode*)come_increment_ref_count((struct sIfNode*)come_calloc(1, sizeof(struct sIfNode)*(1), "08if.c", 825, "struct sIfNode*")),(struct sNode*)come_increment_ref_count(conditional_node2),if_block,elif_expression_nodes,elif_blocks,elif_num,else_block,0,info))));
    ...
    come_call_finalizer(sIfNode_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    _inf_value11=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 826, "struct sNode");
    _inf_obj_value11=(struct sIfMethodNode*)come_increment_ref_count(((struct sIfMethodNode*)(__right_value1=sIfMethodNode_initialize((struct sIfMethodNode*)come_increment_ref_count((struct sIfMethodNode*)come_calloc(1, sizeof(struct sIfMethodNode)*(1), "08if.c", 826, "struct sIfMethodNode*")),(struct sNode*)come_increment_ref_count(it_node),(struct sNode*)come_increment_ref_count(if_node),info))));
