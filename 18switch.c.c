...
struct sNode* string_node_v12(char* buf, char* head, int head_sline, struct sInfo* info  )
{
    ...
    if(charp_operator_equals(buf,"case")) {
        ...
        node2=((void*)0);
        if((come_push_stackframe("18switch.c", 281, 0),__exception_result_var_b1=parsecmp("...",info), come_pop_stackframe(), __exception_result_var_b1)) {
            info->p+=strlen("...");
        ...
        (come_push_stackframe("18switch.c", 290, 1),__exception_result_var_b2=expected_next_character(58,info), come_pop_stackframe(), __exception_result_var_b2);
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "18switch.c", 292, "struct sNode");
        _inf_obj_value1=(struct sCaseNode*)come_increment_ref_count(((struct sCaseNode*)(__right_value1=sCaseNode_initialize((struct sCaseNode*)come_increment_ref_count((struct sCaseNode*)come_calloc(1, sizeof(struct sCaseNode)*(1), "18switch.c", 292, "struct sCaseNode*")),(struct sNode*)come_increment_ref_count(node),(struct sNode*)come_increment_ref_count(node2),info))));
        ...
        (come_push_stackframe("18switch.c", 295, 2),__exception_result_var_b3=expected_next_character(58,info), come_pop_stackframe(), __exception_result_var_b3);
        _inf_value2=(struct sNode*)come_calloc(1, sizeof(struct sNode), "18switch.c", 297, "struct sNode");
        _inf_obj_value2=(struct sDefaultNode*)come_increment_ref_count(((struct sDefaultNode*)(__right_value1=sDefaultNode_initialize((struct sDefaultNode*)come_increment_ref_count((struct sDefaultNode*)come_calloc(1, sizeof(struct sDefaultNode)*(1), "18switch.c", 297, "struct sDefaultNode*")),info))));
        ...
        _inf_value3=(struct sNode*)come_calloc(1, sizeof(struct sNode), "18switch.c", 300, "struct sNode");
        _inf_obj_value3=(struct sBreakNode*)come_increment_ref_count(((struct sBreakNode*)(__right_value1=sBreakNode_initialize((struct sBreakNode*)come_increment_ref_count((struct sBreakNode*)come_calloc(1, sizeof(struct sBreakNode)*(1), "18switch.c", 300, "struct sBreakNode*")),info))));
        ...
        _inf_value4=(struct sNode*)come_calloc(1, sizeof(struct sNode), "18switch.c", 303, "struct sNode");
        _inf_obj_value4=(struct sContinueNode*)come_increment_ref_count(((struct sContinueNode*)(__right_value1=sContinueNode_initialize((struct sContinueNode*)come_increment_ref_count((struct sContinueNode*)come_calloc(1, sizeof(struct sContinueNode)*(1), "18switch.c", 303, "struct sContinueNode*")),info))));
        ...
        skip_spaces_and_lf(info);
        if(*info->p==59) {
            _inf_value5=(struct sNode*)come_calloc(1, sizeof(struct sNode), "18switch.c", 310, "struct sNode");
            _inf_obj_value5=(struct sLabelNode*)come_increment_ref_count(((struct sLabelNode*)(__right_value2=sLabelNode_initialize((struct sLabelNode*)come_increment_ref_count((struct sLabelNode*)come_calloc(1, sizeof(struct sLabelNode)*(1), "18switch.c", 310, "struct sLabelNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),info,1))));
            ...
            _inf_value6=(struct sNode*)come_calloc(1, sizeof(struct sNode), "18switch.c", 313, "struct sNode");
            _inf_obj_value6=(struct sLabelNode*)come_increment_ref_count(((struct sLabelNode*)(__right_value2=sLabelNode_initialize((struct sLabelNode*)come_increment_ref_count((struct sLabelNode*)come_calloc(1, sizeof(struct sLabelNode)*(1), "18switch.c", 313, "struct sLabelNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),info,0))));
        ...
        _inf_value7=(struct sNode*)come_calloc(1, sizeof(struct sNode), "18switch.c", 319, "struct sNode");
        _inf_obj_value7=(struct sGotoNode*)come_increment_ref_count(((struct sGotoNode*)(__right_value1=sGotoNode_initialize((struct sGotoNode*)come_increment_ref_count((struct sGotoNode*)come_calloc(1, sizeof(struct sGotoNode)*(1), "18switch.c", 319, "struct sGotoNode*")),(struct sNode*)come_increment_ref_count(exp),info))));
        ...
        (come_push_stackframe("18switch.c", 322, 3),__exception_result_var_b4=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b4);
        expression_node=(struct sNode*)come_increment_ref_count(expression_v13(info,0));
        (come_push_stackframe("18switch.c", 326, 4),__exception_result_var_b5=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b5);
        block=(struct sBlock*)come_increment_ref_count(parse_block(info,0,0));
        _inf_value8=(struct sNode*)come_calloc(1, sizeof(struct sNode), "18switch.c", 330, "struct sNode");
        _inf_obj_value8=(struct sSwitchNode*)come_increment_ref_count(((struct sSwitchNode*)(__right_value1=sSwitchNode_initialize((struct sSwitchNode*)come_increment_ref_count((struct sSwitchNode*)come_calloc(1, sizeof(struct sSwitchNode)*(1), "18switch.c", 330, "struct sSwitchNode*")),(struct sNode*)come_increment_ref_count(expression_node),block,info))));
