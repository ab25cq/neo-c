...
struct sNode* string_node_v12(char* buf, char* head, int head_sline, struct sInfo* info  )
{
    ...
    if(charp_operator_equals(buf,"case")) {
        ...
        _inf_value2=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "18switch.c", 297, "struct sNode");
        _inf_obj_value2=(struct sDefaultNode*)come_increment_ref_count(((struct sDefaultNode*)(__right_value1=sDefaultNode_initialize((struct sDefaultNode*)come_increment_ref_count((struct sDefaultNode*)come_calloc_v2(1, sizeof(struct sDefaultNode)*(1), "18switch.c", 297, "struct sDefaultNode*")),info))));
        ...
        _inf_value3=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "18switch.c", 300, "struct sNode");
        _inf_obj_value3=(struct sBreakNode*)come_increment_ref_count(((struct sBreakNode*)(__right_value1=sBreakNode_initialize((struct sBreakNode*)come_increment_ref_count((struct sBreakNode*)come_calloc_v2(1, sizeof(struct sBreakNode)*(1), "18switch.c", 300, "struct sBreakNode*")),info))));
        ...
        _inf_value4=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "18switch.c", 303, "struct sNode");
        _inf_obj_value4=(struct sContinueNode*)come_increment_ref_count(((struct sContinueNode*)(__right_value1=sContinueNode_initialize((struct sContinueNode*)come_increment_ref_count((struct sContinueNode*)come_calloc_v2(1, sizeof(struct sContinueNode)*(1), "18switch.c", 303, "struct sContinueNode*")),info))));
        ...
        skip_spaces_and_lf(info);
        if(*info->p==59) {
            _inf_value5=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "18switch.c", 310, "struct sNode");
            _inf_obj_value5=(struct sLabelNode*)come_increment_ref_count(((struct sLabelNode*)(__right_value2=sLabelNode_initialize((struct sLabelNode*)come_increment_ref_count((struct sLabelNode*)come_calloc_v2(1, sizeof(struct sLabelNode)*(1), "18switch.c", 310, "struct sLabelNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),info,1))));
            ...
            _inf_value6=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "18switch.c", 313, "struct sNode");
            _inf_obj_value6=(struct sLabelNode*)come_increment_ref_count(((struct sLabelNode*)(__right_value2=sLabelNode_initialize((struct sLabelNode*)come_increment_ref_count((struct sLabelNode*)come_calloc_v2(1, sizeof(struct sLabelNode)*(1), "18switch.c", 313, "struct sLabelNode*")),(char*)come_increment_ref_count(__builtin_string(buf)),info,0))));
        ...
        _inf_value7=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "18switch.c", 319, "struct sNode");
        _inf_obj_value7=(struct sGotoNode*)come_increment_ref_count(((struct sGotoNode*)(__right_value1=sGotoNode_initialize((struct sGotoNode*)come_increment_ref_count((struct sGotoNode*)come_calloc_v2(1, sizeof(struct sGotoNode)*(1), "18switch.c", 319, "struct sGotoNode*")),(struct sNode*)come_increment_ref_count(exp),info))));
        ...
        _inf_value8=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "18switch.c", 330, "struct sNode");
        _inf_obj_value8=(struct sSwitchNode*)come_increment_ref_count(((struct sSwitchNode*)(__right_value1=sSwitchNode_initialize((struct sSwitchNode*)come_increment_ref_count((struct sSwitchNode*)come_calloc_v2(1, sizeof(struct sSwitchNode)*(1), "18switch.c", 330, "struct sSwitchNode*")),(struct sNode*)come_increment_ref_count(expression_node),block,info))));
