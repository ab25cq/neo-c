...
sNode*% string_node(char* buf, char* head, int head_sline, sInfo* info) version 11
{
    if(buf === "for") {
        ...
        list<tup: string,sNode*%>*% params  = [new tuple2<string, sNode*%>(s"self", create_load_var(s"o2_saved"))];
        ...
        list<tup: string,sNode*%>*% params2 = [new tuple2<string,sNode*%>(s"self", create_load_var(s"o2_saved"))];
...
*/
        list<tup: string,sNode*%>*% params3 = [new tuple2<string, sNode*%>(s"self", create_load_var(s"o2_saved"))];
