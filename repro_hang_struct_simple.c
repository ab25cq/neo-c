...
int main(int argc, char** argv)
{
    ...
    # 7 "/tmp/repro_hang_struct_simple.nc"
    # 9 "/tmp/repro_hang_struct_simple.nc"
    aaa.aaa=123;
    # 11 "/tmp/repro_hang_struct_simple.nc"
        __result_obj__0 = 0;
    come_call_finalizer(anonymous_typeX19_finalize, (&aaa), (void*)0, (void*)0, 1, 0, 0, (void*)0, "/tmp/repro_hang_struct_simple.nc}", 11, 1);
