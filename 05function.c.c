...
memset(&__result_obj__, 0, sizeof(void*));
memset(&result_58, 0, sizeof(struct list$1sTypeph*));
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&result_66, 0, sizeof(struct list$1sNodeph*));
...
memset(&prev_it_73, 0, sizeof(struct list_item$1sNodeph*));
    it_72=self->head;
    while(it_72!=((void*)0)) {
        prev_it_73=it_72;
        it_72=it_72->next;
...
memset(&prev_it_80, 0, sizeof(struct list_item$1charph*));
    it_79=self->head;
    while(it_79!=((void*)0)) {
        prev_it_80=it_79;
        it_79=it_79->next;
...
char* __dec_obj42;
_Bool __result71__;
memset(&come_fun_84, 0, sizeof(struct sFun*));
memset(&result_type_86, 0, sizeof(struct sType*));
...
memset(&old_table_103, 0, sizeof(struct sVarTable*));
memset(&current_loop_vtable_104, 0, sizeof(struct sVarTable*));
memset(&param_types__105, 0, sizeof(struct list$1sTypeph*));
memset(&param_names__106, 0, sizeof(struct list$1charph*));
...
memset(&it_127, 0, sizeof(struct list_item$1sRightValueObjectph*));
memset(&prev_it_128, 0, sizeof(struct list_item$1sRightValueObjectph*));
    it_127=self->head;
    while(it_127!=((void*)0)) {
        prev_it_128=it_127;
        it_127=it_127->next;
...
memset(&it_129, 0, sizeof(struct list_item$1sRightValueObjectph*));
memset(&prev_it_130, 0, sizeof(struct list_item$1sRightValueObjectph*));
    it_129=self->head;
    while(it_129!=((void*)0)) {
        prev_it_130=it_129;
        it_129=it_129->next;
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&it_134, 0, sizeof(struct list_item$1sRightValueObjectph*));
memset(&prev_it_135, 0, sizeof(struct list_item$1sRightValueObjectph*));
    it_134=self->head;
    while(it_134!=((void*)0)) {
        prev_it_135=it_134;
        it_134=it_134->next;
...
char* __result95__;
memset(&__result_obj__, 0, sizeof(void*));
memset(&asm_fun_name_146, 0, sizeof(struct buffer*));
...
memset(&main_fun_271, 0, sizeof(struct sFun*));
...
memset(&main_fun_279, 0, sizeof(struct sFun*));
memset(&result_type_281, 0, sizeof(struct sType*));
...
memset(&param_default_parametors_298, 0, sizeof(struct list$1charph*));
memset(&fun_299, 0, sizeof(struct sFun*));
memset(&result_type_301, 0, sizeof(struct sType*));
memset(&param_types_302, 0, sizeof(struct list$1sTypeph*));
memset(&param_names_303, 0, sizeof(struct list$1charph*));
memset(&param_default_parametors_304, 0, sizeof(struct list$1charph*));
memset(&fun_305, 0, sizeof(struct sFun*));
    skip_spaces_and_lf(info);
    parse_sharp_v5(info);
    {
...
memset(&litem_162, 0, sizeof(struct list_item$1sTypeph*));
    if(self->len==0) {
...
memset(&items_174, 0, sizeof(struct sFun**));
memset(&default_value_182, 0, sizeof(struct sFun*));
memset(&it2_183, 0, sizeof(struct sFun*));
...
memset(&prev_it_201, 0, sizeof(struct list_item$1charp*));
memset(&it_202, 0, sizeof(struct list_item$1charp*));
memset(&head_prev_it_203, 0, sizeof(struct list_item$1charp*));
memset(&tail_it_204, 0, sizeof(struct list_item$1charp*));
memset(&prev_it_206, 0, sizeof(struct list_item$1charp*));
    if(head<0) {
        head+=self->len;
    }
    if(tail<0) {
...
memset(&litem_215, 0, sizeof(struct list_item$1charp*));
    if(self->len==0) {
...
memset(&param_types_344, 0, sizeof(struct list$1sTypeph*));
memset(&param_names_345, 0, sizeof(struct list$1charph*));
memset(&param_types2_350, 0, sizeof(struct list$1sTypeph*));
memset(&param_names2_351, 0, sizeof(struct list$1charph*));
memset(&result_type2_357, 0, sizeof(struct sType*));
memset(&header_buf_359, 0, sizeof(struct buffer*));
memset(&param_default_parametors_360, 0, sizeof(struct list$1charph*));
memset(&fun_361, 0, sizeof(struct sFun*));
memset(&fun2_365, 0, sizeof(struct sFun*));
memset(&node_402, 0, sizeof(struct sNode*));
memset(&header_404, 0, sizeof(struct buffer*));
...
memset(&prev_it_337, 0, sizeof(struct list_item$1charph*));
    it_336=self->head;
    while(it_336!=((void*)0)) {
        prev_it_337=it_336;
        it_336=it_336->next;
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&result_367, 0, sizeof(struct sFun*));
    if(self==(void*)0) {
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&result_368, 0, sizeof(struct sBlock*));
    if(self==(void*)0) {
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&result_369, 0, sizeof(struct sVarTable*));
    if(self==(void*)0) {
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&result_375, 0, sizeof(struct map$2charphsVarph*));
memset(&default_value_381, 0, sizeof(struct sVar*));
memset(&it2_384, 0, sizeof(struct sVar*));
    if(self==((void*)0)) {
...
memset(&it_371, 0, sizeof(struct list_item$1charp*));
memset(&prev_it_372, 0, sizeof(struct list_item$1charp*));
    it_371=self->head;
    while(it_371!=((void*)0)) {
        prev_it_372=it_371;
        it_371=it_371->next;
...
memset(&items_387, 0, sizeof(struct sVar**));
memset(&default_value_391, 0, sizeof(struct sVar*));
memset(&it2_392, 0, sizeof(struct sVar*));
...
memset(&generics_class_416, 0, sizeof(struct sClass*));
...
char* __dec_obj122;
_Bool __result177__;
memset(&caller_fun_420, 0, sizeof(struct sFun*));
memset(&funX_428, 0, sizeof(struct sFun*));
memset(&result_type_429, 0, sizeof(struct sType*));
memset(&param_types_430, 0, sizeof(struct list$1sTypeph*));
memset(&o2_saved_431, 0, sizeof(struct list$1sTypeph*));
memset(&it_434, 0, sizeof(struct sType*));
memset(&param_type_437, 0, sizeof(struct sType*));
memset(&param_names_438, 0, sizeof(struct list$1charph*));
memset(&param_default_parametors_439, 0, sizeof(struct list$1charph*));
memset(&source_444, 0, sizeof(struct buffer*));
memset(&generics_type_saved_445, 0, sizeof(struct sType*));
memset(&method_generics_type_names_446, 0, sizeof(struct list$1charph*));
memset(&o2_saved_447, 0, sizeof(struct list$1charph*));
memset(&block_449, 0, sizeof(struct sBlock*));
memset(&fun_451, 0, sizeof(struct sFun*));
memset(&node_452, 0, sizeof(struct sNode*));
...
char* __dec_obj139;
_Bool __result182__;
memset(&caller_fun_454, 0, sizeof(struct sFun*));
memset(&funX_462, 0, sizeof(struct sFun*));
memset(&result_type_463, 0, sizeof(struct sType*));
memset(&param_types_464, 0, sizeof(struct list$1sTypeph*));
memset(&o2_saved_465, 0, sizeof(struct list$1sTypeph*));
memset(&it_466, 0, sizeof(struct sType*));
...
memset(&source_474, 0, sizeof(struct buffer*));
memset(&method_generics_type_names_475, 0, sizeof(struct list$1charph*));
memset(&o2_saved_476, 0, sizeof(struct list$1charph*));
memset(&block_478, 0, sizeof(struct sBlock*));
memset(&fun_480, 0, sizeof(struct sFun*));
memset(&node_481, 0, sizeof(struct sNode*));
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&result_type_485, 0, sizeof(struct sType*));
memset(&buf2_494, 0, sizeof(struct buffer*));
memset(&fun_name_495, 0, sizeof(char*));
memset(&header_buf_505, 0, sizeof(struct buffer*));
memset(&block_508, 0, sizeof(struct sBlock*));
memset(&fun_511, 0, sizeof(struct sFun*));
memset(&fun2_512, 0, sizeof(struct sFun*));
memset(&fun_518, 0, sizeof(struct sGenericsFun*));
memset(&fun_544, 0, sizeof(struct sGenericsFun*));
memset(&header_547, 0, sizeof(struct buffer*));
memset(&param_type_551, 0, sizeof(struct sType*));
memset(&param_type_562, 0, sizeof(struct sType*));
memset(&block_565, 0, sizeof(struct sBlock*));
memset(&fun_568, 0, sizeof(struct sFun*));
memset(&fun2_569, 0, sizeof(struct sFun*));
memset(&fun_572, 0, sizeof(struct sFun*));
memset(&fun2_573, 0, sizeof(struct sFun*));
memset(&header_575, 0, sizeof(struct buffer*));
memset(&fun_578, 0, sizeof(struct sFun*));
memset(&fun2_579, 0, sizeof(struct sFun*));
memset(&header_581, 0, sizeof(struct buffer*));
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&result_513, 0, sizeof(struct sLambdaNode*));
    if(self==(void*)0) {
...
memset(&items_522, 0, sizeof(struct sGenericsFun**));
memset(&default_value_530, 0, sizeof(struct sGenericsFun*));
memset(&it2_531, 0, sizeof(struct sGenericsFun*));
memset(&default_value_536, 0, sizeof(struct sGenericsFun*));
...
char* __result200__;
memset(&__result_obj__, 0, sizeof(void*));
memset(&it_552, 0, sizeof(struct list_item$1charph*));
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&current_stack_frame_struct_586, 0, sizeof(struct sClass*));
memset(&finalizer_587, 0, sizeof(struct sFun*));
memset(&user_finalizer_590, 0, sizeof(struct sFun*));
memset(&type2_591, 0, sizeof(struct sType*));
memset(&klass_592, 0, sizeof(struct sClass*));
memset(&source_593, 0, sizeof(struct buffer*));
memset(&o2_saved_595, 0, sizeof(struct list$1tuple2$2charphsTypephph*));
memset(&it_598, 0, sizeof(struct tuple2$2charphsTypeph*));
memset(&source3_608, 0, sizeof(struct buffer*));
memset(&block_609, 0, sizeof(struct sBlock*));
memset(&result_type_610, 0, sizeof(struct sType*));
memset(&self_type_612, 0, sizeof(struct sType*));
memset(&param_types_614, 0, sizeof(struct list$1sTypeph*));
memset(&param_names_616, 0, sizeof(struct list$1charph*));
memset(&param_default_parametors_617, 0, sizeof(struct list$1charph*));
memset(&header_buf_618, 0, sizeof(struct buffer*));
memset(&param_type_620, 0, sizeof(struct sType*));
memset(&fun_622, 0, sizeof(struct sFun*));
memset(&fun2_623, 0, sizeof(struct sFun*));
memset(&node_624, 0, sizeof(struct sNode*));
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&current_stack_frame_struct_629, 0, sizeof(struct sClass*));
memset(&finalizer_630, 0, sizeof(struct sFun*));
memset(&type2_632, 0, sizeof(struct sType*));
memset(&klass_633, 0, sizeof(struct sClass*));
memset(&source_634, 0, sizeof(struct buffer*));
memset(&o2_saved_635, 0, sizeof(struct list$1tuple2$2charphsTypephph*));
memset(&it_636, 0, sizeof(struct tuple2$2charphsTypeph*));
memset(&source3_644, 0, sizeof(struct buffer*));
memset(&block_645, 0, sizeof(struct sBlock*));
memset(&result_type_646, 0, sizeof(struct sType*));
memset(&self_type_648, 0, sizeof(struct sType*));
...
memset(&node_660, 0, sizeof(struct sNode*));
...
memset(&equaler_666, 0, sizeof(struct sFun*));
...
memset(&source3_682, 0, sizeof(struct buffer*));
memset(&block_683, 0, sizeof(struct sBlock*));
memset(&result_type_684, 0, sizeof(struct sType*));
memset(&left_type_686, 0, sizeof(struct sType*));
memset(&right_type_687, 0, sizeof(struct sType*));
memset(&param_types_689, 0, sizeof(struct list$1sTypeph*));
memset(&param_names_691, 0, sizeof(struct list$1charph*));
memset(&param_default_parametors_692, 0, sizeof(struct list$1charph*));
memset(&header_buf_693, 0, sizeof(struct buffer*));
memset(&param_type_695, 0, sizeof(struct sType*));
memset(&fun_697, 0, sizeof(struct sFun*));
memset(&fun2_698, 0, sizeof(struct sFun*));
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&current_stack_frame_struct_704, 0, sizeof(struct sClass*));
memset(&equaler_705, 0, sizeof(struct sFun*));
memset(&type2_707, 0, sizeof(struct sType*));
memset(&klass_708, 0, sizeof(struct sClass*));
memset(&source_709, 0, sizeof(struct buffer*));
memset(&o2_saved_714, 0, sizeof(struct list$1tuple2$2charphsTypephph*));
memset(&it_715, 0, sizeof(struct tuple2$2charphsTypeph*));
memset(&source3_725, 0, sizeof(struct buffer*));
memset(&block_726, 0, sizeof(struct sBlock*));
memset(&result_type_727, 0, sizeof(struct sType*));
memset(&left_type_729, 0, sizeof(struct sType*));
memset(&right_type_730, 0, sizeof(struct sType*));
memset(&param_types_732, 0, sizeof(struct list$1sTypeph*));
memset(&param_names_734, 0, sizeof(struct list$1charph*));
memset(&param_default_parametors_735, 0, sizeof(struct list$1charph*));
memset(&header_buf_736, 0, sizeof(struct buffer*));
memset(&param_type_738, 0, sizeof(struct sType*));
memset(&fun_740, 0, sizeof(struct sFun*));
memset(&fun2_741, 0, sizeof(struct sFun*));
memset(&node_742, 0, sizeof(struct sNode*));
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&current_stack_frame_struct_747, 0, sizeof(struct sClass*));
memset(&equaler_748, 0, sizeof(struct sFun*));
memset(&type2_750, 0, sizeof(struct sType*));
memset(&klass_751, 0, sizeof(struct sClass*));
memset(&source_752, 0, sizeof(struct buffer*));
memset(&o2_saved_755, 0, sizeof(struct list$1tuple2$2charphsTypephph*));
memset(&it_756, 0, sizeof(struct tuple2$2charphsTypeph*));
memset(&source3_764, 0, sizeof(struct buffer*));
memset(&block_765, 0, sizeof(struct sBlock*));
memset(&result_type_766, 0, sizeof(struct sType*));
memset(&left_type_768, 0, sizeof(struct sType*));
memset(&right_type_769, 0, sizeof(struct sType*));
memset(&param_types_771, 0, sizeof(struct list$1sTypeph*));
memset(&param_names_773, 0, sizeof(struct list$1charph*));
memset(&param_default_parametors_774, 0, sizeof(struct list$1charph*));
memset(&header_buf_775, 0, sizeof(struct buffer*));
memset(&param_type_777, 0, sizeof(struct sType*));
memset(&fun_779, 0, sizeof(struct sFun*));
memset(&fun2_780, 0, sizeof(struct sFun*));
memset(&node_781, 0, sizeof(struct sNode*));
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&current_stack_frame_struct_786, 0, sizeof(struct sClass*));
memset(&cloner_787, 0, sizeof(struct sFun*));
memset(&type2_789, 0, sizeof(struct sType*));
memset(&klass_790, 0, sizeof(struct sClass*));
memset(&source_791, 0, sizeof(struct buffer*));
memset(&o2_saved_794, 0, sizeof(struct list$1tuple2$2charphsTypephph*));
memset(&it_795, 0, sizeof(struct tuple2$2charphsTypeph*));
memset(&o2_saved_800, 0, sizeof(struct list$1tuple2$2charphsTypephph*));
memset(&it_801, 0, sizeof(struct tuple2$2charphsTypeph*));
memset(&source3_810, 0, sizeof(struct buffer*));
memset(&block_812, 0, sizeof(struct sBlock*));
memset(&result_type_813, 0, sizeof(struct sType*));
memset(&self_type_815, 0, sizeof(struct sType*));
memset(&param_types_817, 0, sizeof(struct list$1sTypeph*));
memset(&param_names_819, 0, sizeof(struct list$1charph*));
memset(&param_default_parametors_820, 0, sizeof(struct list$1charph*));
memset(&header_buf_821, 0, sizeof(struct buffer*));
memset(&param_type_823, 0, sizeof(struct sType*));
memset(&fun_825, 0, sizeof(struct sFun*));
memset(&fun2_826, 0, sizeof(struct sFun*));
memset(&node_827, 0, sizeof(struct sNode*));
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&result_828, 0, sizeof(struct sFunNode*));
    if(self==(void*)0) {
