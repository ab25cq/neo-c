    ...
    for(    it=map$2char$phsVar$ph_begin(self)    ;    !map$2char$phsVar$ph_end(self)    ;    it=map$2char$phsVar$ph_next(self)    ){
        ...
        while(        (_Bool)1        ) {
            if(            item_existance[n]            ) {
                ...
                item_existance[n]=(_Bool)1;
                keys[n]=it;
                memset(&default_value_121,0,sizeof(struct sVar*));
                __right_value0 = (void*)0;
...
struct sGenericsFun* default_value_142;
    ...
    keys=(char**)come_increment_ref_count(((char**)(__right_value0=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size)), "./neo-c.h", 2280, "char**"))));
    __right_value0 = (void*)0;
    items=(struct sGenericsFun**)come_increment_ref_count(((struct sGenericsFun**)(__right_value0=(struct sGenericsFun**)come_calloc_v2(1, sizeof(struct sGenericsFun*)*(1*(size)), "./neo-c.h", 2281, "struct sGenericsFun**"))));
    __right_value0 = (void*)0;
    item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value0=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size)), "./neo-c.h", 2282, "_Bool*"))));
    len=0;
    for(    it=map$2char$phsGenericsFun$ph_begin(self)    ;    !map$2char$phsGenericsFun$ph_end(self)    ;    it=map$2char$phsGenericsFun$ph_next(self)    ){
        ...
        while(        (_Bool)1        ) {
            if(            item_existance[n]            ) {
                ...
                item_existance[n]=(_Bool)1;
                keys[n]=it;
                memset(&default_value_142,0,sizeof(struct sGenericsFun*));
                __right_value0 = (void*)0;
