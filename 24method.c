...
struct tuple2$2char$phsGenericsFun$p* make_generics_function(struct sType* type  , char* fun_name  , struct sInfo* info  , _Bool array_equal_pointer)
{
    ...
    fr.fun_name  = "make_generics_function";
...
static void tuple2$2char$ph_Bool$$p_finalize(struct tuple2$2char$ph_Bool$* self)
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "tuple2$2char$ph_Bool$$p_finalize";
    neo_current_frame = &fr;
...
static struct tuple2$2char$phsGenericsFun$p* tuple2$2char$phsGenericsFun$p_initialize(struct tuple2$2char$phsGenericsFun$p* self, char* v1  , struct sGenericsFun* v2  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "tuple2$2char$phsGenericsFun$p_initialize";
    neo_current_frame = &fr;
    char* __dec_obj33  ;
    struct tuple2$2char$phsGenericsFun$p* __result_obj__0;
    __dec_obj33=self->v1,
...
struct tuple2$2char$phsGenericsFun$p* make_method_generics_function(char* fun_name  , struct list$1sType$ph* method_generics_types, struct sInfo* info  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "make_method_generics_function";
    neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    char* fun_name3  ;
...
_Bool compile_method_block(struct buffer* method_block  , struct list$1CVALUE$ph* come_params, struct sFun* fun  , char* fun_name, int method_block_sline, struct sInfo* info  , _Bool no_create_current_stack)
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "compile_method_block";
    neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
...
static struct tuple3$3char$phsFun$psGenericsFun$p* tuple3$3char$phsFun$psGenericsFun$p_initialize(struct tuple3$3char$phsFun$psGenericsFun$p* self, char* v1  , struct sFun* v2  , struct sGenericsFun* v3  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "tuple3$3char$phsFun$psGenericsFun$p_initialize";
    neo_current_frame = &fr;
    char* __dec_obj52  ;
    struct tuple3$3char$phsFun$psGenericsFun$p* __result_obj__0;
    __dec_obj52=self->v1,
...
static void tuple3$3char$phsFun$psGenericsFun$p$p_finalize(struct tuple3$3char$phsFun$psGenericsFun$p* self)
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "tuple3$3char$phsFun$psGenericsFun$p$p_finalize";
    neo_current_frame = &fr;
    if(self!=((void*)0)&&self->v1!=((void*)0)) {
        (self->v1 = come_decrement_ref_count(self->v1, (void*)0, (void*)0, 0, 0, (void*)0));
    }
...
static void tuple2$2sFun$pchar$ph$p_finalize(struct tuple2$2sFun$pchar$ph* self)
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "tuple2$2sFun$pchar$ph$p_finalize";
    neo_current_frame = &fr;
    if(self!=((void*)0)&&self->v2!=((void*)0)) {
...
struct sMethodCallNode* sMethodCallNode_initialize(struct sMethodCallNode* self, char* fun_name, struct sNode* obj, struct list$1tuple2$2char$phsNode$ph$ph* params, struct buffer* method_block  , int method_block_sline, struct list$1sType$ph* method_generics_types, _Bool no_infference_method_generics, _Bool recursive, struct sInfo* info  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "sMethodCallNode_initialize";
    neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
...
_Bool sMethodCallNode_terminated(struct sMethodCallNode* self)
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "sMethodCallNode_terminated";
    neo_current_frame = &fr;
...
char* sMethodCallNode_kind(struct sMethodCallNode* self)
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "sMethodCallNode_kind";
    neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
...
_Bool sMethodCallNode_compile(struct sMethodCallNode* self, struct sInfo* info  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "sMethodCallNode_compile";
    neo_current_frame = &fr;
    char* fun_name  ;
    struct list$1tuple2$2char$phsNode$ph$ph* params;
    struct sNode* obj;
...
static void sMethodCallNode_finalize(struct sMethodCallNode* self)
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "sMethodCallNode_finalize";
    neo_current_frame = &fr;
    if(self!=((void*)0)&&self->sname!=((void*)0)) {
        (self->sname = come_decrement_ref_count(self->sname, (void*)0, (void*)0, 0, 0, (void*)0));
    }
...
struct sNode* create_method_call(char* fun_name, struct sNode* obj, struct list$1tuple2$2char$phsNode$ph$ph* params, struct buffer* method_block  , int method_block_sline, struct list$1sType$ph* method_generics_types, struct sInfo* info  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "create_method_call";
    neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
...
static struct sMethodCallNode* sMethodCallNode_clone(struct sMethodCallNode* self)
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "sMethodCallNode_clone";
    neo_current_frame = &fr;
    struct sMethodCallNode* __result_obj__0;
    void* __right_value0 = (void*)0;
...
struct sNode* parse_method_call_v20(struct sNode* obj, char* fun_name  , struct sInfo* info  )
{
        struct neo_frame fr;
    fr.prev = neo_current_frame;
    fr.fun_name  = "parse_method_call_v20";
    neo_current_frame = &fr;
    void* __right_value0 = (void*)0;
    void* __right_value1 = (void*)0;
    struct list$1tuple2$2char$phsNode$ph$ph* params;
