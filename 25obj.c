...
_Bool sTrueNode_compile(struct sTrueNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 405, "struct sType*")),(char*)come_increment_ref_count(xsprintf("_Bool")),0,info,0));
...
_Bool sFalseNode_compile(struct sFalseNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 438, "struct sType*")),(char*)come_increment_ref_count(xsprintf("_Bool")),0,info,0));
...
struct sNode* create_false_object(struct sInfo* info  )
{
    ...
    void* __right_value2 = (void*)0;
    struct sNode* __result_obj__0;
    _inf_value2=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 452, "struct sNode");
    _inf_obj_value2=(struct sFalseNode*)come_increment_ref_count(((struct sFalseNode*)(__right_value1=sFalseNode_initialize((struct sFalseNode*)come_increment_ref_count((struct sFalseNode*)come_calloc(1, sizeof(struct sFalseNode)*(1), (void*)0, 452, "struct sFalseNode*")),info))));
...
_Bool sGeneric_compile(struct sGeneric* self, struct sInfo* info  )
{
    ...
    come_value2=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 546, "struct CVALUE*"))));
...
_Bool sSizeOfNode_compile(struct sSizeOfNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    type=(struct sType*)come_increment_ref_count(self->type);
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 578, "struct CVALUE*"))));
    type2_=(struct sType*)come_increment_ref_count(solve_generics(type,info->generics_type,info));
    type2=(struct sType*)come_increment_ref_count(solve_method_generics(type2_,info));
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 586, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
struct sOffsetOf* sOffsetOf_initialize(struct sOffsetOf* self, struct sType* type  , char* name  , struct sInfo* info  )
{
    ...
    self->name=(char*)come_increment_ref_count((char*)come_memdup(name, "25obj.nc", 605, "char*"));
...
_Bool sOffsetOf_compile(struct sOffsetOf* self, struct sInfo* info  )
{
    ...
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 618, "struct CVALUE*"))));
    type2_=(struct sType*)come_increment_ref_count(solve_generics(type,info->generics_type,info));
    type2=(struct sType*)come_increment_ref_count(solve_method_generics(type2_,info));
...
_Bool sSizeOfExpNode_compile(struct sSizeOfExpNode* self, struct sInfo* info  )
{
    ...
    come_value=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
    come_value2=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 663, "struct CVALUE*"))));
    ...
    come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 666, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sTypeOfNode_compile(struct sTypeOfNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    type=(struct sType*)come_increment_ref_count(self->type);
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 696, "struct CVALUE*"))));
    type2_=(struct sType*)come_increment_ref_count(solve_generics(type,info->generics_type,info));
    type2=(struct sType*)come_increment_ref_count(solve_method_generics(type2_,info));
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 704, "struct sType*")),(char*)come_increment_ref_count(xsprintf("char*")),0,info,0));
...
_Bool sTypeOfExpNode_compile(struct sTypeOfExpNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 747, "struct sType*")),(char*)come_increment_ref_count(xsprintf("char*")),0,info,0));
...
_Bool sDynamicTypeOf_compile(struct sDynamicTypeOf* self, struct sInfo* info  )
{
    ...
    if(come_value->type->mPointerNum>0&&come_value->type->mHeap) {
        come_value2=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 783, "struct CVALUE*"))));
        ...
        come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 786, "struct sType*")),(char*)come_increment_ref_count(xsprintf("char*")),0,info,0));
        ...
        come_value2_50=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 794, "struct CVALUE*"))));
        ...
        come_value2_50->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 797, "struct sType*")),(char*)come_increment_ref_count(xsprintf("char*")),0,info,0));
...
_Bool sAlignOfNode_compile(struct sAlignOfNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    type=(struct sType*)come_increment_ref_count(self->type);
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 831, "struct CVALUE*"))));
    type2_=(struct sType*)come_increment_ref_count(solve_generics(type,info->generics_type,info));
    type2=(struct sType*)come_increment_ref_count(solve_method_generics(type2_,info));
    type_name=(char*)come_increment_ref_count(make_type_name_string(type2,info,0,0,0));
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 839, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sAlignOfExpNode_compile(struct sAlignOfExpNode* self, struct sInfo* info  )
{
    ...
    come_value=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
    come_value2=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 875, "struct CVALUE*"))));
    ...
    come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 878, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sAlignOfNode2_compile(struct sAlignOfNode2* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    type=(struct sType*)come_increment_ref_count(self->type);
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 908, "struct CVALUE*"))));
    type2_=(struct sType*)come_increment_ref_count(solve_generics(type,info->generics_type,info));
    type2=(struct sType*)come_increment_ref_count(solve_method_generics(type2_,info));
    type_name=(char*)come_increment_ref_count(make_type_name_string(type2,info,0,0,0));
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 916, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sAlignOfExpNode2_compile(struct sAlignOfExpNode2* self, struct sInfo* info  )
{
    ...
    come_value=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
    come_value2=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 952, "struct CVALUE*"))));
    ...
    come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 955, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sAlignAsNode_compile(struct sAlignAsNode* self, struct sInfo* info  )
{
    ...
    _Bool __result_obj__0;
    type=(struct sType*)come_increment_ref_count(self->type);
    come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 985, "struct CVALUE*"))));
    type2_=(struct sType*)come_increment_ref_count(solve_generics(type,info->generics_type,info));
    type2=(struct sType*)come_increment_ref_count(solve_method_generics(type2_,info));
    type_name=(char*)come_increment_ref_count(make_type_name_string(type2,info,0,0,0));
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 993, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sAlignAsExpNode_compile(struct sAlignAsExpNode* self, struct sInfo* info  )
{
    ...
    come_value=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
    come_value2=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 1029, "struct CVALUE*"))));
    ...
    come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 1032, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
;    struct sType* result_type  =0;
    ...
    if(left_type->mPointerNum==1&&string_operator_equals(left_type->mClass->mName,"void")&&left_type->mHeap==0) {
        ...
        come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 1154, "struct CVALUE*"))));
...
;    struct sType* result_type  =0;
    ...
    if(left_type->mPointerNum==0) {
        ...
        come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 1204, "struct CVALUE*"))));
...
_Bool sIsHeap_compile(struct sIsHeap* self, struct sInfo* info  )
{
    ...
    node=self->type;
    if(self->type->mHeap) {
        come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 1347, "struct CVALUE*"))));
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 1350, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
        ...
        come_value_51=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 1358, "struct CVALUE*"))));
        ...
        come_value_51->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 1361, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sIsPointer_compile(struct sIsPointer* self, struct sInfo* info  )
{
    ...
    if(self->type->mPointerNum>0) {
        come_value=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 1392, "struct CVALUE*"))));
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 1395, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
        ...
        come_value_52=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), (void*)0, 1403, "struct CVALUE*"))));
        ...
        come_value_52->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), (void*)0, 1406, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
    ...
    if(!gComeC&&charp_operator_equals(buf,"new")) {
        ...
        if(*info->p==40) {
            if(type->mClass->mNumber) {
                ...
                _inf_value3=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1471, "struct sNode");
                _inf_obj_value3=(struct sNewNode*)come_increment_ref_count(((struct sNewNode*)(__right_value1=sNewNode_initialize((struct sNewNode*)come_increment_ref_count((struct sNewNode*)come_calloc(1, sizeof(struct sNewNode)*(1), (void*)0, 1471, "struct sNewNode*")),type,((void*)0),(struct sNode*)come_increment_ref_count(exp),info))));
                ...
                _inf_value4=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1474, "struct sNode");
                _inf_obj_value4=(struct sNewNode*)come_increment_ref_count(((struct sNewNode*)(__right_value1=sNewNode_initialize((struct sNewNode*)come_increment_ref_count((struct sNewNode*)come_calloc(1, sizeof(struct sNewNode)*(1), (void*)0, 1474, "struct sNewNode*")),type,((void*)0),((void*)0),info))));
            ...
            info->p++;
            skip_spaces_and_lf(info);
            initializer=(struct list$1tuple2$2char$phsNode$ph$ph*)come_increment_ref_count(list$1tuple2$2char$phsNode$ph$ph_initialize((struct list$1tuple2$2char$phsNode$ph$ph*)come_increment_ref_count((struct list$1tuple2$2char$phsNode$ph$ph*)come_calloc(1, sizeof(struct list$1tuple2$2char$phsNode$ph$ph)*(1), (void*)0, 1484, "struct list$1tuple2$2char$phsNode$ph$ph*"))));
            while(1) {
                ...
                if(*info->p==58) {
                    ...
                    list$1tuple2$2char$phsNode$ph$ph_add(initializer,(struct tuple2$2char$phsNode$ph*)come_increment_ref_count(tuple2$2char$phsNode$ph_initialize((struct tuple2$2char$phsNode$ph*)come_increment_ref_count((struct tuple2$2char$phsNode$ph*)come_calloc(1, sizeof(struct tuple2$2char$phsNode$ph)*(1), "25obj.nc", 1503, "struct tuple2$2char$phsNode$ph")),(char*)come_increment_ref_count(word),(struct sNode*)come_increment_ref_count(exp_56))));
            ...
            _inf_value5=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1524, "struct sNode");
            _inf_obj_value5=(struct sNewNode*)come_increment_ref_count(((struct sNewNode*)(__right_value1=sNewNode_initialize((struct sNewNode*)come_increment_ref_count((struct sNewNode*)come_calloc(1, sizeof(struct sNewNode)*(1), (void*)0, 1524, "struct sNewNode*")),type,(struct list$1tuple2$2char$phsNode$ph$ph*)come_increment_ref_count(initializer),((void*)0),info))));
            ...
            _inf_value6=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1527, "struct sNode");
            _inf_obj_value6=(struct sNewNode*)come_increment_ref_count(((struct sNewNode*)(__right_value1=sNewNode_initialize((struct sNewNode*)come_increment_ref_count((struct sNewNode*)come_calloc(1, sizeof(struct sNewNode)*(1), (void*)0, 1527, "struct sNewNode*")),type,((void*)0),((void*)0),info))));
        ...
        _inf_value7=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1531, "struct sNode");
        _inf_obj_value7=(struct sTrueNode*)come_increment_ref_count(((struct sTrueNode*)(__right_value1=sTrueNode_initialize((struct sTrueNode*)come_increment_ref_count((struct sTrueNode*)come_calloc(1, sizeof(struct sTrueNode)*(1), (void*)0, 1531, "struct sTrueNode*")),info))));
        ...
        puts("GGG");
        _inf_value8=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1535, "struct sNode");
        _inf_obj_value8=(struct sFalseNode*)come_increment_ref_count(((struct sFalseNode*)(__right_value1=sFalseNode_initialize((struct sFalseNode*)come_increment_ref_count((struct sFalseNode*)come_calloc(1, sizeof(struct sFalseNode)*(1), (void*)0, 1535, "struct sFalseNode*")),info))));
        ...
        _inf_value9=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1540, "struct sNode");
        _inf_obj_value9=(struct sDeleteNode*)come_increment_ref_count(((struct sDeleteNode*)(__right_value1=sDeleteNode_initialize((struct sDeleteNode*)come_increment_ref_count((struct sDeleteNode*)come_calloc(1, sizeof(struct sDeleteNode)*(1), (void*)0, 1540, "struct sDeleteNode*")),(struct sNode*)come_increment_ref_count(node),info))));
        ...
        _inf_value11=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1550, "struct sNode");
        _inf_obj_value11=(struct sCloneNode*)come_increment_ref_count(((struct sCloneNode*)(__right_value1=sCloneNode_initialize((struct sCloneNode*)come_increment_ref_count((struct sCloneNode*)come_calloc(1, sizeof(struct sCloneNode)*(1), (void*)0, 1550, "struct sCloneNode*")),(struct sNode*)come_increment_ref_count(node_58),info))));
        ...
        _inf_value12=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1555, "struct sNode");
        _inf_obj_value12=(struct sDupeNode*)come_increment_ref_count(((struct sDupeNode*)(__right_value1=sDupeNode_initialize((struct sDupeNode*)come_increment_ref_count((struct sDupeNode*)come_calloc(1, sizeof(struct sDupeNode)*(1), (void*)0, 1555, "struct sDupeNode*")),(struct sNode*)come_increment_ref_count(node_59),info))));
        ...
        _inf_value13=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1560, "struct sNode");
        _inf_obj_value13=(struct sDummyHeapNode*)come_increment_ref_count(((struct sDummyHeapNode*)(__right_value1=sDummyHeapNode_initialize((struct sDummyHeapNode*)come_increment_ref_count((struct sDummyHeapNode*)come_calloc(1, sizeof(struct sDummyHeapNode)*(1), (void*)0, 1560, "struct sDummyHeapNode*")),(struct sNode*)come_increment_ref_count(node_60),info))));
        ...
        expected_next_character(41,info);
        _inf_value14=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1570, "struct sNode");
        _inf_obj_value14=(struct sGCIncNode*)come_increment_ref_count(((struct sGCIncNode*)(__right_value1=sGCIncNode_initialize((struct sGCIncNode*)come_increment_ref_count((struct sGCIncNode*)come_calloc(1, sizeof(struct sGCIncNode)*(1), (void*)0, 1570, "struct sGCIncNode*")),(struct sNode*)come_increment_ref_count(node_61),info))));
        ...
        expected_next_character(41,info);
        _inf_value15=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1580, "struct sNode");
        _inf_obj_value15=(struct sGCDecNode*)come_increment_ref_count(((struct sGCDecNode*)(__right_value1=sGCDecNode_initialize((struct sGCDecNode*)come_increment_ref_count((struct sGCDecNode*)come_calloc(1, sizeof(struct sGCDecNode)*(1), (void*)0, 1580, "struct sGCDecNode*")),(struct sNode*)come_increment_ref_count(node_62),info))));
        ...
        expected_next_character(41,info);
        _inf_value16=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1590, "struct sNode");
        _inf_obj_value16=(struct sGCDecNoFreeNode*)come_increment_ref_count(((struct sGCDecNoFreeNode*)(__right_value1=sGCDecNoFreeNode_initialize((struct sGCDecNoFreeNode*)come_increment_ref_count((struct sGCDecNoFreeNode*)come_calloc(1, sizeof(struct sGCDecNoFreeNode)*(1), (void*)0, 1590, "struct sGCDecNoFreeNode*")),(struct sNode*)come_increment_ref_count(node_63),info))));
        ...
        expected_next_character(41,info);
        _inf_value17=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1600, "struct sNode");
        _inf_obj_value17=(struct sGCDecNoFreeNode*)come_increment_ref_count(((struct sGCDecNoFreeNode*)(__right_value1=sGCDecNoFreeNode_initialize((struct sGCDecNoFreeNode*)come_increment_ref_count((struct sGCDecNoFreeNode*)come_calloc(1, sizeof(struct sGCDecNoFreeNode)*(1), (void*)0, 1600, "struct sGCDecNoFreeNode*")),(struct sNode*)come_increment_ref_count(node_64),info))));
        ...
        type2=(struct sType*)come_increment_ref_count(solve_method_generics(type2_,info));
        expected_next_character(41,info);
        _inf_value18=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1617, "struct sNode");
        _inf_obj_value18=(struct sIsHeap*)come_increment_ref_count(((struct sIsHeap*)(__right_value1=sIsHeap_initialize((struct sIsHeap*)come_increment_ref_count((struct sIsHeap*)come_calloc(1, sizeof(struct sIsHeap)*(1), (void*)0, 1617, "struct sIsHeap*")),type2,info))));
        ...
        expected_next_character(41,info);
        _inf_value19=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1634, "struct sNode");
        _inf_obj_value19=(struct sIsPointer*)come_increment_ref_count(((struct sIsPointer*)(__right_value1=sIsPointer_initialize((struct sIsPointer*)come_increment_ref_count((struct sIsPointer*)come_calloc(1, sizeof(struct sIsPointer)*(1), (void*)0, 1634, "struct sIsPointer*")),type2_70,info))));
        ...
        types=(struct list$1sType$ph*)come_increment_ref_count(list$1sType$ph_initialize((struct list$1sType$ph*)come_increment_ref_count((struct list$1sType$ph*)come_calloc(1, sizeof(struct list$1sType$ph)*(1), (void*)0, 1695, "struct list$1sType$ph*"))));
        exps=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc(1, sizeof(struct list$1sNode$ph)*(1), (void*)0, 1696, "struct list$1sNode$ph*"))));
        default_exp=((void*)0);
        while(1) {
        ...
        _inf_value20=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1741, "struct sNode");
        _inf_obj_value20=(struct sGeneric*)come_increment_ref_count(((struct sGeneric*)(__right_value1=sGeneric_initialize((struct sGeneric*)come_increment_ref_count((struct sGeneric*)come_calloc(1, sizeof(struct sGeneric)*(1), (void*)0, 1741, "struct sGeneric*")),(struct sNode*)come_increment_ref_count(exp_73),(struct list$1sType$ph*)come_increment_ref_count(types),(struct list$1sNode$ph*)come_increment_ref_count(exps),(struct sNode*)come_increment_ref_count(default_exp),info))));
        ...
        expected_next_character(41,info);
        _inf_value21=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1761, "struct sNode");
        _inf_obj_value21=(struct sOffsetOf*)come_increment_ref_count(((struct sOffsetOf*)(__right_value1=sOffsetOf_initialize((struct sOffsetOf*)come_increment_ref_count((struct sOffsetOf*)come_calloc(1, sizeof(struct sOffsetOf)*(1), (void*)0, 1761, "struct sOffsetOf*")),type_80,(char*)come_increment_ref_count(word_83),info))));
        ...
        if(is_type_name_flag) {
            ...
            _inf_value22=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1804, "struct sNode");
            _inf_obj_value22=(struct sSizeOfNode*)come_increment_ref_count(((struct sSizeOfNode*)(__right_value1=sSizeOfNode_initialize((struct sSizeOfNode*)come_increment_ref_count((struct sSizeOfNode*)come_calloc(1, sizeof(struct sSizeOfNode)*(1), (void*)0, 1804, "struct sSizeOfNode*")),type_85,info))));
            ...
            _inf_value23=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1825, "struct sNode");
            _inf_obj_value23=(struct sSizeOfExpNode*)come_increment_ref_count(((struct sSizeOfExpNode*)(__right_value1=sSizeOfExpNode_initialize((struct sSizeOfExpNode*)come_increment_ref_count((struct sSizeOfExpNode*)come_calloc(1, sizeof(struct sSizeOfExpNode)*(1), (void*)0, 1825, "struct sSizeOfExpNode*")),(struct sNode*)come_increment_ref_count(exp_88),info))));
        ...
        _inf_value24=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1924, "struct sNode");
        _inf_obj_value24=(struct sDynamicTypeOf*)come_increment_ref_count(((struct sDynamicTypeOf*)(__right_value1=sDynamicTypeOf_initialize((struct sDynamicTypeOf*)come_increment_ref_count((struct sDynamicTypeOf*)come_calloc(1, sizeof(struct sDynamicTypeOf)*(1), (void*)0, 1924, "struct sDynamicTypeOf*")),(struct sNode*)come_increment_ref_count(exp_91),info))));
        ...
        if(is_type_name_flag_94) {
            ...
            _inf_value25=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1964, "struct sNode");
            _inf_obj_value25=(struct sAlignOfNode*)come_increment_ref_count(((struct sAlignOfNode*)(__right_value1=sAlignOfNode_initialize((struct sAlignOfNode*)come_increment_ref_count((struct sAlignOfNode*)come_calloc(1, sizeof(struct sAlignOfNode)*(1), (void*)0, 1964, "struct sAlignOfNode*")),type_98,info))));
            ...
            _inf_value26=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 1978, "struct sNode");
            _inf_obj_value26=(struct sAlignOfExpNode*)come_increment_ref_count(((struct sAlignOfExpNode*)(__right_value1=sAlignOfExpNode_initialize((struct sAlignOfExpNode*)come_increment_ref_count((struct sAlignOfExpNode*)come_calloc(1, sizeof(struct sAlignOfExpNode)*(1), (void*)0, 1978, "struct sAlignOfExpNode*")),(struct sNode*)come_increment_ref_count(exp_101),info))));
        ...
        if(is_type_name_flag_104) {
            ...
            _inf_value27=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 2019, "struct sNode");
            _inf_obj_value27=(struct sAlignOfNode2*)come_increment_ref_count(((struct sAlignOfNode2*)(__right_value1=sAlignOfNode2_initialize((struct sAlignOfNode2*)come_increment_ref_count((struct sAlignOfNode2*)come_calloc(1, sizeof(struct sAlignOfNode2)*(1), (void*)0, 2019, "struct sAlignOfNode2*")),type_108,info))));
            ...
            _inf_value28=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 2033, "struct sNode");
            _inf_obj_value28=(struct sAlignOfExpNode2*)come_increment_ref_count(((struct sAlignOfExpNode2*)(__right_value1=sAlignOfExpNode2_initialize((struct sAlignOfExpNode2*)come_increment_ref_count((struct sAlignOfExpNode2*)come_calloc(1, sizeof(struct sAlignOfExpNode2)*(1), (void*)0, 2033, "struct sAlignOfExpNode2*")),(struct sNode*)come_increment_ref_count(exp_111),info))));
...
struct sNode* create_implements(struct sNode* node, struct sType* inf_type  , struct sInfo* info  )
{
    ...
    _inf_obj_value29=(struct sImplementsNode*)come_increment_ref_count(((struct sImplementsNode*)(__right_value1=sImplementsNode_initialize((struct sImplementsNode*)come_increment_ref_count((struct sImplementsNode*)come_calloc(1, sizeof(struct sImplementsNode)*(1), (void*)0, 2139, "struct sImplementsNode*")),(struct sNode*)come_increment_ref_count(node),inf_type,info))));
...
;    struct sType* type3  =0;
    ...
    if(!node->terminated(node->_protocol_obj)&&!gComeC&&parsecmp("implements",info)) {
        ...
        _inf_value30=(struct sNode*)come_calloc(1, sizeof(struct sNode), (void*)0, 2156, "struct sNode");
        _inf_obj_value30=(struct sImplementsNode*)come_increment_ref_count(((struct sImplementsNode*)(__right_value1=sImplementsNode_initialize((struct sImplementsNode*)come_increment_ref_count((struct sImplementsNode*)come_calloc(1, sizeof(struct sImplementsNode)*(1), (void*)0, 2156, "struct sImplementsNode*")),(struct sNode*)come_increment_ref_count(node),inf_type,info))));
