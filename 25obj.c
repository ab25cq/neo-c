...
_Bool sTrueNode_compile(struct sTrueNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 408, "struct sType*")),(char*)come_increment_ref_count(xsprintf("bool")),0,info,0));
...
_Bool sFalseNode_compile(struct sFalseNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 441, "struct sType*")),(char*)come_increment_ref_count(xsprintf("bool")),0,info,0));
...
_Bool sSizeOfNode_compile(struct sSizeOfNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 587, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sSizeOfExpNode_compile(struct sSizeOfExpNode* self, struct sInfo* info  )
{
    ...
    come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 666, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sTypeOfNode_compile(struct sTypeOfNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 703, "struct sType*")),(char*)come_increment_ref_count(xsprintf("char*")),0,info,0));
...
_Bool sTypeOfExpNode_compile(struct sTypeOfExpNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 745, "struct sType*")),(char*)come_increment_ref_count(xsprintf("char*")),0,info,0));
...
_Bool sDynamicTypeOf_compile(struct sDynamicTypeOf* self, struct sInfo* info  )
{
    ...
    if(come_value->type->mPointerNum>0&&come_value->type->mHeap) {
        ...
        come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 784, "struct sType*")),(char*)come_increment_ref_count(xsprintf("char*")),0,info,0));
        ...
        come_value2_50->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 795, "struct sType*")),(char*)come_increment_ref_count(xsprintf("char*")),0,info,0));
...
_Bool sAlignOfNode_compile(struct sAlignOfNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 836, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sAlignOfExpNode_compile(struct sAlignOfExpNode* self, struct sInfo* info  )
{
    ...
    come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 875, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sAlignOfNode2_compile(struct sAlignOfNode2* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 912, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sAlignOfExpNode2_compile(struct sAlignOfExpNode2* self, struct sInfo* info  )
{
    ...
    come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 951, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sAlignAsNode_compile(struct sAlignAsNode* self, struct sInfo* info  )
{
    ...
    come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 988, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sAlignAsExpNode_compile(struct sAlignAsExpNode* self, struct sInfo* info  )
{
    ...
    come_value2->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 1027, "struct sType*")),(char*)come_increment_ref_count(xsprintf("long")),0,info,0));
...
_Bool sIsHeap_compile(struct sIsHeap* self, struct sInfo* info  )
{
    ...
    if(self->type->mHeap) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 1345, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
        ...
        come_value_51->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 1356, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
_Bool sIsPointer_compile(struct sIsPointer* self, struct sInfo* info  )
{
    ...
    if(self->type->mPointerNum>0) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 1390, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
        ...
        come_value_52->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "25obj.nc", 1401, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),0,info,0));
...
;    struct sType* type_107  =0;
    ...
    if(!gComeC&&charp_operator_equals(buf,"new")) {
        multiple_assign_var8=(come_push_stackframe("25obj.nc", 1452, 1),__exception_result_var_b2=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b2);
        ...
        if(*info->p==40) {
            if(type->mClass->mNumber) {
                ...
                (come_push_stackframe("25obj.nc", 1464, 2),__exception_result_var_b3=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b3);
        ...
        (come_push_stackframe("25obj.nc", 1562, 3),__exception_result_var_b4=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b4);
        ...
        (come_push_stackframe("25obj.nc", 1572, 4),__exception_result_var_b5=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b5);
        ...
        (come_push_stackframe("25obj.nc", 1582, 5),__exception_result_var_b6=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b6);
        ...
        (come_push_stackframe("25obj.nc", 1592, 6),__exception_result_var_b7=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b7);
        ...
        info->p++;
        skip_spaces_and_lf(info);
        multiple_assign_var9=(come_push_stackframe("25obj.nc", 1600, 8),__exception_result_var_b9=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b9);
        ...
        (come_push_stackframe("25obj.nc", 1608, 9),__exception_result_var_b10=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b10);
        ...
        info->p++;
        skip_spaces_and_lf(info);
        multiple_assign_var10=(come_push_stackframe("25obj.nc", 1616, 11),__exception_result_var_b12=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b12);
        ...
        (come_push_stackframe("25obj.nc", 1624, 12),__exception_result_var_b13=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b13);
        ...
        if((come_push_stackframe("25obj.nc", 1629, 13),__exception_result_var_b14=parsecmp("neo-c-pthread",info), come_pop_stackframe(), __exception_result_var_b14)) {
        ...
        else if((come_push_stackframe("25obj.nc", 1637, 14),__exception_result_var_b15=parsecmp("neo-c-net",info), come_pop_stackframe(), __exception_result_var_b15)) {
        ...
        else if((come_push_stackframe("25obj.nc", 1645, 15),__exception_result_var_b16=parsecmp("neo-c",info), come_pop_stackframe(), __exception_result_var_b16)) {
            info->p+=strlen("neo-c");
            skip_spaces_and_lf(info);
            gComeC=0;
            __result_obj__0 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value0=create_nothing_node(info))));
        ...
        else if((come_push_stackframe("25obj.nc", 1653, 16),__exception_result_var_b17=parsecmp("c",info), come_pop_stackframe(), __exception_result_var_b17)||(come_push_stackframe("25obj.nc", 1653, 17),__exception_result_var_b18=parsecmp("C",info), come_pop_stackframe(), __exception_result_var_b18)) {
            info->p+=strlen("c");
            skip_spaces_and_lf(info);
            come_c=gComeC;
            gComeC=1;
        ...
        (come_push_stackframe("25obj.nc", 1685, 18),__exception_result_var_b19=expected_next_character(44,info), come_pop_stackframe(), __exception_result_var_b19);
        ...
        while(1) {
            if(strncmp(info->p,"default",strlen("default"))==0) {
                ...
                skip_spaces_and_lf(info);
                (come_push_stackframe("25obj.nc", 1696, 19),__exception_result_var_b20=expected_next_character(58,info), come_pop_stackframe(), __exception_result_var_b20);
                ...
                multiple_assign_var11=(come_push_stackframe("25obj.nc", 1704, 21),__exception_result_var_b22=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,0,0))), come_pop_stackframe(), __exception_result_var_b22);
                ...
                (come_push_stackframe("25obj.nc", 1708, 22),__exception_result_var_b23=expected_next_character(58,info), come_pop_stackframe(), __exception_result_var_b23);
        ...
        (come_push_stackframe("25obj.nc", 1736, 23),__exception_result_var_b24=expected_next_character(40,info), come_pop_stackframe(), __exception_result_var_b24);
        info->in_offsetof=1;
        multiple_assign_var12=(come_push_stackframe("25obj.nc", 1739, 25),__exception_result_var_b26=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,0,0))), come_pop_stackframe(), __exception_result_var_b26);
        ...
        (come_push_stackframe("25obj.nc", 1747, 26),__exception_result_var_b27=expected_next_character(44,info), come_pop_stackframe(), __exception_result_var_b27);
        word_82=(char*)come_increment_ref_count(parse_word(0,info));
        (come_push_stackframe("25obj.nc", 1751, 27),__exception_result_var_b28=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b28);
        ...
        if(is_type_name_flag) {
            multiple_assign_var13=(come_push_stackframe("25obj.nc", 1783, 29),__exception_result_var_b30=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b30);
        ...
        if(is_type_name_flag_93) {
            multiple_assign_var14=(come_push_stackframe("25obj.nc", 1945, 31),__exception_result_var_b32=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b32);
        ...
        if(is_type_name_flag_103) {
            multiple_assign_var15=(come_push_stackframe("25obj.nc", 2000, 33),__exception_result_var_b34=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b34);
...
struct sNode* top_level_v94(char* buf, char* head, int head_sline, struct sInfo* info  )
{
    ...
    if(charp_operator_equals(buf,"using")) {
        if((come_push_stackframe("25obj.nc", 2077, 34),__exception_result_var_b35=parsecmp("neo-c-pthread",info), come_pop_stackframe(), __exception_result_var_b35)) {
            info->p+=strlen("neo-c-pthread");
            skip_spaces_and_lf(info);
            gComePthread=1;
            __result_obj__0 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value0=create_nothing_node(info))));
        ...
        else if((come_push_stackframe("25obj.nc", 2085, 35),__exception_result_var_b36=parsecmp("neo-c-net",info), come_pop_stackframe(), __exception_result_var_b36)) {
            info->p+=strlen("neo-c-net");
            skip_spaces_and_lf(info);
            gComeNet=1;
            __result_obj__0 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value0=create_nothing_node(info))));
        ...
        else if((come_push_stackframe("25obj.nc", 2093, 36),__exception_result_var_b37=parsecmp("neo-c",info), come_pop_stackframe(), __exception_result_var_b37)) {
            info->p+=strlen("neo-c");
            skip_spaces_and_lf(info);
            gComeC=0;
        }
        else if((come_push_stackframe("25obj.nc", 2099, 37),__exception_result_var_b38=parsecmp("c",info), come_pop_stackframe(), __exception_result_var_b38)||(come_push_stackframe("25obj.nc", 2099, 38),__exception_result_var_b39=parsecmp("C",info), come_pop_stackframe(), __exception_result_var_b39)) {
            info->p+=strlen("c");
            skip_spaces_and_lf(info);
            if(*info->p==123) {
                info->p++;
...
;    struct sType* type3  =0;
    ...
    void* __right_value2 = (void*)0;
    struct sNode* __result_obj__0;
    if(!node->terminated(node->_protocol_obj)&&!gComeC&&(come_push_stackframe("25obj.nc", 2136, 39),__exception_result_var_b40=parsecmp("implements",info), come_pop_stackframe(), __exception_result_var_b40)) {
        info->p+=strlen("implements");
        skip_spaces_and_lf(info);
        multiple_assign_var16=(come_push_stackframe("25obj.nc", 2140, 41),__exception_result_var_b42=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,0,0))), come_pop_stackframe(), __exception_result_var_b42);
