...
struct list$1CVALUE$ph* __result_obj__33;
    ...
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_10=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./neo-c.h", 1176, "struct list_item$1CVALUE$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_11=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./neo-c.h", 1186, "struct list_item$1CVALUE$ph*"))));
...
struct sNode* __result_obj__208;
    node=((void*)0);
    skip_spaces_and_lf(info);
    if(    type_name_exp&&(*info->p==95||((*__ctype_b_loc())[(int)((*info->p))]&(unsigned short int)(((((2)<8)?(((1<<(2))<<8)):(((1<<(2))>>8)))))))    ) {
        p=info->p;
        sline=info->sline;
