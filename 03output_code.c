...
char* make_type_name_string(struct sType* type  , struct sInfo* info  , _Bool no_static, _Bool cast_type, _Bool typedef_extended)
{
    ...
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 5, "struct buffer*"))));
...
static struct list$1sType$ph* list$1sType$ph_add(struct list$1sType$ph* self, struct sType* item  )
{
    ...
    if(self->len==0) {
        ...
        litem_19=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/neo-c.h", 966, "struct list_item$1sType$ph*"))));
        ...
        litem_20=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/neo-c.h", 976, "struct list_item$1sType$ph*"))));
...
static struct list$1sNode$ph* list$1sNode$ph_add(struct list$1sNode$ph* self, struct sNode* item)
{
    ...
    if(self->len==0) {
        ...
        litem_21=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "/usr/local/include/neo-c.h", 966, "struct list_item$1sNode$ph*"))));
        ...
        litem_22=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "/usr/local/include/neo-c.h", 976, "struct list_item$1sNode$ph*"))));
...
static struct list$1int$* list$1int$_add(struct list$1int$* self, int item)
{
    ...
    if(self->len==0) {
        ...
        litem_23=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 966, "struct list_item$1int$*"))));
        ...
        litem_24=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 976, "struct list_item$1int$*"))));
...
static struct list$1char$ph* list$1char$ph_add(struct list$1char$ph* self, char* item  )
{
    ...
    if(self->len==0) {
        ...
        litem_25=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 966, "struct list_item$1char$ph*"))));
        ...
        litem_26=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 976, "struct list_item$1char$ph*"))));
...
static struct list$1sType$ph* list$1sType$ph_push_back(struct list$1sType$ph* self, struct sType* item  )
{
    ...
    if(self->len==0) {
        ...
        litem_27=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/neo-c.h", 1051, "struct list_item$1sType$ph*"))));
        ...
        litem_28=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/neo-c.h", 1061, "struct list_item$1sType$ph*"))));
...
char* make_come_type_name_string(struct sType* type  , struct sInfo* info  )
{
    ...
    int i_34;
    int i_35;
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 259, "struct buffer*"))));
    ...
    if(type->mOriginalTypeName&&string_operator_not_equals(type->mOriginalTypeName,"")) {
        buf_30=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 266, "struct buffer*"))));
...
static char* make_lambda_type_name_string(struct sType* type  , char* var_name, struct sInfo* info  )
{
    ...
    struct sType* it_46  ;
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 362, "struct buffer*"))));
...
char* output_lambda_original_type(struct sType* type2  , char* name, struct sInfo* info  )
{
    ...
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 483, "struct buffer*"))));
...
char* make_define_var(struct sType* type  , char* name, struct sInfo* info  , _Bool no_static, _Bool in_typedef)
{
    ...
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 560, "struct buffer*"))));
...
char* make_var_name(struct sType* type  , char* name, struct sInfo* info  , _Bool no_static)
{
    ...
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 683, "struct buffer*"))));
    type2=(struct sType*)come_increment_ref_count(sType_clone(type));
    if(type2->mArrayPointerType) {
        type2->mPointerNum--;
    }
...
char* output_function(struct sFun* fun  , struct sInfo* info  )
{
    ...
    char* name_79;
    char* str_80  ;
    output=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 968, "struct buffer*"))));
    if(fun->mResultType->mResultType) {
        output2=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 970, "struct buffer*"))));
        ...
        base_result_type->mArrayNum=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc(1, sizeof(struct list$1sNode$ph)*(1), "03output_code.nc", 1020, "struct list$1sNode$ph*"))));
...
char* header_function(struct sFun* fun  , struct sInfo* info  )
{
    ...
    char* name_91;
    char* str_92  ;
    output=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 1144, "struct buffer*"))));
    if(fun->mResultType->mResultType) {
        output2=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 1147, "struct buffer*"))));
        buffer_append_str(output2,fun->mName);
        buffer_append_str(output2,"(");
        i=0;
        for(o2_saved=(struct list$1sType$ph*)come_increment_ref_count(fun->mParamTypes),it=list$1sType$ph_begin(o2_saved);!list$1sType$ph_end(o2_saved);it=list$1sType$ph_next(o2_saved)){
        ...
        base_result_type->mArrayNum=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc(1, sizeof(struct list$1sNode$ph)*(1), "03output_code.nc", 1184, "struct list$1sNode$ph*"))));
...
static char* header_lambda(struct sType* lambda_type  , char* name  , struct sInfo* info  )
{
    ...
    char* __result_obj__0  ;
    output=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "03output_code.nc", 1286, "struct buffer*"))));
...
_Bool output_source_file(struct sInfo* info  )
{
    ...
    struct map$2char$phbuffer$ph* o2_saved_120;
    char* it_121  ;
    struct buffer* buf_122  ;
    struct map$2char$phbuffer$ph* o2_saved_123;
    char* it_124  ;
    struct buffer* buf_125  ;
    struct map$2char$phsFun$ph* o2_saved_126;
    char* it_127  ;
    struct sFun* it2_128  ;
    _Bool contained_generics;
    char* header  ;
    struct map$2char$phchar$ph* o2_saved_129;
    char* it_131  ;
    char* str;
    struct map$2char$phsFun$ph* o2_saved_134;
    char* it_135  ;
    struct sFun* it2_136  ;
    _Bool contained_generics_137;
    char* output  ;
    struct map$2char$phsFun$ph* o2_saved_138;
    char* it_139  ;
    struct sFun* it2_140  ;
    _Bool contained_generics_141;
    char* output_142  ;
    _Bool __result_obj__0;
    ...
    if(f==((void*)0)) {
        (come_push_stackframe("03output_code.nc", 1431, 0),__exception_result_var_b1=die("fopen"), come_pop_stackframe(), __exception_result_var_b1);
    }
    fprintf(f,"/// c_include definition ///\n");
    for(o2_saved_109=(struct map$2char$phbuffer$ph*)come_increment_ref_count(info->c_include_definition),it_111=map$2char$phbuffer$ph_begin(o2_saved_109);!map$2char$phbuffer$ph_end(o2_saved_109);it_111=map$2char$phbuffer$ph_next(o2_saved_109)){
    ...
    for(o2_saved_114=(struct map$2char$phbuffer$ph*)come_increment_ref_count(info->typedef_definition),it_115=map$2char$phbuffer$ph_begin(o2_saved_114);!map$2char$phbuffer$ph_end(o2_saved_114);it_115=map$2char$phbuffer$ph_next(o2_saved_114)){
        buf_116=((struct buffer*)(__right_value2=map$2char$phbuffer$ph_operator_load_element(info->typedef_definition,((char*)(__right_value1=__builtin_string(it_115))))));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    for(o2_saved_117=(struct map$2char$phbuffer$ph*)come_increment_ref_count(info->previous_struct_definition),it_118=map$2char$phbuffer$ph_begin(o2_saved_117);!map$2char$phbuffer$ph_end(o2_saved_117);it_118=map$2char$phbuffer$ph_next(o2_saved_117)){
        buf_119=((struct buffer*)(__right_value2=map$2char$phbuffer$ph_operator_load_element(info->previous_struct_definition,((char*)(__right_value1=__builtin_string(it_118))))));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    for(o2_saved_120=(struct map$2char$phbuffer$ph*)come_increment_ref_count(info->struct_definition),it_121=map$2char$phbuffer$ph_begin(o2_saved_120);!map$2char$phbuffer$ph_end(o2_saved_120);it_121=map$2char$phbuffer$ph_next(o2_saved_120)){
    ...
    come_call_finalizer(map$2char$phbuffer$ph$p_finalize, o2_saved_120, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    fprintf(f,"/// variable definition ///\n");
    for(o2_saved_123=(struct map$2char$phbuffer$ph*)come_increment_ref_count(info->var_definition),it_124=map$2char$phbuffer$ph_begin(o2_saved_123);!map$2char$phbuffer$ph_end(o2_saved_123);it_124=map$2char$phbuffer$ph_next(o2_saved_123)){
        buf_125=((struct buffer*)(__right_value2=map$2char$phbuffer$ph_operator_load_element(info->var_definition,((char*)(__right_value1=__builtin_string(it_124))))));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
        fprintf(f,"%s\n",((char*)(__right_value0=buffer_to_string(buf_125))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    come_call_finalizer(map$2char$phbuffer$ph$p_finalize, o2_saved_123, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    fprintf(f,"// source head\n");
    fprintf(f,"%s\n",((char*)(__right_value0=buffer_to_string(info->module->mSourceHead))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    fprintf(f,"// header function\n");
    for(o2_saved_126=(struct map$2char$phsFun$ph*)come_increment_ref_count(info->funcs),it_127=map$2char$phsFun$ph_begin(o2_saved_126);!map$2char$phsFun$ph_end(o2_saved_126);it_127=map$2char$phsFun$ph_next(o2_saved_126)){
        ...
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
        contained_generics=is_contained_generics_funcstion(it2_128,info);
        if(!contained_generics) {
            header=(char*)come_increment_ref_count(header_function(it2_128,info));
            if(it2_128->mInline) {
            }
            else if(string_operator_not_equals(it_127,"__builtin_va_start")&&string_operator_not_equals(it_127,"__builtin_va_end")) {
                fprintf(f,"%s",header);
            }
            (header = come_decrement_ref_count(header, (void*)0, (void*)0, 0, 0, (void*)0));
        }
    }
    come_call_finalizer(map$2char$phsFun$ph$p_finalize, o2_saved_126, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    fprintf(f,"// uniq global variable\n");
    if(main_module) {
        for(o2_saved_129=(struct map$2char$phchar$ph*)come_increment_ref_count(info->uniq_definition),it_131=map$2char$phchar$ph_begin(o2_saved_129);!map$2char$phchar$ph_end(o2_saved_129);it_131=map$2char$phchar$ph_next(o2_saved_129)){
            str=((char*)(__right_value2=map$2char$phchar$ph_operator_load_element(info->uniq_definition,((char*)(__right_value1=__builtin_string(it_131))))));
            (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
            fprintf(f,"%s\n",str);
        }
        come_call_finalizer(map$2char$phchar$ph$p_finalize, o2_saved_129, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    fprintf(f,"// inline function\n");
    for(o2_saved_134=(struct map$2char$phsFun$ph*)come_increment_ref_count(info->funcs),it_135=map$2char$phsFun$ph_begin(o2_saved_134);!map$2char$phsFun$ph_end(o2_saved_134);it_135=map$2char$phsFun$ph_next(o2_saved_134)){
        it2_136=((struct sFun*)(__right_value2=map$2char$phsFun$ph_operator_load_element(info->funcs,((char*)(__right_value1=__builtin_string(it_135))))));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
        contained_generics_137=is_contained_generics_funcstion(it2_136,info);
        if(contained_generics_137) {
        }
        else if(it2_136->mInline) {
            output=(char*)come_increment_ref_count(output_function(it2_136,info));
            fprintf(f,"%s",output);
    ...
    for(o2_saved_138=(struct map$2char$phsFun$ph*)come_increment_ref_count(info->funcs),it_139=map$2char$phsFun$ph_begin(o2_saved_138);!map$2char$phsFun$ph_end(o2_saved_138);it_139=map$2char$phsFun$ph_next(o2_saved_138)){
        it2_140=((struct sFun*)(__right_value2=map$2char$phsFun$ph_operator_load_element(info->funcs,((char*)(__right_value1=__builtin_string(it_139))))));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
        contained_generics_141=is_contained_generics_funcstion(it2_140,info);
        if(contained_generics_141) {
        }
        else if(it2_140->mExternal) {
        }
        else if(!main_module&&it2_140->mUniq) {
        }
        else if(it2_140->mInline) {
        }
        else {
            output_142=(char*)come_increment_ref_count(output_function(it2_140,info));
            fprintf(f,"%s",output_142);
            fprintf(f,"\n");
            (output_142 = come_decrement_ref_count(output_142, (void*)0, (void*)0, 0, 0, (void*)0));
        }
    }
    come_call_finalizer(map$2char$phsFun$ph$p_finalize, o2_saved_138, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    fclose(f);
    __result_obj__0 = 1;
...
static void map$2char$phsFun$ph_rehash(struct map$2char$phsFun$ph* self)
{
    ...
    items=(struct sFun**)come_increment_ref_count(((struct sFun**)(__right_value0=(struct sFun**)come_calloc(1, sizeof(struct sFun*)*(1*(size)), "/usr/local/include/neo-c.h", 2208, "struct sFun**"))));
    ...
    for(it=map$2char$phsFun$ph_begin(self);!map$2char$phsFun$ph_end(self);it=map$2char$phsFun$ph_next(self)){
        ...
        while(1) {
            if(item_existance[n]) {
                ...
                items[n]=((struct sFun*)(__right_value0=map$2char$phsFun$ph_at(self,it,(struct sFun*)come_increment_ref_count(default_value_97),0)));
                len++;
...
static struct list$1char$ph* list$1char$ph_push_back(struct list$1char$ph* self, char* item  )
{
    ...
    if(self->len==0) {
        ...
        litem_106=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1051, "struct list_item$1char$ph*"))));
        litem_106->prev=self->head;
        litem_106->next=((void*)0);
        __dec_obj48=litem_106->item,
        ...
        litem_107=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1061, "struct list_item$1char$ph*"))));
    ...
    if(head==0&&tail==self->len) {
        ...
        while(it_143!=((void*)0)) {
            ...
            if(i_144>=head) {
                ...
                it_143=it_143->next;
                i_144++;
                come_call_finalizer(list_item$1CVALUE$ph$p_finalize, prev_it_145, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                self->len--;
            }
            else {
                it_143=it_143->next;
        ...
        while(it_146!=((void*)0)) {
            ...
            if(i_147>=head&&i_147<tail) {
                ...
                it_146=it_146->next;
                i_147++;
                come_call_finalizer(list_item$1CVALUE$ph$p_finalize, prev_it_148, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                self->len--;
            }
            else {
                it_146=it_146->next;
...
static struct CVALUE* list$1CVALUE$ph$p_operator_load_element(struct list$1CVALUE$ph* self, int position)
{
    ...
    struct list_item$1CVALUE$ph* it;
    int i;
    struct CVALUE* default_value_149  ;
    if(self==((void*)0)) {
    ...
    memset(&default_value_149,0,sizeof(struct CVALUE*));
    __result_obj__0 = (struct CVALUE*)come_increment_ref_count(default_value_149);
    come_call_finalizer(CVALUE_finalize, default_value_149, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(CVALUE_finalize, __result_obj__0, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__0;
}
