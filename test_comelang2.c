...
void method_block1_codetestcomelang2nc(struct __current_stack1__* parent, int it);
static void anonymous_typeX29_finalize(struct anonymous_typeX29* self);
void stackframe();
...
int main(int argc, char** argv)
{
    ...
    # 11 "code/test_comelang2.nc"
    # 15 "code/test_comelang2.nc"
    const int xxx[]={
        1, 2, 3
    };
    # 19 "code/test_comelang2.nc"
    int yyy[3]={
        4, 5, 6
    };
    # 25 "code/test_comelang2.nc"
    int xyz[3][3]={
        1, 2, 3,
        4, 5, 6,
        7, 8, 9
    };
    # 27 "code/test_comelang2.nc"
    aaa.aaa=123;
    # 28 "code/test_comelang2.nc"
    aaa.ccc.bbb=567;
    # 29 "code/test_comelang2.nc"
    printf("%d\n",aaa.ccc.bbb);
    # 39 "code/test_comelang2.nc"
    ({    __current_stack1__.argc = &argc;
    __current_stack1__.argv = &argv;
    __current_stack1__.aaa = &aaa;
    __current_stack1__.xxx = &xxx;
    __current_stack1__.yyy = &yyy;
    __current_stack1__.xyz = &xyz;
    })    ,    int_times(3,&__current_stack1__,(void*)method_block1_codetestcomelang2nc);
    # 39 "code/test_comelang2.nc"
    printf("%d\n",xyz[1][0]);
    # 41 "code/test_comelang2.nc"
        __result_obj__0 = 0;
    come_call_finalizer(anonymous_typeX29_finalize, (&aaa), (void*)0, (void*)0, 1, 0, 0, (void*)0, "code/test_comelang2.nc}", 41, 1);
...
void method_block1_codetestcomelang2nc(struct __current_stack1__* parent, int it)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "method_block1_codetestcomelang2nc"; neo_current_frame = &fr;
    # 33 "code/test_comelang2.nc"
    printf("%d %d\n",(*(parent->aaa)).aaa,(*(parent->aaa)).ccc.bbb);
    # 34 "code/test_comelang2.nc"
    printf("%d %d %d\n",(*(parent->xxx))[0],(*(parent->xxx))[1],(*(parent->xxx))[2]);
    # 35 "code/test_comelang2.nc"
    printf("%d %d %d\n",(*(parent->yyy))[0],(*(parent->yyy))[1],(*(parent->yyy))[2]);
    # 36 "code/test_comelang2.nc"
    printf("%d %d %d\n",(*(parent->xyz))[1][0],(*(parent->xyz))[1][1],(*(parent->xyz))[1][2]);
    # 37 "code/test_comelang2.nc"
    (*(parent->xyz))[1][0]=777;
        neo_current_frame = fr.prev;
}
...
static void anonymous_typeX29_finalize(struct anonymous_typeX29* self)
{
    struct neo_frame fr; fr.stacktop =&fr; fr.prev = neo_current_frame; fr.fun_name = "anonymous_typeX29_finalize"; neo_current_frame = &fr;
    # 1 "anonymous_typeX29_finalize"
        neo_current_frame = fr.prev;
}
