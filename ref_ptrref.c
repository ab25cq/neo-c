...
static struct ref$1int$p* ref$1int$p_initialize(struct ref$1int$p* self, int* (*p)[3], _Bool global_, _Bool heap_, _Bool local_, void* stacktop);
...
int main(int argc, char** argv)
{
    ...
    int __result_obj__0;
    int x[3]={ 111, 222, 333 };
    p=(struct ref$1int$p*)come_increment_ref_count(ref$1int$p_initialize((struct ref$1int$p*)come_increment_ref_count((struct ref$1int$p*)come_calloc(1, sizeof(struct ref$1int$p)*(1), (void*)0, 5, "struct ref$1int$p*")),&x[0],(_Bool)0,(_Bool)0,(_Bool)1,neo_current_frame->stacktop));
        __result_obj__0 = 0;
