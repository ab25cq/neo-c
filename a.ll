...
entry:
  ...
  store i8* bitcast (i32* @fun_n to i8*), i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 331), align 8
  %n = load i32, i32* @fun_n, align 4
  %addtmp = add nsw i32 %n, 1
  store i32 %addtmp, i32* @fun_n, align 4
  %subttmp = sub nsw i32 %addtmp, 1
  %n2 = load i32, i32* @fun_n, align 4
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @global_string, i32 0, i32 0), i32 %n2)
...
entry:
  ...
  %3 = bitcast [10 x i32]* %a to i32*
  %b = alloca i32*
  %4 = bitcast i32** %b to i8*
  store i8* %4, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 332), align 8
  store i32* %3, i32** %b, align 8
  %5 = bitcast [10 x i32]* %a to i32*
  %element_addressC = getelementptr i32, i32* %5, i32 0
  store i32 123, i32* %element_addressC, align 4
  %6 = bitcast [10 x i32]* %a to i32*
  %element_addressC2 = getelementptr i32, i32* %6, i32 1
  store i32 234, i32* %element_addressC2, align 4
  %b3 = load i32*, i32** %b, align 8
  %derefference_value = load i32, i32* %b3, align 8
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @global_string.1, i32 0, i32 0), i32 %derefference_value)
  %b4 = load i32*, i32** %b, align 8
  %8 = ptrtoint i32* %b4 to i64
  %addtmp = add nsw i64 %8, 4
  %intToPtr2 = inttoptr i64 %addtmp to i32*
  %derefference_value5 = load i32, i32* %intToPtr2, align 8
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @global_string.2, i32 0, i32 0), i32 %derefference_value5)
  call void @fun()
  call void @fun()
...
!1 = !DIFile(filename: "a.nc", directory: "/home/ab25cq/repo/neo-c")
!2 = !{}
