...
static char** ref$1char$pp_unwrap(struct ref$1char$pp* self);
void stackframe();
...
int main(int argc, char** argv)
{
    ...
    rs=(struct ref$1char$pp*)come_increment_ref_count(ref$1char$pp_initialize((struct ref$1char$pp*)come_increment_ref_count((struct ref$1char$pp*)come_calloc(1, sizeof(struct ref$1char$pp)*(1), "/tmp/ref_string_test3.nc", 9, "struct ref$1char$pp*")),&s,(_Bool)0,(_Bool)1,(_Bool)0,neo_current_frame->stacktop));
    rc=(struct ref$1char$pp*)come_increment_ref_count(rs);
    printf("%s %s\n",ref$1char$pp_unwrap(rs),ref$1char$pp_unwrap(rc));
        __result_obj__0 = 0;
