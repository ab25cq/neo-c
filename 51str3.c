                ...
                switch (                *info->p) {
                    ...
                    case 88:
                    {
                        ...
                        while(*info->p>=48&&*info->p<=57||*info->p>=97&&*info->p<=102||*info->p>=65&&*info->p<=70) {
                            ...
                            ({ long long __neo_array_index9_0 = (long long)(0); if(__neo_array_index9_0 < 0 || __neo_array_index9_0 >= (long long)(2)) { extern void stackframe(void) __attribute__((weak)); extern void exit(int); puts("array index out of bounds"); if(stackframe) stackframe(); else { puts("stackframe"); puts(__func__); } exit(2); } buf2[__neo_array_index9_0] = *info->p; });
                            ({ long long __neo_array_index10_0 = (long long)(1); if(__neo_array_index10_0 < 0 || __neo_array_index10_0 >= (long long)(2)) { extern void stackframe(void) __attribute__((weak)); extern void exit(int); puts("array index out of bounds"); if(stackframe) stackframe(); else { puts("stackframe"); puts(__func__); } exit(2); } buf2[__neo_array_index10_0] = 0; });
                            info->p++;
        ...
        if(*info->p==92) {
            ...
            if(p2>127) {
                ...
                if(size_64>6) {
                    ...
                    ({ long long __neo_array_index11_0 = (long long)(size_64); if(__neo_array_index11_0 < 0 || __neo_array_index11_0 >= (long long)(6+1)) { extern void stackframe(void) __attribute__((weak)); extern void exit(int); puts("array index out of bounds"); if(stackframe) stackframe(); else { puts("stackframe"); puts(__func__); } exit(2); } str[__neo_array_index11_0] = 0; });
...
static struct list$1sNode$ph* list$1sNode$ph_push_back(struct list$1sNode$ph* self, struct sNode* item)
{
    ...
    if(self==((void*)0)) {
                __result_obj__0 = self;
        ((item) ? item = come_decrement_ref_count(item, ((struct sNode*)item)->finalize, ((struct sNode*)item)->_protocol_obj, 0, 0,(void*)0, "./neo-c.h", 1674, 361):(void*)0);
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(self->len==0) {
        litem=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./neo-c.h", 1678, 362, "struct list_item$1sNode$ph*"))), "./neo-c.h", 1678, 363);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        __dec_obj9=litem->item,
        litem->item=(struct sNode*)come_increment_ref_count(item, "./neo-c.h", 1682, 365);
        (__dec_obj9 ? __dec_obj9 = come_decrement_ref_count(__dec_obj9, ((struct sNode*)__dec_obj9)->finalize, ((struct sNode*)__dec_obj9)->_protocol_obj, 0,0, (void*)0, "./neo-c.h", 1682, 364) :0);
        self->tail=litem;
        self->head=litem;
    }
    else if(self->len==1) {
        __right_value0 = (void*)0;
        litem_86=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./neo-c.h", 1688, 366, "struct list_item$1sNode$ph*"))), "./neo-c.h", 1688, 367);
        litem_86->prev=self->head;
        litem_86->next=((void*)0);
        __dec_obj10=litem_86->item,
        litem_86->item=(struct sNode*)come_increment_ref_count(item, "./neo-c.h", 1692, 369);
        (__dec_obj10 ? __dec_obj10 = come_decrement_ref_count(__dec_obj10, ((struct sNode*)__dec_obj10)->finalize, ((struct sNode*)__dec_obj10)->_protocol_obj, 0,0, (void*)0, "./neo-c.h", 1692, 368) :0);
        self->tail=litem_86;
        self->head->next=litem_86;
    }
    else {
        __right_value0 = (void*)0;
        litem_87=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./neo-c.h", 1698, 370, "struct list_item$1sNode$ph*"))), "./neo-c.h", 1698, 371);
        litem_87->prev=self->tail;
        litem_87->next=((void*)0);
        __dec_obj11=litem_87->item,
        litem_87->item=(struct sNode*)come_increment_ref_count(item, "./neo-c.h", 1702, 373);
        (__dec_obj11 ? __dec_obj11 = come_decrement_ref_count(__dec_obj11, ((struct sNode*)__dec_obj11)->finalize, ((struct sNode*)__dec_obj11)->_protocol_obj, 0,0, (void*)0, "./neo-c.h", 1702, 372) :0);
        self->tail->next=litem_87;
        self->tail=litem_87;
    }
    self->len++;
        __result_obj__0 = self;
    ((item) ? item = come_decrement_ref_count(item, ((struct sNode*)item)->finalize, ((struct sNode*)item)->_protocol_obj, 0, 0,(void*)0, "./neo-c.h", 1710, 374):(void*)0);
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
...
static struct list$1tuple2$2char$phsNode$ph$ph* list$1tuple2$2char$phsNode$ph$ph_push_back(struct list$1tuple2$2char$phsNode$ph$ph* self, struct tuple2$2char$phsNode$ph* item)
{
    ...
    if(self==((void*)0)) {
                __result_obj__0 = self;
        come_call_finalizer(tuple2$2char$phsNode$ph$p_finalize, item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "./neo-c.h}", 1674, 452);
        neo_current_frame = fr.prev;
        return __result_obj__0;
    }
    if(self->len==0) {
        litem=(struct list_item$1tuple2$2char$phsNode$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2char$phsNode$ph$ph*)(__right_value0=(struct list_item$1tuple2$2char$phsNode$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple2$2char$phsNode$ph$ph)*(1), "./neo-c.h", 1678, 453, "struct list_item$1tuple2$2char$phsNode$ph$ph*"))), "./neo-c.h", 1678, 454);
        litem->prev=((void*)0);
        litem->next=((void*)0);
        __dec_obj14=litem->item,
        litem->item=(struct tuple2$2char$phsNode$ph*)come_increment_ref_count(item, "./neo-c.h", 1682, 456);
        come_call_finalizer(tuple2$2char$phsNode$ph$p_finalize, __dec_obj14,(void*)0, (void*)0, 0, 0, 0, (void*)0, "./neo-c.h", 1682, 455);
        self->tail=litem;
        self->head=litem;
    }
    else if(self->len==1) {
        __right_value0 = (void*)0;
        litem_95=(struct list_item$1tuple2$2char$phsNode$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2char$phsNode$ph$ph*)(__right_value0=(struct list_item$1tuple2$2char$phsNode$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple2$2char$phsNode$ph$ph)*(1), "./neo-c.h", 1688, 457, "struct list_item$1tuple2$2char$phsNode$ph$ph*"))), "./neo-c.h", 1688, 458);
        litem_95->prev=self->head;
        litem_95->next=((void*)0);
        __dec_obj15=litem_95->item,
        litem_95->item=(struct tuple2$2char$phsNode$ph*)come_increment_ref_count(item, "./neo-c.h", 1692, 460);
        come_call_finalizer(tuple2$2char$phsNode$ph$p_finalize, __dec_obj15,(void*)0, (void*)0, 0, 0, 0, (void*)0, "./neo-c.h", 1692, 459);
        self->tail=litem_95;
        self->head->next=litem_95;
    }
    else {
        __right_value0 = (void*)0;
        litem_96=(struct list_item$1tuple2$2char$phsNode$ph$ph*)come_increment_ref_count(((struct list_item$1tuple2$2char$phsNode$ph$ph*)(__right_value0=(struct list_item$1tuple2$2char$phsNode$ph$ph*)come_calloc(1, sizeof(struct list_item$1tuple2$2char$phsNode$ph$ph)*(1), "./neo-c.h", 1698, 461, "struct list_item$1tuple2$2char$phsNode$ph$ph*"))), "./neo-c.h", 1698, 462);
        litem_96->prev=self->tail;
        litem_96->next=((void*)0);
        __dec_obj16=litem_96->item,
        litem_96->item=(struct tuple2$2char$phsNode$ph*)come_increment_ref_count(item, "./neo-c.h", 1702, 464);
        come_call_finalizer(tuple2$2char$phsNode$ph$p_finalize, __dec_obj16,(void*)0, (void*)0, 0, 0, 0, (void*)0, "./neo-c.h", 1702, 463);
        self->tail->next=litem_96;
        self->tail=litem_96;
    }
    self->len++;
        __result_obj__0 = self;
    come_call_finalizer(tuple2$2char$phsNode$ph$p_finalize, item, (void*)0, (void*)0, 0, 0, 0, (void*)0, "./neo-c.h}", 1710, 465);
    neo_current_frame = fr.prev;
    return __result_obj__0;
}
