...
_conditional_value_X0;})) {
    ...
    if(*info->p==58) {
        ...
        multiple_assign_var2=(come_push_stackframe("21enum.nc", 141, 1),__exception_result_var_b2=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b2);
    ...
    (come_push_stackframe("21enum.nc", 146, 2),__exception_result_var_b3=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b3);
...
;    struct sType* type_33  =0;
    ...
    if(charp_operator_equals(buf,"enum")) {
        ...
        if(*info->p==58) {
            info->p++;
            skip_spaces_and_lf(info);
            multiple_assign_var3=(come_push_stackframe("21enum.nc", 218, 4),__exception_result_var_b5=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b5);
        ...
        if(*info->p==123) {
            ...
            if(*info->p==58) {
                info->p++;
                skip_spaces_and_lf(info);
                multiple_assign_var4=(come_push_stackframe("21enum.nc", 238, 6),__exception_result_var_b7=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b7);
        ...
        ((char*)(__right_value0=parse_struct_attribute(info)));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (come_push_stackframe("21enum.nc", 245, 7),__exception_result_var_b8=expected_next_character(123,info), come_pop_stackframe(), __exception_result_var_b8);
        ((char*)(__right_value0=parse_struct_attribute(info)));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
