...
unsigned int* __builtin_wstring(char* str)
{
    ...
    len=strlen(str);
    wstr=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc_v2(1, sizeof(unsigned int)*(1*(len+1)), "./neo-c.h", 6583, "unsigned int*"));
...
unsigned int* wchar_tp_substring(unsigned int* str, int head, int tail)
{
    ...
    result=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc_v2(1, sizeof(unsigned int)*(1*(tail-head+1)), "./neo-c.h", 6685, "unsigned int*"));
...
unsigned int* wchar_tp_reverse(unsigned int* str)
{
    ...
    len=wcslen(str);
    result=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc_v2(1, sizeof(unsigned int)*(1*(len+1)), "./neo-c.h", 6927, "unsigned int*"));
    for(i=0;i<len;i++){
        result[i]=str[len-i-1];
    }
    result[len]=0;
...
unsigned int* wchar_tp_multiply(unsigned int* str, int n)
{
    ...
    len=wcslen(str)*n+1;
    result=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc_v2(1, sizeof(unsigned int)*(1*(len)), "./neo-c.h", 6946, "unsigned int*"));
    result[0]=0;
    for(i=0;i<n;i++){
        wcscat(result,str);
    }
...
unsigned int* wchar_tp_printable(unsigned int* str)
{
    ...
    result=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc_v2(1, sizeof(unsigned int)*(1*(len*2+1)), "./neo-c.h", 6963, "unsigned int*"));
    n=0;
    for(i=0;i<len;i++){
        c=str[i];
        if((c>=0&&c<32)||c==127) {
...
unsigned int* wchar_tp_operator_add(unsigned int* left, unsigned int* right)
{
    ...
    result=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc_v2(1, sizeof(unsigned int)*(1*(wcslen(left)+wcslen(right)+1)), "./neo-c.h", 7071, "unsigned int*"));
    wcscpy(result,left);
    wcscat(result,right);
    __result_obj__0 = (unsigned int*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
unsigned int* wstring_operator_add(unsigned int* left, unsigned int* right)
{
    ...
    result=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc_v2(1, sizeof(unsigned int)*(1*(wcslen(left)+wcslen(right)+1)), "./neo-c.h", 7084, "unsigned int*"));
    wcscpy(result,left);
    wcscat(result,right);
    __result_obj__0 = (unsigned int*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
