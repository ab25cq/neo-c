...
void come_heap_final(){
/*a*/struct sMemHeader* it;
/*a*/int n;
/*a*/_Bool flag;
/*a*/int i;
/*a*/struct sMemHeaderTiny* it_0;
/*a*/int n_1;
/*a*/int i_2;
    if(    gComeStackFrameBuffer    ) {
        free(gComeStackFrameBuffer);
...
void* alloc_from_pages(unsigned long  int size){
/*a*/void* result;
/*a*/unsigned long  int free_area;
/*a*/int new_size_pages;
/*a*/char** new_pages;
/*a*/int i;
...
void come_free_mem_of_heap_pool(void* mem){
/*a*/struct sMemHeader* it;
/*a*/struct sMemHeader* prev_it;
/*a*/struct sMemHeader* next_it;
/*a*/unsigned long  int size;
/*a*/struct sMemHeaderTiny* it_3;
/*a*/struct sMemHeaderTiny* prev_it_4;
/*a*/struct sMemHeaderTiny* next_it_5;
/*a*/unsigned long  int size_6;
    if(    mem    ) {
        if(        gComeDebugLib        ) {
...
void* come_calloc(unsigned long  int count, unsigned long  int size, char* sname, int sline, char* class_name){
/*a*/char* mem;
/*a*/unsigned long  int* ref_count;
/*a*/unsigned long  int* size2;
...
/*a*/unsigned long  int* ref_count;
/*a*/unsigned long  int count;
/*a*/void (*finalizer)(void*);
...
void come_call_finalizer(void* fun, void* mem, void* protocol_fun, void* protocol_obj, int call_finalizer_only, int no_decrement, int no_free, void* result_obj){
/*a*/void (*finalizer)(void*);
/*a*/void (*finalizer_12)(void*);
/*a*/void (*finalizer_13)(void*);
/*a*/unsigned long  int* ref_count;
/*a*/unsigned long  int count;
/*a*/void (*finalizer_14)(void*);
/*a*/void (*finalizer_15)(void*);
/*a*/void (*finalizer_16)(void*);
    if(    result_obj    ) {
        if(        mem==result_obj        ) {
            return;
        }
...
char* __result_obj__20;
    ...
    len=strlen(str)+1;
    result=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len)), "/usr/local/include/neo-c.h", 952, "char*"));
...
struct buffer* __result_obj__23;
    self->size=128;
    __dec_obj1=self->buf,
    self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/neo-c.h", 2997, "char*"));
...
struct buffer* __result_obj__24;
    self->size=128;
    __dec_obj2=self->buf,
    self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/neo-c.h", 3007, "char*"));
...
struct buffer* __result_obj__26;
    ...
    result=(struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 3027, "struct buffer*"));
    result->size=self->size;
    __right_value0 = (void*)0;
    __dec_obj3=result->buf,
    result->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/neo-c.h", 3030, "char*"));
...
struct buffer* __result_obj__29;
    ...
    if(    self->len+size+1+1>=self->size    ) {
        old_buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/neo-c.h", 3078, "char*"));
        memcpy(old_buf,self->buf,self->size);
        old_len=self->len;
        new_size=(self->size+size+1)*2;
        __right_value0 = (void*)0;
        __dec_obj4=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size)), "/usr/local/include/neo-c.h", 3082, "char*"));
...
struct buffer* __result_obj__31;
    ...
    if(    self->len+1+1+1>=self->size    ) {
        old_buf=(char*)come_increment_ref_count((char*)come_memdup(self->buf, "/usr/local/include/neo-c.h", 3101, "char*"));
        old_len=self->len;
        new_size=(self->size+10+1)*2;
        __right_value0 = (void*)0;
        __dec_obj5=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size)), "/usr/local/include/neo-c.h", 3105, "char*"));
...
struct buffer* __result_obj__33;
    ...
    size=strlen(mem);
    if(    self->len+size+1+1>=self->size    ) {
        old_buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/neo-c.h", 3127, "char*"));
        memcpy(old_buf,self->buf,self->size);
        old_len=self->len;
        new_size=(self->size+size+1)*2;
        __right_value0 = (void*)0;
        __dec_obj6=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size)), "/usr/local/include/neo-c.h", 3131, "char*"));
...
memset(&result, 0, sizeof(result));
    ...
    if(    self->len+size+1+1>=self->size    ) {
        __right_value0 = (void*)0;
        old_buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/neo-c.h", 3175, "char*"));
        memcpy(old_buf,self->buf,self->size);
        old_len=self->len;
        new_size=(self->size+size+1)*2;
        __right_value0 = (void*)0;
        __dec_obj7=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size)), "/usr/local/include/neo-c.h", 3179, "char*"));
...
struct buffer* __result_obj__38;
    ...
    if(    self->len+size+1+1+1>=self->size    ) {
        old_buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/neo-c.h", 3201, "char*"));
        memcpy(old_buf,self->buf,self->size);
        old_len=self->len;
        new_size=(self->size+size+1)*2;
        __right_value0 = (void*)0;
        __dec_obj8=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size)), "/usr/local/include/neo-c.h", 3205, "char*"));
...
struct buffer* __result_obj__40;
    ...
    size=sizeof(int);
    if(    self->len+size+1+1>=self->size    ) {
        old_buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/neo-c.h", 3228, "char*"));
        memcpy(old_buf,self->buf,self->size);
        old_len=self->len;
        new_size=(self->size+size+1)*2;
        __right_value0 = (void*)0;
        __dec_obj9=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size)), "/usr/local/include/neo-c.h", 3232, "char*"));
...
struct buffer* __result_obj__41;
    ...
    size=sizeof(long);
    if(    self->len+size+1+1>=self->size    ) {
        old_buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/neo-c.h", 3251, "char*"));
        memcpy(old_buf,self->buf,self->size);
        old_len=self->len;
        new_size=(self->size+size+1)*2;
        __right_value0 = (void*)0;
        __dec_obj10=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size)), "/usr/local/include/neo-c.h", 3255, "char*"));
...
struct buffer* __result_obj__43;
    ...
    size=sizeof(short);
    if(    self->len+size+1+1>=self->size    ) {
        old_buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/neo-c.h", 3278, "char*"));
        memcpy(old_buf,self->buf,self->size);
        old_len=self->len;
        new_size=(self->size+size+1)*2;
        __right_value0 = (void*)0;
        __dec_obj11=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size)), "/usr/local/include/neo-c.h", 3282, "char*"));
...
struct buffer* __result_obj__47;
    result=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 3336, "struct buffer*"))));
    if(    self==((void*)0)    ) {
...
struct buffer* __result_obj__51;
    result=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 3363, "struct buffer*"))));
...
struct buffer* __result_obj__53;
    result=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 3379, "struct buffer*"))));
...
char* __result_obj__58;
    len=self->len;
    result=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len*2+1)), "/usr/local/include/neo-c.h", 3415, "char*"));
    n=0;
    for(    i=0    ;    i<len    ;    i++    ){
        c=self->buf[i];
        if(        (c>=0&&c<32)||c==127        ) {
...
static struct list$1char$* list$1char$_push_back(struct list$1char$* self, char item){
void* __right_value0 = (void*)0;
/*a*/struct list_item$1char$* litem;
/*a*/struct list_item$1char$* litem_17;
/*a*/struct list_item$1char$* litem_18;
struct list$1char$* __result_obj__59;
    if(    self->len==0    ) {
        litem=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value0=(struct list_item$1char$*)come_calloc_v2(1, sizeof(struct list_item$1char$)*(1), "/usr/local/include/neo-c.h", 1146, "struct list_item$1char$*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_17=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value0=(struct list_item$1char$*)come_calloc_v2(1, sizeof(struct list_item$1char$)*(1), "/usr/local/include/neo-c.h", 1156, "struct list_item$1char$*"))));
        ...
        __right_value0 = (void*)0;
        litem_18=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value0=(struct list_item$1char$*)come_calloc_v2(1, sizeof(struct list_item$1char$)*(1), "/usr/local/include/neo-c.h", 1166, "struct list_item$1char$*"))));
...
static void list$1char$$p_finalize(struct list$1char$* self){
/*a*/struct list_item$1char$* it;
/*a*/struct list_item$1char$* prev_it;
    it=self->head;
    while(    it!=((void*)0)    ) {
        prev_it=it;
        it=it->next;
...
struct list$1char$* __result_obj__61;
    __result_obj__61 = (struct list$1char$*)come_increment_ref_count(((struct list$1char$*)(__right_value1=list$1char$_initialize_with_values((struct list$1char$*)come_increment_ref_count((struct list$1char$*)come_calloc_v2(1, sizeof(struct list$1char$)*(1), "/usr/local/include/neo-c.h", 3456, "struct list$1char$*")),len,self))));
...
static struct list$1char$p* list$1char$p_push_back(struct list$1char$p* self, char* item){
void* __right_value0 = (void*)0;
/*a*/struct list_item$1char$p* litem;
/*a*/struct list_item$1char$p* litem_19;
/*a*/struct list_item$1char$p* litem_20;
struct list$1char$p* __result_obj__62;
    if(    self->len==0    ) {
        litem=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value0=(struct list_item$1char$p*)come_calloc_v2(1, sizeof(struct list_item$1char$p)*(1), "/usr/local/include/neo-c.h", 1146, "struct list_item$1char$p*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_19=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value0=(struct list_item$1char$p*)come_calloc_v2(1, sizeof(struct list_item$1char$p)*(1), "/usr/local/include/neo-c.h", 1156, "struct list_item$1char$p*"))));
        ...
        __right_value0 = (void*)0;
        litem_20=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value0=(struct list_item$1char$p*)come_calloc_v2(1, sizeof(struct list_item$1char$p)*(1), "/usr/local/include/neo-c.h", 1166, "struct list_item$1char$p*"))));
...
static void list$1char$p$p_finalize(struct list$1char$p* self){
/*a*/struct list_item$1char$p* it;
/*a*/struct list_item$1char$p* prev_it;
    it=self->head;
    while(    it!=((void*)0)    ) {
        prev_it=it;
        it=it->next;
...
static struct list$1short$* list$1short$_push_back(struct list$1short$* self, short item){
void* __right_value0 = (void*)0;
/*a*/struct list_item$1short$* litem;
/*a*/struct list_item$1short$* litem_21;
/*a*/struct list_item$1short$* litem_22;
struct list$1short$* __result_obj__65;
    if(    self->len==0    ) {
        litem=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value0=(struct list_item$1short$*)come_calloc_v2(1, sizeof(struct list_item$1short$)*(1), "/usr/local/include/neo-c.h", 1146, "struct list_item$1short$*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_21=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value0=(struct list_item$1short$*)come_calloc_v2(1, sizeof(struct list_item$1short$)*(1), "/usr/local/include/neo-c.h", 1156, "struct list_item$1short$*"))));
        ...
        __right_value0 = (void*)0;
        litem_22=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value0=(struct list_item$1short$*)come_calloc_v2(1, sizeof(struct list_item$1short$)*(1), "/usr/local/include/neo-c.h", 1166, "struct list_item$1short$*"))));
...
static void list$1short$$p_finalize(struct list$1short$* self){
/*a*/struct list_item$1short$* it;
/*a*/struct list_item$1short$* prev_it;
    it=self->head;
    while(    it!=((void*)0)    ) {
        prev_it=it;
        it=it->next;
...
struct list$1short$* __result_obj__67;
    __result_obj__67 = (struct list$1short$*)come_increment_ref_count(((struct list$1short$*)(__right_value1=list$1short$_initialize_with_values((struct list$1short$*)come_increment_ref_count((struct list$1short$*)come_calloc_v2(1, sizeof(struct list$1short$)*(1), "/usr/local/include/neo-c.h", 3466, "struct list$1short$*")),len,self))));
...
/*a*/struct list_item$1int$* litem_23;
/*a*/struct list_item$1int$* litem_24;
struct list$1int$* __result_obj__68;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_23=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc_v2(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1156, "struct list_item$1int$*"))));
        ...
        __right_value0 = (void*)0;
        litem_24=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc_v2(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1166, "struct list_item$1int$*"))));
...
struct list$1int$* __result_obj__70;
    __result_obj__70 = (struct list$1int$*)come_increment_ref_count(((struct list$1int$*)(__right_value1=list$1int$_initialize_with_values((struct list$1int$*)come_increment_ref_count((struct list$1int$*)come_calloc_v2(1, sizeof(struct list$1int$)*(1), "/usr/local/include/neo-c.h", 3471, "struct list$1int$*")),len,self))));
...
static struct list$1long$* list$1long$_push_back(struct list$1long$* self, long item){
void* __right_value0 = (void*)0;
/*a*/struct list_item$1long$* litem;
/*a*/struct list_item$1long$* litem_25;
/*a*/struct list_item$1long$* litem_26;
struct list$1long$* __result_obj__71;
    if(    self->len==0    ) {
        litem=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value0=(struct list_item$1long$*)come_calloc_v2(1, sizeof(struct list_item$1long$)*(1), "/usr/local/include/neo-c.h", 1146, "struct list_item$1long$*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_25=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value0=(struct list_item$1long$*)come_calloc_v2(1, sizeof(struct list_item$1long$)*(1), "/usr/local/include/neo-c.h", 1156, "struct list_item$1long$*"))));
        ...
        __right_value0 = (void*)0;
        litem_26=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value0=(struct list_item$1long$*)come_calloc_v2(1, sizeof(struct list_item$1long$)*(1), "/usr/local/include/neo-c.h", 1166, "struct list_item$1long$*"))));
...
static void list$1long$$p_finalize(struct list$1long$* self){
/*a*/struct list_item$1long$* it;
/*a*/struct list_item$1long$* prev_it;
    it=self->head;
    while(    it!=((void*)0)    ) {
        prev_it=it;
        it=it->next;
...
struct list$1long$* __result_obj__73;
    __result_obj__73 = (struct list$1long$*)come_increment_ref_count(((struct list$1long$*)(__right_value1=list$1long$_initialize_with_values((struct list$1long$*)come_increment_ref_count((struct list$1long$*)come_calloc_v2(1, sizeof(struct list$1long$)*(1), "/usr/local/include/neo-c.h", 3476, "struct list$1long$*")),len,self))));
...
static struct list$1float$* list$1float$_push_back(struct list$1float$* self, float item){
void* __right_value0 = (void*)0;
/*a*/struct list_item$1float$* litem;
/*a*/struct list_item$1float$* litem_27;
/*a*/struct list_item$1float$* litem_28;
struct list$1float$* __result_obj__74;
    if(    self->len==0    ) {
        litem=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value0=(struct list_item$1float$*)come_calloc_v2(1, sizeof(struct list_item$1float$)*(1), "/usr/local/include/neo-c.h", 1146, "struct list_item$1float$*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_27=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value0=(struct list_item$1float$*)come_calloc_v2(1, sizeof(struct list_item$1float$)*(1), "/usr/local/include/neo-c.h", 1156, "struct list_item$1float$*"))));
        ...
        __right_value0 = (void*)0;
        litem_28=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value0=(struct list_item$1float$*)come_calloc_v2(1, sizeof(struct list_item$1float$)*(1), "/usr/local/include/neo-c.h", 1166, "struct list_item$1float$*"))));
...
static void list$1float$$p_finalize(struct list$1float$* self){
/*a*/struct list_item$1float$* it;
/*a*/struct list_item$1float$* prev_it;
    it=self->head;
    while(    it!=((void*)0)    ) {
        prev_it=it;
        it=it->next;
...
struct list$1float$* __result_obj__76;
    __result_obj__76 = (struct list$1float$*)come_increment_ref_count(((struct list$1float$*)(__right_value1=list$1float$_initialize_with_values((struct list$1float$*)come_increment_ref_count((struct list$1float$*)come_calloc_v2(1, sizeof(struct list$1float$)*(1), "/usr/local/include/neo-c.h", 3481, "struct list$1float$*")),len,self))));
...
static struct list$1double$* list$1double$_push_back(struct list$1double$* self, double item){
void* __right_value0 = (void*)0;
/*a*/struct list_item$1double$* litem;
/*a*/struct list_item$1double$* litem_29;
/*a*/struct list_item$1double$* litem_30;
struct list$1double$* __result_obj__77;
    if(    self->len==0    ) {
        litem=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value0=(struct list_item$1double$*)come_calloc_v2(1, sizeof(struct list_item$1double$)*(1), "/usr/local/include/neo-c.h", 1146, "struct list_item$1double$*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        litem->item=item;
        self->tail=litem;
        ...
        __right_value0 = (void*)0;
        litem_29=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value0=(struct list_item$1double$*)come_calloc_v2(1, sizeof(struct list_item$1double$)*(1), "/usr/local/include/neo-c.h", 1156, "struct list_item$1double$*"))));
        ...
        __right_value0 = (void*)0;
        litem_30=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value0=(struct list_item$1double$*)come_calloc_v2(1, sizeof(struct list_item$1double$)*(1), "/usr/local/include/neo-c.h", 1166, "struct list_item$1double$*"))));
...
static void list$1double$$p_finalize(struct list$1double$* self){
/*a*/struct list_item$1double$* it;
/*a*/struct list_item$1double$* prev_it;
    it=self->head;
    while(    it!=((void*)0)    ) {
        prev_it=it;
        it=it->next;
...
char* __result_obj__81;
    ...
    __right_value0 = (void*)0;
    result=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len+1)), "/usr/local/include/neo-c.h", 3715, "char*"));
...
char* __result_obj__83;
    ...
    len=strlen(self)+strlen(right);
    __right_value0 = (void*)0;
    result=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len+1)), "/usr/local/include/neo-c.h", 3730, "char*"));
    strncpy(result,self,len+1);
    strncat(result,right,len+1);
...
char* __result_obj__85;
    ...
    __right_value0 = (void*)0;
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 3743, "struct buffer*"))));
    for(    i=0    ;    i<right    ;    i++    ){
...
char* __result_obj__87;
    ...
    __right_value0 = (void*)0;
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 3757, "struct buffer*"))));
    for(    i=0    ;    i<right    ;    i++    ){
        buffer_append_str(buf,self);
    }
    __right_value0 = (void*)0;
...
char* __dec_obj13;
/*a*/struct list_item$1char$ph* litem_31;
char* __dec_obj14;
/*a*/struct list_item$1char$ph* litem_32;
char* __dec_obj15;
struct list$1char$ph* __result_obj__114;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_31=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1156, "struct list_item$1char$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_32=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1166, "struct list_item$1char$ph*"))));
...
struct list$1char$ph* __result_obj__115;
    if(    self==((void*)0)    ) {
        __result_obj__113 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 4215, "struct list$1char$ph*"))))));
...
char* __result_obj__119;
    __result_obj__119 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_printable(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__121;
    if(    str==((void*)0)||replace==((void*)0)    ) {
        __result_obj__120 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__result_obj__120 = come_decrement_ref_count(__result_obj__120, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__120;
    }
    __right_value0 = (void*)0;
    result=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 4285, "struct buffer*"))));
    p=self;
    while(    (_Bool)1    ) {
        p2=strstr(p,str);
        if(        p2==((void*)0)        ) {
    ...
    __right_value0 = (void*)0;
    __result_obj__121 = (char*)come_increment_ref_count(((char*)(__right_value0=buffer_to_string(result))));
...
char* __result_obj__125;
    ...
    if(    p<path    ) {
        __right_value0 = (void*)0;
        __result_obj__123 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(path))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        __right_value0 = (void*)0;
        __result_obj__124 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(p+1))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__129;
    ...
    if(    p<path2    ) {
        __right_value0 = (void*)0;
        __result_obj__127 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(path2))));
        ...
        __right_value0 = (void*)0;
        __result_obj__128 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_substring(path2,0,p-path2))));
        (path2 = come_decrement_ref_count(path2, (void*)0, (void*)0, 0, 0, (void*)0));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__133;
    ...
    if(    p<path    ) {
        __right_value0 = (void*)0;
        __result_obj__131 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(path))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        __right_value0 = (void*)0;
        __result_obj__132 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(p+1))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__137;
    if(    self    ) {
        __result_obj__136 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string("true"))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        __right_value0 = (void*)0;
        __result_obj__137 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string("false"))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__138;
    __result_obj__138 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%c",self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__140;
    __result_obj__140 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%d",self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__142;
    __result_obj__142 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%ld",self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__143;
    __result_obj__143 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%f",self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__144;
    __result_obj__144 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%lf",self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int re_matchp(struct re_program* pattern, const char* text, int* matchlength, struct re_capture* captures, int max_captures){
/*a*/struct re_program* program;
/*a*/struct regex_t* start;
        ...
        while(        1        ) {
            ...
            if(            end_33!=0            ) {
                ...
                *matchlength=(int)(end_33-cursor);
                __result_obj__158 = (int)(cursor-text);
                come_call_finalizer(match_context_finalize, (&ctx), (void*)0, (void*)0, 1, 0, 0, (void*)0);
...
/*a*/int pos;
/*a*/struct regex_t* head;
struct re_program* __result_obj__160;
struct re_program* __result_obj__161;
...
memset(&state, 0, sizeof(state));
    ...
    __result_obj__161 = (struct re_program*)&program;
    come_call_finalizer(regex_program_t_finalize, (&program), (void*)0, (void*)0, 1, 0, 0, (void*)0);
    come_call_finalizer(compiler_state_finalize, (&state), (void*)0, (void*)0, 1, 0, 0, (void*)0);
...
/*a*/struct regex_t* current;
/*a*/struct regex_t* next;
/*a*/struct regex_t* owner;
/*a*/int idx;
/*a*/int start;
...
const char* matchgroup(struct regex_t* token, struct regex_t* rest, const char* text, struct anonymous_typeX16* ctx){
/*a*/struct regex_t* end_token;
/*a*/struct regex_t* saved_next;
/*a*/int idx;
...
const char* __result_obj__204;
    ...
    restore_captures(ctx,snapshot_entry);
    __result_obj__204 = matchpattern(rest,text,ctx);
...
const char* __result_obj__225;
    switch (    token->type) {
        case (1):
        __result_obj__212 = (((*text!=0&&matchdot(*text)))?(text+1):(0));
        return __result_obj__212;
        case (7):
        __result_obj__213 = (((*text!=0&&token->u.ch==(unsigned char)*text))?(text+1):(0));
        return __result_obj__213;
        case (8):
        __result_obj__214 = (((*text!=0&&matchcharclass(*text,(const char*)token->u.ccl)))?(text+1):(0));
        return __result_obj__214;
        case (9):
        __result_obj__215 = (((*text!=0&&!matchcharclass(*text,(const char*)token->u.ccl)))?(text+1):(0));
        return __result_obj__215;
        case (10):
        __result_obj__216 = (((*text!=0&&matchdigit(*text)))?(text+1):(0));
        return __result_obj__216;
        case (11):
        __result_obj__217 = (((*text!=0&&!matchdigit(*text)))?(text+1):(0));
        return __result_obj__217;
        case (12):
        __result_obj__218 = (((*text!=0&&matchalphanum(*text)))?(text+1):(0));
        return __result_obj__218;
        case (13):
        __result_obj__219 = (((*text!=0&&!matchalphanum(*text)))?(text+1):(0));
        return __result_obj__219;
        case (14):
        __result_obj__220 = (((*text!=0&&matchwhitespace(*text)))?(text+1):(0));
        return __result_obj__220;
        case (15):
        __result_obj__221 = (((*text!=0&&!matchwhitespace(*text)))?(text+1):(0));
        return __result_obj__221;
        case (16):
        __result_obj__222 = matchgroup(token,(struct regex_t*)0,text,ctx);
...
char* __result_obj__228;
    ...
    if(    result[string_length(result)-1]==10    ) {
        __right_value0 = (void*)0;
        __result_obj__227 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_substring(result,0,-2))));
    ...
    __result_obj__228 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
/*a*/struct list_item$1char$ph* litem;
char* __dec_obj16;
/*a*/struct list_item$1char$ph* litem_40;
char* __dec_obj17;
/*a*/struct list_item$1char$ph* litem_41;
char* __dec_obj18;
struct list$1char$ph* __result_obj__233;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_40=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1078, "struct list_item$1char$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_41=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/neo-c.h", 1088, "struct list_item$1char$ph*"))));
...
/*a*/char* str;
/*a*/int i;
/*a*/struct re_capture cp;
/*a*/char* match_string;
struct list$1char$ph* __result_obj__234;
    if(    reg==((void*)0)||reg==((void*)0)    ) {
        __result_obj__231 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6047, "struct list$1char$ph*"))))));
        come_call_finalizer(list$1char$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    ...
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    result=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6049, "struct list$1char$ph*"))));
    re=re_compile(reg);
    if(    re==((void*)0)    ) {
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __result_obj__232 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6054, "struct list$1char$ph*"))))));
...
struct list$1char$ph* __result_obj__237;
    if(    reg==((void*)0)||reg==((void*)0)    ) {
        __result_obj__235 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6110, "struct list$1char$ph*"))))));
        come_call_finalizer(list$1char$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    ...
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    result=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6113, "struct list$1char$ph*"))));
    re=re_compile(reg);
    if(    re==((void*)0)    ) {
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __result_obj__236 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6118, "struct list$1char$ph*"))))));
        come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer(list$1char$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    ...
    __result_obj__237 = (struct list$1char$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__238;
    __result_obj__238 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_sub(self,reg,replace))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
struct list$1char$ph* __result_obj__239;
    __result_obj__239 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value0=charp_scan(self,reg))));
...
struct list$1char$ph* __result_obj__240;
    __result_obj__240 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value0=charp_split(self,reg))));
    come_call_finalizer(list$1char$ph$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    come_call_finalizer(list$1char$ph$p_finalize, __result_obj__240, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__243;
    ...
    n=0;
    __right_value0 = (void*)0;
    result=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 6203, "struct buffer*"))));
    group_count=re_get_group_count(re);
    while(    (_Bool)1    ) {
        matchlength=0;
        max_captures=8;
...
/*a*/int regex_result;
/*a*/char* str;
/*a*/struct list$1char$ph* group_strings;
/*a*/char* match_string;
/*a*/char* block_result;
/*a*/char* str_44;
/*a*/struct list$1char$ph* group_strings_45;
/*a*/int i;
/*a*/struct re_capture cp;
/*a*/char* match_string_46;
/*a*/char* match_string_47;
/*a*/char* block_result_48;
/*a*/char* str_49;
char* __result_obj__246;
    if(    reg==((void*)0)||reg==((void*)0)    ) {
        __result_obj__244 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__result_obj__244 = come_decrement_ref_count(__result_obj__244, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__244;
    }
    __right_value0 = (void*)0;
    result=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 6245, "struct buffer*"))));
    re=re_compile(reg);
    if(    re==((void*)0)    ) {
        __right_value0 = (void*)0;
    ...
    while(    (_Bool)1    ) {
        ...
        if(        regex_result>=0&&group_count==0        ) {
            ...
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            group_strings=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6272, "struct list$1char$ph*"))));
            __right_value0 = (void*)0;
            ...
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            group_strings_45=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6294, "struct list$1char$ph*"))));
            for(            i=0            ;            i<group_count            ;            i++            ){
                cp=captures[i];
                __right_value0 = (void*)0;
    ...
    __right_value0 = (void*)0;
    __result_obj__246 = (char*)come_increment_ref_count(((char*)(__right_value0=buffer_to_string(result))));
    come_call_finalizer(buffer_finalize, result, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
/*a*/char* match_string;
/*a*/char* block_result;
/*a*/struct list$1char$ph* group_strings_50;
/*a*/int i;
/*a*/struct re_capture cp;
/*a*/char* match_string_51;
/*a*/char* match_string_52;
/*a*/char* block_result_53;
struct list$1char$ph* __result_obj__249;
    if(    reg==((void*)0)||reg==((void*)0)    ) {
        __result_obj__247 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6328, "struct list$1char$ph*"))))));
        come_call_finalizer(list$1char$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    ...
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    result=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6330, "struct list$1char$ph*"))));
    re=re_compile(reg);
    if(    re==((void*)0)    ) {
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __result_obj__248 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6335, "struct list$1char$ph*"))))));
        come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer(list$1char$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    ...
    while(    (_Bool)1    ) {
        ...
        if(        regex_result>=0&&group_count==0        ) {
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            group_strings=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6353, "struct list$1char$ph*"))));
            __right_value0 = (void*)0;
            match_string=(char*)come_increment_ref_count(charp_substring(self,offset+regex_result,offset+regex_result+matchlength));
            __right_value0 = (void*)0;
            block_result=(char*)come_increment_ref_count(block(parent,match_string,group_strings));
            ...
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            group_strings_50=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6370, "struct list$1char$ph*"))));
            for(            i=0            ;            i<group_count            ;            i++            ){
                cp=captures[i];
                __right_value0 = (void*)0;
    ...
    __result_obj__249 = (struct list$1char$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__250;
    __result_obj__250 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_sub_block(self,reg,parent,block))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__252;
    if(    str==((void*)0)    ) {
        __result_obj__251 = (int*)come_increment_ref_count(((void*)0));
        (__result_obj__251 = come_decrement_ref_count(__result_obj__251, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__251;
    }
    len=strlen(str);
    wstr=(int*)come_increment_ref_count((int*)come_calloc_v2(1, sizeof(int)*(1*(len+1)), "/usr/local/include/neo-c.h", 6422, "int*"));
    ret=mbstowcs(wstr,str,len+1);
    wstr[ret]=0;
    if(    ret<0    ) {
        wstr[0]=0;
    }
    __result_obj__252 = (int*)come_increment_ref_count(wstr);
...
char* __result_obj__253;
    ...
    __result_obj__253 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__254;
    ...
    __result_obj__254 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
int* __result_obj__259;
    ...
    if(    head>tail    ) {
        __right_value0 = (void*)0;
        __result_obj__256 = (int*)come_increment_ref_count(((int*)(__right_value0=__builtin_wstring(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    if(    head==tail    ) {
        __right_value0 = (void*)0;
        __result_obj__257 = (int*)come_increment_ref_count(((int*)(__right_value0=__builtin_wstring(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    if(    tail-head+1<1    ) {
        __right_value0 = (void*)0;
        __result_obj__258 = (int*)come_increment_ref_count(((int*)(__right_value0=__builtin_wstring(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__result_obj__258 = come_decrement_ref_count(__result_obj__258, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__258;
    }
    __right_value0 = (void*)0;
    result=(int*)come_increment_ref_count((int*)come_calloc_v2(1, sizeof(int)*(1*(tail-head+1)), "/usr/local/include/neo-c.h", 6513, "int*"));
    memcpy(result,str+head,sizeof(int)*(tail-head));
    result[tail-head]=0;
    __result_obj__259 = (int*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__260;
    ...
    __result_obj__260 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__261;
    len=6*(wcslen(wstr)+1);
    result=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len)), "/usr/local/include/neo-c.h", 6614, "char*"));
    if(    wcstombs(result,wstr,len)<0    ) {
        strncpy(result,"",len);
    }
    __result_obj__261 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__262;
    __result_obj__262 = (char*)come_increment_ref_count(((char*)(__right_value0=wchar_tp_to_string(wstr))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__263;
    __result_obj__263 = (int*)come_increment_ref_count(((int*)(__right_value0=__builtin_wstring(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__264;
    __result_obj__264 = (int*)come_increment_ref_count(((int*)(__right_value0=__builtin_wstring(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__267;
    len=wcslen(str);
    if(    len==0    ) {
        __result_obj__265 = (int*)come_increment_ref_count(((int*)(__right_value1=string_to_wstring(((char*)(__right_value0=wchar_tp_to_string(str)))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    if(    tail<0    ) {
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __result_obj__266 = (int*)come_increment_ref_count(((int*)(__right_value1=string_to_wstring(((char*)(__right_value0=wchar_tp_to_string(str)))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __result_obj__267 = (int*)come_increment_ref_count(((int*)(__right_value1=string_to_wstring(((char*)(__right_value0=wchar_tp_to_string(str)))))));
...
int* __result_obj__268;
    len=wcslen(str);
    result=(int*)come_increment_ref_count((int*)come_calloc_v2(1, sizeof(int)*(1*(len+1)), "/usr/local/include/neo-c.h", 6713, "int*"));
    for(    i=0    ;    i<len    ;    i++    ){
        result[i]=str[len-i-1];
    }
    result[len]=0;
...
int* __result_obj__269;
    len=wcslen(str)*n+1;
    result=(int*)come_increment_ref_count((int*)come_calloc_v2(1, sizeof(int)*(1*(len)), "/usr/local/include/neo-c.h", 6728, "int*"));
    result[0]=0;
    for(    i=0    ;    i<n    ;    i++    ){
        wcscat(result,str);
    }
...
int* __result_obj__270;
    ...
    result=(int*)come_increment_ref_count((int*)come_calloc_v2(1, sizeof(int)*(1*(len*2+1)), "/usr/local/include/neo-c.h", 6742, "int*"));
    n=0;
    for(    i=0    ;    i<len    ;    i++    ){
        c=str[i];
        if(        (c>=0&&c<32)||c==127        ) {
    ...
    result[n]=0;
    __result_obj__270 = (int*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
int* __result_obj__271;
    __result_obj__271 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_multiply(str,n))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__272;
    __result_obj__272 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_multiply(str,n))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__273;
    result=(int*)come_increment_ref_count((int*)come_calloc_v2(1, sizeof(int)*(1*(wcslen(left)+wcslen(right)+1)), "/usr/local/include/neo-c.h", 6815, "int*"));
    wcscpy(result,left);
    wcscat(result,right);
...
int* __result_obj__274;
    result=(int*)come_increment_ref_count((int*)come_calloc_v2(1, sizeof(int)*(1*(wcslen(left)+wcslen(right)+1)), "/usr/local/include/neo-c.h", 6825, "int*"));
    wcscpy(result,left);
    wcscat(result,right);
    __result_obj__274 = (int*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__276;
    len=strlen(self);
    if(    strcmp(self,"")==0    ) {
        __result_obj__275 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    self[index]=c;
    __right_value0 = (void*)0;
    __result_obj__276 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__277;
    len=strlen(str)*n+1;
    result=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len)), "/usr/local/include/neo-c.h", 6876, "char*"));
    result[0]=0;
    for(    i=0    ;    i<n    ;    i++    ){
        strcat(result,str);
    }
    __result_obj__277 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
struct list$1char$ph* __result_obj__278;
    result=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 6892, "struct list$1char$ph*"))));
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 6894, "struct buffer*"))));
    for(    i=0    ;    i<charp_length(self)    ;    i++    ){
    ...
    __result_obj__278 = (struct list$1char$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    come_call_finalizer(list$1char$ph$p_finalize, __result_obj__278, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__279;
    __result_obj__279 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%ls",wc))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__281;
    if(    path==((void*)0)    ) {
        __result_obj__280 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    result2=(char*)come_increment_ref_count(__builtin_string(result));
    free(result);
    __result_obj__281 = (char*)come_increment_ref_count(result2);
    (result2 = come_decrement_ref_count(result2, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__283;
    if(    path==((void*)0)    ) {
        __result_obj__282 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__result_obj__282 = come_decrement_ref_count(__result_obj__282, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__282;
    }
    __right_value0 = (void*)0;
    __result_obj__283 = (char*)come_increment_ref_count(((char*)(__right_value1=__builtin_string(dirname(((char*)(__right_value0=__builtin_string(path))))))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__284;
    __result_obj__284 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_substring(str,head,tail))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__285;
    __result_obj__285 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_strip(self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__286;
    __result_obj__286 = (char*)come_increment_ref_count(((char*)(__right_value0=wchar_tp_to_string(wstr))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__287;
    __result_obj__287 = (int*)come_increment_ref_count(((int*)(__right_value1=string_to_wstring(((char*)(__right_value0=xsprintf("%d",self)))))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__288;
    __result_obj__288 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_delete(str,head,tail))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__289;
    __result_obj__289 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_reverse(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__290;
    __result_obj__290 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_multiply(str,n))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__291;
    __result_obj__291 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_printable(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__292;
    __result_obj__292 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_replace(self,index,c))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__293;
    __result_obj__293 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_multiply(str,n))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
struct list$1char$ph* __result_obj__294;
    __result_obj__294 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value0=charp_split_str(self,str))));
    come_call_finalizer(list$1char$ph$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
...
int* __result_obj__295;
    __result_obj__295 = (int*)come_increment_ref_count(((int*)(__right_value0=charp_to_wstring(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__296;
    __result_obj__296 = (char*)come_increment_ref_count(((char*)(__right_value0=string_chomp(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__298;
    ...
    __right_value0 = (void*)0;
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 7149, "struct buffer*"))));
    while(    1    ) {
        char buf2[1024];
    ...
    __right_value0 = (void*)0;
    __result_obj__298 = (char*)come_increment_ref_count(((char*)(__right_value0=buffer_to_string(buf))));
    come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
struct __sFILE* FILE_fprintf(struct __sFILE* f, const char* msg, ...){
struct __sFILE* __result_obj__299;
__builtin_va_list args;
/*a*/int result;
struct __sFILE* __result_obj__300;
struct __sFILE* __result_obj__301;
...
char* __result_obj__305;
    if(    file_name==((void*)0)    ) {
        __result_obj__302 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    if(    f==((void*)0)    ) {
        __right_value0 = (void*)0;
        __result_obj__303 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__result_obj__303 = come_decrement_ref_count(__result_obj__303, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__303;
    }
    __right_value0 = (void*)0;
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c.h", 7256, "struct buffer*"))));
    while(    1    ) {
        char buf2[1024];
        memset(&buf2, 0, sizeof(buf2));
        size=fread(buf2,1,1024,f);
    ...
    if(    result2<0    ) {
        __right_value0 = (void*)0;
        __result_obj__304 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 0, (void*)0));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    __result_obj__305 = (char*)come_increment_ref_count(result);
    come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
struct list$1char$ph* __result_obj__307;
    result=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 7283, "struct list$1char$ph*"))));
    if(    f==((void*)0)    ) {
        __result_obj__306 = (struct list$1char$ph*)come_increment_ref_count(result);
        come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
        come_call_finalizer(list$1char$ph$p_finalize, __result_obj__306, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    ...
    __result_obj__307 = (struct list$1char$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1char$ph$p_finalize, __result_obj__307, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct list$1tuple2$2char$phsType$ph$ph* __result_obj__308;
    ...
    self->tail=((void*)0);
    self->len=0;
    __result_obj__308 = (struct list$1tuple2$2char$phsType$ph$ph*)come_increment_ref_count(self);
    come_call_finalizer(list$1tuple2$2char$phsType$ph$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1tuple2$2char$phsType$ph$ph$p_finalize, __result_obj__308, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct sClass* __result_obj__309;
    ...
    __result_obj__309 = (struct sClass*)come_increment_ref_count(self);
    ...
    while(    (_Bool)1    ) {
        if(        self->item_existance[it]        ) {
            if(            string_equals(self->keys[it],key)            ) {
                __result_obj__310 = (struct sClass*)come_increment_ref_count(self->items[it]);
            ...
            if(            it>=self->size            ) {
                ...
                __result_obj__311 = (struct sClass*)come_increment_ref_count(default_value);
...
struct sClass* __result_obj__317;
    ...
    while(    (_Bool)1    ) {
        if(        self->item_existance[it]        ) {
            if(            string_equals(self->keys[it],key)            ) {
                __result_obj__314 = (struct sClass*)come_increment_ref_count(self->items[it]);
                come_call_finalizer(sClass_finalize, default_value, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            ...
            __result_obj__316 = (struct sClass*)come_increment_ref_count(default_value);
            come_call_finalizer(sClass_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
            come_call_finalizer(sClass_finalize, __result_obj__316, (void*)0, (void*)0, 0, 0, 1, (void*)0);
            return __result_obj__316;
        }
    }
    __result_obj__317 = (struct sClass*)come_increment_ref_count(default_value);
    come_call_finalizer(sClass_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
/*a*/char* it2;
struct map$2char$phsClass$ph* __result_obj__338;
...
memset(&default_value_56, 0, sizeof(default_value_56));
    size=self->size*10;
...
struct sClass* __result_obj__327;
    ...
    while(    (_Bool)1    ) {
        if(        self->item_existance[it]        ) {
            if(            string_equals(self->keys[it],key)            ) {
                __result_obj__324 = (struct sClass*)come_increment_ref_count(self->items[it]);
                come_call_finalizer(sClass_finalize, default_value, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            ...
            if(            it>=self->size            ) {
                ...
                __result_obj__325 = (struct sClass*)come_increment_ref_count(default_value);
                come_call_finalizer(sClass_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
                come_call_finalizer(sClass_finalize, __result_obj__325, (void*)0, (void*)0, 0, 0, 1, (void*)0);
                return __result_obj__325;
            }
        }
        else {
            __result_obj__326 = (struct sClass*)come_increment_ref_count(default_value);
            come_call_finalizer(sClass_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
            come_call_finalizer(sClass_finalize, __result_obj__326, (void*)0, (void*)0, 0, 0, 1, (void*)0);
            return __result_obj__326;
        }
    }
    __result_obj__327 = (struct sClass*)come_increment_ref_count(default_value);
    come_call_finalizer(sClass_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(sClass_finalize, __result_obj__327, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
/*a*/int i;
/*a*/struct list_item$1char$ph* prev_it;
/*a*/struct list_item$1char$ph* it_57;
/*a*/int i_58;
/*a*/struct list_item$1char$ph* prev_it_59;
/*a*/struct list_item$1char$ph* it_60;
/*a*/struct list_item$1char$ph* head_prev_it;
/*a*/struct list_item$1char$ph* tail_it;
/*a*/int i_61;
/*a*/struct list_item$1char$ph* prev_it_62;
struct list$1char$ph* __result_obj__330;
    if(    head<0    ) {
        head+=self->len;
    }
    if(    tail<0    ) {
...
struct list$1sType$ph* __result_obj__339;
    ...
    self->tail=((void*)0);
    self->len=0;
    __result_obj__339 = (struct list$1sType$ph*)come_increment_ref_count(self);
...
struct list$1sNode$ph* __result_obj__340;
    ...
    self->tail=((void*)0);
    self->len=0;
    __result_obj__340 = (struct list$1sNode$ph*)come_increment_ref_count(self);
    come_call_finalizer(list$1sNode$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1sNode$ph$p_finalize, __result_obj__340, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
static struct list$1int$* list$1int$_initialize(struct list$1int$* self){
struct list$1int$* __result_obj__341;
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
    __result_obj__341 = (struct list$1int$*)come_increment_ref_count(self);
    come_call_finalizer(list$1int$$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1int$$p_finalize, __result_obj__341, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct sType* __result_obj__342;
    ...
    if(    klass    ) {
        ...
        __right_value0 = (void*)0;
        klass2=(struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "./common.h", 202, "struct sClass*"));
        __right_value0 = (void*)0;
    ...
    self->mGenericsTypes=(struct list$1sType$ph*)come_increment_ref_count(list$1sType$ph_initialize((struct list$1sType$ph*)come_increment_ref_count((struct list$1sType$ph*)come_calloc_v2(1, sizeof(struct list$1sType$ph)*(1), "./common.h", 212, "struct list$1sType$ph*"))));
    come_call_finalizer(list$1sType$ph_finalize, __dec_obj24,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj25=self->mArrayNum,
    self->mArrayNum=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc_v2(1, sizeof(struct list$1sNode$ph)*(1), "./common.h", 213, "struct list$1sNode$ph*"))));
    come_call_finalizer(list$1sNode$ph_finalize, __dec_obj25,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj26=self->mVarNameArrayNum,
    self->mVarNameArrayNum=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc_v2(1, sizeof(struct list$1sNode$ph)*(1), "./common.h", 214, "struct list$1sNode$ph*"))));
    come_call_finalizer(list$1sNode$ph_finalize, __dec_obj26,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj27=self->mArrayStatic,
    self->mArrayStatic=(struct list$1int$*)come_increment_ref_count(list$1int$_initialize((struct list$1int$*)come_increment_ref_count((struct list$1int$*)come_calloc_v2(1, sizeof(struct list$1int$)*(1), "./common.h", 215, "struct list$1int$*"))));
    come_call_finalizer(list$1int$_finalize, __dec_obj27,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj28=self->mArrayRestrict,
    self->mArrayRestrict=(struct list$1int$*)come_increment_ref_count(list$1int$_initialize((struct list$1int$*)come_increment_ref_count((struct list$1int$*)come_calloc_v2(1, sizeof(struct list$1int$)*(1), "./common.h", 216, "struct list$1int$*"))));
    come_call_finalizer(list$1int$_finalize, __dec_obj28,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj29=self->mParamTypes,
    self->mParamTypes=(struct list$1sType$ph*)come_increment_ref_count(list$1sType$ph_initialize((struct list$1sType$ph*)come_increment_ref_count((struct list$1sType$ph*)come_calloc_v2(1, sizeof(struct list$1sType$ph)*(1), "./common.h", 217, "struct list$1sType$ph*"))));
    come_call_finalizer(list$1sType$ph_finalize, __dec_obj29,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj30=self->mParamNames,
    self->mParamNames=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "./common.h", 218, "struct list$1char$ph*"))));
    ...
    __result_obj__342 = (struct sType*)come_increment_ref_count(self);
    ...
    come_call_finalizer(sType_finalize, __result_obj__342, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__342;
}

static struct list$1sVar$ph* list$1sVar$ph_initialize(struct list$1sVar$ph* self){
struct list$1sVar$ph* __result_obj__343;
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
    __result_obj__343 = (struct list$1sVar$ph*)come_increment_ref_count(self);
    come_call_finalizer(list$1sVar$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1sVar$ph$p_finalize, __result_obj__343, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct sType* __result_obj__346;
    if(    self==((void*)0)    ) {
...
/*a*/struct list_item$1sType$ph* litem_67;
struct sType* __dec_obj43;
/*a*/struct list_item$1sType$ph* litem_68;
...
struct list$1sType$ph* __result_obj__350;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_67=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/neo-c.h", 1156, "struct list_item$1sType$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_68=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/neo-c.h", 1166, "struct list_item$1sType$ph*"))));
        litem_68->prev=self->tail;
        litem_68->next=((void*)0);
        __dec_obj44=litem_68->item,
...
struct list$1int$* __dec_obj63;
struct list$1int$* __dec_obj64;
...
struct sType* __result_obj__365;
    if(    self==(void*)0    ) {
    ...
    if(    self!=((void*)0)&&self->mArrayStatic!=((void*)0)    ) {
        __right_value0 = (void*)0;
        __dec_obj63=result->mArrayStatic,
        result->mArrayStatic=(struct list$1int$*)come_increment_ref_count(list$1int$$p_clone(self->mArrayStatic));
        come_call_finalizer(list$1int$_finalize, __dec_obj63,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    if(    self!=((void*)0)&&self->mArrayRestrict!=((void*)0)    ) {
        __right_value0 = (void*)0;
        __dec_obj64=result->mArrayRestrict,
        result->mArrayRestrict=(struct list$1int$*)come_increment_ref_count(list$1int$$p_clone(self->mArrayRestrict));
        come_call_finalizer(list$1int$_finalize, __dec_obj64,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    if(    self!=((void*)0)    ) {
    ...
    if(    self!=((void*)0)&&self->mTypedefOriginalType!=((void*)0)    ) {
        __right_value0 = (void*)0;
        __dec_obj65=result->mTypedefOriginalType,
    ...
    if(    self!=((void*)0)&&self->mOriginalTypeName!=((void*)0)    ) {
        __right_value0 = (void*)0;
        __dec_obj66=result->mOriginalTypeName,
    ...
    if(    self!=((void*)0)&&self->mResultType!=((void*)0)    ) {
        __right_value0 = (void*)0;
        __dec_obj69=result->mResultType,
    ...
    if(    self!=((void*)0)&&self->mTypeOfNode!=((void*)0)    ) {
        __right_value0 = (void*)0;
        __dec_obj70=result->mTypeOfNode,
...
/*a*/struct list_item$1sType$ph* it;
struct list$1sType$ph* __result_obj__354;
    if(    self==((void*)0)    ) {
        __result_obj__352 = (struct list$1sType$ph*)come_increment_ref_count(((void*)0));
        come_call_finalizer(list$1sType$ph$p_finalize, __result_obj__352, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    ...
    __result_obj__354 = (struct list$1sType$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1sType$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1sType$ph$p_finalize, __result_obj__354, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
/*a*/struct list_item$1sType$ph* litem_69;
struct sType* __dec_obj48;
/*a*/struct list_item$1sType$ph* litem_70;
...
struct list$1sType$ph* __result_obj__353;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_69=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/neo-c.h", 1078, "struct list_item$1sType$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_70=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/neo-c.h", 1088, "struct list_item$1sType$ph*"))));
...
struct sNode* __result_obj__356;
    if(    self==(void*)0    ) {
        __result_obj__355 = (struct sNode*)come_increment_ref_count((void*)0);
    ...
    __result_obj__356 = (struct sNode*)come_increment_ref_count(result);
...
/*a*/struct list_item$1sNode$ph* it;
struct list$1sNode$ph* __result_obj__359;
    if(    self==((void*)0)    ) {
        __result_obj__357 = (struct list$1sNode$ph*)come_increment_ref_count(((void*)0));
        come_call_finalizer(list$1sNode$ph$p_finalize, __result_obj__357, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    ...
    __result_obj__359 = (struct list$1sNode$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1sNode$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1sNode$ph$p_finalize, __result_obj__359, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
/*a*/struct list_item$1sNode$ph* litem_71;
struct sNode* __dec_obj59;
/*a*/struct list_item$1sNode$ph* litem_72;
struct sNode* __dec_obj60;
struct list$1sNode$ph* __result_obj__358;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_71=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc_v2(1, sizeof(struct list_item$1sNode$ph)*(1), "/usr/local/include/neo-c.h", 1078, "struct list_item$1sNode$ph*"))));
        litem_71->prev=self->head;
        litem_71->next=((void*)0);
        __dec_obj59=litem_71->item,
        ...
        __right_value0 = (void*)0;
        litem_72=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc_v2(1, sizeof(struct list_item$1sNode$ph)*(1), "/usr/local/include/neo-c.h", 1088, "struct list_item$1sNode$ph*"))));
        litem_72->prev=self->tail;
        litem_72->next=((void*)0);
        __dec_obj60=litem_72->item,
...
static struct list$1int$* list$1int$$p_clone(struct list$1int$* self){
struct list$1int$* __result_obj__360;
void* __right_value0 = (void*)0;
void* __right_value1 = (void*)0;
/*a*/struct list$1int$* result;
/*a*/struct list_item$1int$* it;
struct list$1int$* __result_obj__362;
    if(    self==((void*)0)    ) {
        __result_obj__360 = (struct list$1int$*)come_increment_ref_count(((void*)0));
        come_call_finalizer(list$1int$$p_finalize, __result_obj__360, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    ...
    __result_obj__362 = (struct list$1int$*)come_increment_ref_count(result);
    come_call_finalizer(list$1int$$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1int$$p_finalize, __result_obj__362, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
void* __right_value0 = (void*)0;
/*a*/struct list_item$1int$* litem;
/*a*/struct list_item$1int$* litem_73;
/*a*/struct list_item$1int$* litem_74;
struct list$1int$* __result_obj__361;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_73=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc_v2(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1078, "struct list_item$1int$*"))));
        ...
        __right_value0 = (void*)0;
        litem_74=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value0=(struct list_item$1int$*)come_calloc_v2(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/neo-c.h", 1088, "struct list_item$1int$*"))));
...
struct list$1char$ph* __result_obj__364;
    if(    self==((void*)0)    ) {
        __result_obj__363 = (struct list$1char$ph*)come_increment_ref_count(((void*)0));
        come_call_finalizer(list$1char$ph$p_finalize, __result_obj__363, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    ...
    __result_obj__364 = (struct list$1char$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1char$ph$p_finalize, __result_obj__364, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
/*a*/struct sType* it;
/*a*/struct list$1char$ph* o2_saved_75;
/*a*/char* it_76;
...
struct sFun* __result_obj__366;
    ...
    self->mAllVar=(struct list$1sVar$ph*)come_increment_ref_count(list$1sVar$ph_initialize((struct list$1sVar$ph*)come_increment_ref_count((struct list$1sVar$ph*)come_calloc_v2(1, sizeof(struct list$1sVar$ph)*(1), "./common.h", 304, "struct list$1sVar$ph*"))));
    come_call_finalizer(list$1sVar$ph_finalize, __dec_obj40,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj41=self->mLambdaType,
    self->mLambdaType=(struct sType*)come_increment_ref_count((come_push_stackframe("./common.h", 306, 0),__exception_result_var_b1=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "./common.h", 306, "struct sType*")),(char*)come_increment_ref_count(xsprintf("lambda")),(_Bool)0,info), come_pop_stackframe(), __exception_result_var_b1));
    ...
    for(    o2_saved_75=(struct list$1char$ph*)come_increment_ref_count(param_names),it_76=list$1char$ph_begin(o2_saved_75)    ;    !list$1char$ph_end(o2_saved_75)    ;    it_76=list$1char$ph_next(o2_saved_75)    ){
        __right_value0 = (void*)0;
        list$1char$ph_push_back(self->mLambdaType->mParamNames,(char*)come_increment_ref_count((char*)come_memdup(it_76, "./common.h", 313, "char*")));
    }
    come_call_finalizer(list$1char$ph$p_finalize, o2_saved_75, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    ...
    self->mSource=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./common.h", 319, "struct buffer*"))));
    come_call_finalizer(buffer_finalize, __dec_obj72,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj73=self->mSourceHead,
    self->mSourceHead=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./common.h", 320, "struct buffer*"))));
    come_call_finalizer(buffer_finalize, __dec_obj73,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj74=self->mSourceHead2,
    self->mSourceHead2=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./common.h", 321, "struct buffer*"))));
    come_call_finalizer(buffer_finalize, __dec_obj74,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj75=self->mSourceDefer,
    self->mSourceDefer=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./common.h", 322, "struct buffer*"))));
    ...
    __dec_obj78=self->mTextBlockSName,
    ...
    __dec_obj80=self->mFunAttribute,
    ...
    __result_obj__366 = (struct sFun*)come_increment_ref_count(self);
    ...
    come_call_finalizer(sFun_finalize, __result_obj__366, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct sGenericsFun* __result_obj__367;
    __dec_obj81=self->mGenericsTypeNames,
    ...
    __right_value0 = (void*)0;
    __dec_obj82=self->mMethodGenericsTypeNames,
    ...
    __right_value0 = (void*)0;
    __dec_obj89=self->mGenericsSName,
    self->mGenericsSName=(char*)come_increment_ref_count(__builtin_string(generics_sname));
    __dec_obj89 = come_decrement_ref_count(__dec_obj89, (void*)0, (void*)0, 0,0, (void*)0);
    self->mGenericsSLine=generics_sline;
    self->mConstFun=const_fun;
    __result_obj__367 = (struct sGenericsFun*)come_increment_ref_count(self);
    ...
    (generics_sname = come_decrement_ref_count(generics_sname, (void*)0, (void*)0, 0, 0, (void*)0));
    come_call_finalizer(sGenericsFun_finalize, __result_obj__367, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct CVALUE* __result_obj__368;
    __result_obj__368 = (struct CVALUE*)come_increment_ref_count(self);
    come_call_finalizer(CVALUE_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(CVALUE_finalize, __result_obj__368, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct map$2char$phchar$ph* __result_obj__369;
    ...
    __right_value0 = (void*)0;
    self->items=(char**)come_increment_ref_count(((char**)(__right_value0=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "/usr/local/include/neo-c.h", 1984, "char**"))));
    __right_value0 = (void*)0;
    ...
    self->it=0;
    __result_obj__369 = (struct map$2char$phchar$ph*)come_increment_ref_count(self);
    come_call_finalizer(map$2char$phchar$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(map$2char$phchar$ph$p_finalize, __result_obj__369, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct sModule* __result_obj__370;
    __dec_obj90=self->mSourceHead,
    self->mSourceHead=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./common.h", 406, "struct buffer*"))));
    come_call_finalizer(buffer_finalize, __dec_obj90,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj91=self->mSource,
    self->mSource=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./common.h", 407, "struct buffer*"))));
    come_call_finalizer(buffer_finalize, __dec_obj91,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __dec_obj92=self->mLastCode,
    self->mLastCode=((void*)0);
    __dec_obj92 = come_decrement_ref_count(__dec_obj92, (void*)0, (void*)0, 0,0, (void*)0);
    __dec_obj93=self->mLastCode2,
    self->mLastCode2=((void*)0);
    __dec_obj93 = come_decrement_ref_count(__dec_obj93, (void*)0, (void*)0, 0,0, (void*)0);
    __right_value0 = (void*)0;
    __right_value1 = (void*)0;
    __dec_obj95=self->mHeader,
    self->mHeader=(struct map$2char$phchar$ph*)come_increment_ref_count(map$2char$phchar$ph_initialize((struct map$2char$phchar$ph*)come_increment_ref_count((struct map$2char$phchar$ph*)come_calloc_v2(1, sizeof(struct map$2char$phchar$ph)*(1), "./common.h", 410, "struct map$2char$phchar$ph*"))));
    come_call_finalizer(map$2char$phchar$ph_finalize, __dec_obj95,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    __result_obj__370 = (struct sModule*)come_increment_ref_count(self);
    come_call_finalizer(sModule_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(sModule_finalize, __result_obj__370, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct map$2char$phsVar$ph* __result_obj__371;
    ...
    self->it=0;
    __result_obj__371 = (struct map$2char$phsVar$ph*)come_increment_ref_count(self);
    come_call_finalizer(map$2char$phsVar$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(map$2char$phsVar$ph$p_finalize, __result_obj__371, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct sVarTable* __result_obj__372;
    __dec_obj97=self->mVars,
    ...
    come_call_finalizer(map$2char$phsVar$ph_finalize, __dec_obj97,(void*)0, (void*)0, 0, 0, 0, (void*)0);
    self->mGlobal=global;
    self->mParent=parent;
    __result_obj__372 = (struct sVarTable*)come_increment_ref_count(self);
    come_call_finalizer(sVarTable_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(sVarTable_finalize, __result_obj__372, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct sBlock* __result_obj__373;
    ...
    __result_obj__373 = (struct sBlock*)come_increment_ref_count(self);
    come_call_finalizer(sBlock_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(sBlock_finalize, __result_obj__373, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct sClassModule* __result_obj__374;
    ...
    self->mSLine=sline;
    __result_obj__374 = (struct sClassModule*)come_increment_ref_count(self);
    ...
    come_call_finalizer(sClassModule_finalize, __result_obj__374, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
void* __right_value0 = (void*)0;
char* __dec_obj103;
struct sNodeBase* __result_obj__375;
    ...
    __result_obj__375 = (struct sNodeBase*)come_increment_ref_count(self);
    come_call_finalizer(sNodeBase_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(sNodeBase_finalize, __result_obj__375, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__376;
    __result_obj__376 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self->sname))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__result_obj__376 = come_decrement_ref_count(__result_obj__376, (void*)0, (void*)0, 0, 1, (void*)0));
...
struct sCurrentNode* sCurrentNode_initialize(struct sCurrentNode* self, struct sInfo* info){
void* __right_value0 = (void*)0;
struct sCurrentNode* __result_obj__377;
    ((struct sNodeBase*)(__right_value0=sNodeBase_initialize((struct sNodeBase*)come_increment_ref_count((struct sNodeBase*)self),info)));
    come_call_finalizer(sNodeBase_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    __result_obj__377 = (struct sCurrentNode*)come_increment_ref_count(self);
    come_call_finalizer(sCurrentNode_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(sCurrentNode_finalize, __result_obj__377, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__378;
    __result_obj__378 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self->sname))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__result_obj__378 = come_decrement_ref_count(__result_obj__378, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__379;
    __result_obj__379 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string("sCurrentNode"))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__result_obj__379 = come_decrement_ref_count(__result_obj__379, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__382;
    ...
    self->key_list->it=self->key_list->head;
    if(    self->key_list->it    ) {
        __result_obj__381 = self->key_list->it->item;
        return __result_obj__381;
    }
    memset(&result_81,0,sizeof(char*));
    __result_obj__382 = result_81;
...
char* __result_obj__385;
    if(    self==((void*)0)||self->key_list->it==((void*)0)    ) {
        memset(&result,0,sizeof(char*));
        __result_obj__383 = result;
        return __result_obj__383;
    }
    self->key_list->it=self->key_list->it->next;
    if(    self->key_list->it    ) {
        __result_obj__384 = self->key_list->it->item;
        return __result_obj__384;
    }
    memset(&result_82,0,sizeof(char*));
    __result_obj__385 = result_82;
...
struct sVar* __result_obj__387;
struct sVar* __result_obj__388;
struct sVar* __result_obj__389;
    ...
    while(    (_Bool)1    ) {
        if(        self->item_existance[it]        ) {
            if(            string_equals(self->keys[it],key)            ) {
                __result_obj__386 = (struct sVar*)come_increment_ref_count(self->items[it]);
            ...
            if(            it>=self->size            ) {
                ...
                __result_obj__387 = (struct sVar*)come_increment_ref_count(default_value);
                come_call_finalizer(sVar_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
                come_call_finalizer(sVar_finalize, __result_obj__387, (void*)0, (void*)0, 0, 0, 1, (void*)0);
                return __result_obj__387;
            }
        }
        else {
            __result_obj__388 = (struct sVar*)come_increment_ref_count(default_value);
            come_call_finalizer(sVar_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
            come_call_finalizer(sVar_finalize, __result_obj__388, (void*)0, (void*)0, 0, 0, 1, (void*)0);
            return __result_obj__388;
        }
    }
    __result_obj__389 = (struct sVar*)come_increment_ref_count(default_value);
    come_call_finalizer(sVar_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(sVar_finalize, __result_obj__389, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
/*a*/unsigned int hash;
/*a*/unsigned int it;
struct sVar* __result_obj__390;
struct sVar* __result_obj__391;
struct sVar* __result_obj__392;
struct sVar* __result_obj__393;
    memset(&default_value,0,sizeof(struct sVar*));
    hash=string_get_hash_key(((char*)key))%self->size;
    it=hash;
    while(    (_Bool)1    ) {
        if(        self->item_existance[it]        ) {
            if(            string_equals(self->keys[it],key)            ) {
                __result_obj__390 = (struct sVar*)come_increment_ref_count(self->items[it]);
                come_call_finalizer(sVar_finalize, default_value, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                come_call_finalizer(sVar_finalize, __result_obj__390, (void*)0, (void*)0, 0, 0, 1, (void*)0);
            ...
            if(            it>=self->size            ) {
                ...
                __result_obj__391 = (struct sVar*)come_increment_ref_count(default_value);
                come_call_finalizer(sVar_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
                come_call_finalizer(sVar_finalize, __result_obj__391, (void*)0, (void*)0, 0, 0, 1, (void*)0);
                return __result_obj__391;
            }
        }
        else {
            __result_obj__392 = (struct sVar*)come_increment_ref_count(default_value);
            come_call_finalizer(sVar_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
            come_call_finalizer(sVar_finalize, __result_obj__392, (void*)0, (void*)0, 0, 0, 1, (void*)0);
            return __result_obj__392;
        }
    }
    __result_obj__393 = (struct sVar*)come_increment_ref_count(default_value);
    come_call_finalizer(sVar_finalize, default_value, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(sVar_finalize, __result_obj__393, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct tuple2$2char$phsType$ph* __result_obj__394;
    ...
    __result_obj__394 = (struct tuple2$2char$phsType$ph*)come_increment_ref_count(self);
    ...
    come_call_finalizer(tuple2$2char$phsType$ph$p_finalize, __result_obj__394, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
/*a*/struct list_item$1tuple2$2char$phsType$ph$ph* litem_83;
struct tuple2$2char$phsType$ph* __dec_obj107;
/*a*/struct list_item$1tuple2$2char$phsType$ph$ph* litem_84;
struct tuple2$2char$phsType$ph* __dec_obj108;
struct list$1tuple2$2char$phsType$ph$ph* __result_obj__396;
    if(    self->len==0    ) {
...
static struct tuple2$2char$phsType$ph* tuple2$2char$phsType$ph_clone(struct tuple2$2char$phsType$ph* self){
struct tuple2$2char$phsType$ph* __result_obj__397;
void* __right_value0 = (void*)0;
/*a*/struct tuple2$2char$phsType$ph* result;
char* __dec_obj109;
struct sType* __dec_obj110;
struct tuple2$2char$phsType$ph* __result_obj__398;
    if(    self==(void*)0    ) {
        __result_obj__397 = (struct tuple2$2char$phsType$ph*)come_increment_ref_count((void*)0);
        come_call_finalizer(tuple2$2char$phsType$ph$p_finalize, __result_obj__397, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    ...
    __result_obj__398 = (struct tuple2$2char$phsType$ph*)come_increment_ref_count(result);
    come_call_finalizer(tuple2$2char$phsType$ph_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(tuple2$2char$phsType$ph$p_finalize, __result_obj__398, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
/*a*/struct list_item$1CVALUE$ph* litem_92;
struct CVALUE* __dec_obj115;
struct list$1CVALUE$ph* __result_obj__399;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_91=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "/usr/local/include/neo-c.h", 1156, "struct list_item$1CVALUE$ph*"))));
        litem_91->prev=self->head;
        litem_91->next=((void*)0);
        __dec_obj114=litem_91->item,
        ...
        __right_value0 = (void*)0;
        litem_92=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "/usr/local/include/neo-c.h", 1166, "struct list_item$1CVALUE$ph*"))));
        litem_92->prev=self->tail;
        litem_92->next=((void*)0);
        __dec_obj115=litem_92->item,
...
/*a*/char* class_name;
void* __right_value1 = (void*)0;
/*a*/struct sClass* current_stack;
/*a*/struct sVarTable* vtable;
...
/*a*/struct tuple2$2char$phsType$ph* item;
/*a*/struct sType* type3;
/*a*/struct tuple2$2char$phsType$ph* item2;
/*a*/struct map$2char$phsVar$ph* o2_saved_85;
/*a*/char* it_86;
/*a*/char* key_87;
/*a*/struct sVar* value_88;
/*a*/struct sType* type2_89;
/*a*/struct tuple2$2char$phsType$ph* item_90;
...
_Bool __result_obj__400;
    ...
    __right_value0 = (void*)0;
    current_stack=(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "./common.h", 670, "struct sClass*")),(char*)come_increment_ref_count(class_name),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,(_Bool)0,info));
    ...
    while(    vtable    ) {
        for(        o2_saved=(struct map$2char$phsVar$ph*)come_increment_ref_count(vtable->mVars),it=map$2char$phsVar$ph_begin(o2_saved)        ;        !map$2char$phsVar$ph_end(o2_saved)        ;        it=map$2char$phsVar$ph_next(o2_saved)        ){
            ...
            __right_value1 = (void*)0;
            __right_value2 = (void*)0;
            item=(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph*)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "./common.h", 683, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(__builtin_string(value->mCValueName)),(struct sType*)come_increment_ref_count(type2)));
            if(            value->mCValueName!=((void*)0)            ) {
                if(                strcmp(value->mCValueName,"__list_values")==0                ) {
                    ...
                    __right_value1 = (void*)0;
                    __right_value2 = (void*)0;
                    item2=(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph*)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "./common.h", 703, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(__builtin_string(value->mCValueName)),(struct sType*)come_increment_ref_count(type3)));
                    __right_value0 = (void*)0;
    ...
    add_come_code(info,"({");
    while(    vtable    ) {
        for(        o2_saved_85=(struct map$2char$phsVar$ph*)come_increment_ref_count(vtable->mVars),it_86=map$2char$phsVar$ph_begin(o2_saved_85)        ;        !map$2char$phsVar$ph_end(o2_saved_85)        ;        it_86=map$2char$phsVar$ph_next(o2_saved_85)        ){
            key_87=it_86;
            __right_value0 = (void*)0;
            value_88=((struct sVar*)(__right_value0=map$2char$phsVar$ph_operator_load_element(vtable->mVars,key_87)));
            ...
            __right_value0 = (void*)0;
            __right_value1 = (void*)0;
            item_90=(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph*)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "./common.h", 734, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(value_88->mCValueName),(struct sType*)come_increment_ref_count(type2_89)));
            if(            value_88->mCValueName!=((void*)0)            ) {
                if(                strcmp(value_88->mCValueName,"__list_values")==0                ) {
                }
                else if(                strcmp(value_88->mCValueName,"__map_keys")==0                ) {
                }
                else if(                strcmp(value_88->mCValueName,"__map_element")==0                ) {
                }
                else if(                string_operator_equals(value_88->mType->mClass->mName,"va_list")||string_operator_equals(value_88->mType->mClass->mName,"__builtin_va_list")                ) {
                }
                else {
                    if(                    string_operator_equals(value_88->mFunName,info->come_fun->mName)                    ) {
                        if(                        string_operator_equals(type2_89->mClass->mName,"lambda")                        ) {
                            add_come_code(info,"__current_stack%d__.%s = %s;\n",info->current_stack_num,value_88->mCValueName,value_88->mCValueName);
                        }
                        else {
                            add_come_code(info,"__current_stack%d__.%s = &%s;\n",info->current_stack_num,value_88->mCValueName,value_88->mCValueName);
                        }
            ...
            come_call_finalizer(tuple2$2char$phsType$ph$p_finalize, item_90, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        }
        come_call_finalizer(map$2char$phsVar$ph$p_finalize, o2_saved_85, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        vtable=vtable->mParent;
    }
    add_come_code(info,"})");
    ...
    come_value->type=(struct sType*)come_increment_ref_count((come_push_stackframe("./common.h", 783, 2),__exception_result_var_b3=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "./common.h", 783, "struct sType*")),(char*)come_increment_ref_count(class_name),(_Bool)0,info), come_pop_stackframe(), __exception_result_var_b3));
...
struct sNothingNode* sNothingNode_initialize(struct sNothingNode* self, struct sInfo* info){
void* __right_value0 = (void*)0;
struct sNothingNode* __result_obj__401;
    ((struct sNodeBase*)(__right_value0=sNodeBase_initialize((struct sNodeBase*)come_increment_ref_count((struct sNodeBase*)self),info)));
    come_call_finalizer(sNodeBase_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    __result_obj__401 = (struct sNothingNode*)come_increment_ref_count(self);
    come_call_finalizer(sNothingNode_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(sNothingNode_finalize, __result_obj__401, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__402;
    __result_obj__402 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string("sNothingNode"))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__result_obj__402 = come_decrement_ref_count(__result_obj__402, (void*)0, (void*)0, 0, 1, (void*)0));
