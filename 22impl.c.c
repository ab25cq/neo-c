...
memset(&header_66, 0, sizeof(struct buffer*));
    if(charp_operator_equals(buf,"impl")) {
        ...
        word_48=(char*)come_increment_ref_count(((char*)(__right_value79=parse_word(info))));
        if(*info->p==60) {
            info->p++;
            skip_spaces_and_lf(info);
            list$1charph_reset(info->generics_type_names);
            while((_Bool)1) {
                generics_name_51=(char*)come_increment_ref_count(((char*)(__right_value80=parse_word(info))));
                list$1charph_push_back(info->generics_type_names,(char*)come_increment_ref_count(((char*)(__right_value84=string_clone(generics_name_51)))));
        ...
        info->impl_type=(struct sType*)come_increment_ref_count(((struct sType*)(__right_value86=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(__right_value85=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "22impl.c", 45, "sType")))),word_48,(_Bool)0,info))));
        ...
        while(*info->p!=125) {
            parse_sharp_v5(info);
            head_62=info->p;
            buf_63=(char*)come_increment_ref_count(((char*)(__right_value87=parse_word(info))));
            parse_sharp_v5(info);
            node_64=(struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value88=top_level_v99(buf_63,head_62,head_sline,info))));
            parse_sharp_v5(info);
            while(*info->p==59) {
                info->p++;
                skip_spaces_and_lf(info);
        ...
        header_66=(struct buffer*)come_increment_ref_count(((struct buffer*)(__right_value90=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(__right_value89=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "22impl.c", 82, "buffer"))))))));
        come_call_finalizer3(__right_value89,buffer_finalize, 0, 1, 0, 0, __result_obj__);
        buffer_append(header_66,source_head_47,source_tail_65-source_head_47);
        add_come_code_at_come_header(info,"impl %s\n",((char*)(__right_value91=buffer_to_string(header_66))));
        __right_value91 = come_decrement_ref_count2(__right_value91, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
        __result47__ = __result_obj__ = (struct sNode*)((void*)0);
    ...
    __result48__ = __result_obj__ = ((struct sNode*)(__right_value92=top_level_v92(buf,head,head_sline,info)));
    if(__right_value92) { __right_value92 = come_decrement_ref_count2(__right_value92, ((struct sNode*)__right_value92)->finalize, ((struct sNode*)__right_value92)->_protocol_obj, 1, 0, 0, __result_obj__); } 
    return __result48__;
}
...
memset(&litem_54, 0, sizeof(struct list_item$1charph*));
                    if(self->len==0) {
                        litem_52=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value81=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./neo-c.h", 219, "list_item$1charph"))));
                        come_call_finalizer3(__right_value81,list_item$1charphp_finalize, 0, 1, 0, 0, __result_obj__);
                        ...
                        if(self->len==1) {
                            litem_53=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value82=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./neo-c.h", 229, "list_item$1charph"))));
                            come_call_finalizer3(__right_value82,list_item$1charphp_finalize, 0, 1, 0, 0, __result_obj__);
                            ...
                            litem_54=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value83=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./neo-c.h", 239, "list_item$1charph"))));
                            come_call_finalizer3(__right_value83,list_item$1charphp_finalize, 0, 1, 0, 0, __result_obj__);
