...
struct sNode* __result_obj__4;
    if(    !gComeC&&charp_operator_equals(buf,"impl")    ) {
        ...
        info->impl_type=(struct sType*)come_increment_ref_count((come_push_stackframe("22impl.c", 45, 1),__exception_result_var_b2=sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "22impl.c", 45, "struct sType*")),(char*)come_increment_ref_count(word),(_Bool)0,info), come_pop_stackframe(), __exception_result_var_b2));
        ...
        (come_push_stackframe("22impl.c", 81, 3),__exception_result_var_b4=expected_next_character(125,info), come_pop_stackframe(), __exception_result_var_b4);
        list$1char$ph_reset(info->generics_type_names);
...
struct list$1char$ph* __result_obj__2;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_0=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 1172, "struct list_item$1char$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_1=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./neo-c.h", 1182, "struct list_item$1char$ph*"))));
