...
_Bool sArrayInitializer_compile(struct sArrayInitializer* self, struct sInfo* info  )
{
    ...
    if(type_) {
        ...
        come_value->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "09pre_op.nc", 677, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0));
        ...
        come_value_31->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "09pre_op.nc", 687, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),0,info,0));
...
;    struct sType* type_53  =0;
    ...
    if(*info->p==123) {
        ...
        struct_initializer_flag=0;
        {
            ...
            if(xisalpha(*info->p)||*info->p==95) {
                ...
                if(is_type_name(word,info)) {
                    info->p=p2;
                    info->sline=sline2;
                    (come_push_stackframe("09pre_op.nc", 919, 1),__exception_result_var_b2=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b2);
        ...
        if(*info->p==123) {
            ...
            (come_push_stackframe("09pre_op.nc", 1022, 2),__exception_result_var_b3=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b3);
            ...
            skip_spaces_and_lf(info);
            multiple_assign_var2=(come_push_stackframe("09pre_op.nc", 1041, 4),__exception_result_var_b5=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b5);
            ...
            (come_push_stackframe("09pre_op.nc", 1048, 5),__exception_result_var_b6=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b6);
            skip_spaces_and_lf(info);
            ...
            skip_spaces_and_lf(info);
            multiple_assign_var3=(come_push_stackframe("09pre_op.nc", 1119, 7),__exception_result_var_b8=((struct tuple3$3sType$phchar$ph_Bool$*)(__right_value0=parse_type(info,0,1,0))), come_pop_stackframe(), __exception_result_var_b8);
            ...
            (come_push_stackframe("09pre_op.nc", 1126, 8),__exception_result_var_b9=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b9);
            skip_spaces_and_lf(info);
            ...
            (come_push_stackframe("09pre_op.nc", 1154, 9),__exception_result_var_b10=expected_next_character(41,info), come_pop_stackframe(), __exception_result_var_b10);
            skip_spaces_and_lf(info);
