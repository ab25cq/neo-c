...
_conditional_value_X0;})) {
    ...
    if(field_type_17->mHeap&&right_type->mHeap&&field_type_17->mPointerNum>0&&right_type->mPointerNum>0) {
        ...
        __dec_obj77=come_value_20->type,
    ...
    __dec_obj84=come_value_20->type,
...
_conditional_value_X0;})) {
    ...
    if(field_type==((void*)0)) {
        ...
        if(arrow_) {
            __dec_obj93=come_value_29->c_value,
        ...
        __dec_obj95=come_value_29->type,
    ...
    if(left_value->type->mPointerNum>0||left_value->type->mArrayPointerNum>0) {
        __dec_obj96=come_value_30->c_value,
    ...
    __dec_obj99=come_value_30->type,
    ...
    if(list$1sNode$ph_length(come_value_30->type->mArrayNum)>0) {
        if(info->in_store_array) {
            ...
            __dec_obj100=come_value_30->type->mOriginalLoadVarType,
            ...
            __dec_obj101=come_value_30->type->mOriginalLoadVarType,
...
;    char*  fun_name2  =0;
    ...
    if(!calling_fun) {
        ...
        __dec_obj114=result_type->mArrayNum,
