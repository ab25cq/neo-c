...
left_type3 = (void*)0;
    ...
    if(    list$1sNode$ph_length(come_value->type->mArrayNum)==1    ) {
        __right_value0 = (void*)0;
        __dec_obj92=come_value->type->mOriginalLoadVarType,
