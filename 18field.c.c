...
right_value191 = (void*)0;
    ...
    for(    o2_saved_123=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count((klass_114->mFields)),field_126=list$1tuple2$2charphsTypephph_begin((o2_saved_123));    !list$1tuple2$2charphsTypephph_end((o2_saved_123));    field_126=list$1tuple2$2charphsTypephph_next((o2_saved_123))    ){
        ...
        if(string_operator_equals(field_name_129,name_108)) {
    ...
    if(index_121==list$1tuple2$2charphsTypephph_length(klass_114->mFields)) {
        ...
        for(        o2_saved_131=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count((klass_114->mFields)),field_132=list$1tuple2$2charphsTypephph_begin((o2_saved_131));        !list$1tuple2$2charphsTypephph_end((o2_saved_131));        field_132=list$1tuple2$2charphsTypephph_next((o2_saved_131))        ){
            ...
            for(            o2_saved_136=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count((klass2_135->mFields)),field2_137=list$1tuple2$2charphsTypephph_begin((o2_saved_136));            !list$1tuple2$2charphsTypephph_end((o2_saved_136));            field2_137=list$1tuple2$2charphsTypephph_next((o2_saved_136))            ){
                ...
                if(string_operator_equals(field_name2_138,name_108)) {
            ...
            if(string_operator_equals(field_name_133,name_108)) {
...
memset(&result_128, 0, sizeof(struct tuple2$2charphsTypeph*));
        if(self==((void*)0)||self->it==((void*)0)) {
            memset(&result_127,0,sizeof(struct tuple2$2charphsTypeph*));
            __result88__ = __result_obj__ = result_127;
            return __result88__;
        }
...
right_value194 = (void*)0;
    __result99__ = __result_obj__ = ((char*)(right_value194=__builtin_string("sNullCheckNode")));
...
right_value209 = (void*)0;
    __result107__ = __result_obj__ = ((char*)(right_value209=__builtin_string("sNullableNode")));
...
right_value219 = (void*)0;
    __result112__ = __result_obj__ = ((char*)(right_value219=__builtin_string("sRangeCheckNode")));
...
right_value234 = (void*)0;
    __result117__ = __result_obj__ = ((char*)(right_value234=__builtin_string("sLoadFieldNode")));
...
right_value250 = (void*)0;
    ...
    for(    o2_saved_182=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count((klass_178->mFields)),field_183=list$1tuple2$2charphsTypephph_begin((o2_saved_182));    !list$1tuple2$2charphsTypephph_end((o2_saved_182));    field_183=list$1tuple2$2charphsTypephph_next((o2_saved_182))    ){
        ...
        if(string_operator_equals(field_name_184,name_174)) {
    ...
    if(index_180==list$1tuple2$2charphsTypephph_length(klass_178->mFields)) {
        ...
        for(        o2_saved_186=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count((klass_178->mFields)),field_187=list$1tuple2$2charphsTypephph_begin((o2_saved_186));        !list$1tuple2$2charphsTypephph_end((o2_saved_186));        field_187=list$1tuple2$2charphsTypephph_next((o2_saved_186))        ){
            ...
            for(            o2_saved_191=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count((klass2_190->mFields)),field2_192=list$1tuple2$2charphsTypephph_begin((o2_saved_191));            !list$1tuple2$2charphsTypephph_end((o2_saved_191));            field2_192=list$1tuple2$2charphsTypephph_next((o2_saved_191))            ){
                ...
                if(string_operator_equals(field_name2_193,name_174)) {
            ...
            if(string_operator_equals(field_name_188,name_174)) {
    ...
    if(list$1sNodeph_length(come_value_195->type->mArrayNum)==1) {
...
right_value255 = (void*)0;
    __result125__ = __result_obj__ = ((char*)(right_value255=__builtin_string("sStoreArrayNode")));
...
right_value291 = (void*)0;
    ...
    dec_stack_ptr(1,info);
    if(gComeDebug&&left_value_201->type->mPointerNum>0) {
    ...
    come_call_finalizer3(right_value259,list$1CVALUEphp_finalize, 0, 1, 0, 0, (void*)0);
    come_call_finalizer3(right_value260,list$1CVALUEphp_finalize, 0, 1, 0, 0, (void*)0);
    ...
    if(!node_compile(right_199,info)) {
    ...
    if(!calling_fun_218) {
        ...
        if(left_value_201->var&&left_value_201->var->mType&&list$1sNodeph_length(left_value_201->var->mType->mArrayNum)>0) {
            ...
            if(list$1sNodeph_length(result_type_224->mArrayNum)>0) {
                ...
                if(n_225==0) {
                    ...
                    if(n_225>0) {
                        ...
                        if(n_225<0) {
                            ...
                            if(result_type_224->mPointerNum<0) {
            ...
            for(            o2_saved_249=(struct list$1sNodeph*)come_increment_ref_count((var_type_223->mArrayNum)),it_250=list$1sNodeph_begin((o2_saved_249));            !list$1sNodeph_end((o2_saved_249));            it_250=list$1sNodeph_next((o2_saved_249))            ){
                ...
                if(i_248!=list$1sNodeph_length(var_type_223->mArrayNum)-1) {
        ...
        come_call_finalizer3(right_value279,buffer_finalize, 0, 1, 0, 0, (void*)0);
        come_call_finalizer3(right_value280,buffer_finalize, 0, 1, 0, 0, (void*)0);
        ...
        if(left_type_202->mHeap&&right_type_214->mHeap&&left_type_202->mPointerNum>0&&right_type_214->mPointerNum>0) {
            if(left_value_201->type->mPointerNum>=1) {
                ...
                if(left_value_201->type->mPointerNum==0) {
                    decrement_ref_count_object(left_type_202,left_value_code_257,info,(_Bool)0);
                    std_move(left_type_202,right_type_214,right_value_213,info);
        ...
        come_call_finalizer3(right_value289,list$1sNodephp_finalize, 0, 1, 0, 0, (void*)0);
        come_call_finalizer3(right_value290,list$1sNodephp_finalize, 0, 1, 0, 0, (void*)0);
...
memset(&result_208, 0, sizeof(struct sNode*));
        if(self==((void*)0)) {
            memset(&result_207,0,sizeof(struct sNode*));
            __result127__ = __result_obj__ = result_207;
        ...
        memset(&result_208,0,sizeof(struct sNode*));
        __result129__ = __result_obj__ = result_208;
...
memset(&result_211, 0, sizeof(struct sNode*));
        if(self==((void*)0)||self->it==((void*)0)) {
            memset(&result_210,0,sizeof(struct sNode*));
            __result130__ = __result_obj__ = result_210;
        ...
        memset(&result_211,0,sizeof(struct sNode*));
        __result132__ = __result_obj__ = result_211;
...
memset(&default_value_221, 0, sizeof(struct CVALUE*));
            ...
            while(it_219!=((void*)0)) {
                if(position==i_220) {
                    __result135__ = __result_obj__ = it_219->item;
            ...
            memset(&default_value_221,0,sizeof(struct CVALUE*));
            __result136__ = __result_obj__ = default_value_221;
                                ...
                                if(head==0&&tail==self->len) {
                                    ...
                                    if(head==0) {
                                        ...
                                        if(tail==self->len) {
                                            ...
                                            if(head_prev_it_235!=((void*)0)) {
                                                head_prev_it_235->next=tail_it_236;
                                            }
                                            if(tail_it_236!=((void*)0)) {
...
memset(&result_244, 0, sizeof(struct CVALUE*));
                if(self==((void*)0)) {
                    memset(&result_243,0,sizeof(struct CVALUE*));
                    __result139__ = __result_obj__ = result_243;
                ...
                memset(&result_244,0,sizeof(struct CVALUE*));
                __result141__ = __result_obj__ = result_244;
...
memset(&result_247, 0, sizeof(struct CVALUE*));
                ...
                memset(&result_247,0,sizeof(struct CVALUE*));
                __result144__ = __result_obj__ = result_247;
...
right_value295 = (void*)0;
    __result149__ = __result_obj__ = ((char*)(right_value295=__builtin_string("sLoadArrayNode")));
...
right_value330 = (void*)0;
    ...
    come_call_finalizer3(right_value300,list$1CVALUEphp_finalize, 0, 1, 0, 0, (void*)0);
    come_call_finalizer3(right_value301,list$1CVALUEphp_finalize, 0, 1, 0, 0, (void*)0);
    ...
    if(!calling_fun_270) {
        if(gComeDebug&&left_value_262->var&&left_value_262->var->mType&&list$1sNodeph_length(left_value_262->var->mType->mArrayNum)>0) {
            ...
            come_call_finalizer3(right_value308,buffer_finalize, 0, 1, 0, 0, (void*)0);
            come_call_finalizer3(right_value309,buffer_finalize, 0, 1, 0, 0, (void*)0);
            ...
            come_call_finalizer3(right_value322,buffer_finalize, 0, 1, 0, 0, (void*)0);
            ...
            if(list$1sNodeph_length(result_type_290->mArrayNum)>0) {
                ...
                if(n_291==0) {
                    ...
                    if(left_type_263->mOriginalLoadVarType->v1) {
                        ...
                        come_call_finalizer3(right_value329,sType_finalize, 0, 1, 0, 0, (void*)0);
                    }
...
right_value334 = (void*)0;
    __result153__ = __result_obj__ = ((char*)(right_value334=__builtin_string("sLoadRangeArrayNode")));
...
right_value350 = (void*)0;
    ...
    come_call_finalizer3(right_value335,CVALUE_finalize, 0, 1, 0, 0, (void*)0);
    dec_stack_ptr(1,info);
    ...
    come_call_finalizer3(right_value337,list$1CVALUEphp_finalize, 0, 1, 0, 0, (void*)0);
    come_call_finalizer3(right_value338,list$1CVALUEphp_finalize, 0, 1, 0, 0, (void*)0);
    ...
    if(!calling_fun_303) {
        ...
        come_call_finalizer3(right_value342,buffer_finalize, 0, 1, 0, 0, (void*)0);
...
right_value358 = (void*)0;
    ...
    __result159__ = __result_obj__ = ((struct sNode*)(right_value358=_inf_value1));
    if(right) { right = come_decrement_ref_count2(right, ((struct sNode*)right)->finalize, ((struct sNode*)right)->_protocol_obj, 0, 1, 0, (void*)0); } 
    name = come_decrement_ref_count2(name, (void*)0, (void*)0, 0, 1, 0, (void*)0);
                        ...
                        if(*info->p==63&&*(info->p+1)==63) {
                            ...
                            if((*info->p==46&&*(info->p+1)!=46)||(*info->p==45&&*(info->p+1)==62)) {
                                ...
                                if(*info->p==61&&*(info->p+1)!=61) {
                                    ...
                                    if(*info->p==40||*info->p==123||parse_method_generics_type_351||(*info->p==45&&*(info->p+1)==62&&*(info->p+2)==40)) {
...
memset(&litem_325, 0, sizeof(struct list_item$1sNodeph*));
                if(self->len==0) {
                    litem_323=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value363=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./neo-c.h", 219, "list_item$1sNodeph"))));
                    ...
                    if(self->len==1) {
                        litem_324=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value364=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./neo-c.h", 229, "list_item$1sNodeph"))));
                        ...
                        litem_325=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value365=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./neo-c.h", 239, "list_item$1sNodeph"))));
